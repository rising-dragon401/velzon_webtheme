      ...
      <React.Fragment>
          <Col className="col-xxl-8">
              <Card className="card card-height-100">
                  <Card.Header className="card-header border-0 align-items-center d-flex">
                  ...
                  <Card.Header className="card-header p-0 border-0 bg-light-subtle">
                  ...
                  <Card.Body className="card-body p-0 pb-2">
                      <div className="w-100">
