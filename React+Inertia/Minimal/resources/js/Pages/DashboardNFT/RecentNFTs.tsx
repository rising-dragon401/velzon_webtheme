...
import { Card, Col, DropdownItem, Row, Dropdown } from 'react-bootstrap';
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        <div className="flex-grow-1">
                                                            <h6 className="mb-1"><Link href="/apps-nft-item-details" className="text-body">{item.title}</Link></h6>
