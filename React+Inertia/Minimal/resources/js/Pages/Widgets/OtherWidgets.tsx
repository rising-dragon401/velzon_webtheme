            ...
            <Row>
                ...
                <Col xl={4}>
                    <Card className="bg-primary">
                        <Card.Body className="p-0">
                            <Alert variant="success" className="rounded-top alert-solid alert-label-icon border-0 rounded-0 m-0 d-flex align-items-center">
                ...
                <Col xl={4}>
                    <Card>
                        <Card.Body className="p-0">
                            <Alert variant="primary" className="border-0 rounded-top rounded-0 m-0 d-flex align-items-center">
                                <div className="flex-grow-1 text-truncate">
