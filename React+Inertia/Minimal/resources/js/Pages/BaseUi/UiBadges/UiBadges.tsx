                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <Card.Body>
                                    ...
                                    <p className="text-muted">Use the <code>rounded-pill badge-*-subtle</code> class with the below-mentioned variation
                            ...
                            <Card>
                                ...
                                <Card.Body>
                                    ...
                                    <p className="text-muted">
                                        Use the <code>badge-border</code> and <code>badge-*-subtle</code> with below mentioned modifier classes to make badges with border & soft backgorund.
                                    </p>
                                    <div className="live-preview">
