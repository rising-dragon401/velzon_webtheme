                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            ...
                                            <Alert variant="light" className="alert-top-border" role="alert" dismissible>
                                                <i className="ri-mail-line me-3 align-middle fs-lg text-body"></i><strong>Light</strong> - Top border alert
                                            </Alert>

                                            <h6>Dark Alert</h6>
                                            <Alert variant="dark" className="alert-top-border mb-0" role="alert" dismissible>
                                                <i className="me-3 align-middle fs-lg text-body ri-refresh-line label-icon"></i><strong>Dark</strong> - Top border alert
                                            </Alert>
