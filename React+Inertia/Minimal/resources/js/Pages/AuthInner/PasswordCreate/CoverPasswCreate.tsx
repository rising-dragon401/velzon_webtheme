                                                    ...
                                                    <Form onSubmit={validation.handleSubmit} action="/auth-signin-basic">
                                                        <div className="mb-3">
                                                            ...
                                                            <div className="position-relative auth-pass-inputgroup">
                                                                ...
                                                                <Button variant="link" onClick={() => setPasswordShow(!passwordShow)} className="position-absolute end-0 top-0 text-decoration-none text-muted password-addon"
                                                        ...
                                                        <div className="mt-4">
                                                            <Button className="w-100 btn-secondary" type="submit">Reset Password</Button>
                                                        </div>
                                                    </Form>
                                                </div>
