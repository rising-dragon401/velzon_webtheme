                                ...
                                {marketPlacewidget.map((item, key) => (<Col lg={4} md={6} key={key}>
                                    <Card>
                                        <Card.Body>
                                            ...
                                            <Link href="#!" className="float-end fs-14"> View All <i className="ri-arrow-right-line align-bottom"></i></Link>
                                            <h5 className="mb-0 fs-15"><Link href="#!" className="text-reset">{item.category} <span className="badge bg-success-subtle text-success">{item.quantity}</span></Link></h5>
                                        </Card.Body>
                                    </Card>
                                </Col>))}
                            </Row>
                                ...
                                <Card className="explore-box">
                                    <Card.Body>
                                        ...
                                        <div className="mt-3">
                                            ...
                                            <h6 className="fs-16 mb-0"><Link href="/apps-nft-item-details" className="text-body">{item.category}</Link></h6>
                                        </div>
                                    </Card.Body>
                                </Card>
                            </Col>
                        ...
                        {nftArtworkData.map((item, key) => (
                            <Col key={key}>
                                <Card className="explore-box card-animate">
                                    ...
                                    <Card.Body>
                                        <p className="fw-medium mb-0 float-end"><i className="mdi mdi-heart text-danger align-middle"></i> {item.likes} </p>
                                        <h5 className="mb-1 fs-16"><Link href="/apps-nft-item-details" className="text-reset">{item.title}</Link></h5>
                            ...
                            <Col key={key}>
                                <Card>
                                    ...
                                    <Card.Body className="text-center">
                                        ...
                                        <h5 className="mt-3 mb-1 fs-16"><Link href="#!" className="text-reset">{item.author}</Link></h5>
