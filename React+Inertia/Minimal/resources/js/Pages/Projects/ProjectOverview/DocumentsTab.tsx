                    ...
                    <Row>
                        <Col lg={12}>
                                ...
                                <Table className="table-borderless align-middle mb-0">
                                    ...
                                    <tbody>
                                        <tr> 
                                            ...
                                            <td>
                                            <Dropdown>
                                                    <Dropdown.Toggle as="a" href="#" className="btn btn-soft-primary btn-sm btn-icon arrow-none ">
                            ...
                            <div className="text-center mt-3">
                                <Link href="#" className="text-primary"><i className="mdi mdi-loading mdi-spin fs-20 align-middle me-2"></i> Load more </Link>
                            </div>
                        </Col>
                    </Row>
                </Card.Body>
