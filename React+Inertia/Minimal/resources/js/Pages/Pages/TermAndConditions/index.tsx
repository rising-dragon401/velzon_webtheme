                        ...
                        <Card>
                            ...
                            <Card.Body className='p-4'>
                                ...
                                <div className="text-end">
                                    <Link href="#!" className="btn btn-primary me-1">Accept</Link>
                                    <Link href="#!" className="btn btn-outline-danger"><i className="ri-close-line align-bottom me-1"></i> Decline</Link>
                                </div>
                            </Card.Body>
                        </Card>
                    </Col>
...
TermAndConditions.layout = (page:any) => <Layout children={page} />
