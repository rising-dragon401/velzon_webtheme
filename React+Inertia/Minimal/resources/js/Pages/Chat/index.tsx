          ...
          <div className="chat-wrapper d-lg-flex gap-1 mx-n4 mt-n4 p-1">
            <div className="chat-leftsidebar">
                  ...
                  <div className="flex-shrink-0">
                    ...
                    >
                      <Button
                        id="addcontact"
                        size="sm"
                        className="shadow-none btn-soft-primary"
                      >
              ...
              <Tab.Container defaultActiveKey="1">
                <Nav className="nav nav-tabs nav-tabs-custom nav-primary nav-justified mb-3">
                  <Nav.Item>
                    <Nav.Link
                      eventKey="1"
                    >
                        ...
                        <SimpleBar className="chat-room-list pt-3" style={{ margin: "-16px 0px 0px" }}>
                          ...
                          <div className="d-flex align-items-center px-4 mt-4 pt-2 mb-2">
                            ...
                            <div className="flex-shrink-0">
                              <OverlayTrigger
                                placement="bottom"
                                overlay={<Tooltip id="tooltip">Create group</Tooltip>}
                                rootClose={true}
                              >
                                <Button
                                  id="createnewmsg"
                    ...
                    <SimpleBar className="chat-room-list pt-3" style={{ margin: "-16px 0px 0px" }}>
                      {
                        isLoading ? <Spinners setLoading={setLoading} />
                          ...
                          <div className="sort-contact">
                            {(chatContactData || []).map((contact: any, key: number) => (
                              <div className="mt-3" key={key}>
                                ...
                                <ul id={"contact-sort-" + contact.title} className="list-unstyled contact-list">
                                  {
                                    contact.contacts && contact.contacts.map((item: any, key: number) => (
                                          ...
                                          <div className="flex-shrink-0">
                                            <Dropdown>
                                              ...
                                              <Dropdown.Menu className="dropdown-menu-end">
                                                <Dropdown.Item><i className="ri-pencil-line text-muted me-2 align-bottom" />Edit</Dropdown.Item>
                                                <Dropdown.Item><i className="ri-forbid-2-line text-muted me-2 align-bottom" />Block</Dropdown.Item>
                                                <Dropdown.Item><i className="ri-delete-bin-6-line text-muted me-2 align-bottom" /> Remove</Dropdown.Item>
                                              </Dropdown.Menu>
                                            </Dropdown>
                                          </div>
                                        </div>
