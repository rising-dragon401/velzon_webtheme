                    ...
                    <Card.Body>
                        <div className="d-flex mb-3">
                            ...
                            <div className="flex-shrink-0">
                                <Link href="#" className="badge bg-secondary-subtle text-secondary badge-border">BTC</Link>
                                <Link href="#" className="badge bg-secondary-subtle text-secondary badge-border">ETH</Link>
                                <Link href="#" className="badge bg-secondary-subtle text-secondary badge-border">USD</Link>
                                <Link href="#" className="badge bg-secondary-subtle text-secondary badge-border">EUR</Link>
                            </div>
                        </div>
                        <h3 className="mb-2">
