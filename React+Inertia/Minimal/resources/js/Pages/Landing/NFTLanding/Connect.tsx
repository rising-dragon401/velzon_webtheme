                            ...
                            <Col key={key} lg={4}>
                                <Card className="text-center border shadow-none">
                                    <Card.Body className="py-5 px-4">
                                        ...
                                        <h5>{item.title}</h5>
                                        <p className="text-muted pb-1 fs-14">{item.textContent}</p>
                                        <Link href="#!" className={item.bgColor ? "btn btn-info" : "btn btn-soft-info"}>{key === connectData.length - 2 ? "Change Wallet" : "Connect Wallet"}</Link>
                                    </Card.Body>
                                </Card>
                            </Col>
                        ))}
