    ...
    () => [
      {
        ...
        cell: (cellProps: any) => {
          return <Form.Check.Input type="checkbox" className="contactCheckBox form-check-input" value={cellProps.getValue()} onChange={() => deleteCheckbox()} />;
        },
        id: '#',
      },
      {
      ...
      },
      {
        ...
        cell: (contact: any) => (
          <>
            {handleValidDate(contact.getValue())},{" "}
            <small className="text-muted">{handleValidTime(contact.getValue())}</small>
          </>
        ),
      },
      {
          ...
          return (
            <ul className="list-inline hstack gap-2 mb-0">
              <li className="list-inline-item edit" title="Call">
                <Button variant="link" href="#" className="p-0 text-muted d-inline-block">
                    ...
                    <div className="flex-shrink-0">
                      <div className="hstack text-nowrap gap-2">
                        ...
                        <Dropdown>
                          <Dropdown.Toggle
                            href="#"
                            className="btn btn-soft-danger arrow-none"
                            as="button"
                          >
