                  ...
                  <Card.Header className="border-bottom-dashed p-4">
                      <div className="d-flex">
                        ...
                        <div className="flex-shrink-0 mt-sm-0 mt-3">
                          ...
                          <h6><span className="text-muted fw-normal">Website:</span> <Link href="https://themesbrand.com/" className="link-primary" target="_blank" id="website">www.themesbrand.com</Link></h6>
                  ...
                  <Col lg={12}>
                    <Card.Body className="p-4">
                      ...
                      <div className="hstack gap-2 justify-content-end d-print-none mt-4">
                        <Link href="#" className="btn btn-info" onClick={printInvoice}><i className="ri-printer-line align-bottom me-1"></i> Print</Link>
                        <Link href="#" className="btn btn-primary"><i className="ri-download-2-line align-bottom me-1"></i> Download</Link>
                      </div>
                    </Card.Body>
                  </Col>
                </Row>
