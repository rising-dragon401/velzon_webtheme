                                                    ...
                                                    {item.subItem.map((item: any, key: any) => (
                                                        <React.Fragment key={key}>
                                                            {item.img ? (<div className="avatar-group-item">
                                                                <Link href="#" className="d-inline-block" id={item.targetId}>
                                            ...
                                            {(widgetsTasks || []).map((item, key) => (<ListGroup.Item className="ps-0" key={key}>
                                                <div className="d-flex align-items-start">
                                                    <div className="form-check ps-0 flex-sharink-0">
                                                        <Form.Check.Input type="checkbox" className="form-check-input ms-0" id={item.forId} />
                                                    </div>
                                                    <div className="flex-grow-1">
                                                        <Form.Check.Label className="form-check-label mb-0 ps-2" htmlFor={item.forId}>{item.text}</Form.Check.Label>
                                                    </div>
