            ...
            <Row>
                ...
                <Col xl={4}>
                    <Card className="bg-primary">
                        <Card.Body className="p-0">
                            <Alert variant="info" className="rounded-top alert-solid alert-label-icon border-0 rounded-0 m-0 d-flex align-items-center">
                        ...
                        <Card.Body className="p-0">
                            ...
                            <div className="d-flex p-3">
                                ...
                                <div>
                                    ...
                                    <div className="mt-3">
                                        <Link href="/pages-pricing" className="btn btn-primary">Get a Free Gift</Link>
                                    </div>
                                </div>
                            </div>
                        </Card.Body>
