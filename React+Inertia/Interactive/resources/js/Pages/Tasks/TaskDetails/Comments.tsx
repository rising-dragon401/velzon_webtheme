...
import { Card, Col, Nav, Row, Table, Dropdown, Tab } from 'react-bootstrap';
                                ...
                                <SimpleBar style={{ height: "508px" }} className="px-3 mx-n3 mb-2">
                                    <div className="d-flex mb-4">
                                        ...
                                        <div className="flex-grow-1 ms-3">
                                            <h5 className="fs-14"><Link href="/pages-profile" className="text-body">Joseph Parker</Link> <small className="text-muted">20 Dec 2021 - 05:47AM</small></h5>
                                            ...
                                            <div className="d-flex mt-4">
                                                ...
                                                <div className="flex-grow-1 ms-3">
                                                    <h5 className="fs-14"><Link href="/pages-profile" className="text-body">Tonya Noble</Link> <small className="text-muted">22 Dec 2021 - 02:32PM</small></h5>
                                    ...
                                    <div className="d-flex mb-4">
                                        ...
                                        <div className="flex-grow-1 ms-3">
                                            <h5 className="fs-14"><Link href="/pages-profile" className="text-body">Thomas Taylor</Link> <small className="text-muted">24 Dec 2021 - 05:20PM</small></h5>
                                    ...
                                    <div className="d-flex">
                                        ...
                                        <div className="flex-grow-1 ms-3">
                                            <h5 className="fs-14"><Link href="/pages-profile" className="text-body">Tonya Noble</Link> <small className="text-muted">26 min ago</small></h5>
                                            ...
                                            <div className="d-flex mt-4">
                                                ...
                                                <div className="flex-grow-1 ms-3">
                                                    <h5 className="fs-14"><Link href="/pages-profile">Nancy Martino</Link> <small className="text-muted">8 sec ago</small></h5>
                                                ...
                                                <th scope="row">
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        <div className="flex-grow-1 ms-2">
                                                            <Link href="/pages-profile" className="fw-medium">Thomas Taylor</Link>
                                                        </div>
                                                    </div>
                                                </th>
                                                <td>02 Jan, 2022</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        <div className="flex-grow-1 ms-2">
                                                            <Link href="/pages-profile" className="fw-medium">Tonya Noble</Link>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>28 Dec, 2021</td>
