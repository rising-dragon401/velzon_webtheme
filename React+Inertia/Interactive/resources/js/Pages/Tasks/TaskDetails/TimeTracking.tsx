    ...
    return (
        <React.Fragment>
                    ...
                    <ul className="list-unstyled vstack gap-3 mb-0">
                        <li>
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-grow-1 ms-2">
                                    <h6 className="mb-1"><Link href="/pages-profile" className="text-body">Tonya Noble</Link></h6>
                        ...
                        <li>
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-grow-1 ms-2">
                                    <h6 className="mb-1"><Link href="/pages-profile" className="text-body">Thomas Taylor</Link></h6>
                        ...
                        <li>
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-grow-1 ms-2">
                                    <h6 className="mb-1"><Link href="/pages-profile" className="text-body">Nancy Martino</Link></h6>
                    ...
                    <div className="vstack gap-2">
                        <div className="border rounded border-dashed p-2">
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-grow-1 overflow-hidden">
                                    <h5 className="fs-14 mb-1"><Link href="#" className="text-body text-truncate d-block">App pages.zip</Link></h5>
                        ...
                        <div className="border rounded border-dashed p-2">
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-grow-1 overflow-hidden">
                                    <h5 className="fs-14 mb-1"><Link href="#" className="text-body text-truncate d-block">Velzon admin.ppt</Link></h5>
                        ...
                        <div className="border rounded border-dashed p-2">
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-grow-1 overflow-hidden">
                                    <h5 className="fs-14 mb-1"><Link href="#" className="text-body text-truncate d-block">Images.zip</Link></h5>
            ...
            <Modal isOpen={modal} toggle={toggle} centered className="border-0">
                <Modal.Header closeButton className="p-3 ps-4 bg-success-subtle">
                ...
                <Modal.Body className="modal-body p-4">
                    ...
                    <div className="mb-4 d-flex align-items-center">
                        ...
                        <div className="avatar-group justify-content-center">
                            <Link href="#" className="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Tonya Noble">
                                <div className="avatar-xs">
                                    <img src={avatar10} alt="" className="rounded-circle img-fluid" />
                                </div>
                            </Link>
                            <Link href="#" className="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Thomas Taylor">
                                <div className="avatar-xs">
                                    <img src={avatar8} alt="" className="rounded-circle img-fluid" />
                                </div>
                            </Link>
                            <Link href="#" className="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Nancy Martino">
                                <div className="avatar-xs">
