                                ...
                                <Tab.Container defaultActiveKey="overview">
                                    <div className="d-flex">
                                        ...
                                        <div className="flex-shrink-0">
                                            <a href="/pages-profile-settings" className="btn btn-info mx-3"><i
                                                ...
                                                <Card.Body>
                                                    <div className="d-flex align-items-center mb-4">
                                                        ...
                                                        <div className="flex-shrink-0">
                                                            ...
                                                            <Form.Label htmlFor="formFile" className="btn btn-primary"><i className="ri-upload-2-fill me-1 align-bottom"></i> Upload
                                                                File</Form.Label>
                                                        </div>
                                                    </div>
                                                    <Row>
                                                        <Col lg={12}>
                                                            ...
                                                            <div className="text-center mt-3">
                                                                <Link href="#" className="text-info"><i
