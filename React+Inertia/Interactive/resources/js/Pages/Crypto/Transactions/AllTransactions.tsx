            ...
            <Row className="align-items-center mb-4 g-3">
                ...
                <div className="col-sm-auto ms-auto">
                    <div className="d-flex gap-2">
                        <Link href="#" data-bs-toggle="modal" className="btn btn-info" onClick={() => flowType("Deposit")}>Deposite</Link>
                        <Link href="#" data-bs-toggle="modal" className="btn btn-primary" onClick={() => flowType("Withdraw")}>Withdraw</Link>
                    </div>
                </div>
            </Row>
