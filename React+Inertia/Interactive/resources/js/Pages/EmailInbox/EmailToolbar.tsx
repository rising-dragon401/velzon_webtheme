                                ...
                                {filteredMails.length === 0 ? (
                                    ...
                                    <li className={classnames({ unread: item.unread })} key={key} id={item.forId}>
                                        <div className="col-mail col-mail-1">
                                            ...
                                            <a href="#" className="title" onClick={() => sidebarToggle(item)}>{item.name} {" "} {item.number} </a>
                                        </div>
                                        <div className="col-mail col-mail-2" onClick={() => sidebarToggle(item)}>
                                            <a href="#" className="subject"> {item.badge ? <span className="me-2 ">{item.badge}</span> : null} {item.subject} - <span className="teaser">{item.teaser}</span>
                                            </a>
