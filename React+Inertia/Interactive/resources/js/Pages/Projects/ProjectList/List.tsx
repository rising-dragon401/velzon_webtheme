        ...
        <React.Fragment>
            ...
            <Row className="g-4 mb-3">
                <div className="col-sm-auto">
                    <div>
                        <Link href="/apps-projects-create" className="btn btn-success"><i
                                    ...
                                    <Card.Body>
                                        <div className="d-flex flex-column h-100">
                                            ...
                                            <div className="d-flex mb-2">
                                                ...
                                                <div className="flex-grow-1">
                                                    <h5 className="mb-1 fs-16"><Link href="/apps-projects-overview" className="text-body">{item.label}</Link></h5>
                                    ...
                                    <Col xxl={3} sm={6} className="project-card">
                                        <Card>
                                            <Card.Body>
                                                ...
                                                <div className="py-3">
                                                    <h5 className="fs-15 mb-3"><Link href="/apps-projects-overview" className="text-body">{item.label}</Link></h5>
                                                    <Row className="gy-3">
                                                        <Col xs={6}>
                                                            <div>
                                                                <p className="text-muted mb-1">Status</p>
