...
import { Collapse, Container, Nav, NavbarToggle } from "react-bootstrap";
                        ...
                        <>
                            ...
                            >
                                <li className="nav-item">
                                    <Nav.Link className="fs-15" href="#hero">Home</Nav.Link>
                                </li>
                                <li className="nav-item">
                                    <Nav.Link className="fs-15" href="#services">Services</Nav.Link>
                                </li>
                                <li className="nav-item">
                                    <Nav.Link className="fs-15" href="#features">Features</Nav.Link>
                                </li>
                                <li className="nav-item">
                                    <Nav.Link className="fs-15" href="#plans">Plans</Nav.Link>
                                </li>
                                <li className="nav-item">
                                    <Nav.Link className="fs-15" href="#reviews">Reviews</Nav.Link>
                                </li>
                                <li className="nav-item">
                                    <Nav.Link className="fs-15" href="#team">Team</Nav.Link>
                                </li>
                                <li className="nav-item">
                                    <Nav.Link className="fs-15" href="#contact">Contact</Nav.Link>
                                </li>
                            </Scrollspy>
