    ...
    () => [
      {
        ...
        cell: (cellProps: any) => {
          return <Form.Check.Input type="checkbox" className="leadsCheckBox form-check-input" value={cellProps.getValue()} onChange={() => deleteCheckbox()} />;
        },
        id: '#',
      },
      {
          ...
          <>
            <div className="d-flex align-items-center">
              <div className="flex-shrink-0">
                <img src={leads.row.original.img} alt="" className="avatar-xxs rounded-circle" />
              </div>
