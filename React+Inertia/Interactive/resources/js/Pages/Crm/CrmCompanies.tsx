    ...
    () => [
      {
        ...
        cell: (cellProps: any) => {
          return <input type="checkbox" className="companyCheckBox form-check-input" value={cellProps.getValue()} onChange={() => deleteCheckbox()} />;
        },
        id: '#',
      },
      {
      ...
      },
      {
        ...
        cell: (cellProps: any) => (
          <>
            {cellProps.getValue()}{" "}<i className="ri-star-fill text-warning align-bottom"></i>
          </>
        ),
      },
      {
          ...
          return (
            <ul className="list-inline hstack gap-2 mb-0">
              ...
              <li className="list-inline-item" title="Edit">
                <Button variant="link" className="edit-item-btn p-0"
                  ...
                  <div className="d-flex align-items-center flex-wrap gap-2">
                    ...
                    <div className="flex-shrink-0">
                      <div className="hstack text-nowrap gap-2">
                        {isMultiDeleteButton && <button className="btn btn-soft-primary" id="remove-actions"
                        ...
                        <Dropdown>
                          <Dropdown.Toggle
                            href="#"
                            className="arrow-none btn btn-soft-primary btn-icon"
                            as="button"
                          >
