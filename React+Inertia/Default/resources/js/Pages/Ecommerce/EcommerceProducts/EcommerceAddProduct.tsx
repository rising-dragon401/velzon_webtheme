            ...
            <Col lg={8}>
              <Form
                ...
                <Card>
                  <Card.Body>
                    <div className="mb-3">
                      <Form.Label className="form-label" htmlFor="product-title-input">
                        Product Title
                      </Form.Label>
                      <Form.Control
                        type="text"
                      ...
                      {validation.errors.name && validation.touched.name ? (
                        <Form.Control.Feedback type="invalid" className="d-block">{validation.errors.name}</Form.Control.Feedback>
                      ) : null}
                    </div>
                    <div>
                      ...
                      <div className="text-center">
                        <div className="position-relative d-inline-block">
                          <div className="position-absolute top-100 start-100 translate-middle">
                            ...
                            <Form.Control className="form-control d-none" id="customer-image-input" type="file" accept="image/png, image/gif, image/jpeg" onChange={handleImageChange}
                            />
                          </div>
                        ...
                        {validation.errors.image && validation.touched.image ? (
                          <Form.Control.Feedback type="invalid"> {validation.errors.image} </Form.Control.Feedback>
                        ) : null}
                      </div>
                    </div>
                    <div>
                            ...
                            <Col lg={6}>
                              <div className="mb-3">
                                ...
                                {validation.errors.manufacturer_name && validation.touched.manufacturer_name ? (
                                  <Form.Control.Feedback type="invalid" className="d-block">{validation.errors.manufacturer_name}</Form.Control.Feedback>
                                ) : null}
                              </div>
                            </Col>
                            <Col lg={6}>
                              <div className="mb-3">
                                ...
                                {validation.errors.manufacturer_brand && validation.touched.manufacturer_brand ? (
                                  <Form.Control.Feedback type="invalid" className="d-block">{validation.errors.manufacturer_brand}</Form.Control.Feedback>
                                ) : null}
                              </div>
                            </Col>
                          </Row>
                              ...
                              <div className="mb-3">
                                ...
                                <div className="input-group mb-3">
                                  ...
                                  {validation.errors.stock && validation.touched.stock ? (
                                    <Form.Control.Feedback type="invalid" className="d-block">{validation.errors.stock}</Form.Control.Feedback>
                                  ) : null}
                                </div>
                              </div>
                            </Col>
                              ...
                              <div className="mb-3">
                                ...
                                <div className="input-group mb-3">
                                  ...
                                  {validation.errors.price && validation.touched.price ? (
                                    <Form.Control.Feedback type="invalid" className="d-block">{validation.errors.price}</Form.Control.Feedback>
                                  ) : null}
                                </div>
                              </div>
                            </Col>
                              ...
                              <div className="mb-3">
                                ...
                                <div className="input-group mb-3">
                                  ...
                                  {validation.errors.product_discount && validation.touched.product_discount ? (
                                    <Form.Control.Feedback type="invalid" className="d-block">{validation.errors.product_discount}</Form.Control.Feedback>
                                  ) : null}
                                </div>
                              </div>
                            </Col>
                              ...
                              <div className="mb-3">
                                ...
                                <div className="input-group mb-3">
                                  ...
                                  {validation.errors.orders && validation.touched.orders ? (
                                    <Form.Control.Feedback type="invalid" className="d-block">{validation.errors.orders}</Form.Control.Feedback>
                                  ) : null}
                                </div>
                              </div>
                            </Col>
                ...
                <Card.Body>
                  <div>
                    ...
                    {validation.touched.publishedDate && validation.errors.publishedDate ? (
                      <Form.Control.Feedback type="invalid">{validation.errors.publishedDate}</Form.Control.Feedback>
                    ) : null}
                  </div>
                </Card.Body>
              </Card>
              ...
              <Card>
                ...
                <Card.Body>
                  <p className="text-muted mb-2">
                    {" "}
                    <Link href="#" className="float-end text-decoration-underline">
                      Add New
                    </Link>
                  ...
                  <div className="hstack gap-3 align-items-start">
                    <div className="flex-grow-1">
                      ...
                      {validation.errors.product_tags && validation.touched.product_tags ? (
                        <Form.Control.Feedback type="invalid" className="d-block">{validation.errors.product_tags}</Form.Control.Feedback>
                      ) : null}
                    </div>
                  </div>
                </Card.Body>
