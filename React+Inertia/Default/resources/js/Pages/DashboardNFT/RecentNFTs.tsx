...
import { Card, CardBody, CardHeader, Col, Row, Dropdown } from 'react-bootstrap';
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        <div className="flex-grow-1">
                                                            <h6 className="mb-1"><Link href="/apps-nft-item-details">{item.title}</Link></h6>
                                            ...
                                            <div className="d-flex">
                                                ...
                                                <div>
                                                    <Dropdown className='float-end'>
                                                        <Dropdown.Toggle as="a" className="btn btn-ghost-primary btn-icon dropdown" role="button">
