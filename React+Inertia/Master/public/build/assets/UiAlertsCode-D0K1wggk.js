import{j as e}from"./app-zibdNuU4.js";import{P as r}from"./Prism-nZoYWd-t.js";const a=`
<!-- Primary Alert -->
<Alert className="material-shadow" varient="primary">
    <strong> Hi! </strong> A simple <b>Primary alert</b> —check it out!
</Alert>

<!-- Secondary Alert -->
<Alert className="material-shadow" varient="secondary">
    <strong> How are you! </strong> A simple <b>secondary alert</b> —check it out!
</Alert>

<!-- Success Alert -->
<Alert className="material-shadow" varient="success">
    <strong> Yey! Everything worked! </strong> A simple <b>success alert</b> —check it out!
</Alert>

<!-- Danger Alert -->
<Alert className="material-shadow" varient="danger">
    <strong> Something is very wrong! </strong> A simple <b>danger alert</b> —check it out!
</Alert>

<!-- Warning Alert -->
<Alert className="material-shadow" varient="warning">
    <strong> Uh oh, something went wrong </strong> A simple <b>warning alert</b> —check it out!
</Alert>

<!-- Info Alert -->
<Alert className="material-shadow" varient="info">
    <strong> Don't forget' it ! </strong> A simple <b>info alert</b> —check it out!
</Alert>

<!-- Light Alert -->
<Alert className="material-shadow" varient="light">
    <strong> Mind Your Step! </strong> A simple <b>light alert</b> —check it out!
</Alert>

<!-- Dark Alert -->
<Alert className="material-shadow" varient="dark">
    <strong> Did you know? </strong> A simple <b>dark alert</b> —check it out!
</Alert>
`,u=()=>e.jsx(r,{code:a,language:"html",plugins:["line-numbers"]}),l=`
<!-- Primary Alert -->
<Alert varient="primary" className="material-shadow border-0">
    <strong> Hi! </strong> A simple <b>Primary alert</b> —check it out!
</Alert>

<!-- Secondary Alert -->
<Alert varient="secondary" className="material-shadow border-0">
    <strong> How are you! </strong> A simple <b>secondary alert</b> —check it out!
</Alert>

<!-- Success Alert -->
<Alert varient="success" className="material-shadow border-0">
    <strong> Yey! Everything worked! </strong> A simple <b>success alert</b> —check it out!
</Alert>

<!-- Danger Alert -->
<Alert varient="danger" className="material-shadow border-0 mb-xl-0">
    <strong> Something is very wrong! </strong> A simple danger alert—check it out!
</Alert>

<!-- Warning Alert -->
<Alert varient="warning" className="material-shadow border-0">
    <strong> Uh oh, something went wrong </strong> A simple <b>warning alert</b> —check it out!
</Alert>

<!-- Info Alert -->
<Alert varient="info" className="material-shadow border-0">
    <strong>Don't forget' it !</strong> A simple <b>info alert</b> —check it out!
</Alert>

<!-- Light Alert -->
<Alert varient="light" className="material-shadow border-0 bg-light">
    <strong>Mind Your Step!</strong> A simple <b>light alert</b> —check it out!
</Alert>

<!-- Dark Alert -->
<Alert varient="dark" className="material-shadow border-0 mb-0">
    <strong>Did you know?</strong> A simple <b>dark alert</b> —check it out!
</Alert>`,N=()=>e.jsx(r,{code:l,language:"html",plugins:["line-numbers"]}),t=`
<!-- Primary Alert -->
<Alert className="material-shadow" varient="primary">
...
<!-- Danger Alert -->
<Alert className="material-shadow mb-xl-0" varient="danger" >
...
<!-- Dark Alert -->
<Alert className="material-shadow mb-0" varient="dark">
    <strong>Did you know?</strong> A simple <b>Dismissible dark alert</b> —check it out!
</Alert>`,y=()=>e.jsx(r,{code:t,language:"html",plugins:["line-numbers"]}),i=`
<!-- Primary Alert -->
<Alert className="material-shadow" varient="primary">
...
</Alert>`,v=()=>e.jsx(r,{code:i,language:"html",plugins:["line-numbers"]}),s=`
const [show, setShow] = useState<boolean>(false);
<Alert varient="success" isOpen={show} toggle={() => setShow(false)}>
    Nice, you triggered this alert message!
</Alert>
<button type="button" className="btn btn-primary" id="liveAlertBtn" onClick={() => setShow(true)}>Show live alert</button>`,p=()=>e.jsx(r,{code:s,language:"jsx",plugins:["line-numbers"]}),n=`
<!-- Primary Alert -->
...
<!-- Secondary Alert -->
<Alert varient="secondary" className="border-2 bg-body-secondary alert-dismissible material-shadow bg-body-secondary fade show">
    <strong> How are you! </strong> - Outline <b>secondary alert</b> example
</Alert>

<!-- Success Alert -->
<Alert varient="success" className="border-2 bg-body-secondary alert-dismissible material-shadow bg-body-secondary fade show">
    <strong> Yey! Everything worked! </strong> - Outline <b>success alert</b> example
</Alert>

<!-- Danger Alert -->
<Alert varient="danger" className="border-2 bg-body-secondary alert-dismissible material-shadow bg-body-secondary fade show mb-xl-0">
    <strong> Something is very wrong! </strong> - Outline <b>danger alert</b> example
</Alert>

<!-- Warning Alert -->
<Alert varient="warning" className="border-2 bg-body-secondary alert-dismissible material-shadow bg-body-secondary fade show">
    <strong> Uh oh, something went wrong! </strong> - Outline <b>warning alert</b> example
</Alert>

<!-- Info Alert -->
<Alert varient="info" className="border-2 bg-body-secondary alert-dismissible material-shadow bg-body-secondary fade show">
    <strong>Don't forget' it !</strong> - Outline <b>info alert</b> example
</Alert>

<!-- Dark Alert -->
<Alert varient="dark" className="border-2 bg-body-secondary alert-dismissible material-shadow bg-body-secondary fade show mb-0">
    <strong>Did you know?</strong> - Outline <b>dark alert</b> example
</Alert>`,f=()=>e.jsx(r,{code:n,language:"html",plugins:["line-numbers"]}),o=`
<!-- Primary Alert -->
<Alert varient="primary" className="alert-border-left material-shadow">
    <i className="ri-user-smile-line me-3 align-middle fs-16"></i><strong>Primary</strong> - Left border alert
</Alert>

<!-- Secondary Alert -->
<Alert varient="secondary" className="alert-border-left material-shadow">
    <i className="ri-check-double-line me-3 align-middle fs-16"></i><strong>Secondary</strong> - Left border alert
</Alert>

<!-- Success Alert -->
<Alert varient="success" className="alert-border-left material-shadow">
    <i className="ri-notification-off-line me-3 align-middle fs-16"></i><strong>Success</strong> - Left border alert
</Alert>

<!-- Danger Alert -->
<Alert varient="danger" className="alert-border-left material-shadow mb-xl-0">
    <i className="ri-error-warning-line me-3 align-middle fs-16"></i><strong>Danger</strong> - Left border alert
</Alert>

<!-- Warning Alert -->
<Alert varient="warning" className="alert-border-left material-shadow">
    <i className="ri-alert-line me-3 align-middle fs-16"></i><strong>Warning</strong> - Left border alert
</Alert>

<!-- Info Alert -->
<Alert varient="info" className="alert-border-left material-shadow">
    <i className="ri-airplay-line me-3 align-middle fs-16"></i><strong>Info</strong> - Left border alert
</Alert>

<!-- Light Alert -->
<Alert varient="light" className="alert-border-left material-shadow">
    <i className="ri-mail-line me-3 align-middle fs-16"></i><strong>Light</strong> - Left border alert
</Alert>

<!-- Dark Alert -->
<Alert varient="dark" className="alert-border-left material-shadow mb-0">
    <i className="ri-refresh-line me-3  align-middle fs-16"></i><strong>Dark</strong> - Left border alert
</Alert>`,k=()=>e.jsx(r,{code:o,language:"html",plugins:["line-numbers"]}),m=`
<!-- Primary Alert -->
<Alert varient="primary" className="alert-solid alert-dismissible material-shadow bg-primary text-white alert-label-icon fade show">
    <i className="ri-user-smile-line label-icon"></i><strong>Primary</strong> -Label icon alert 
</Alert>

<!-- Secondary Alert -->
<Alert varient="secondary" className="alert-solid alert-dismissible material-shadow bg-secondary text-white alert-label-icon fade show">
    <i className="ri-check-double-line label-icon"></i><strong>Secondary</strong> - Label icon alert
</Alert>

<!-- Success Alert -->
<Alert varient="success" className="alert-solid alert-dismissible material-shadow bg-success text-white alert-label-icon fade show">
    <i className="ri-notification-off-line label-icon"></i><strong>Success</strong> - Label icon alert
</Alert>

<!-- Danger Alert -->
<Alert varient="danger" className="alert-solid alert-dismissible material-shadow bg-danger text-white alert-label-icon fade show mb-xl-0">
    <i className="ri-error-warning-line label-icon"></i><strong>Danger</strong> - Label icon alert
</Alert>

<!-- Warning Alert -->
<Alert varient="warning" className="alert-solid alert-dismissible material-shadow bg-warning text-white alert-label-icon fade show">
    <i className="ri-alert-line label-icon"></i><strong>warning</strong> - Label icon alert
</Alert>

<!-- Info Alert -->
<Alert varient="info" className="alert-solid alert-dismissible material-shadow bg-info text-white alert-label-icon fade show">
    <i className="ri-airplay-line label-icon"></i><strong>Info</strong> - Label icon alert
</Alert>

<!-- Light Alert -->
<Alert varient="light" className="alert-solid alert-dismissible material-shadow bg-light text-white alert-label-icon fade show">
    <i className="ri-mail-line label-icon"></i><strong>Light</strong> - Label icon alert
</Alert>

<!-- Dark Alert -->
<Alert varient="dark" className="alert-solid alert-dismissible material-shadow bg-dark text-white alert-label-icon fade show mb-0">
    <i className="ri-refresh-line label-icon"></i><strong>Dark</strong> - Label icon alert
</Alert>`,x=()=>e.jsx(r,{code:m,language:"html",plugins:["line-numbers"]}),c=`
<!-- Primary Alert -->
<Alert varient="primary" className="alert-top-border material-shadow">
    <i className="ri-user-smile-line me-3 align-middle fs-16 text-primary"></i><strong>Primary</strong> - Top border alert
</Alert>

<!-- Secondary Alert -->
<Alert varient="secondary" className="alert-top-border material-shadow">
    <i className="ri-check-double-line me-3 align-middle fs-16 text-secondary"></i><strong>Secondary</strong> - Top border alert
</Alert>

<!-- Success Alert -->
<Alert varient="success" className="alert-top-border material-shadow">
    <i className="ri-notification-off-line me-3 align-middle fs-16 text-success"></i><strong>Success</strong> - Top border alert
</Alert>

<!-- Danger Alert -->
<Alert varient="danger" className="alert-top-border material-shadow mb-xl-0">
    <i className="ri-error-warning-line me-3 align-middle fs-16 text-danger "></i><strong>Danger</strong> - Top border alert
</Alert>

<!-- Warning Alert -->
<Alert varient="warning" className="alert-top-border material-shadow">
    <i className="ri-alert-line me-3 align-middle fs-16 text-warning"></i><strong>Warning</strong> - Top border alert
</Alert>

<!-- Info Alert -->
<Alert varient="info" className="alert-top-border material-shadow">
    <i className="ri-airplay-line me-3 align-middle fs-16 text-info"></i><strong>Info</strong> - Top border alert
</Alert>

<!-- Light Alert -->
<Alert varient="light" className="alert-top-border material-shadow">
    <i className="ri-mail-line me-3 align-middle fs-16 text-body"></i><strong>Light</strong> - Top border alert
</Alert>

<!-- Dark Alert -->
<Alert varient="dark" className="alert-top-border material-shadow mb-0">
    <i className="ri-refresh-line me-3 align-middle fs-16 text-body"></i><strong>Dark</strong> - Top border alert
</Alert>`,L=()=>e.jsx(r,{code:c,language:"html",plugins:["line-numbers"]}),d=`
<!-- Primary Alert -->
<Alert varient="primary" className="alert-label-icon label-arrow material-shadow ">
 <i className="ri-user-smile-line label-icon"></i><strong>Primary</strong> - Label icon arrow alert
</Alert>

<!-- Secondary Alert -->
<Alert varient="secondary" className="alert-label-icon label-arrow material-shadow ">
    <i className="ri-check-double-line label-icon"></i><strong>Secondary</strong> - Label icon arrow alert
</Alert>

<!-- Success Alert -->
<Alert varient="success" className="alert-label-icon label-arrow material-shadow ">
    <i className="ri-notification-off-line label-icon"></i><strong>Success</strong> - Label icon arrow alert
</Alert>

<!-- Danger Alert -->
<Alert varient="danger" className="alert-label-icon label-arrow material-shadow mb-xl-0">
    <i className="ri-error-warning-line label-icon"></i><strong>Danger</strong> - Label icon arrow alert
</Alert>

<!-- Warning Alert -->
<Alert varient="warning" className="alert-label-icon label-arrow material-shadow ">
    <i className="ri-alert-line label-icon"></i><strong>Warning</strong> - Label icon arrow alert
</Alert>

<!-- Info Alert -->
<Alert varient="info" className="alert-label-icon label-arrow material-shadow ">
    <i className="ri-airplay-line label-icon"></i><strong>Info</strong> - Label icon arrow alert
</Alert>

<!-- Light Alert -->
<Alert varient="light" className="alert-label-icon label-arrow material-shadow ">
    <i className="ri-mail-line label-icon"></i><strong>Light</strong> - Label icon arrow alert
</Alert>

<!-- Dark Alert -->
<Alert varient="dark" className="alert-label-icon label-arrow material-shadow mb-0">
    <i className="ri-refresh-line label-icon"></i><strong>Dark</strong> - Label icon arrow alert
</Alert>`,S=()=>e.jsx(r,{code:d,language:"html",plugins:["line-numbers"]}),g=`
<!-- Primary Alert -->
<Alert varient="primary" className="alert-label-icon rounded-label material-shadow">
    <i className="ri-user-smile-line label-icon"></i><strong>Primary</strong> - Rounded label alert 
</Alert>

<!-- Secondary Alert -->
<Alert varient="secondary" className="alert-label-icon rounded-label material-shadow">
    <i className="ri-check-double-line label-icon"></i><strong>Secondary</strong> - Rounded label alert
</Alert>

<!-- Success Alert -->
<Alert varient="success" className="alert-label-icon rounded-label material-shadow">
    <i className="ri-notification-off-line label-icon"></i><strong>Success</strong> - Rounded label alert
</Alert>

<!-- Danger Alert -->
<Alert varient="danger" className="alert-label-icon rounded-label material-shadow">
    <i className="ri-error-warning-line label-icon"></i><strong>Danger</strong> - Rounded label alert
</Alert>

<!-- Warning Alert -->
<Alert varient="warning" className="alert-label-icon rounded-label material-shadow">
    <i className="ri-alert-line label-icon"></i><strong>Warning</strong> - Rounded label alert 
</Alert>

<!-- Info Alert -->
<Alert varient="info" className="alert-label-icon rounded-label material-shadow">
    <i className="ri-airplay-line label-icon"></i><strong>Info</strong> - Rounded label alert
</Alert>

<!-- Light Alert -->
<Alert varient="light" className="alert-label-icon rounded-label material-shadow">
    <i className="ri-mail-line label-icon"></i><strong>Light</strong> - Rounded label alert
</Alert>

<!-- Dark Alert -->
<Alert varient="dark" className="alert-label-icon rounded-label material-shadow">
    <i className="ri-refresh-line label-icon"></i><strong>Dark</strong> - Rounded label alert
</Alert>`,D=()=>e.jsx(r,{code:g,language:"html",plugins:["line-numbers"]}),b=`
<!-- Primary Alert -->
<Alert varient="primary" className="alert-additional material-shadow">
...
<!-- Success Alert -->
<Alert varient="success" className="alert-additional material-shadow">
<div className="alert-body">
    <div className="d-flex">
        <div className="flex-shrink-0 me-3">
...
<!-- Danger Alert -->
<Alert varient="danger" className="alert-additional material-shadow mb-xl-0">
<div className="alert-body">
    <div className="d-flex">
        <div className="flex-shrink-0 me-3">
...
<!-- Warning Alert -->
<Alert varient="warning" className="alert-additional material-shadow mb-0">
<div className="alert-body">
    <div className="d-flex">
        <div className="flex-shrink-0 me-3">
            <i className="ri-alert-line fs-16 align-middle"></i>
...
<!-- Primary Alert -->
<Alert varient="primary" className="material-shadow bg-primary text-white border-0">
    <strong>Hi!</strong> - Solid <b>primary alert</b> example
</Alert>

<!-- Secondary Alert -->
<Alert varient="secondary" className="material-shadow border-0 bg-secondary text-white">
    <strong>How are you!</strong> - Solid <b>secondary alert</b> example
</Alert>

<!-- Success Alert -->
<Alert varient="success" className="material-shadow border-0 bg-success text-white">
    <strong>Yey! Everything worked! </strong> - Solid <b>success alert</b> example
</Alert>

<!-- Danger Alert -->
<Alert varient="danger" className="material-shadow border-0 bg-danger text-white mb-xl-0">
    <strong>Something is very wrong!</strong> - Solid <b>danger alert</b> example
</Alert>

<!-- Warning Alert -->
<Alert varient="warning" className="material-shadow border-0 bg-warning text-white">
    <strong>Uh oh, something went wrong!</strong> - Solid <b>warning alert</b> example
</Alert>

<!-- Info Alert -->
<Alert varient="info" className="material-shadow border-0 bg-info text-white">
    <strong>Don't forget' it !</strong> - Solid <b>info alert</b> example
</Alert>

<!-- Light Alert -->
<Alert varient="light" className="material-shadow border-0 bg-secondary text-white">
    <strong>Mind Your Step!</strong> - Solid <b>secondary alert</b> example
</Alert>

<!-- Dark Alert -->
<Alert varient="dark" className="material-shadow border-0 bg-dark text-white mb-0">
    <strong>Did you know?</strong> - Solid <b>dark alert</b> example
</Alert>`,I=()=>e.jsx(r,{code:A,language:"html",plugins:["line-numbers"]});export{W as AdditionalContentAlertsExample,N as BorderlessExample,u as DefaultAlertsExample,y as DismissingExample,x as LabelIconAlertsExample,S as LabelIconArrowAlertsExample,k as LeftBorderAlertsExample,v as LinkColorExample,p as LiveExample,f as OutlineAlertsExample,D as RoundedLabelIconAlertsExample,I as SolidAlertsExample,L as TopBarAlertsExample};
