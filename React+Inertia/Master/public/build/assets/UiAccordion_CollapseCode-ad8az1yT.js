import{j as o}from"./app-zibdNuU4.js";import{P as e}from"./Prism-nZoYWd-t.js";const i=`<!-- Base Example -->
<Accordion id="default-accordion-example">
    <Accordion.Item className="material-shadow">
...
`,w=()=>o.jsx(e,{code:i,language:"html",plugins:["line-numbers"]}),a=`
...
`,b=()=>o.jsx(e,{code:a,language:"html",plugins:["line-numbers"]}),c=`
...
`,x=()=>o.jsx(e,{code:t,language:"html",plugins:["line-numbers"]}),r=`
...
`,I=()=>o.jsx(e,{code:r,language:"html",plugins:["line-numbers"]}),n=`
...
`,B=()=>o.jsx(e,{code:n,language:"html",plugins:["line-numbers"]}),s=`
<!-- Accordions Bordered -->
        ...
        <Accordion.Header id="headingTwo">
            ...
            <Accordion.Body>
                ...
                <Accordion className="nesting3-accordion custom-accordionwithicon accordion-border-box mt-3" id="accordionnesting3">
                    <Accordion.Item className="material-shadow mt-2">
                        <Accordion.Header id="accordionnesting4Example2">
...
`,N=()=>o.jsx(e,{code:u,language:"html",plugins:["line-numbers"]}),m=`
<!-- Horizontal Collapse -->
...
`,v=()=>o.jsx(e,{code:m,language:"html",plugins:["line-numbers"]}),h=`
<!-- Collapse with Icon -->
...
`,E=()=>o.jsx(e,{code:h,language:"html",plugins:["line-numbers"]}),p=`
