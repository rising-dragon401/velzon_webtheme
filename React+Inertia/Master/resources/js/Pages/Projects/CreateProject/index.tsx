                    ...
                    <Row>
                        <Col lg={8}>
                            <Card>
                                <Card.Body>
                                    <div className="mb-3">
                                        <Form.Label className="form-label" htmlFor="project-title-input">Project Title</Form.Label>
                                        <Form.Control type="text" className="form-control" id="project-title-input"
                                            placeholder="Enter project title" />
                                    </div>

                                    <div className="mb-3">
                                        <Form.Label className="form-label" htmlFor="project-thumbnail-img">Thumbnail Image</Form.Label>
                                        <Form.Control className="form-control" id="project-thumbnail-img" type="file" accept="image/png, image/gif, image/jpeg" />
                                    </div>
                                    ...
                                    <Row>
                                        <Col lg={4}>
                                            <div className="mb-3 mb-lg-0">
                                                <Form.Label htmlFor="choices-priority-input" className="form-label">Priority</Form.Label>
                                        ...
                                        <Col lg={4}>
                                            <div className="mb-3 mb-lg-0">
                                                <Form.Label htmlFor="choices-status-input" className="form-label">Status</Form.Label>
                                                <select className="form-select" data-choices data-choices-search-false
                                        ...
                                        <Col lg={4}>
                                            <div>
                                                <Form.Label htmlFor="datepicker-deadline-input" className="form-label">Deadline</Form.Label>
                                                <Flatpickr
                        ...
                        <Col lg={4}>
                            <div className="card">
                                ...
                                <Card.Body>
                                    <div>
                                        <Form.Label htmlFor="choices-privacy-status-input" className="form-label">Status</Form.Label>
                                        <select className="form-select" data-choices data-choices-search-false
                            ...
                            <Card>
                                ...
                                <Card.Body>
                                    <div className="mb-3">
                                        <Form.Label htmlFor="choices-categories-input" className="form-label">Categories</Form.Label>
                                        <select className="form-select" data-choices data-choices-search-false
                                    ...
                                    <div>
                                        <Form.Label htmlFor="choices-text-input" className="form-label">Skills</Form.Label>
                                        <Select
                                            value={selectedMulti}
                                            isMulti={true}                                                            
                            ...
                            <Card>
                                ...
                                <Card.Body>
                                    <div className="mb-3">
                                        <Form.Label htmlFor="choices-lead-input" className="form-label">Team Lead</Form.Label>
                                        <select className="form-select" data-choices data-choices-search-false
                                    ...
                                    <div>
                                        ...
                                        <div className="avatar-group">
                                            <Link href="#" className="avatar-group-item material-shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Brent Gonzalez">
                                                <div className="avatar-xs">
                                                    <img src={avatar3} alt="" className="rounded-circle img-fluid" />
                                                </div>
                                            </Link>
                                            <Link href="#" className="avatar-group-item material-shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Sylvia Wright">
                                                <div className="avatar-xs">
                                            ...
                                            <Link href="#" className="avatar-group-item material-shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Ellen Smith">
                                                <div className="avatar-xs">
                                                    <img src={avatar4} alt="" className="rounded-circle img-fluid" />
                                                </div>
                                            </Link>
                                            <Link href="#" className="avatar-group-item material-shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Add Members">
