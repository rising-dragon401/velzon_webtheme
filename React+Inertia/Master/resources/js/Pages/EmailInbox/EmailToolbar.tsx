                    ...
                    >
                        ...
                        <div className="border-top border-top-dashed pt-3 mt-3">
                            ...
                            <div className="mt-2 vstack email-chat-list mx-n4">
                                ...
                                {chatData.map((item, key) => (<a href='#' className="d-flex align-items-center" key={key}>
                        ...
                        <Row className="mt-n2 mb-3 mb-sm-0">
                            ...
                            <div className="col-sm order-3 order-sm-2">
                                <div className="hstack gap-sm-1 align-items-center flex-wrap email-topbar-link">
                                        ...
                                        <div className="hstack gap-sm-1 align-items-center flex-wrap">
                                            ...
                                            >
                                                <Button as='a'
                                                    variant="link"
                                                    size="sm"
                                                    className="fs-16 material-shadow-none"
                                                >
                                    ...
                                    <Dropdown>
                                        <Dropdown.Toggle as="button" className="btn btn-ghost-secondary btn-icon btn-sm fs-16 arrow-none material-shadow-none">
                                ...
                                {filteredMails.length === 0 ? (
                                    ...
                                    <li className={classnames({ unread: item.unread })} key={key} id={item.forId}>
                                        ...
                                        <div className="col-mail col-mail-2" onClick={() => sidebarToggle(item)}>
                                            <a href='#' className="text-start subject"> {item.badge ? <span className="me-2 ">{item.badge}</span> : null} {item.subject} - <span className="teaser">{item.teaser}</span>
                                            </a>
                                    ...
                                    <Row>
                                        <Col>   
                                            <OverlayTrigger
                                                ...
                                                rootClose={true}
                                            >
                                                <Button size='sm' variant='light' className="py-0 fs-15 material-shadow-none" id="Bold1"><i className="ri-bold align-bottom"></i></Button>
                                            </OverlayTrigger>
                                            ...
                                            <OverlayTrigger
                                                ...
                                                rootClose={true}
                                            >
                                                <Button size='sm' variant='light' className="py-0 fs-15 material-shadow-none" id="Italic1"><i className="ri-italic align-bottom"></i></Button>
                                            </OverlayTrigger>
                                            ...
                                            <OverlayTrigger
                                                ...
                                                rootClose={true}
                                            >
                                                <Button size='sm' variant='light' className="py-0 fs-15 material-shadow-none" id="Link1"><i className="ri-link align-bottom"></i></Button>
                                            </OverlayTrigger>
                                            ...
                                            <OverlayTrigger
                                                ...
                                                rootClose={true}
                                            >
                                                <Button size='sm' variant='light' className="py-0 fs-15 material-shadow-none" id="Image1"><i className="ri-image-2-line align-bottom"></i></Button>
                                            </OverlayTrigger>
