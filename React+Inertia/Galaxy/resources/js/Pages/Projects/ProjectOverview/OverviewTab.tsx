                                                ...
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="flex-shrink-0 ms-2">
                                                        <div className="d-flex gap-1">
                                                            ...
                                                            <Dropdown>
                                                                <Dropdown.Toggle as="button" className="btn btn-icon text-muted btn-sm fs-18 dropdown arrow-none">
                    ...
                    <Card>
                        <Card.Header className="align-items-center d-flex">
                            ...
                            <Dropdown className="card-header-dropdown">
                                    <Dropdown.Toggle as="a" className="arrow-none text-reset dropdown-btn" href="#">
                            ...
                            <form className="mt-4">
                                <Row className="g-3">
                                    ...
                                    <Col xs={12} className="text-end">
                                        <button type="button" className="btn btn-ghost-primary btn-icon waves-effect me-1"><i className="ri-attachment-line fs-16"></i></button> <Link href="#" className="btn btn-primary">Post Comments</Link>
                                    </Col>
                                </Row>
                            </form>
                        </Card.Body>
                                    ...
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-shrink-0">
                                            <div className="d-flex align-items-center gap-1">
                                                ...
                                                <Dropdown>
                                                    <Dropdown.Toggle type="button" className="arrow-none btn btn-icon btn-sm fs-16 text-muted dropdown" as="button">
                                                        <i className="ri-more-fill"></i>
                                                    </Dropdown.Toggle>
                                                    <Dropdown.Menu>
                            ...
                            <div className="vstack gap-2">
                                ...
                                <div className="border rounded border-dashed p-2">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-grow-1 overflow-hidden">
                                            <h5 className="fs-13 mb-1"><Link href="#" className="text-body text-truncate d-block">bg-pattern.png</Link></h5>
                                            <div>1.1MB</div>
                                        </div>
                                        <div className="flex-shrink-0 ms-2">
                                            <div className="d-flex gap-1">
