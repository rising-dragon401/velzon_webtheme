                            ...
                            <Row className="g-2">
                                ...
                                <Col className="col-sm-auto ms-auto">
                                    <div className="list-grid-nav hstack gap-1">
                                        ...
                                        <Button variant="secondary" id="grid-view-button" className="btn btn-soft-secondary nav-link btn-icon fs-14 active filter-button"><i className="ri-grid-fill"></i></Button>
                                        <Button variant="secondary" id="list-view-button" className="btn btn-soft-secondary nav-link  btn-icon fs-14 filter-button"><i className="ri-list-unordered"></i></Button>
                                        <Dropdown
                                            show={dropdownOpen}
                                            onClick={toggledropDown}>
                                            <Dropdown.Toggle type="button" className="btn btn-soft-secondary btn-icon fs-14 arrow-none">
                                        ...
                                        <Button variant="primary" onClick={() => handleTeamClicks()}>
