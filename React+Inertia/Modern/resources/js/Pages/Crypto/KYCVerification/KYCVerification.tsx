                ...
                <Tab.Pane eventKey="3">
                  ...
                  <div className="d-flex gap-2">
                    <div>
                      ...
                      />
                      <Form.Label className="btn btn-outline-info" htmlFor="passport">
                        Passport
                      </Form.Label>
                    </div>
                    <div>
                      <Form.Control
                        ...
                        name="choose-document"
                      />
                      <Form.Label className="btn btn-outline-info" htmlFor="aadhar-card">
                        Aadhar Card
                      </Form.Label>
                    </div>
                    <div>
                      <Form.Control
                        ...
                        name="choose-document"
                      />
                      <Form.Label className="btn btn-outline-info" htmlFor="pan-card">
                        Pan Card
                      </Form.Label>
                    </div>
                    <div>
                      <Form.Control
                        ...
                        name="choose-document"
                      />
                      <Form.Label className="btn btn-outline-info" htmlFor="other">
                        Other
                      </Form.Label>
                    </div>
                  </div>
