...
const OrdersId = (cell: any) => {
    return (
        <React.Fragment>
            <Link href="/apps-tasks-details" className="fw-medium link-primary">{cell.getValue()}</Link>
        </React.Fragment>
    );
};
...
const Project = (cell: any) => {
    return (
        <React.Fragment>
            <Link href="/apps-projects-overview" className="fw-medium link-secondary">{cell.getValue()}</Link>
        </React.Fragment>
    );
};
            ...
            <div className="d-flex">
                ...
                <div className="flex-shrink-0 ms-4">
                    <ul className="list-inline tasks-list-menu mb-0">
                        ...
                        <li className="list-inline-item">
                            <Link href="#" className="remove-item-btn" onClick={onDeleteIconClick}>
