                        ...
                        <Col lg={8} sm={10}>
                            <div className="text-center mt-lg-5 pt-5">
                                <h1 className="display-6 fw-semibold mb-3 lh-base">The better way to manage your website with <span
                                    className="text-secondary">Velzon </span></h1>
                                ...
                                <div className="d-flex gap-2 justify-content-center mt-4">
                                    ...
                                    <Link href="/pages-pricing" className="btn btn-soft-secondary">View Plans <i className="ri-eye-line align-middle ms-1"></i></Link>
                                </div>
                            </div>
