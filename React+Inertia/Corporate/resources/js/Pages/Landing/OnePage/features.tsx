                ...
                <Container>
                    <Row className="align-items-center gy-4">
                        ...
                        <Col className="col-sm-auto">
                            <div>
                                <Link href="/1.envato.market/velzon-admin" target="_blank" className="btn bg-gradient btn-secondary"><i className="ri-shopping-cart-2-line align-middle me-1"></i> Buy Now</Link>
                            </div>
                        </Col>
                    </Row>
                </Container>
                    ...
                    <Row className="align-items-center gy-4">
                        <Col lg={6} className="order-2 order-lg-1">
                            <div className="text-muted">
                                ...
                                <div className="mt-4">
                                    <Link href="/dashboard" className="btn btn-primary">Learn More <i className="ri-arrow-right-line align-middle ms-1"></i></Link>
                                </div>
                            </div>
                        </Col>
