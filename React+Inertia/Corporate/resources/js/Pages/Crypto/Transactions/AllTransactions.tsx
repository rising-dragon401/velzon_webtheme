            ...
            <Row className="align-items-center mb-4 g-3">
                ...
                <div className="col-sm-auto ms-auto">
                    <div className="d-flex gap-2">
                        <a href="#" data-bs-toggle="modal" className="btn btn-success" onClick={() => flowType("Deposit")}>Deposite</a>
                        <a href="#" data-bs-toggle="modal" className="btn btn-secondary" onClick={() => flowType("Withdraw")}>Withdraw</a>
                    </div>
                </div>
            </Row>
