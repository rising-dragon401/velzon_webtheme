                        ...
                        <Col lg={12}>
                            <div className="d-lg-flex align-items-center mb-4">
                                ...
                                <div className="flex-shrink-0 mt-4 mt-lg-0">
                                    <Link href="/apps-nft-explore" className="btn btn-soft-secondary">View All <i className="ri-arrow-right-line align-bottom"></i></Link>
                                </div>
                            </div>
                        </Col>
                    </Row>
                                    ...
                                    <Card.Body>
                                        ...
                                        <div className="explore-place-bid-img overflow-hidden rounded">
                                            ...
                                            <div className="place-bid-btn">
                                                <Link href="#" className="btn btn-secondary"><i className="ri-auction-fill align-bottom me-1"></i> Place Bid</Link>
                                            </div>
                                        </div>
                                        <div className="mt-3">
                                            ...
                                            <h6 className="fs-16 mb-0"><Link href="/apps-nft-item-details" className="text-reset">{item.category}</Link></h6>
                                        </div>
                                    </Card.Body>
                                </Card>
                            </Col>
                    ...
                    <Row>
                        <Col lg={12}>
                            <div className="d-lg-flex align-items-center mb-4">
                                ...
                                <div className="flex-shrink-0 mt-4 mt-lg-0">
                                    <Link href="/apps-nft-creators" className="btn btn-soft-secondary">View All <i className="ri-arrow-right-line align-bottom"></i></Link>
                                </div>
                            </div>
                        </Col>
                    </Row>
                        ...
                        {nftArtworkData.map((item, key) => (
                            <Col key={key}>
                                <Card className="explore-box card-animate">
                                    ...
                                    <Card.Body>
                                        <p className="fw-medium mb-0 float-end"><i className="mdi mdi-heart text-danger align-middle"></i> {item.likes} </p>
                                        <h5 className="mb-1"><Link href="/apps-nft-item-details" className="text-reset">{item.title}</Link></h5>
                            ...
                            <Col key={key}>
                                <Card>
                                    ...
                                    <Card.Body className="text-center">
                                        ...
                                        <h5 className="mt-3 mb-1"><Link href="#" className="text-reset">{item.author}</Link></h5>
