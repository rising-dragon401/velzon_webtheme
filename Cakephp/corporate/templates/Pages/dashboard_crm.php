...
<head>
    ...
    <?= $this->element('title-meta', array('title' => 'CRM')) ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?= $this->element('page-title', array('pagetitle' => 'Dashboards', 'title' => 'CRM')) ?>
                                ...
                                <div class="card-body px-0">
                                    <ul class="list-inline main-chart text-center mb-0">
                                        ...
                                        <li class="list-inline-item chart-border-left me-0">
                                            <h5>$497k<span class="text-muted d-inline-block fs-13 align-middle ms-2">Expenses</span></h5>
                                        </li>
                                        <li class="list-inline-item chart-border-left me-0">
