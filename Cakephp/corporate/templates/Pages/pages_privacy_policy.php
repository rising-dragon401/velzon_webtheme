...
<head>
    ...
    <?= $this->element('title-meta', array('title' => 'Privacy Policy')) ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?= $this->element('page-title', array('pagetitle' => 'Pages', 'title' => 'Privacy Policy')) ?>
                        ...
                        <div class="col-lg-10">
                            <div class="card">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="text-end">
                                        <a href="#!" class="btn btn-secondary">I'm Understand</a>
                                    </div>
                                </div>
                            </div>
                        </div>
