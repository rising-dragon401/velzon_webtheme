        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?= $this->element('page-title', array('pagetitle' => 'Ecommerce', 'title' => 'Order Details')) ?>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                <h5 class="fs-15"><a href="apps-ecommerce-product-details" class="text-reset">Noise NoiseFit Endure Smart Watch</a></h5>
