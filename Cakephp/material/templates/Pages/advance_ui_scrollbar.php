...
<head>
    ...
    <?= $this->element('title-meta', array('title' => 'Scrollbar')) ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?= $this->element('page-title', array('pagetitle' => 'Advance UI', 'title' => 'Scrollbar')) ?>
                                            ...
                                            <div class="mx-n3">
                                                <div data-simplebar data-simplebar-auto-hide="false" data-simplebar-track="primary" style="max-height: 275px;">
                                                    <a href="#!" class="text-reset notification-item d-block dropdown-item">
                                                        <div class="d-flex">
                                                            <div class="flex-shrink-0 avatar-xs me-3">
                                                                <span class="avatar-title bg-info-subtle text-info rounded-circle fs-16 shadow">
                                                    ...
                                                    <a href="#!" class="text-reset notification-item d-block dropdown-item active">
                                                        <div class="d-flex">
                                                            <div class="flex-shrink-0 avatar-xs me-3">
                                                                <img src="/images/users/avatar-2.jpg" class="rounded-circle img-fluid shadow" alt="user-pic">
                                                            </div>
                                                            <div class="flex-grow-1 text-muted">
                                                    ...
                                                    <a href="#!" class="text-reset notification-item d-block dropdown-item">
                                                        <div class="d-flex">
                                                            <div class="flex-shrink-0 avatar-xs me-3">
                                                                <span class="avatar-title bg-danger-subtle text-danger rounded-circle fs-16 shadow">
                                                    ...
                                                    <a href="#!" class="text-reset notification-item d-block dropdown-item">
                                                        <div class="d-flex">
                                                            <div class="flex-shrink-0 avatar-xs me-3">
                                                                <img src="/images/users/avatar-8.jpg" class="rounded-circle img-fluid shadow" alt="user-pic">
                                                            </div>
                                                            <div class="flex-grow-1 text-muted">
