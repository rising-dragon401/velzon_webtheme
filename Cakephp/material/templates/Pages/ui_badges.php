        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?= $this->element('page-title', array('pagetitle' => 'Base UI', 'title' => 'Badges')) ?>
                        ...
                        <div class="col-xxl-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="text-muted">Use the <code>bg-*-subtle text-*</code> class with the below-mentioned variation to create a softer badge.
                                    </p>
                        ...
                        <div class="col-xxl-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="text-muted">Use the <code>rounded-pill bg-*-subtle text-*</code> class with the below-mentioned variation
