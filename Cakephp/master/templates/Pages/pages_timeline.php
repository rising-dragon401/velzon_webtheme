        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?= $this->element('page-title', array('pagetitle' => 'Pages', 'title' => 'Timeline')) ?>
                                        ...
                                        <div class="content">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="/images/users/avatar-5.jpg" alt="" class="avatar-sm rounded material-shadow-none">
                                                </div>
                                    ...
                                    <div class="timeline-item left">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="row border border-dashed rounded gx-2 p-2">
                                                <div class="col-3">
                                                    <img src="/images/small/img-2.jpg" alt="" class="img-fluid rounded material-shadow-none">
                                                </div>
                                                <!--end col-->
                                                <div class="col-3">
                                                    <img src="/images/small/img-3.jpg" alt="" class="img-fluid rounded material-shadow-none">
                                                </div>
                                                <!--end col-->
                                                <div class="col-3">
                                                    <img src="/images/small/img-4.jpg" alt="" class="img-fluid rounded material-shadow-none">
                                                </div>
                                                <!--end col-->
                                                <div class="col-3">
                                                    <img src="/images/small/img-6.jpg" alt="" class="img-fluid rounded material-shadow-none">
                                                </div>
                                                <!--end col-->
                                            </div>
                                            <!--end row-->
                                            ...
                                            <div class="col-12">
                                                <div class="timeline-box material-shadow">
                                                    <div class="timeline-text">
                                                        ...
                                                        <div class="row border border-dashed rounded gx-2 p-2">
                                                            <div class="col-3">
                                                                <a href="javascript:void(0);"><img src="/images/small/img-7.jpg" alt="" class="img-fluid rounded material-shadow"></a>
                                                            </div>
                                                            <!--end col-->
                                                            <div class="col-3">
                                                                <a href="javascript:void(0);"><img src="/images/small/img-3.jpg" alt="" class="img-fluid rounded material-shadow"></a>
                                                            </div>
                                                            <!--end col-->
                                                            <div class="col-3">
                                                                <a href="javascript:void(0);"><img src="/images/small/img-10.jpg" alt="" class="img-fluid rounded material-shadow"></a>
                                                            </div>
                                                            <!--end col-->
                                                            <div class="col-3">
                                                                <a href="javascript:void(0);"><img src="/images/small/img-9.jpg" alt="" class="img-fluid rounded material-shadow"></a>
                                                            </div>
                                                            <!--end col-->
                                                        </div>
                                                    </div>
