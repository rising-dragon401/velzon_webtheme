...
<head>
    ...
    <?= $this->element('title-meta', array('title' => 'Term & Conditions')) ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?= $this->element('page-title', array('pagetitle' => 'Pages', 'title' => 'Term & Conditions')) ?>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="text-end hstack gap-2 justify-content-end">
                                        ...
                                        <a href="#!" class="btn btn-outline-danger material-shadow-none"><i class="ri-close-line align-bottom me-1"></i> Decline</a>
                                    </div>
                                </div>
                            </div>
                        </div><!--end col-->
