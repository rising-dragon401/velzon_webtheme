...
<head>
    ...
    <?= $this->element('title-meta', array('title' => 'Product Details')) ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?= $this->element('page-title', array('pagetitle' => 'Ecommerce', 'title' => 'Product Details')) ?>
                                                                            ...
                                                                            <div class="border border-dashed rounded p-3">
                                                                                ...
                                                                                <div class="d-flex flex-grow-1 gap-2 mb-3">
                                                                                    <a href="#" class="d-block">
                                                                                        <img src="/images/small/img-12.jpg" alt="" class="avatar-sm rounded object-fit-cover material-shadow">
                                                                                    </a>
                                                                                    <a href="#" class="d-block">
                                                                                        <img src="/images/small/img-11.jpg" alt="" class="avatar-sm rounded object-fit-cover material-shadow">
                                                                                    </a>
                                                                                    <a href="#" class="d-block">
                                                                                        <img src="/images/small/img-10.jpg" alt="" class="avatar-sm rounded object-fit-cover material-shadow">
                                                                                    </a>
                                                                                </div>
