...
<head>
    ...
    <?= $this->element('title-meta', array('title' => 'Job Landing')) ?>
        ...
        <nav class="navbar navbar-expand-lg navbar-landing fixed-top job-navbar" id="navbar">
            <div class="container-fluid custom-container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="">
                        <a href="auth-signin-basic" class="btn btn-soft-danger"><i class="ri-user-3-line align-bottom me-1"></i> Login & Register</a>
                    </div>
                </div>
                ...
                <div class="row align-items-center justify-content-lg-between justify-content-center gy-4">
                    ...
                    <div class="col-lg-6">
                        <div class="text-muted">
                            <h1 class="mb-3 fw-bold lh-base">Find Your <span class="text-primary">Dream Job</span> in One Place</h1>
