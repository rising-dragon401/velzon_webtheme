<?= $this->element('main') ?>
    ...
    <head>
        ...
        <?= $this->element('title-meta', array('title' => 'Statistics')) ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <?= $this->element('page-title', array('pagetitle' => 'Jobs', 'title' => 'Statistics')) ?>
                        ...
                        <div class="row">
                            <div class="col-xl-8">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div id="distributed_treemap" data-colors='["--vz-danger", "--vz-success", "--vz-warning", "--vz-info","--vz-secondary", "--vz-primary"]' class="apex-charts" dir="ltr"></div>
                                    </div>
                                </div>
                            </div><!--end col-->
                            <div class="col-xl-4">
                                            ...
                                            <table class="table table-borderless table-sm table-centered align-middle table-nowrap mb-0">
                                                <tbody class="border-0">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <p class="text-muted mb-0"><i data-feather="users" class="me-2 icon-sm align-middle"></i>78.56k</p>
                                                        </td>
                                                        <td class="text-end">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <p class="text-muted mb-0"><i data-feather="users" class="me-2 icon-sm align-middle"></i>105.02k</p>
                                                        </td>
                                                        <td class="text-end">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <p class="text-muted mb-0"><i data-feather="users" class="me-2 icon-sm align-middle"></i>42.89k</p>
                                                        </td>
                                                        <td class="text-end">
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div class="card card-height-100">
                                    ...
                                    <div class="card-body pb-0">
                                        <div id="deal-type-charts" data-colors='["--vz-secondary", "--vz-info"]' class="apex-charts" dir="ltr"></div>
                                    </div><!-- end card body -->
                                </div><!-- end card -->
                            </div><!-- end col -->
