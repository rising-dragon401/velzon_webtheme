                                                    ...
                                                    <div class="row align-items-center">
                                                        <div class="col-6">
                                                            <div class="d-flex flex-wrap gap-4 align-items-center">
                                                                ...
                                                                <p class="fw-semibold text-muted mb-0">High <spanclass="text-body fs-12 ms-1">0.014578</span></p>
                                                                <p class="fw-semibold text-muted mb-0">Low <span class="text-body fs-12 ms-1">0.0175489</span></p>
                                                            </div>
                                                        </div><!-- end col -->
                                                        <div class="col-6">
                                                            <div class="d-flex">
