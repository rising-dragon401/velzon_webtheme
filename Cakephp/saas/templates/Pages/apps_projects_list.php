                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="d-flex mb-2">
                                            ...
                                            <div class="flex-grow-1">
                                                <h5 class="mb-1 fs-14"><a href="apps-projects-overview" class="text-body">Slack brand logo design</a></h5>
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="d-flex mb-2">
                                            ...
                                            <div class="flex-grow-1">
                                                <h5 class="mb-1 fs-14"><a href="apps-projects-overview" class="text-body">Redesign - Landing page</a></h5>
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="d-flex mb-2">
                                            ...
                                            <div class="flex-grow-1">
                                                <h5 class="mb-1 fs-14"><a href="apps-projects-overview" class="text-body">Chat Application</a></h5>
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="d-flex mb-2">
                                            ...
                                            <div class="flex-grow-1">
                                                <h5 class="mb-1 fs-14"><a href="apps-projects-overview" class="text-body">Project App</a></h5>
