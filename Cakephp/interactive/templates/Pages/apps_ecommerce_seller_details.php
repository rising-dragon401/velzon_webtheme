...
<head>
    ...
    <?= $this->element('title-meta', array('title' => 'Seller Details')) ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?= $this->element('page-title', array('pagetitle' => 'Ecommerce', 'title' => 'Seller Details')) ?>
                        ...
                        <div class="col-xxl-9">
                            ...
                            <div class="row g-4 mb-3">
                                <div class="col-sm-auto">
                                    <div>
                                        <a href="apps-ecommerce-add-product" class="btn btn-info"><i class="ri-add-line align-bottom me-1"></i> Add New</a>
                                    </div>
                                </div>
                                <div class="col-sm">
