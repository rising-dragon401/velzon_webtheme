...
<head>
    ...
    <?= $this->element('title-meta', array('title' => 'Task Details')) ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?= $this->element('page-title', array('pagetitle' => 'Tasks', 'title' => 'Task Details')) ?>
                                            ...
                                            <div data-simplebar style="height: 508px;" class="px-3 mx-n3 mb-2">
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        ...
                                                        <p class="text-muted">Your <a href="javascript:void(0)" class="text-decoration-underline link-info">Online Order Support</a> provides you with the most current status of your order. To help manage your order refer to the “Action Menu” to initiate return, contact Customer Support and more.</p>
