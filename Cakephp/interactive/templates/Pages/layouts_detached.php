                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div class="card card-height-100">
                                ...
                                <div class="card-body pb-0">
                                    <div id="deal-type-charts" data-colors='["--vz-gray-300", "--vz-info", "--vz-primary"]' class="apex-charts" dir="ltr"></div>
                                </div><!-- end card body -->
                            </div><!-- end card -->
                        </div><!-- end col -->
                        ...
                        <div class="col-xxl-6">
                            <div class="card card-height-100">
                                ...
                                <div class="card-body px-0">
                                    ...
                                    <div id="revenue-expenses-charts" data-colors='["--vz-info", "--vz-primary"]' class="apex-charts"></div>
                                </div>
                            </div><!-- end card -->
                        </div><!-- end col -->
                    </div><!-- end row -->
