<?= $this->element('main') ?>
    ...
    <head>
        ...
        <?= $this->element('title-meta', array('title' => 'Job Categories')) ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <?= $this->element('page-title', array('pagetitle' => 'Jobs', 'title' => 'Job Categories')) ?>
                                        ...
                                        <div class="row justify-content-between gy-3">
                                            ...
                                            <div class="col-lg-auto">
                                                <div class="d-md-flex text-nowrap gap-2">
                                                    <button class="btn btn-primary add-btn"><i class="ri-add-fill me-1 align-bottom"></i> Add Categories</button>
