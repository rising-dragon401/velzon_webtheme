        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?= $this->element('page-title', array('pagetitle' => 'Pages', 'title' => 'Search Results')) ?>
                                        ...
                                        <div class="tab-pane" id="video" role="tabpanel">
                                            <div class="row">
                                                ...
                                                <div class="text-center">
                                                    <button id="loadmore" class="btn btn-link link-info mt-2"><i class="mdi mdi-loading mdi-spin fs-20 align-middle me-2"></i> Load more </button>
                                                </div>
                                            </div>
                                            <!--end row-->
                                        </div>
