...
<head>
    ...
    <?= $this->element('title-meta', array('title' => 'Basic Elements')) ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?= $this->element('page-title', array('pagetitle' => 'Forms', 'title' => 'Basic Elements')) ?>
                                        ...
                                        <div class="row gy-4">
                                            ...
                                            <div class="col-xxl-3 col-md-6">
                                                <div>
                                                    ...
                                                    <input type="color" class="form-control form-control-color w-100" id="colorPicker" value="#8c68cd">
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-xxl-3 col-md-6">
