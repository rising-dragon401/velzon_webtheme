...
<head>
    ...
    <?= $this->element('title-meta', array('title' => 'Transactions')) ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?= $this->element('page-title', array('pagetitle' => 'Crypto', 'title' => 'Transactions')) ?>
                                ...
                                <div class="card-body">
                                    <div class="d-flex mb-3">
                                        <div class="flex-grow-1">
                                            <lord-icon src="https://cdn.lordicon.com/fhtaantg.json" trigger="loop" colors="primary:#8c68cd,secondary:#4788ff" style="width:55px;height:55px"></lord-icon>
                                        </div>
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div class="card card-animate">
                                <div class="card-body">
                                    <div class="d-flex mb-3">
                                        <div class="flex-grow-1">
                                            <lord-icon src="https://cdn.lordicon.com/yeallgsa.json" trigger="loop" colors="primary:#8c68cd,secondary:#4788ff" style="width:55px;height:55px"> </lord-icon>
                                        </div>
                                        <div class="flex-shrink-0">
                                            <a href="javascript:void(0);" class="badge bg-warning-subtle text-warning badge-border">BTC</a>
                                            <a href="javascript:void(0);" class="badge bg-info-subtle text-info badge-border">ETH</a>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card card-animate">
                                            <div class="card-body bg-primary-subtle">
                                                <div class="d-flex mb-3">
                                                    <div class="flex-grow-1">
                                                        <lord-icon src="https://cdn.lordicon.com/vaeagfzc.json" trigger="loop" colors="primary:#8c68cd,secondary:#4788ff" style="width:55px;height:55px"></lord-icon>
                                                    </div>
                                                    <div class="flex-shrink-0">
                    ...
                    <div class="row align-items-center mb-4 g-3">
                        ...
                        <div class="col-sm-auto ms-auto">
                            <div class="d-flex gap-2">
                                <a href="javascript:void(0);" class="btn btn-primary">Deposit</a>
                                ...
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    ...
                                    <tbody class="list form-check-all">
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/images/svg/crypto-icons/btc.svg" alt="" class="avatar-xxs me-2"> BTC
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/images/svg/crypto-icons/eth.svg" alt="" class="avatar-xxs me-2"> ETH
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/images/svg/crypto-icons/eur.svg" alt="" class="avatar-xxs me-2"> EUR
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/images/svg/crypto-icons/gbp.svg" alt="" class="avatar-xxs me-2"> GBP
                                                </div>
                                            </td>
                                            <td class="form_name">Wallet</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/images/svg/crypto-icons/jpy.svg" alt="" class="avatar-xxs me-2"> JPY
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/images/svg/crypto-icons/xrp.svg" alt="" class="avatar-xxs me-2"> XRP
                                                </div>
                                            </td>
                                            <td class="form_name">Wallet</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/images/svg/crypto-icons/ltc.svg" alt="" class="avatar-xxs me-2"> LTC
                                                </div>
                                            </td>
                                            <td class="form_name">Tonya Noble</td>
                                            <td class="to_name">Wallet</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/images/svg/crypto-icons/xmr.svg" alt="" class="avatar-xxs me-2"> XMR
                                                </div>
                                            </td>
                                            <td class="form_name">Wallet</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/images/svg/crypto-icons/xpm.svg" alt="" class="avatar-xxs me-2"> XPM
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/images/svg/crypto-icons/ppt.svg" alt="" class="avatar-xxs me-2"> PPT
                                                </div>
                                            </td>
