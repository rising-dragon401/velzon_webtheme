                            ...
                            <div class="card">
                                <div class="card-body p-0">
                                    ...
                                    <div class="row align-items-end">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="px-3">
                                                <img src="/images/user-illustarator-2.png" class="img-fluid"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card bg-primary">
                                <div class="card-body p-0">
                                    ...
                                    <div class="row align-items-end">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="px-3">
                                                <img src="/images/user-illustarator-1.png" class="img-fluid"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="acitivity-item py-3 d-flex">
                                                        ...
                                                        <div class="flex-grow-1 ms-3">
                                                            ...
                                                            <div
                                                                ...
                                                                <a href="apps-ecommerce-product-details"
                                                                    class="bg-light rounded p-1">
                                                                    <img src="/images/products/img-10.png" alt=""
                                                                        class="img-fluid d-block" />
                                                                </a>
                                                            </div>
                                    ...
                                    <ul class="list-group list-group-flush border-dashed mb-0">
                                            ...
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 avatar-xs">
                                                    <span class="avatar-title bg-light p-1 rounded-circle">
                                                        <img src="/images/svg/crypto-icons/btc.svg"
                                                            class="img-fluid" alt="">
                                                    </span>
                                                </div>
                                        ...
                                        <li class="list-group-item px-0">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 avatar-xs">
                                                    <span class="avatar-title bg-light p-1 rounded-circle">
                                                        <img src="/images/svg/crypto-icons/eth.svg"
                                                            class="img-fluid" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                        ...
                                        <li class="list-group-item px-0">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 avatar-xs">
                                                    <span class="avatar-title bg-light p-1 rounded-circle">
                                                        <img src="/images/svg/crypto-icons/ltc.svg"
                                                            class="img-fluid" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                        ...
                                        <li class="list-group-item px-0 pb-0">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 avatar-xs">
                                                    <span class="avatar-title bg-light p-1 rounded-circle">
                                                        <img src="/images/svg/crypto-icons/dash.svg"
                                                            class="img-fluid" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-grow-1 ms-2">
