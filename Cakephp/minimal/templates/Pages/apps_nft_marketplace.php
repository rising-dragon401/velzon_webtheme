...
<head>
    ...
    <?= $this->element('title-meta', array('title' => 'Marketplace')) ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?= $this->element('page-title', array('pagetitle' => 'NFT Marketplace', 'title' => 'Marketplace')) ?>
                            ...
                            <div class="card explore-box">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-15 mb-0"><a href="apps-nft-item-details" class="text-body">Patterns Arts & Culture</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card explore-box">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-15 mb-0"><a href="apps-nft-item-details" class="text-body">Evolved Reality</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card explore-box">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-15 mb-0"><a href="apps-nft-item-details" class="text-body">Long-tailed Macaque</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card explore-box">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-15 mb-0"><a href="apps-nft-item-details" class="text-body">Robotic Body Art</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card explore-box">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-15 mb-0"><a href="apps-nft-item-details" class="text-body">Creative Filtered Portrait</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1 fs-15"><a href="apps-nft-item-details" class="text-body">The Chirstoper</a></h5>
                        ...
                        <div class="col">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1 fs-15"><a href="apps-nft-item-details" class="text-body">Trendy Fashion Portraits</a></h5>
                        ...
                        <div class="col">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1 fs-15"><a href="apps-nft-item-details" class="text-body">Smillevers Crypto</a></h5>
                        ...
                        <div class="col">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1 fs-15"><a href="apps-nft-item-details" class="text-body">Evolved Reality</a></h5>
                        ...
                        <div class="col">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1 fs-15"><a href="apps-nft-item-details" class="text-body">Abstract Face Painting</a></h5>
                    ...
                    <div class="row row-cols-xl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
                        <div class="col">
                            <div class="card">
                                <img src="/images/nft/img-03.jpg" alt="" class="card-img-top object-fit-cover" height="120">
                                <div class="card-body text-center">
                                    <img src="/images/users/avatar-1.jpg" alt="" class="avatar-md mt-n5 rounded-circle mx-auto d-block object-fit-cover">
                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    <img src="/images/nft/img-04.jpg" alt="" class="avatar-md mt-n5 rounded-circle mx-auto d-block object-fit-cover">
                        ...
                        <div class="col">
                            <div class="card">
                                <img src="/images/nft/img-01.jpg" alt="" class="card-img-top object-fit-cover" height="120">
                                <div class="card-body text-center">
                                    <img src="/images/nft/img-06.jpg" alt="" class="avatar-md mt-n5 rounded-circle mx-auto d-block object-fit-cover">
                        ...
                        <div class="col">
                            <div class="card">
                                <img src="/images/nft/img-05.jpg" alt="" class="card-img-top object-fit-cover" height="120">
                                <div class="card-body text-center">
                        ...
                        <div class="col">
                            <div class="card">
                                <img src="/images/nft/img-02.jpg" alt="" class="card-img-top object-fit-cover" height="120">
                                <div class="card-body text-center">
