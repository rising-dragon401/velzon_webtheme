			...
			<CardBody class="p-0">
				...
				<div data-simplebar style="max-height: 410px;" class="p-3 pt-0">
					<div class="acitivity-timeline acitivity-main">
						...
						<div class="acitivity-item py-3 d-flex">
							...
							<div class="flex-grow-1 ms-3">
								...
								<p class="text-muted mb-0">
									Flash sale by{" "}
									<a href="{null}" class="link-secondary fw-medium">
										Zoetic Fashion
									</a>
								</p>
						...
						<div class="acitivity-item d-flex">
							<div class="flex-shrink-0">
								<img src={avatar3} alt="" class="avatar-xs rounded-circle acitivity-avatar shadow" />
							</div>
							<div class="flex-grow-1 ms-3">
								<h6 class="mb-1 lh-base">
				...
				<div class="p-3 mt-2">
					...
					<div class="mt-3 text-center">
						<a href="{null}" class="text-muted text-decoration-underline">
							View all Categories
						</a>
					</div>
				</div>
				...
				<div class="p-3">
					...
					<div class="mt-3">
						<Row class="align-items-center g-2">
							...
							<div class="col">
								<div class="p-1">
									<Progress class="animated-progess progress-sm bg-success-subtle" color="success" value="50.16" />
								</div>
							</div>
							<div class="col-auto">
								<div class="p-1">
						...
						<Row class="align-items-center g-2">
							...
							<div class="col">
								<div class="p-1">
									<Progress class="animated-progess progress-sm bg-success-subtle" color="success" value="29.32" />
								</div>
							</div>
							<div class="col-auto">
								<div class="p-1">
						...
						<Row class="align-items-center g-2">
							...
							<div class="col">
								<div class="p-1">
									<Progress class="animated-progess progress-sm bg-warning-subtle" color="warning" value="18.12" />
								</div>
							</div>
							<div class="col-auto">
								<div class="p-1">
						...
						<Row class="align-items-center g-2">
							...
							<div class="col">
								<div class="p-1">
									<Progress class="animated-progess progress-sm bg-success-subtle" color="success" value="4.98" />
								</div>
							</div>
						...
						<Row class="align-items-center g-2">
							...
							<div class="col">
								<div class="p-1">
									<Progress class="animated-progess progress-sm bg-danger-subtle" color="danger" value="7.42" />
								</div>
							</div>
							<div class="col-auto">
								<div class="p-1">
					...
					<CardBody>
						...
						<div class="mt-4">
							...
							<p class="text-muted lh-base">
								Refer a new seller to us and earn $100 per
								refer.
							</p>
