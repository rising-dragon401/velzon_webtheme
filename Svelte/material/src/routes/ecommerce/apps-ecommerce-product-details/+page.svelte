<svelte:head>
  <title>Product Details | Velzon - Svelte Admin & Dashboard Template</title>
</svelte:head>
<script>
	import {
		Card,
								...
								<div class="mt-xl-0 mt-5">
									<div class="d-flex">
										...
										<div class="flex-shrink-0">
											<div>
												<a href="/ecommerce/apps-ecommerce-add-product" class="btn btn-light" id="edit-product"
													><i class="ri-pencil-fill align-bottom" /></a
												>
												...
												<div>
													...
													<div class="mt-3">
														<Row class="align-items-center g-2">
															...
															<div class="col">
																<div class="p-2">
																	<div class="progress bg-success-subtle animated-progess progress-sm">
														...
														<Row class="align-items-center g-2">
															...
															<div class="col">
																<div class="p-2">
																	<div class="progress bg-warning-subtle animated-progess progress-sm">
														...
														<Row class="align-items-center g-2">
															...
															<div class="col">
																<div class="p-2">
																	<div class="progress bg-danger-subtle animated-progess progress-sm">
																	...
																	<div class="d-flex flex-grow-1 gap-2 mb-3">
																		<a href="{null}" class="d-block">
																			<img
																				src={img12}
																				alt=""
																				class="avatar-sm rounded object-cover shadow"
																			/>
																		</a>
																		<a href="{null}" class="d-block">
																			<img
