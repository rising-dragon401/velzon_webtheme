...
<!-- Base Examples -->
<div class="mb-4">
    <Progress value={0}  class="bg-primary-subtle"/>
</div>

<div class="mb-4">
    <Progress value={25} class="bg-primary-subtle" />
</div>

<div class="mb-4">
    <Progress value={50} class="bg-primary-subtle" />
</div>

<div class="mb-4">
    <Progress value={75}  class="bg-primary-subtle"/>
</div>

<div>
    <Progress value={100} class="bg-primary-subtle" />
</div>`;
...
<!-- Backgrounds -->
<div class="mb-4">
    <Progress color="primary" class="bg-primary-subtle" value={15} />
</div>

<div class="mb-4">
    <Progress color="success" class="bg-success-subtle" value={25} />
</div>

<div class="mb-4">
    <Progress color="info" class="bg-info-subtle" value={50} />
</div>

<div class="mb-4">
    <Progress color="warning" class="bg-warning-subtle" value={75} />
</div>

<div>
    <Progress color="danger" class="bg-danger-subtle" value={100} />
</div>`;
...
<!-- Gradient -->
<div class="mb-4">
    <Progress value={15} class="bg-gradient bg-primary-subtle" />
</div>
<div class="mb-4">
    <Progress color="success" value={25} class="bg-gradient bg-success-subtle" />
</div>
<div class="mb-4">
    <Progress color="info" value={50} class="bg-gradient bg-info-subtle" />
</div>
<div class="mb-4">
    <Progress color="warning" value={75} class="bg-gradient bg-warning-subtle" />
</div>
<div>
    <Progress color="danger" value={100} class="bg-gradient  bg-danger-subtle" />
</div>
`;
...
<!-- Animated Progress -->
<div class="mb-4">
    <Progress value={15} class="animated-progess bg-primary-subtle" />
</div>
<div class="mb-4">
    <Progress value={25} color="success" class="animated-progess bg-success-subtle" />
</div>
<div class="mb-4">
    <Progress value={50} color="info" class="animated-progess bg-info-subtle" />
</div>
<div class="mb-4">
    <Progress value={75} color="warning" class="animated-progess bg-warning-subtle" />
</div>
<div>
    <Progress value={100} color="danger" class="animated-progess  bg-danger-subtle" />
</div>
`;
...
<!-- Custom Progress -->
<div class="mb-4">
    <Progress value={15} color="primary" class="animated-progess custom-progress bg-primary-subtle" />
</div>
<div class="mb-4">
    <Progress value={25} color="success" class="animated-progess custom-progress bg-success-subtle" />
</div>
<div class="mb-4">
    <Progress value={50} color="info" class="animated-progess custom-progress bg-info-subtle" />
</div>
<div class="mb-4">
    <Progress value={75} color="warning" class="animated-progess custom-progress bg-warning-subtle" />
</div>
<div>
    <Progress value={100} color="danger" class="animated-progess custom-progress  bg-danger-subtle" />
</div>
`;
...
<svelte:head>
	<title>Progress | Velzon - Svelte Admin & Dashboard Template</title>
</svelte:head>
		...
		<Row>
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						...
						<div class="live-preview">
							<Progress color="primary" value={25} class="bg-primary-subtle">25%</Progress>
						</div>
			...
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Multiple bar color to change the appearance of
							individual progress bars.
						</p>

						<div class="live-preview">
							<div>
								<Progress multi class="bg-primary-subtle">
									<Progress bar value="15" />
									<Progress bar color="success" value="30" />
									<Progress bar color="info" value="20" />
								</Progress>
						...
						<div class="live-preview">
							<div class="mb-4">
								...
								<Progress
									color="primary"
									value={25}
									class="progress-sm bg-primary-subtle"
								/>
							</div>
							<div class="mb-4">
								<h5 class="fs-13">Default Progress</h5>
								<Progress
									color="success"
									value={40}
									class="progress-md bg-success-subtle"
								/>
							</div>
							<div class="mb-4">
								<h5 class="fs-13">Large Progress</h5>
								<Progress
									color="warning"
									value={50}
									class="progress-lg bg-warning-subtle"
								/>
							</div>
							<div>
								<h5 class="fs-13">Extra Large Progress</h5>
								<Progress
									color="danger"
									value={70}
									class="progress-xl bg-danger-subtle"
								/>
							</div>
						</div>
						...
						<div class="live-preview">
							...
							<div class="mb-4">
								<Progress
									color="success"
									value={25}
									class="bg-gradient bg-success-subtle"
								/>
							</div>
							<div class="mb-4">
								<Progress
									color="info"
									value={50}
									class="bg-gradient bg-info-subtle"
								/>
							</div>
							<div class="mb-4">
								<Progress
									color="warning"
									value={75}
									class="bg-gradient bg-warning-subtle"
								/>
							</div>
							<div>
								<Progress
									color="danger"
									value={100}
									class="bg-gradient bg-danger-subtle"
								/>
							</div>
						</div>
						...
						<div class="live-preview">
							...
							<div class="mb-4">
								<Progress
									value={25}
									color="success"
									class="animated-progess bg-success-subtle"
								/>
							</div>
							<div class="mb-4">
								<Progress
									value={50}
									color="info"
									class="animated-progess bg-info-subtle"
								/>
							</div>
							<div class="mb-4">
								<Progress
									value={75}
									color="warning"
									class="animated-progess bg-warning-subtle"
								/>
							</div>
							<div>
								<Progress
									value={100}
									color="danger"
									class="animated-progess  bg-danger-subtle"
								/>
							</div>
						</div>
		...
		<Row>
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>animated-progess custom-progess </code> class
			...
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code
								>animated-progess custom-progess progress-label</code
						...
						<div class="live-preview">
							<div class="d-flex align-items-center pb-2 mt-4">
								<div class="flex-shrink-0 me-3">
									<div class="avatar-xs">
										<div
											class="avatar-title bg-light rounded-circle text-muted fs-16"
										>
		...
		<Row>
				...
				<Card>
					...
					<CardBody>
						<p class="text-muted pb-2">
							Example of progress with content wrapped in
							progress.
						</p>
							...
							<Card class="bg-light overflow-hidden shadow-none">
								...
								<div>
									<Progress
										value={30}
										color="secondary"
										class="bg-secondary-subtle rounded-0"
									/>
								</div>
							</Card>
							...
							<Card class="bg-light overflow-hidden shadow-none">
								<CardBody>
									<div class="d-flex">
										<div class="flex-grow-1">
											<h6 class="mb-0">
												<b class="text-success">60%</b> Update
												in progress...
											</h6>
										</div>
										<div class="flex-shrink-0">
								...
								<div>
									<Progress
										value={60}
										color="success"
										class="bg-success-subtle rounded-0"
									/>
								</div>
							</Card>
							...
							<Card class="bg-light overflow-hidden shadow-none">
								<CardBody>
									<div class="d-flex">
										<div class="flex-grow-1">
											<h6 class="mb-0">
												<b class="text-danger">82%</b> Update
												in progress...
											</h6>
										</div>
										<div class="flex-shrink-0">
								...
								<div>
									<Progress
										value={82}
										color="danger"
										class="bg-danger-subtle rounded-0"
									/>
								</div>
							</Card>
						</div>
			...
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted pb-2">
							Here is the example of progress which is represented
							by steps completion.
						</p>
				...
				<Card>
					...
					<CardBody>
						<p class="text-muted pb-2">
							Use <code>progress-step-arrow </code>class to create
						...
						<div class="live-preview">
							...
							>
								...
								<Progress
									...
									value="35"
									color="light"
									class="text-dark">Step 3</Progress
								>
							</Progress>
						</div>
