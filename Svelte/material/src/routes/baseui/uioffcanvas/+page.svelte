...
<svelte:head>
	<title>Offcanvas | Velzon - Svelte Admin & Dashboard Template</title>
</svelte:head>
		...
		<Row>
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Here are the example of offcanvas with scrolling
				...
				<div class="acitivity-item py-3 d-flex">
					...
					<div class="flex-grow-1 ms-3">
						...
						<div class="avatar-group mb-2">
							...
							<Link href="" class="avatar-group-item shadow" id="Frank">
								<img
									src={avatar3}
									alt=""
									class="rounded-circle avatar-xs"
							...
							<Link href="" class="avatar-group-item shadow" id="Ruby">
								<div class="avatar-xs">
									<div
							...
							<Link href="" class="avatar-group-item shadow" id="more">
								<div class="avatar-xs">
									<div class="avatar-title rounded-circle">
										2+
									</div>
	...
	<OffcanvasBody class="p-0 overflow-hidden">
		<div data-simplebar style="height: calc(100vh - 112px);">
			<div class="acitivity-timeline p-4">
				...
				<div class="acitivity-item py-3 d-flex">
					<div class="flex-shrink-0 avatar-xs acitivity-avatar rounded-circle shadow shadow">
						<div
							class="avatar-title bg-success-subtle text-success rounded-circle"
						>
							N
