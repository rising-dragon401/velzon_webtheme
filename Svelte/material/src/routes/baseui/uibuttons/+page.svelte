...
<!-- Outline Buttons -->
<Button color="primary" outline class="shadow-none" > primary </Button>

<Button color="secondary" outline class="shadow-none" > Secondary </Button>

<Button color="success" outline class="shadow-none" > Success </Button>

<Button color="info" outline class="shadow-none" > Info </Button>

<Button color="warning" outline class="shadow-none" > Warning </Button>

<Button color="danger" outline class="shadow-none" > Danger </Button>

<Button color="dark" outline class="shadow-none" > Dark </Button>

<Button color="light" outline class="shadow-none" > Light </Button>
`;
...
<!-- Soft Buttons -->
<Button class="btn-soft-primary shadow-none"> Primary </Button>

<Button class="btn-soft-secondary shadow-none"> Secondary </Button>

<Button class="btn-soft-success shadow-none"> Success </Button>

<Button class="btn-soft-info shadow-none"> Info </Button>

<Button class="btn-soft-warning shadow-none"> Warning </Button>

<Button class="btn-soft-danger shadow-none"> Danger </Button>

<Button class="btn-soft-dark shadow-none"> Dark </Button>
`;
...
<Button color="primary" outline class="btn btn-ghost-primary shadow-none">Primary</Button>

<Button color="secondary" outline class="btn btn-ghost-secondary shadow-none">Secondary</Button>

<Button color="success" outline class="btn btn-ghost-success shadow-none">Success</Button>

<Button color="info" outline class="btn btn-ghost-info shadow-none">Info</Button>

<Button color="warning" outline class="btn btn-ghost-warning shadow-none">Warning</Button>

<Button color="danger" outline class="btn btn-ghost-danger shadow-none">Danger</Button>

<Button color="dark" outline class="btn btn-ghost-dark shadow-none">Dark</Button>
`;
				...
				<Card>
					...
					<CardBody>
						...
						<div class="live-preview">
							<div class="d-flex flex-wrap gap-2">
								<Button color="primary" outline class="shadow-none">Primary</Button>
								<Button color="secondary" outline class="shadow-none"
									>Secondary</Button
								>
								<Button color="success" outline class="shadow-none">Success</Button>
								<Button color="info" outline class="shadow-none">Info</Button>
					...
					<CardBody>
						...
						<div class="live-preview">
							<div class="d-flex flex-wrap gap-2">
								<Button
									color="primary"
									class="btn-soft-primary waves-effect shadow-none waves-light"
									>Primary</Button
								>
								<Button
									class="btn-soft-secondary waves-effect shadow-none waves-light"
									>Secondary</Button
								>
								<Button
									class="btn-soft-success waves-effect shadow-none waves-light"
									>Success</Button
								>
								<Button
									class="btn-soft-info waves-effect shadow-none waves-light"
									>Info</Button
								>
								<Button
									class="btn-soft-warning waves-effect shadow-none waves-light"
									>Warning</Button
								>
								<Button
									class="btn-soft-danger waves-effect shadow-none waves-light"
									>Danger</Button
								>
								<Button
									class="btn-soft-dark waves-effect shadow-none waves-light"
									>Dark</Button
								>
							</div>
						</div>
						...
						<div class="live-preview">
							<div class="d-flex flex-wrap gap-2">
								<Button
									color="primary"
									outline
									class="btn btn-ghost-primary shadow-none"
									>Primary</Button
								>
								<Button
									color="secondary"
								...
								<Button
									color="success"
									outline
									class="btn btn-ghost-success shadow-none"
									>Success</Button
								>
								<Button
									color="info"
									outline
									class="btn btn-ghost-info shadow-none">Info</Button
								>
								<Button
									color="warning"
									outline
									class="btn btn-ghost-warning shadow-none"
									>Warning</Button
								>
								<Button
									color="danger"
									outline
									class="btn btn-ghost-danger shadow-none">Danger</Button
								>
								<Button
									color="dark"
									outline
									class="btn btn-ghost-dark shadow-none">Dark</Button
								>
							</div>
						</div>
							...
							<Row>
								...
								<Col lg={4}>
									...
									>
										<Button
											color="primary"
											class="btn-label rounded-pill waves-effect waves-light"
										>
											<i
												class="ri-user-smile-line label-icon align-middle fs-16 me-2 rounded-pill"
											/> Primary
										</Button>
										<Button
											color="success"
										...
										>
											<i
												class="ri-check-double-line label-icon align-middle fs-16 me-2 rounded-pill"
											/> Success
										</Button>
										<Button
											color="warning"
										...
										>
											<i
												class="ri-error-warning-line label-icon align-middle fs-16 me-2 rounded-pill"
											/> Warning
										</Button>
									</div>
								</Col>
								<Col lg={4}>
									<div class="d-flex flex-wrap gap-2">
										<Button
											color="primary"
											class="btn-label right waves-effect waves-light"
										>
											<i
										...
										<Button
											color="success"
											class="btn-label right rounded-pill waves-effect waves-light"
										>
											<i
					...
					<CardBody>
						...
						<div class="live-preview">
							<Row>
								<Col lg={6}>
									<div
										class="hstack flex-wrap gap-2 mb-3 mb-lg-0"
									>
										<Button
											color="primary"
											class="btn-load"
							...
							<Row>
								<Col lg={6}>
									...
									>
										<Button
											color="primary"
											class="btn-border">Primary</Button
										>
										<Button
											color="secondary"
											class="btn-border">Secondary</Button
										>
										<Button
											color="success"
											class="btn-border">Success</Button
										>
										<Button
											color="warning"
											class="btn-border">Warning</Button
										>
										<Button
											color="danger"
											class="btn-border">Danger</Button
										>
									</div>
								</Col>
								<Col lg={6}>
									...
									>
										...
										>
										<Button
											class="btn-soft-warning btn-border"
											>Warning</Button
										>
										<Button
											class="btn-soft-danger btn-border"
											>Danger</Button
										>
										<Button class="btn-soft-dark btn-border"
											>Dark</Button
										>
									</div>
								</Col>
								...
								<Col lg={6}>
									...
									>
										...
										>
											<span class="icon-on"
												><i
													class="ri-alarm-line align-bottom"
												/> Active</span
											>
											<span class="icon-off"
												>Unactive</span
										...
										>
											...
											<span class="icon-off"
												><i
													class="ri-check-fill align-bottom me-1"
												/> Unconnect</span
											>
										</Button>
										<Button
										...
										>
											<span class="icon-on"
												><i
													class="ri-thumb-up-line align-bottom me-1"
												/> Yes</span
											>
											<span class="icon-off"
												><i
													class="ri-thumb-down-line align-bottom me-1"
												/> No</span
											>
										</Button>
										<Button
										...
										>
											<span class="icon-on"
												><i
													class="ri-bookmark-line align-bottom me-1"
												/> Bookmark</span
											>
											<span class="icon-off"
												><i
													class="ri-bookmark-3-fill align-bottom me-1"
												/> Unbookmark</span
											>
										</Button>
									</div>
								...
								<Col lg={6}>
									...
									>
										...
										<Button
											color="danger"
											outline
											class="btn-soft-danger custom-toggle"
											on:click={(e) =>
												favouriteBtn(e.target)}
										>
											<span class="icon-on">On</span>
										...
										<Button
											class="btn-dark custom-toggle active"
											on:click={(e) =>
												favouriteBtn(e.target)}
										>
											<span class="icon-on"
												><i
													class="ri-bookmark-line align-bottom"
												/></span
											>
											<span class="icon-off"
												><i
													class="ri-bookmark-3-fill align-bottom"
												/></span
											>
										</Button>
									</div>
					...
					<CardBody>
						...
						<div class="live-preview">
							<div
								class="d-flex flex-wrap align-items-center gap-2"
							>
								<Button size="lg" color="primary" class="waves-effect waves-light"
									>Large button</Button
								>
								<Button size="lg" color="light" class="waves-effect"
									>Large button</Button
								>

								<Button size="sm" color="primary" class="waves-effect waves-light"
									>Small button</Button
								>
								<Button size="sm" color="light" class="waves-effect"
									>Small button</Button
								>
							</div>
						</div>
			...
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						...
						<div class="live-preview">
							<div class="d-flex flex-wrap gap-2">
								<Link href={null} class="btn btn-primary"
									>Link</Link
								>
								<Button color="success" type="submit"
									>Button</Button
								>
								<Button color="info" type="button" class="waves-effect waves-light">Input</Button
								>
								<Button color="danger" type="submit" class="waves-effect waves-light"
									>Submit</Button
								>
								<Button color="warning" type="reset" class="waves-effect waves-light"
									>Reset</Button
								>
							</div>
						</div>
				...
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							...
							By default, <code> .btn </code> controls have a transparent border and background color, and lack any explicit focus and hover styles.
						</p>
						<div class="live-preview">
							<div class="d-flex flex-wrap gap-2">
						...
						<div class="d-none code-view">
							<pre class="language-markup">
                                <code
									>&lt;Button class="" color=""&gt;Base Class&lt;/Button&gt;</code
								></pre>
						</div>
					</CardBody>
				</Card>
				...
				<Card>
					...
					<CardBody>
						...
						<div class="d-none code-view">
							<pre class="language-markup">
                                <code
									>&lt;Button class="" color="primary" style="--vz-btn-padding-y: .25rem;--vz-btn-padding-x: .5rem;--vz-btn-font-size: .75rem;" &gt;Custom button&lt;/Button&gt;</code
								></pre>
						</div>
					</CardBody>
				</Card>
			...
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						...
						<div class="live-preview">
							<div class="d-grid gap-2">
								<Button color="primary" class="waves-effect waves-light">Button</Button>
								<Button color="primary" class="waves-effect waves-light">Button</Button>
							</div>
						</div>
						<div class="d-none code-view">
							...
							<Row>
								<Col sm={6}>
									<ButtonGroup class="shadow">
										<Button color="primary" class="waves-effect waves-light shadow-none">Left</Button>
										<Button color="primary" class="waves-effect waves-light shadow-none">Middle</Button>
										<Button color="primary" class="waves-effect waves-light shadow-none">Right</Button>
									</ButtonGroup>
								</Col>
								<Col sm={6}>
									<ButtonGroup class="mt-4 mt-sm-0 shadow">
										<Button color="light" class="btn-icon waves-effect shadow-none"
											><i
					...
					<CardBody>
						...
						<div class="live-preview">
							<div class="d-flex flex-wrap gap-3">
								<ButtonToolbar>
									<ButtonGroup class="me-2 shadow">
										<Button color="light" class="waves-effect shadow-none">1</Button>
										<Button color="light" class="waves-effect shadow-none">2</Button>
										<Button color="light" class="waves-effect shadow-none">3</Button>
										<Button color="light" class="waves-effect shadow-none">4</Button>
									</ButtonGroup>
									<ButtonGroup class="me-2 shadow">
										<Button color="light" class="waves-effect shadow-none">5</Button>
										<Button color="light" class="waves-effect shadow-none">6</Button>
										<Button color="light" class="waves-effect shadow-none">7</Button>
									</ButtonGroup>
									<ButtonGroup class="shadow">
										<Button color="light" class="waves-effect shadow-none">8</Button>
									</ButtonGroup>
								</ButtonToolbar>
							</div>
						</div>
					...
					<CardBody>
						...
						<div class="live-preview">
							<div
								class="d-flex flex-wrap align-items-center gap-2"
							>
								<ButtonGroup size="lg shadow">
									<Button color="primary" class="waves-effect waves-light shadow-none">Left</Button>
									<Button color="primary" class="waves-effect waves-light shadow-none">Middle</Button>
									<Button color="primary" class="waves-effect waves-light shadow-none">Right</Button>
								</ButtonGroup>
								<ButtonGroup class="mt-2 shadow">
									<Button color="light" class="waves-effect shadow-none">Left</Button>
									<Button color="light" class="waves-effect shadow-none">Middle</Button>
									<Button color="light" class="waves-effect shadow-none">Right</Button>
								</ButtonGroup>
								<ButtonGroup size="sm" class="mt-2 shadow">
									<Button color="secondary" class="waves-effect waves-light shadow-none">Left</Button>
									<Button color="secondary" class="waves-effect waves-light shadow-none">Middle</Button>
									<Button color="secondary" class="waves-effect waves-light shadow-none">Right</Button>
								</ButtonGroup>
							</div>
						</div>
						<div class="d-none code-view">
					...
					<CardBody>
						...
						<div class="live-preview">
							<Row>
								<div class="col-auto">
									<ButtonGroup class="shadow">
										<Button color="primary" class="waves-effect waves-light shadow-none">1</Button>
										<Button color="primary" class="waves-effect waves-light shadow-none">2</Button>
										<Dropdown id="btnGroupDrop1">
											<DropdownToggle
												color="primary" class="waves-effect waves-light shadow-none"
								...
								<div class="col-auto">
									<ButtonGroup vertical class="shadow">
										<Button color="light" class="waves-effect shadow-none">Button</Button>

										<Dropdown id="btnGroupVerticalDrop1">
											<DropdownToggle color="light" class="waves-effect shadow-none" caret
								...
								<div class="col-auto">
									<ButtonGroup vertical>
										...
										<Button
											color="secondary"
											for="vbtn-radio1" class="waves-effect waves-light shadow-none"
											outline>Radio 1</Button
										>
										<input
											type="radio"
										...
										<Button
											color="secondary"
											for="vbtn-radio2" class="waves-effect waves-light shadow-none"
											outline>Radio 2</Button
										>
										<input
											type="radio"
										...
										<Button
											color="secondary"
											for="vbtn-radio3" class="waves-effect waves-light shadow-none"
											outline>Radio 3</Button
										>
									</ButtonGroup>
								</div>
		...
		<Row>
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							In addition to <code> .focus-ring</code>, we have several <code> .focus-ring-* </code> utilities to modify the helper class defaults. Modify the color with any of our theme colors.
