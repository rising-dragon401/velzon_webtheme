				...
				<Card>
					<CardBody>
						...
						<Nav pills class="nav-success mb-3">
							<NavItem>
								<NavLink class="waves-effect waves-light"
									style="cursor: pointer"
									on:click={() => (pillsTab = 1)}
									active={pillsTab == 1}
								>
								...
								<div class="d-flex">
									...
									<div class="flex-grow-1 ms-2">
										...
										<div class="mt-2">
											<Link
												href={null}
												class="btn btn-sm btn-soft-primary shadow-none"
												>Read More <i
							...
							<TabPane
								...
								<div class="d-flex">
									...
									<div class="flex-grow-1 ms-2">
										...
										DIY salvia PBR.
										<div class="mt-2">
											<Link href={null} class="btn btn-link shadow-none shadow-none"
												>Read More <i
													class="ri-arrow-right-line ms-1 align-middle"
												/></Link
											>
							...
							<TabPane
								...
								<div class="d-flex">
									...
									<div class="flex-grow-1 ms-2">
										...
										earth, a thousand unknown.
										<div class="mt-2">
											<Link href={null} class="btn btn-link shadow-none"
												>Read More <i
													class="ri-arrow-right-line ms-1 align-middle"
												/></Link
											>
