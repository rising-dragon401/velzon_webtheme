...
<!-- Rounded Ribbon -->
<Card class="ribbon-box border mb-lg-0">
    <CardBody>
...
<!-- Right Ribbon -->
<Card class="ribbon-box border right mb-lg-0">
    <CardBody>
...
<Card class="ribbon-box border mb-lg-0 right">
    <CardBody>
...
<!-- Filled Ribbons -->
<Card class="ribbon-box border ribbon-fill mb-lg-0">
    <CardBody>
...
<!-- Right Ribbon -->
<Card class="ribbon-box border ribbon-fill right mb-lg-0">
    <CardBody>
...
<!-- Ribbons Hover -->
<Card class="ribbon-box border overflow-hidden">
    <CardBody class="text-muted">
...
<Card class="ribbon-box right border overflow-hidden">
    <CardBody class="text-muted">
        <div class="ribbon ribbon-info ribbon-shape trending-ribbon">
