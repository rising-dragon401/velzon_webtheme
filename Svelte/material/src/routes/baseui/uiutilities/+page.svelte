							...
							<div>
								<div>
									...
									>
										...
										<div class="text-center">
											<img
												src={img2}
												class="avatar-md w-auto rounded-pill shadow"
												alt="rounded-pill"
											/>
								...
								<div>
									...
									<div class="d-flex align-items-start flex-wrap gap-4">
										...
										<div class="text-center">
											<img src={avatar1} class="avatar-md rounded-4 shadow" alt="rounded-4" />
											<p><code>.rounded-4</code></p>
										</div>
										<div class="text-center">
											<img src={avatar1} class="avatar-md rounded-5 shadow" alt="rounded-5" />
			...
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						...
						<div class="live-preview">
							<div class="vstack gap-3">
								<div class="bg-light border shadow p-1 px-2">
									First item
								</div>
								<div class="bg-light border shadow p-1 px-2">
									Second item
							...
							<div class="mt-5">
								...
								<div class="vstack gap-2 col-md-5 mx-auto">
									<Button color="primary">Save changes</Button
									>
									<Button color="secondary" class="shadow-none" outline
										>Cancel</Button
									>
								</div>
							</div>
						...
						<div class="live-preview">
							...
							<div class="mt-4">
								...
								<div class="hstack gap-3">
									...
									<div
										class="bg-light border  shadow p-1 px-2 ms-auto"
									>
										Second item
									</div>
									<div class="bg-light border shadow  p-1 px-2">
