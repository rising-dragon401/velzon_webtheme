	...
	<div class="p-4 pb-0">
		<div class="border-bottom border-bottom-dashed">
				...
				<div class="col-sm order-3 order-sm-2">
					<div class="hstack gap-sm-1 align-items-center flex-wrap email-topbar-link">
						...
						<Button
							id="archive"
							color=""
							class="btn-ghost-secondary btn-icon btn-sm shadow-none fs-16"
						>
						...
						<Button
							color=""
							class="btn btn-ghost-secondary btn-icon btn-sm fs-16 shadow-none remove-mail"
							id="trash"
						>
				...
				<div class="col-auto order-2 order-sm-3">
					<div class="d-flex gap-sm-1 email-topbar-link">
						...
						<Dropdown>
							<DropdownToggle
								tag="button"
								class="btn btn-ghost-secondary btn-icon btn-sm fs-16 shadow-none shadow-none p-0"
								color="">
			...
			<Row class="align-items-center mt-3">
				<Col>
					<ul
						class="nav nav-tabs nav-tabs-custom gap-1 text-center border-bottom-0"
						role="tablist">
						<NavItem>
							<NavLink class="fw-semibold active" href={null}>
								<i
						...
						<NavItem>
							<NavLink class="fw-semibold" href={null}>
								<i
				...
				<Row>
					<Col>
						<div class="">
							<button
								type="button"
								class="btn btn-soft-danger btn-icon btn-sm fs-16 shadow-none close-btn-email"
								on:click={toggleRightCanvas}>
					...
					<Col class="col-auto">
						...
						>
							<button
								type="button"
								class="btn btn-ghost-secondary btn-icon btn-sm fs-16 shadow-none favourite-btn active">
							...
							<Dropdown>
								<DropdownToggle
									tag="button"
									class="btn btn-ghost-secondary btn-icon btn-sm shadow-none fs-16 p-0"
									color=""
								>
									<i class="ri-more-2-fill align-bottom" />
								</DropdownToggle>
				...
				<div>
					...
					<div class="bg-light px-2 py-1 rouned-bottom border">
						<Row>
							<Col>
								<ButtonGroup>
									<Button size="sm" color="light" id="Bold1" class="shadow-none"
										><i
											class="ri-bold align-bottom"
										/></Button
									>
									<Button size="sm" color="light" id="Italic1" class="shadow-none"
										><i
											class="ri-italic align-bottom"
										/></Button
									>
									<Button size="sm" color="light" id="Link1" class="shadow-none"
										><i
											class="ri-link align-bottom"
										/></Button
									>
									<Button size="sm" color="light" id="Image1" class="shadow-none"
										><i
							...
							<Col class="col-auto">
								<ButtonDropdown>
									<Button color="success" class="btn-sm shadow-none"
										><i
