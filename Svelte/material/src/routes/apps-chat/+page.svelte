									...
									<Col sm={8} xs={4}>
										...
										>
											<li class="list-inline-item m-0">
												...
												>
													<DropdownToggle
														class="btn btn-ghost-secondary btn-icon p-0 shadow-none"
														tag="button"
														color=""
													>
														<SearchIcon
											...
											<li
												class="list-inline-item d-none d-lg-inline-block m-0 shadow-none"
											>
												<button
													type="button"
											...
											<div class="chat-input-links ms-2">
												<div class="links-list-item">
													<Button
														type="button"
														color="primary"
														class="chat-send waves-effect waves-light shadow"
													>
														<i
