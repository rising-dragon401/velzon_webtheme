        ...
        <Card class="card-height-100">
            <CardHeader class="align-items-center d-flex">
                ...
                <div class="flex-shrink-0">
                    <Button color="primary" size='sm' class="btn-soft-primary shadow-none">
                        Export Report
                    </Button>
                </div>
            </CardHeader>
            <CardBody>
                    <div
                        ...
                        style="height: 252px"
                    >
                        <Map latitude={-34.397} longitude={150.644} MapType={'world_merc'} dataColor={["--vz-light"]}></Map>
                    </div>
    ...
    <Col xxl={4} xl={6}>
        <Card class="card-height-100">
            <CardHeader class="align-items-center d-flex">
                ...
                <div>
                    <Button color="secondary" size="sm" class="btn-soft-secondary shadow-none me-1">
                        ALL
                    </Button>
                    <Button color="primary" size="sm" class="btn-soft-primary shadow-none me-1">
                        1M
                    </Button>
                    <Button color="secondary" size="sm" class="btn-soft-secondary shadow-none">
                        6M
                    </Button>
                </div>
            </CardHeader>
        ...
        <Card class="card-height-100">
            ...
            <CardBody>
                ...
                <div class="px-2 py-2 mt-1">
                    ...
                    <Progress color="primary" value={75} striped class="mt-2 bg-primary-subtle" style="height: 6px" />

                    <p class="mt-3 mb-1">California <span class="float-end">47%</span></p>
                    <Progress color="primary" value={47} striped class="mt-2 bg-primary-subtle" style="height: 6px" />

                    <p class="mt-3 mb-1">Texas <span class="float-end">82%</span></p>
                    <Progress color="primary" value={82} striped class="mt-2 bg-primary-subtle" style="height: 6px" />
                </div>
            </CardBody>
        </Card>
    </Col>
        ...
        <Card class="card-height-100">
            ...
            <CardBody>
                ...
                <div class="mt-2 text-center">
                    <Link href={null} class="text-muted text-decoration-underline">Show All</Link>
                </div>
            </CardBody>
        </Card>
    </Col>
