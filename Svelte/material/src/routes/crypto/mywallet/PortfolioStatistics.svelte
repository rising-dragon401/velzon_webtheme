<script>
	...
	onMount(() => {
		const chart = new ApexCharts(
			document.querySelector("#portfoliostatisticschart"),
			options
		);
		chart.render();
	});
	...
	<CardHeader>
		<div class="d-flex align-items-center">
			...
			>
				<button
					type="button"
					class="btn btn-soft-primary timeline-btn btn-sm shadow-none"
					id="one_month"
				>
					1M
				</button>
				...
				<button
					type="button"
					class="btn btn-soft-primary timeline-btn btn-sm shadow-none active"
					id="all"
				>
					ALL
				</button>
