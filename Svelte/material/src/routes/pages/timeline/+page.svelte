							...
							<div class="content">
								<div class="d-flex">
									...
									<div class="flex-grow-1 ms-3">
										<h5 class="fs-15">
											@Erica245 <small
												class="text-muted fs-13 fw-normal"
												>- 10 min Ago</small
											>
										</h5>
										<p class="text-muted mb-2">
											Wish someone a sincere ‘good luck in
											your new job’ with these sweet
											messages. Make sure you pick out a
											good luck new job card to go with
											the words, and pop a beautiful bunch
											of flowers from our gift range in
											your basket, to make them feel super
											special.
										</p>
								...
								<Row class="g-2">
									<Col sm={6}>
										...
										>
											...
											>
												<div
													class="avatar-title bg-danger-subtle text-danger fs-15 rounded shadow"
												>
													<i
											...
											<div class="flex-shrink-0" />
											<div
												class="flex-grow-1 overflow-hidden ms-2"
											>
									...
									<Col sm={6}>
										...
										>
											...
											>
												<div
													class="avatar-title bg-info-subtle text-info fs-15 rounded shadow"
												>
													<i
											...
											<div
												class="flex-grow-1 ms-2 overflow-hidden"
											>
						...
						<div class="timeline-item right">
							...
							<div class="content">
								...
								<p class="text-muted fst-italic mb-2">
									...
									5.1.3 so far). I integrated it into a Rails
									6 project. Needs manual integration work of
									course but the template structure made it
									easy. "
								</p>
								<div class="hstack gap-2">
									<Link href={null} class="btn btn-sm bg-light"
										><span class="me-1">&#128151;</span> 35</Link
									>
									<Link href={null} class="btn btn-sm btn-light"
							...
							<div class="content">
								<h5>
									New ticket received <span
										class="badge bg-success-subtle text-success fs-10 align-middle ms-1"
										>Completed</span
									>
								</h5>
								<p class="text-muted mb-2">
									It is important for us that we receive email
									notifications when a ticket is created as
									our IT staff are mobile and will not always
									...
									<div class="timeline-box shadow">
										<div class="timeline-text">
											<div class="d-flex">
												...
												<div class="flex-grow-1 ms-3">
													<h5 class="mb-1">
														Frank hook joined with
														our company
													</h5>
													<p class="text-muted mb-0">
														It makes a statement,
														it’s impressive graphic
														design. Increase or
														decrease the letter
														spacing depending on the
														situation and try, try
														again until it looks
														right, and each letter
														has the perfect spot of
														its own.
													</p>
												</div>
											</div>
								...
								<Col xs={12}>
									<div class="timeline-box shadow">
										<div class="timeline-text">
											<h5>Trip planning</h5>
											<p class="text-muted">
												In the trip planner, keep only
												one or two activities in a day
												if the purpose of the trip is to
												relax and take it easy during
												the vacation :
											</p>
											<Row
												class="border border-dashed rounded gx-2 p-2"
									...
									<div class="timeline-box shadow">
										<div class="timeline-text">
											...
											<p class="text-muted mb-0">
												...
												to interpret and describe the
												significance of your findings in
												light of what was already known
												about the research problem being
												investigated, and to explain any
												new understanding or fresh
												insights about the problem after
												you've taken the findings into
												consideration.
											</p>
										</div>
									</div>
								...
								<Col xs={12}>
									<div class="timeline-box shadow">
										<div class="timeline-text">
											...
											<ul
												class="mb-0 text-muted vstack gap-2"
											>
												<li>Last updates</li>
							...
							<SwiperSlide>
								...
								>
									<div class="timeline-content p-3 rounded">
										<div>
											<p
												class="text-muted fw-medium mb-0"
											>
												December, 2020
											</p>
											<h6 class="mb-0">
