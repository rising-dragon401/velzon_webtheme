	...
	{#each projectList as item}
						...
						<div class="d-flex flex-column h-100">
							<div class="d-flex">
								...
								<div class="flex-shrink-0">
									<div class="d-flex gap-1 align-items-center">
										<button
											type="button"
											class={`btn avatar-xs mt-n1 p-0 favourite-btn shadow-none  ${item.ratingClass}`}
										>
										...
										<Dropdown>
											<DropdownToggle
												tag="button"
												color=""
												class="btn btn-link text-muted p-1 mt-n2 py-0 text-decoration-none shadow-none fs-15"
											>
							...
							<div class="d-flex mb-2">
								<div class="flex-shrink-0 me-3">
									<div class="avatar-sm">
										<span class={'avatar-title rounded p-2 bg-' + item.imgbgColor+'-subtle'}>
		...
		{:else if item.isDesign2}
			<Col xxl={3} sm={6} class="project-card">
				<Card>
					<CardBody>
						<div class={`p-3 mt-n3 mx-n3 bg-${item.cardHeaderClass}-subtle rounded-top`}>
							<div class="d-flex align-items-center">
								<div class="flex-grow-1">
									<h5 class="mb-0 fs-14">
										<Link href="/projects/apps-projects-overview" class="text-dark">{item.label}</Link>
								...
								<div class="flex-shrink-0">
									<div class="d-flex gap-1 align-items-center my-n2">
										<button
											type="button"
											class={`btn avatar-xs p-0 favourite-btn ${item.ratingClass} shadow-none `}
										>
											<span class="avatar-title bg-transparent fs-15 ">
												<i class="ri-star-fill" />
											</span>
							...
							<Row class="gy-3">
								<Col xs={6}>
									<div>
										...
										<div class={'fs-12 badge bg-' + item.statusClass+'-subtle text-'+ item.statusClass}>{item.status}</div>
									</div>
								</Col>
								<Col xs={6}>
									<div>
						...
						<div class="py-3">
							...
							<Row class="gy-3">
								<Col xs={6}>
									<div>
										<p class="text-muted mb-1">Status</p>
										<div class={'fs-12 badge bg-' + item.statusClass+'-subtle text-'+ item.textClass}>{item.status}</div>
									</div>
								</Col>
								<Col xs={6}>
									<div>
