	...
	<CardBody>
		<div class="d-flex mb-3">
			...
			<div class="flex-shrink-0">
				<Button color="" class="btn btn-soft-danger btn-sm shadow-none"
			...
			<li>
				<div class="d-flex align-items-center">
					...
					<div class="flex-grow-1 ms-2">
						<h6 class="mb-1">
							<Link href="/pages/profile/simple"  class="text-body">Tonya Noble</Link
							>
						</h6>
				...
				<div class="d-flex align-items-center">
					...
					<div class="flex-shrink-0 ms-2">
						<div class="d-flex gap-1">
							<Button
								color=""
								class="btn btn-icon text-muted btn-sm fs-18 shadow-none"
