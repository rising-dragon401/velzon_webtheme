    ...
    <div class="modal-body">
        <form autocomplete="off" class="needs-validation createfolder-form" id="createfolder-form" novalidate>
            ...
            <div class="hstack gap-2 justify-content-end">
                <button type="button" class="btn btn-ghost-success shadow-none" on:click={closeModal}><i class="ri-close-line align-bottom"></i> Close</button>
...
<Modal isOpen={showFileModal} className="modal-dialog-centered">
    ...
    <div class="modal-body">
        <form autocomplete="off" class="needs-validation createfile-form" id="createfile-form" novalidate>
            ...
            <div class="hstack gap-2 justify-content-end">
                <button type="button" class="btn btn-ghost-success shadow-none" on:click={fileToggle}><i class="ri-close-line align-bottom"></i> Close</button>
                                        ...
                                        <div class="d-flex mb-1">
                                            ...
                                            <Dropdown>
                                                <DropdownToggle tag="button"
                                                    class="btn btn-ghost-primary btn-icon btn-sm dropdown p-0 shadow-none" color="">
