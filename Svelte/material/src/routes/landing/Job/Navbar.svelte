...
>
    <Container fluid class="custom-container">
        ...
        <Collapse class="navbar-collapse" id="navbarSupportedContent" {isOpen}>
            ...
            >
                <li class="nav-item">
                    <NavLink  class="fs-14" href="#hero">Home</NavLink>
                </li>
                <li class="nav-item">
                    <NavLink  class="fs-14" href="#process">Process</NavLink>
                </li>
                <li class="nav-item">
                    <NavLink  class="fs-14" href="#categories">
                        Categories
                    </NavLink>
                </li>
                <li class="nav-item">
                    <NavLink  class="fs-14" href="#findJob">Find Jobs</NavLink>
                </li>
                <li class="nav-item">
                    <NavLink  class="fs-14" href="#candidates">
                        Candidates
                    </NavLink>
                </li>
                <li class="nav-item">
                    <NavLink  class="fs-14" href="#blog">Blog</NavLink>
                </li>
            </nav>
