			...
			<SwiperSlide>
				<Card>
					<CardBody>
						<div class="float-end">
							<Dropdown>
								<DropdownToggle class="text-reset p-0 shadow-none" color="" tag="a" role="button">
									<span class="text-muted fs-18"><i class="mdi mdi-dots-horizontal" /></span>
								</DropdownToggle>
								<DropdownMenu class="dropdown-menu dropdown-menu-end" end>
									<DropdownItem href={null}>Details</DropdownItem>
									<DropdownItem href={null}>Cancel</DropdownItem>
								</DropdownMenu>
							</Dropdown>
						</div>
						<div class="d-flex align-items-center">
							<img src={item.img} class="bg-light rounded-circle p-1 avatar-xs img-fluid shadow" alt="" />
