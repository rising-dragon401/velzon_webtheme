	...
	<Card class="card-height-100">
		<CardHeader class="align-items-center d-flex">
			...
			<div class="d-flex gap-1">
				<button type="button" class="btn btn-soft-info btn-sm shadow-none"> 1H </button>
				<button type="button" class="btn btn-soft-info btn-sm shadow-none"> 1D </button>
				<button type="button" class="btn btn-soft-info btn-sm shadow-none"> 7D </button>
