                        ...
                        <Col lg={4} md={6}>
                            <Card>
                                <CardBody>
                                    ...
                                    >
                                    <h5 class="mb-0 fs-16">
                                        <Link href={null} class="text-body"
                                            >{item.category}
                                            <span
            ...
            <Col lg={12}>
                <div class="d-lg-flex align-items-center mb-4">
                    <div class="flex-grow-1">
                        <h5 class="card-title mb-0 fw-bold fs-17">
                            Trending Artwork
                        </h5>
                    </div>
                    ...
                    <Card class="explore-box">
                        <CardBody>
                            ...
                            <div class="mt-3">
                                ...
                                <h6 class="fs-16 mb-0">
                                    <Link
                                        href="/NFTmarketplace/Itemdetails/apps-nft-item-details" class="text-body"
                                        >{item.category}</Link
                                    >
                                </h6>
                            </div>
                ...
                <Col>
                    <Card>
                        ...
                        <CardBody class="text-center">
                            ...
                            />
                            <h5 class="mt-3 mb-1">
                                <Link href={null} class="text-body">{item.author}</Link>
                            </h5>
