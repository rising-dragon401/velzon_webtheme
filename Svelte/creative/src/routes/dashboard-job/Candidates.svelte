<script>
    ...
    var isUpdateFollow = false;
    const handleChangeFollow = () => {
        isUpdateFollow = !isUpdateFollow;
    };
</script>
...
<Card>
    ...
    <Row class="g-0">
        ...
        <CardBody class="text-center">
            ...
            <div>
                <button type="button" class={isUpdateFollow ? "btn btn-info custom-toggle w-100 active"
                    : "btn btn-info custom-toggle w-100" } on:click={handleChangeFollow}>
                    <span class="icon-on">
