        ...
        <Card class="card-height-100">
            ...
            <CardBody>
                ...
                <div class="px-2 py-2 mt-1">
                    <p class="mb-1">
                        New Maxico <span class="float-end">75%</span>
                    </p>
                    <Progress
                        color="primary"
                        value={75}
                    ...
                    <p class="mt-3 mb-1">
                        Texas <span class="float-end">82%</span>
                    </p>
                    <Progress
                        color="primary"
                        value={82}
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1 ms-2">
                                    ...
                                    <p class="fs-14 mb-0 text-muted">
                                        <i
                                            class={"mdi mdi-circle fs-10 align-middle me-1 text-" +
                                                item.coinNameClass}
                                        />{item.coinName}
                                    </p>
                                </div>
                    ...
                    <Col md={6}>
                        ...
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-truncate text-muted fs-15 mb-0">
                                    <i
                                        class="mdi mdi-circle align-middle text-secondary me-2"
                                    />Other
                                </p>
                            </div>
                            <div class="flex-shrink-0">
