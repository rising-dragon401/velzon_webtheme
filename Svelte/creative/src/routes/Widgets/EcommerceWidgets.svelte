<script>
    ...
    const confirnPayment = () => {
        if (document.querySelector("input[name=listGroupRadioGrid]:checked")) {
            ...
            var checkedElem = document.querySelector(
        ...
        <Card class="card-height-100">
            <div class="card-header align-items-center d-flex">
                ...
                <div class="flex-shrink-0">
                    <Link class="text-muted" href="!#">View All</Link>
                </div>
            </div>
            <CardBody>
                <Swiper
                    ...
                    <SwiperSlide style="max-width: 200px">
                        <div>
                            ...
                            <div class="pt-3">
                                ...
                                <a href={null}>
                                    <h6
                                        class="fs-15 lh-base text-truncate mb-0"
                                    >
        ...
        <Card class="card-height-100">
            <CardBody>
                ...
                <p class="text-muted pb-1">
                    ...
                    point, you might be looking for the singlet T-shirt, which
                    is also known as the half T-shirt.
                </p>
                ...
                <Row class="mb-4">
                    <Col xl={6}>
                        ...
                        <ul
                            class="clothes-size list-unstyled hstack gap-2 mb-0"
                        >
                            <li>
                                <input
                                    type="radio"
                ...
                <div class="d-flex mb-4 align-items-center">
                    <div class="flex-grow-1">
                        <h5 class="text-primary fs-18 mb-0">
                            <span>$22.45</span>
                            <small
                                class="text-decoration-line-through text-muted fs-13"
                                >$37.45</small
                            >
                        </h5>
                    </div>
                    ...
                    <div class="input-step flex-shrink-0">
                        <button
                            type="button"
                            class="minus"
                            on:click={updatecount(setCount - 1)}>–</button
                        >
                        <input
                            type="number"
                ...
                <Link href={null} class="btn btn-soft-secondary d-block"
                    >Add to Cart</Link
                >
            </CardBody>
        </Card>
        ...
        <Card>
            <CardBody class="position-relative">
                        ...
                        >
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <div class="avatar-xs">
                                        <div
                                            class="avatar-title bg-success-subtle text-success fs-18 rounded"
                                        >
                        ...
                        >
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <div class="avatar-xs">
                                        <div
                                            class="avatar-title bg-info-subtle text-info fs-18 rounded"
                                        >
                                            <i class="ri-bank-card-2-line" />
                                        </div>
                                    </div>
                                </div>
                                <div class="flex-grow-1 ms-3">
                        ...
                        >
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <div class="avatar-xs">
                                        <div
                                            class="avatar-title bg-danger-subtle text-danger fs-18 rounded"
                                        >
                                            <i class="ri-mastercard-line" />
                                        </div>
                                    </div>
                                </div>
                                <div class="flex-grow-1 ms-3">
                ...
                <button
                    ...
                    id="confirm-btn"
                    on:click={confirnPayment}>Confirm</button
                >

                <div
                    id="notification-warn"
                    class="position-absolute top-0 start-0 end-0 d-none"
                >
                    ...
                    <div class="text-center">
                        ...
                        <div class="mt-4 pt-2">
                            ...
                            <div>
                                <button
                                    type="button"
                                    class="btn btn-danger btn-sm w-sm"
                                    id="back-btn"
                                    on:click={backToHome}>Back to Home</button
                                >
                            </div>
                        </div>
                    </div>
                ...
                <div class="d-flex mb-4 align-items-center">
                    ...
                    <div class="input-step flex-shrink-0">
                        <button
                            type="button"
                            class="minus"
                            on:click={() => setCount(setCount - 1)}>–</button
                        >
                        <input
                            type="number"
                            class="product-quantity"
                ...
                <div class="col-lg-6">
                    <div class="card-body text-center">
                        ...
                        <div>
                            <button
                                type="button"
                                class="btn btn-danger rounded-pill w-sm"
                                ><i class="ri-add-fill me-1 align-bottom" /> Follow</button
                            >
                        </div>
                    </div>
                </div>
