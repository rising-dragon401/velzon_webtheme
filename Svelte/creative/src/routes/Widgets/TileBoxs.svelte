				...
				<CardBody>
					<div class="d-flex align-items-center">
						<div class="flex-grow-1">
							<p
								class={"text-uppercase fw-semibold mb-0 text-" +
									item.labelClass}
							>
								{item.label}
							</p>
					...
					>
						<div>
							<h4
								class="fs-22 fw-bold ff-secondary mb-4 {item.counterClass}"
							>
								{item.prefix}<span
									class="counter-value"
				...
				<CardBody>
					<div class="d-flex justify-content-between">
						<div>
							...
							<h2
								class={"mt-4 ff-secondary fw-bold " +
									item.counterClass}
							>
						...
						<div class="flex-shrink-0 align-self-center">
							<span
								class={"fs-12 badge bg-" +
									item.percentageClass +'-subtle text-'+ item.percentageTextClass}
								><i
