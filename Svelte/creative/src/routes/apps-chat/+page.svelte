				...
				<Nav class="nav-tabs nav-tabs-custom nav-success nav-justified">
					<NavItem>
						<NavLink
							...
							active={activeTab == 1}>Chats</NavLink
						>
					</NavItem>
					<NavItem>
						<NavLink
							on:click={() => (activeTab = 2)}
							active={activeTab == 2}>Contacts</NavLink
						>
					</NavItem>
				</Nav>
						...
						<div class="chat-room-list pt-3" data-simplebar>
							<div class="d-flex align-items-center px-4 mb-2">
								...
								<div class="flex-shrink-0">
									<Tooltip
										placement="bottom"
										target="addnewmsg">New Message</Tooltip
									>
							...
							<div
								class="d-flex align-items-center px-4 mt-4 pt-2 mb-2"
							>
								<div class="flex-grow-1">
									<h4
										class="mb-0 fs-11 text-muted text-uppercase"
													...
													>
														...
														>
															...
															>
																...
																{:else}
																	<span
																		class="avatar-title rounded-circle bg-primary fs-10"
																	>
																		{item.name.charAt(
																			0
																		) +
														...
														>
															<Dropdown>
																...
																>
																	...
																	<DropdownItem
																		><i
																			class="ri-delete-bin-6-line text-muted me-2 align-bottom"
																		/> Remove</DropdownItem
																	>
																</DropdownMenu>
															</Dropdown>
