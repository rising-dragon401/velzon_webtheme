...
<section class="section bg-light" id="categories">
    <Container>
      ...
      <Row class="justify-content-center">
        {#each categories.categories as item}
          <Col lg={3} md={6}>
            <Card class="shadow-none text-center py-3">
              <CardBody class="py-4">
                ...
                <Link href={null} class="to-link">
                  <h5 class="fs-17 pt-1">{item.lable}</h5>
                </Link>
                <p class="mb-0 text-muted">{item.jobs}</p>
              </CardBody>
            </Card>
          </Col>
        {/each}
...
<section class="py-5 bg-primary position-relative">
    ...
    <Container>
        ...
        <Col class="col-sm">
            <div>
            <h4 class="text-white mb-2 fw-bold">Ready to Started?</h4>
        ...
        <Col class="col-sm-auto">
            <div>
            <Link href={null} class="btn bg-gradient btn-danger">
                Create Free Account
            </Link>
            </div>
        </Col>
