					...
					<CardBody>
						...
						<div class="live-preview">
							<div class="d-flex flex-wrap gap-2">
								...
								>
								<Button
									class="btn-soft-secondary waves-effect waves-light"
									>Secondary</Button
								>
								<Button
									class="btn-soft-success waves-effect waves-light"
									>Success</Button
								>
								<Button
									class="btn-soft-info waves-effect waves-light"
									>Info</Button
								>
								<Button
									class="btn-soft-warning waves-effect waves-light"
									>Warning</Button
								>
								<Button
									class="btn-soft-danger waves-effect waves-light"
									>Danger</Button
								>
								<Button
									class="btn-soft-dark waves-effect waves-light"
									>Dark</Button
								>
							</div>
						</div>
