...
<svelte:head>
	<title>Invoice Details | Velzon - Svelte Admin & Dashboard Template</title>
</svelte:head>
				...
				<Card id="demo">
						...
						<div class="d-sm-flex">
							...
							<div class="flex-shrink-0 mt-sm-0 mt-3">
								...
								<h6>
									...
									>
									<a
										href="/themesbrand.com/"
										class="link-primary"
										target="_blank"
										id="website">www.themesbrand.com</a
									>
								</h6>
								<h6 class="mb-0">
									<span class="text-muted fw-normal"
					...
					<CardBody class="p-4">
						<Row class="g-3">
							<Col xs={6} lg={3}>
								<p
									class="text-muted mb-2 text-uppercase fw-semibold fs-13"
								>
									Invoice No
								</p>
								<h5 class="fs-15 mb-0">
					...
					<CardBody class="p-4 border-top border-top-dashed">
						<Row class="g-3">
							<Col sm={6}>
								<h6
									class="text-muted text-uppercase fw-semibold mb-3 fs-13"
								>
									Billing Address
								</h6>
								...
								<p class="text-muted mb-0">
									<span>Tax: </span><span id="billing-tax-no"
										>12-3456789</span
									>
								</p>
							</Col>
					...
					<CardBody class="p-4">
							...
							>
								...
								<tbody id="products-list">
									...
									<tr>
										...
										<td class="text-start">
											<span class="fw-medium"
												>350 ml Glass Grocery Container</span
											>
											<p class="text-muted mb-0">
												Glass Grocery Container (Pack of
												3, White)
											</p>
										</td>
										<td>$24.99</td>
						...
						<div class="border-top border-top-dashed mt-2">
							...
							>
								<tbody>
									...
									<tr>
										<td
											>Discount <small class="text-muted"
												>(VELZON15)</small
											></td
										>
						...
						<div class="mt-3">
							...
							<p class="text-muted">
								Total Amount: <span class="fw-medium" id=""
									>$
						...
						>
							<button
								...
								><i class="ri-printer-line align-bottom me-1" />
								Print</button
							>
