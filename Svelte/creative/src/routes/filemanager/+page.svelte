    ...
    <Container fluid>
        <Modal isOpen={showModal} className="modal-dialog-centered">
            <div class="modal-header p-3 bg-success-subtle">
                <h5 class="modal-title fw-bold" id="createFileModalLabel">
                    Create Folder
                </h5>
                ...
                >
                    ...
                    <div class="hstack gap-2 justify-content-end">
                        <button
                            ...
                            on:click={closeModal}
                            ><i class="ri-close-line align-bottom" /> Close</button
                        >
                        <button
                            type="submit"
                            class="btn btn-primary"
                            id="addNewFolder">Add Folder</button
                        >
                    </div>
                </form>
            </div>
        ...
        <Modal isOpen={showFileModal} className="modal-dialog-centered">
            <div class="modal-header p-3 bg-success-subtle">
                ...
                <button type="button" class="btn-close" on:click={fileToggle} />
            </div>
            <div class="modal-body">
                <form
                    autocomplete="off"
        ...
        <div class="chat-wrapper d-lg-flex gap-1 mx-n4 mt-n4 p-1">
            <div class="file-manager-sidebar">
                <div class="p-3 d-flex flex-column h-100">
                    ...
                    >
                        <ul class="list-unstyled file-manager-menu">
                            <li>
                                ...
                                >
                                    <i
                                        class="ri-folder-2-line align-bottom me-2"
                                    />
                            ...
                            <li>
                                <a href={null}
                                    ><i
                                        class="ri-file-list-2-line align-bottom me-2"
                                    />
                            ...
                            <li>
                                <a href={null}
                                    ><i
                                        class="ri-image-2-line align-bottom me-2"
                                    />
                            ...
                            <li>
                                <a href={null}
                                    ><i
                                        class="ri-history-line align-bottom me-2"
                                    />
                            ...
                            <li>
                                <a href={null}
                                    ><i
                                        class="ri-star-line align-bottom me-2"
                                    />
                            ...
                            <li>
                                <a href={null}
                                    ><i
                                        class="ri-delete-bin-line align-bottom me-2"
                                    />
                    ...
                    <div class="mt-auto">
                        <h6 class="fs-12 text-muted text-uppercase mb-3">
                            Storage Status
                        </h6>
                    ...
                    <div id="folder-list" class="mb-2">
                        <Row class="justify-content-beetwen g-2 mb-3">
                            <Col>
                                <div class="d-flex align-items-center">
                                    <div
                                        class="flex-shrink-0 me-2 d-block d-lg-none"
                                    >
                                        <button
                                            type="button"
                                        ...
                                        >
                                            <i
                                                class="ri-menu-2-fill align-bottom"
                                            />
                                        </button>
                                    </div>
                            ...
                            <Col class="col-auto">
                                <div
                                    class="d-flex gap-2 align-items-start mb-4"
                                >
                                    <select
                                        class="form-control"
                                    ...
                                    >
                                        <CardBody class="">
                                            <div class="d-flex mb-1">
                                                ...
                                                >
                                                    <input
                                                        ...
                                                        type="checkbox"
                                                        value=""
                                                        id={"folderlistCheckbox_" +
                                                            item.id}
                                                    />
                                                    <Label
                                                        class="form-check-label"
                                                        for={"folderlistCheckbox_" +
                                                            item.id}
                                                    />
                                                </div>
                                            ...
                                            <div class="hstack mt-4 text-muted">
                                                <span class="me-auto"
                                                    ><b>{item.folderFile}</b> Files</span
                                                >
                                ...
                                {#each data.recentFile as item}
                                    <tr>
                                        <td>
                                            ...
                                            >
                                                <div
                                                    class="flex-shrink-0 fs-17 me-2 filelist-icon"
                                                >
                                                    <i
                                                        class={item.icon +
                                                            " text-" +
                                                ...
                                                <div
                                                    class="flex-grow-1 filelist-name"
                                                >
                                                    {item.fileName}
                                                </div>
                                                <div
                                                    class="d-none filelist-type"
                                                >
                                                    {item.fileType}
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            ...
                                            >
                                                ...
                                                >
                                                    <i
                                                        class="ri-star-fill fs-13 align-bottom"
                                                    />
                                                </button>
                                                <Dropdown>
                                                    <DropdownToggle
                                                    ...
                                                    >
                                                        <i
                                                            class="ri-more-fill align-bottom"
                                                        />
                                                    </DropdownToggle>
                                                    <DropdownMenu
                                                        class="dropdown-menu-end"
            ...
            <div class="file-manager-detail-content p-3 py-0">
                <div
                    class="mx-n3 pt-3 px-3 file-detail-content-scroll"
                ...
                >
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <div class="avatar-xs">
                                                ...
                                                >
                                                    <i
                                                        class="ri-error-warning-line fs-17"
                                                    />
                                                </div>
                                            </div>
                                        </div>
                            ...
                            >
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <button class="btn btn-sm btn-danger"
                                        ><i
                                            class="ri-upload-cloud-line align-bottom"
                                        /> Upgrade Now</button
                                    >
                                </div>
                            </div>
                    ...
                    <div id="file-overview" class="h-100">
                        <div class="d-flex h-100 flex-column">
                            ...
                            >
                                <h5 class="flex-grow-1 fw-bold mb-0">
                                    File Preview
                                </h5>
                                <div>
                                    <button
                            ...
                            <div
                                class="pb-3 border-bottom border-bottom-dashed mb-3"
                            >
                                <div
                                ...
                                <p class="text-muted mb-0 fs-12">
                                    <span class="file-size"
                                        >{sidebarData.size}</span
                                    >,
                                    <span class="create-date"
                                        >{sidebarData.createDate}</span
                                    >
                                </p>
                            </div>
                            <div>
                                <h5
                                    class="fs-12 text-uppercase text-muted mb-3"
                                >
                                    File Description :
                                </h5>
                                    ...
                                    >
                                        <tbody>
                                            <tr>
                                                ...
                                                >
                                                <td class="file-name"
                                                    >{sidebarData.fileName}</td
                                                >
                                            </tr>
                                            <tr>
                                                <th scope="row">File Type :</th>
                                                <td class="file-type"
                                                    >{sidebarData.fileType}</td
                                                >
                                            </tr>
                                            <tr>
                            ...
                            <div
                                class="mt-auto border-top border-top-dashed py-3"
                            >
                                <div class="hstack gap-2">
                                    <button
                                        ...
                                        ><i
                                            class="ri-download-2-line align-bottom me-1"
                                        /> Download</button
                                    >
                                    <button
                                        type="button"
                                        ...
                                        ><i
                                            class="ri-close-fill align-bottom me-1"
                                        /> Delete</button
                                    >
                                </div>
                            </div>
