...
<div class="page-content">
	<Container fluid>
		<Row class="mb-4">
			<Col lg={12}>
				<Card class="rounded-0 bg-success-subtle mx-n4 mt-n4 border-top">
					<div class="px-4">
						<Row>
				...
				<Row class="justify-content-evenly">
						...
						<div class="mt-3">
							<div class="d-flex align-items-center mb-2">
								<div class="flex-shrink-0 me-1">
									<i class="ri-question-line fs-24 align-bottom text-success me-1" />
								</div>
					...
					<Col lg={4}>
						<div class="mt-3">
							<div class="d-flex align-items-center mb-2">
								<div class="flex-shrink-0 me-1">
									<i class="ri-user-settings-line fs-24 align-bottom text-success me-1" />
								</div>
								<div class="flex-grow-1">
					...
					<Col lg={4}>
						<div class="mt-3">
							<div class="d-flex align-items-center mb-2">
								<div class="flex-shrink-0 me-1">
									<i class="ri-shield-keyhole-line fs-24 align-bottom text-success me-1" />
								</div>
								<div class="flex-grow-1">
