    ...
    <Col xxl={4} xl={6}>
        <Card class="card-height-100">
            <CardHeader class="align-items-center d-flex">
                ...
                <div>
                    <Button color="primary" size="sm" class="btn btn-soft-primary">
                        ALL
                    </Button>
                    <Button color="primary" size="sm" class="btn btn-soft-primary ">
                        1M
    ...
    <Col xxl={4}>
        <Card class="card-height-100">
            ...
            <CardHeader class="p-0">
                <Alert color="primary" class="alert-solid alert-label-icon border-0 rounded-0 m-0 d-flex align-items-center" role="alert">
