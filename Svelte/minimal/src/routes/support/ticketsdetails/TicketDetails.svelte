				...
				<table class="table table-borderless align-middle mb-0">
					<tbody>
						...
						<tr>
							...
							<td>
								<span class="badge bg-success" id="t-priority"
									>High</span
								>
							</td>
						</tr>
		...
		<CardBody>
			...
			>
				...
				<div class="flex-grow-1 ms-3">
					<h6 class="mb-1">
						<Link href={null} class="link-secondary">Velzon-admin.zip</Link>
					</h6>
					<small class="text-muted">3.2 MB</small>
				</div>
				<div class="hstack gap-3 fs-16">
					<Link href={null} class="text-muted"
						><i class="ri-download-2-line" /></Link
					>
					<Link href={null} class="text-muted"
			...
			>
				<div class="flex-shrink-0 avatar-sm">
					<div class="avatar-title bg-light rounded">
						<i class="ri-file-ppt-2-line fs-20 text-primary" />
					</div>
				</div>
				<div class="flex-grow-1 ms-3">
					<h6 class="mb-1">
						<Link href={null} class="link-secondary">Velzon-admin.ppt</Link>
					</h6>
