                        ...
                        <SwiperSlide>
                            <Card>
                                <CardBody>
                                    ...
                                    <h5 class="mb-0 fs-15"><Link href={null} class="text-body">Artwork <span class="badge badge-soft-success">206</span></Link></h5>
                                </CardBody>
                            </Card>
                        </SwiperSlide>
                        <SwiperSlide>
                            <Card>
                                <CardBody>
                                    ...
                                    <Link href={null} class="float-end"> View All <i class="ri-arrow-right-line align-bottom"></i></Link>
                                    <h5 class="mb-0 fs-16"><Link href={null}>Crypto Card <span class="badge badge-soft-success">743</span></Link></h5>
                                </CardBody>
                            </Card>
                        </SwiperSlide>
                        <SwiperSlide>
                            <Card>
                                <CardBody>
                                    ...
                                    <Link href={null} class="float-end"> View All <i class="ri-arrow-right-line align-bottom"></i></Link>
                                    <h5 class="mb-0 fs-16"><Link href={null}>Music <span class="badge badge-soft-success">679</span></Link></h5>
                                </CardBody>
                            </Card>
                        </SwiperSlide>
                        <SwiperSlide>
                            <Card>
                                <CardBody>
                                    ...
                                    <Link href={null} class="float-end"> View All <i class="ri-arrow-right-line align-bottom"></i></Link>
                                    <h5 class="mb-0 fs-16"><Link href={null}>Games <span class="badge badge-soft-success">341</span></Link></h5>
                                </CardBody>
                            </Card>
                        </SwiperSlide>
                        <SwiperSlide>
                            <Card>
                                <CardBody>
                                    ...
                                    <Link href={null} class="float-end"> View All <i class="ri-arrow-right-line align-bottom"></i></Link>
                                    <h5 class="mb-0 fs-16"><Link href={null}>Photography <span class="badge badge-soft-success">1452</span></Link></h5>
                                </CardBody>
                            </Card>
                        </SwiperSlide>
