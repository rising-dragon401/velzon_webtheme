    ...
    <Container>
        ...
        <Collapse class="navbar-collapse" id="navbarSupportedContent" {isOpen}>
            ...
            >
                ...
                <li class="nav-item">
                    <NavLink class="fs-14" href="#wallet">Wallet</NavLink>
                </li>
                <li class="nav-item">
                    <NavLink class="fs-14" href="#marketplace">Marketplace</NavLink>
                </li>
                <li class="nav-item">
                    <NavLink class="fs-14" href="#categories">Categories</NavLink>
                </li>
                <li class="nav-item">
                    <NavLink class="fs-14" href="#creators">Creators</NavLink>
                </li>
            </div>

            <div class="">
                <Link href="//crypto/mywallet" class="btn btn-primary btn-sm"
                    >Wallet Connect
                </Link>
            </div>
        </Collapse>
