        ...
        <Row class="justify-content-center">
            <Col lg={12}>
                <div class="d-flex align-items-center mb-5">
                    ...
                    <Link href="/NFTmarketplace/ExploreNow/apps-nft-explore" class="btn btn-secondary">View All <i class="ri-arrow-right-line align-bottom"></i></Link>
                </div>
            </Col>
        </Row>
        <Row>
                    ...
                    <CardBody>
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="ms-2 flex-grow-1">
                                <Link href={null}><h6 class="mb-0 fs-15">{item.author}</h6></Link>
                        ...
                        <div class="mt-3">
                            ...
                            <h6 class="fs-16 mb-0"><Link href="/NFTmarketplace/Itemdetails/apps-nft-item-details" class="text-body">{item.category}</Link></h6>
                        </div>
                    </CardBody>
                </Card>
            </Col>
