      ...
      <Col class="col-lg-7">
        <div class="text-center mb-5">
          <h1 class="mb-3 ff-secondary fw-semibold text-capitalize lh-base">
            Find Your <span class="text-primary">Career</span> You Deserve it
          </h1>
          <p class="text-muted">
    ...
    <Row>
          ...
          <Card class="shadow-lg">
            <CardBody>
              <div class="d-flex">
                <div class="avatar-sm">
                  <div
                    class={"avatar-title bg-" +
                      item.iconColor +
                      "-subtle rounded"}
                  >
                    <img src={item.company} alt="" class="avatar-xxs" />
                  </div>
                </div>
                <div class="ms-3 flex-grow-1">
                  ...
                  <ul class="list-inline text-muted mb-3">
                    <li class="list-inline-item">
                      <i class="ri-building-line align-bottom me-1" />{" "}
                      {item.name}
                    </li>
                    <li class="list-inline-item">
      ...
      <div class="col-lg-12">
        <div class="text-center mt-4">
          <Link href={null} class="btn btn-ghost-primary">
            View More Jobs{" "}
            <i class="ri-arrow-right-line align-bottom" />
          </Link>
        </div>
      </div>
    </Row>
...
<section class="section">
  <Container>
    <Row class="align-items-center gy-4">
      <Col class="col-lg-6 order-2 order-lg-1">
        <div class="text-muted mt-5 mt-lg-0">
          <h5 class="fs-12 text-uppercase text-success">
            Hot Featured Company
          </h5>
          <h1 class="mb-3 ff-secondary fw-semibold text-capitalize lh-base">
            Get <span class="text-primary">10,000+</span> Featured Companies
          </h1>
          <p class="ff-secondary mb-2">
            The demand for content writing services is growing. This is because
            content is required in almost every industry.{" "}
            <b>
              Many companies have discovered how effective content marketing is.
            </b>{" "}
            This is Link major reason for this increase in demand.
          </p>
          <p class="mb-4 ff-secondary">
            A Content Writer is Link professional who writes informative and
          ...
          <div class="mt-4">
            <Link href="/dashboard" class="btn btn-primary">
              View More Companies{" "}
              <i class="ri-arrow-right-line align-middle ms-1" />
            </Link>
          </div>
        </div>
      </Col>
      ...
      >
        <div>
            ...
            <CardBody>
              ...
              <div class="avatar-sm mb-4">
                <div class="avatar-title bg-secondary-subtle rounded">
                  <img src={img1} alt="" class="avatar-xxs" />
                </div>
              </div>
              <Link href={null}>
              ...
              <p class="text-muted">
                ...
                Product Delivery Team fused with UX, engineering, product and
                data talent.
              </p>
              ...
              <div class="mt-4 hstack gap-2">
                <Link href={null} class="btn btn-soft-primary w-100">
                  Apply Job
                </Link>
                <Link href={null} class="btn btn-soft-success w-100">
                  Overview
                </Link>
              </div>
            </CardBody>
          ...
          <Card
            class="shadow-lg mb-0 features-company-widgets bg-info rounded-3 card-bg-fill"
          >
            <CardBody>
              <h5 class="text-white fs-16 mb-4">10,000+ Featured Companies</h5>

              <div class="d-flex gap-1">
                <Link href={null} id="abc">
                  <Tooltip placement="top" target="abc">Brent Gonzalez</Tooltip>
                  <div class="avatar-xs">
                    <div
                ...
                <Link href={null} id="abs">
                  <Tooltip placement="top" target="abs">Brent Gonzalez</Tooltip>
                  <div class="avatar-xs">
                    <div
                      class="avatar-title bg-light bg-opacity-25 rounded-circle"
                    >
                ...
                <Link href={null} id="brent">
                  <Tooltip placement="top" target="brent">
                    Brent Gonzalez
                  </Tooltip>
                  <div class="avatar-xs">
                    <div
                ...
                <Link href={null} id="ellen">
                  <Tooltip placement="top" target="ellen">Ellen Smith</Tooltip>
                  <div class="avatar-xs">
                    <div
                      class="avatar-title bg-light bg-opacity-25 rounded-circle"
                    >
