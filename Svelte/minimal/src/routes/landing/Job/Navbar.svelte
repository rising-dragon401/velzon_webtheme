    ...
    <Container fluid class="custom-container">
        ...
        <Collapse class="navbar-collapse" id="navbarSupportedContent" {isOpen}>
            ...
            >
                ...
                <li class="nav-item">
                    <NavLink class="fs-15" href="#process">Process</NavLink>
                </li>
                <li class="nav-item">
                    <NavLink class="fs-15" href="#categories">
                        Categories
                    </NavLink>
                </li>
                <li class="nav-item">
                    <NavLink class="fs-15" href="#findJob">Find Jobs</NavLink>
                </li>
                <li class="nav-item">
                    <NavLink class="fs-15" href="#candidates">
                        Candidates
                    </NavLink>
                </li>
                <li class="nav-item">
                    <NavLink class="fs-15" href="#blog">Blog</NavLink>
                </li>
            </nav>
