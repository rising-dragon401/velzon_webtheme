...
<Col xl={4}>
    <Card class="card-height-100">
        ...
        <CardBody>
            <div dir="ltr">
                <UsersByDeviceCharts dataColors={["--vz-primary", "--vz-primary-rgb, 0.75", "--vz-primary-rgb, 0.5"]} />
            </div>
            ...
            <div class="table-responsive mt-3">
                <table class="table table-borderless table-sm table-centered align-middle table-nowrap mb-0">
                    <tbody class="border-0">
                        ...
                        <tr>
                            <td><h4 class="text-truncate fs-14 fs-medium mb-0"><i class="ri-stop-fill align-middle fs-18 text-success me-2"></i>Mobile Users</h4></td>
                            <td><p class="text-muted mb-0">
                                <UsersIcon
                                    class="me-2 icon-sm"
                                />
                        ...
                        <tr>
                            <td><h4 class="text-truncate fs-14 fs-medium mb-0"><i class="ri-stop-fill align-middle fs-18 text-primary me-2"></i>Tablet Users</h4></td>
                            <td><p class="text-muted mb-0">
                                <UsersIcon
                                    class="me-2 icon-sm"
                                />
