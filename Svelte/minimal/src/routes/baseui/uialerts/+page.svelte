...
<!-- Secondary Alert -->
<Alert color="secondary" class="alert alert-secondary alert-solid">
<strong>How are you!</strong> - Solid
<b>secondary alert</b> example
</Alert>

<!-- Success Alert -->
<Alert color="success" class="alert alert-success alert-solid">
<strong >Yey! Everything worked! </strong>- Solid <b>success alert</b> example
</Alert>

<!-- Danger Alert -->
<Alert color="danger" class="alert alert-danger alert-solid mb-xl-0 mb-xl-0"><strong>Something is very wrong!</strong>- Solid <b>danger alert</b> example
</Alert>

<!-- Warning Alert -->
<Alert color="warning" class="alert alert-warning alert-solid">
<strong >Uh oh, something went wrong!</strong>- Solid <b>warning alert</b> example</Alert>

<!-- Info Alert -->
<Alert color="info" class="alert alert-info alert-solid">
<strong>Don't forget' it !</strong> -
Solid <b>info alert</b> example
</Alert>

<!-- Light Alert -->
<Alert color="light" class="alert alert-light alert-solid">
						...
						<div class="live-preview">
							<Row>
								<Col xl={6}>
									...
									<Alert color="primary" class="alert alert-primary alert-solid">
									...
									<Alert
										color="secondary"
										class="alert alert-secondary alert-solid"
									>
										<strong>How are you!</strong> - Solid
										<b>secondary alert</b> example
									</Alert>
									...
									<Alert
										color="danger"
										class="alert alert-danger alert-solid mb-xl-0"
									>
								...
								<Col xl={6}>
									...
									<Alert
										color="dark"
										class="alert alert-dark alert-solid"
									>
										<strong>Did you know?</strong> - Solid
										<b>dark alert</b> example
									</Alert>
