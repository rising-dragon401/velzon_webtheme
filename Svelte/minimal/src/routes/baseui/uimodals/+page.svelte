	...
	<ModalBody class="text-center p-5">
		...
		<div class="mt-4">
			...
			<div class="hstack gap-2 justify-content-center">
				...
				<Link href={null} class="btn btn-primary">Try Again</Link>
			</div>
		</div>
	</ModalBody>
</Modal>
	...
	<ModalBody class="text-center p-5">
		...
		<div class="mt-4">
			...
			<div class="hstack gap-2 justify-content-center">
				...
				>
				<Link href={null} class="btn btn-primary" on:click={tog_backdrop}>Completed</Link
				>
			</div>
		</div>
	</ModalBody>
	...
	<ModalBody class="text-center p-5">
		...
		<div class="mt-4">
			...
			<div class="hstack gap-2 justify-content-center">
				...
				>
				<Link href={null} class="btn btn-primary">Completed</Link>
			</div>
		</div>
	</ModalBody>
</Modal>
...
>
	...
	<div class="modal-footer">
		<div class="mx-auto">
			<Link href={null} class="btn btn-link fw-medium"
				>Read More <i
