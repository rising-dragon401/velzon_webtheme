...
<Card>
	<CardBody class="text-center">
		...
		<div class="hstack gap-2 justify-content-center">
			<Button color="primary" class="btn-sm"
				><i class="ri-stop-circle-line align-bottom me-1" /> Stop</Button
			>
			<Button color="soft-secondary" class="btn-sm"
			...
			<Table class="mb-0">
				<tbody>
					...
					<tr>
						...
						<td
							><span
								class="badge bg-primary-subtle text-success"
								>Inprogress</span
							></td
						>
					</tr>
	...
	<CardBody>
		<div class="d-flex mb-3">
			...
			<div class="flex-shrink-0">
				<Button color="" class="btn btn-soft-primary btn-sm"
					><i class="ri-share-line me-1 align-bottom" /> Assigned Member</Button
				>
			</div>
		</div>
			...
			<li>
				<div class="d-flex align-items-center">
					...
					<div class="flex-grow-1 ms-2">
						<h6 class="mb-1">
							<Link href="/pages/profile/simple">Tonya Noble</Link
							>
						</h6>
