...
<svelte:head>
	<title>Scrollbar | Velzon - Svelte Admin & Dashboard Template</title>
</svelte:head>
...
<div class="page-content">
	<Container fluid>
		...
		<div class="row mt-2">
			<div class="col-lg-12">
				<div
					class="justify-content-between d-flex align-items-center mb-3"
				>
					...
					<div class="col-xl-4 col-lg-6">
						<Card>
							...
							<CardBody>
								<p class="text-muted">
									Use <code
										>data-simplebar-track="primary"</code
					...
					<div class="col-xl-4 col-lg-6">
						<Card>
							...
							<CardBody>
								<p class="text-muted">
									Use <code
										>data-simplebar-track="secondary"</code
									> attribute to set secondary color simplebar
									track.
								</p>
								...
								<div class="mx-n3">
									...
									>
										...
										>
											<a
												href={null}
												class="list-group-item text-muted py-3"
											>
												<div
												...
												>
													...
													>
														<h5
															class="text-truncate fs-14 mb-1"
														>
															Michael Johnston
														</h5>
														<p
					...
					<div class="col-xl-4 col-lg-6">
						<Card>
							...
							<CardBody>
								<p class="text-muted">
									Use <code
										>data-simplebar-track="success"</code
										...
										<ul class="list-group list-group-flush">
											<li class="list-group-item py-3">
												...
												>
													...
													>
														<i
															class="ri-arrow-right-fill text-muted"
														/>
													</div>
													<div
									...
									>
										...
										>
											...
											>
												A list item
												<Badge
													class="badge ms-auto bg-success-subtle text-success"
													color="success-subtle text-success">Paid</Badge
												>
											</li>
											<li
												class="list-group-item d-flex align-items-center"
											>
												A second list item
												<Badge
													class="badge ms-auto bg-danger-subtle text-danger"
													color="danger-subtle text-danger">Refund</Badge
												>
											</li>
											<li
												class="list-group-item d-flex align-items-center"
											...
											>
												A Fifth list item
												<Badge
													class="badge ms-auto bg-warning-subtle text-warning"
													color="warning-subtle text-warning"
													>Inprogress</Badge
												>
											</li>
											<li
					...
					<div class="col-xl-4 col-lg-6">
						<Card>
							...
							<CardBody>
								<p class="text-muted">
									Use <code
										>data-simplebar-track="warning"</code
					...
					<div class="col-xl-4 col-lg-6">
						<Card>
							...
							<CardBody>
								<p class="text-muted">
									Use <code
										>data-simplebar-track="danger"</code
								...
								<div class="mx-n3">
									...
									>
										...
										>
											...
											<div
												class="flex-shrink-0 align-self-start ms-2"
											>
												<div
											...
											<li class="list-group-item">
												<div>
													...
													>
														...
														>
															<div
																class="badge bg-success bg-gradient mb-2"
															>
																<i
																	class="mdi mdi-star"
																/> 4.1
