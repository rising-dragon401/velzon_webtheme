			...
			<Col xxl={3}>
					...
					<CardBody>
						<div class="d-flex align-items-center mb-5">
							...
							<div class="flex-shrink-0">
								<Link href="{null}" class="badge bg-light text-secondary fs-12"
				...
				<Card>
					<CardBody>
						...
						<div class="mb-3 d-flex">
							<div class="avatar-xs d-block flex-shrink-0 me-3">
								<span class="avatar-title rounded-circle fs-16 bg-primary-subtle text-danger">
				...
				<Card class="mt-xxl-n5">
					<CardHeader>
						<Nav class="nav-tabs-custom rounded card-header-tabs border-bottom-0" role="tablist">
							<NavItem>
								<NavLink class="" on:click={() => (activeTab = 1)} active={activeTab == 1}>
									Personal Details
								</NavLink>
							</NavItem>
							<NavItem>
						...
						<TabContent>
							...
							<TabPane tabId={2} class={activeTab == 2 ? 'active' : ''}>
								...
								<div class="mt-4 mb-3 border-bottom pb-2">
									<div class="float-end">
										<Link href="{null}" class="link-secondary">All Logout</Link>
									</div>
								...
								<div class="d-flex align-items-center mb-3">
									...
									<div>
										<Link class="link-secondary"  href="{null}">Logout</Link>
									</div>
								</div>
								<div class="d-flex align-items-center mb-3">
									<div class="flex-shrink-0 avatar-sm">
									...
									<div id="newlink">
										<div id="1">
											<Row>
												...
												<div class="hstack gap-2 justify-content-end">
													<Link class="btn btn-success" href={"#"}>Delete</Link>
												</div>
											</Row>
										</div>
									</div>
