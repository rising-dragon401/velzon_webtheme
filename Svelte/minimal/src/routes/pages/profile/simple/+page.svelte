							...
							<Card>
								<CardBody>
									...
									<div class="d-flex flex-wrap gap-2 fs-15">
										<Link href={null} class="badge bg-secondary-subtle text-secondary">Photoshop</Link>
										<Link href={null} class="badge bg-secondary-subtle text-secondary">illustrator
										</Link>
										<Link href={null} class="badge bg-secondary-subtle text-secondary">HTML</Link>
										<Link href={null} class="badge bg-secondary-subtle text-secondary">CSS</Link>
										<Link href={null} class="badge bg-secondary-subtle text-secondary">Javascript</Link>
										<Link href={null} class="badge bg-secondary-subtle text-secondary">Php</Link>
										<Link href={null} class="badge bg-secondary-subtle text-secondary">Python</Link>
									</div>
								</CardBody>
							</Card>
								...
								<Card>
									<CardBody>
										...
										<Swiper class="project-swiper" slidesPerView={3} spaceBetween={25} autoplay={{
											...
											<SwiperSlide>
												<Card
													class="profile-project-card shadow-none profile-project-primary mb-0">
													<CardBody class="p-4">
														<div class="d-flex">
									...
									<div class="acitivity-item py-3 d-flex">
										...
										<div class="flex-grow-1 ms-3">
											...
											<div class="avatar-group mb-2">
												<Link href="javascript: void(0);" class="avatar-group-item"
						...
						<Card>
							<CardBody>
								<Row>
									...
									<Col xxl={3} sm={6}>
									<Card class="profile-project-card shadow-none mb-xxl-0   profile-project-info">
										<CardBody class="p-4">
											<div class="d-flex">
												<div class="flex-grow-1 text-muted overflow-hidden">
													<h5 class="fs-14 text-truncate">
									...
									<Col xxl={3} sm={6}>
									<Card class="profile-project-card shadow-none mb-xxl-0  profile-project-success">
										<CardBody class="p-4">
											<div class="d-flex">
												<div class="flex-grow-1 text-muted overflow-hidden">
													<h5 class="fs-14 text-truncate">
									...
									<Col xxl={3} sm={6}>
									<Card class="profile-project-card shadow-none mb-sm-0  profile-project-secondary">
										<CardBody class="p-4">
											<div class="d-flex">
												<div class="flex-grow-1 text-muted overflow-hidden">
													<h5 class="fs-14 text-truncate">
							...
							<CardBody>
								...
								<Row>
													...
													<td>
														<div class="d-flex align-items-center">
															...
															<div class="ms-3 flex-grow-1">
																<h6 class="fs-15 mb-0 link-secondary">
																	<a href={null}
									...
									<div class="text-center mt-3">
										<Link href={null} class="text-primary"><i
