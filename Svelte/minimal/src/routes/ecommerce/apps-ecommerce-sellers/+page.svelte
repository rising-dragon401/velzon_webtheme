...
<Modal isOpen={showSellermodal} className="modal-dialog-centered modal-lg">
    ...
    <div class="modal-body">
        <TabContent pills class="nav-tabs-custom nav-primary p-2 pb-0 ">
				...
				<Row>
					...
					<Col lg={12}>
						<div class="hstack gap-2 justify-content-end">
							<button class="btn btn-link link-priamry text-decoration-none fw-medium" on:click={SellerModalToggle}><i class="ri-close-line me-1 align-middle"></i> Close</button>
