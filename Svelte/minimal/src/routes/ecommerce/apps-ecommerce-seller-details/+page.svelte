...
<script>
	...
	import RevenueCharts from "../../dashboard/DashboardEcommerceCharts.svelte";
								...
								<div class="mt-3">
									...
									<Row class="align-items-center g-2">
										...
										<div class="col">
											<div class="p-1">
												<div class="progress animated-progess progress-sm">
													<Progress bar color="primary" value={29.32} />
												</div>
											</div>
										</div>
										<div class="col-auto">
									...
									<Row class="align-items-center g-2">
										...
										<div class="col">
											<div class="p-1">
												<div class="progress animated-progess progress-sm">
													<Progress bar color="secondary" value={4.98} />
												</div>
											</div>
										</div>
			...
			<div class="col-xxl-9">
					...
					<CardBody class="p-0 pb-2">
						<div class="w-100">
							<div dir="ltr">
								<RevenueCharts
									dataColors={[
										"--vz-primary-rgb, 0.1", "--vz-primary", "--vz-primary-rgb, 0.6"
									]}
								/>
							</div>
						</div>
				...
				<Row class=" g-4 mb-3">
					<div class="col-sm-auto">
						<div>
							<Link href="/ecommerce/apps-ecommerce-add-product" class="btn btn-primary"
