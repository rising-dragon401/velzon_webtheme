...
<svelte:head>
    <style>
        .feather-lock{
            color: #0ab39c;fill: rgba(10,179,156,.16); height: 30px; width: 30px;
        }
    </style>
</svelte:head>
<Row>
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr
                                        ...
                                        <td class="content-block"
                                            ...
                                            valign="top">
                                            <p style="margin-bottom: 13px; line-height: 1.5;">You can change your
                                                password for security reasons or reset it if you forget it. Your Google
                                                Account password is used to access many Google products, like Gmail and
                                                YouTube.</p>
                                        </td>
                                    </tr>
                                    <tr
                                        ...
                                        <td class="content-block" itemprop="handler" itemscope
                                            ...
                                            valign="top">
                                            <a href="!#" itemprop="url"
                                            style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: .8125rem; color: #FFF; text-decoration: none; font-weight: 400; text-align: center; cursor: pointer; display: inline-block; border-radius: .25rem; text-transform: capitalize; background-color: #25a0e2; margin: 0; border-color: #25a0e2; border-style: solid; border-width: 1px; padding: .5rem .9rem;">Reset
                                                Password</a>
                                        </td>
                                    </tr>
