...
<div class="mt-lg-0 mt-3">
    ...
    <div class="avatar-group">
        <Link href={null} class="avatar-group-item" id="img1">
            <img src={avatar4} alt="" class="rounded-circle avatar-sm" />
        </Link>
        <Tooltip placement="top" target="img1" > Christi </Tooltip>
        <Link href={null} class="avatar-group-item" id="img2">
            <img src={avatar3} alt="" class="rounded-circle avatar-sm" />
        </Link>
        <Tooltip placement="top" target="img2" > Frank Hook </Tooltip>
        <Link href={null} class="avatar-group-item" id="img3">
            <div class="avatar-sm">
                <div class="avatar-title rounded-circle bg-light text-primary">
                    C
                </div>
        ...
        <Link href={null} class="avatar-group-item" id="img4">
            <div class="avatar-sm">
