			...
			<div class="col-xxl-3">
				<Card>
					...
					<CardBody class="border-top border-top-dashed p-4">
						<div>
							<h6
								class="text-muted text-uppercase fw-semibold mb-4"
							>
								Customer Reviews
							</h6>
							<div>
						...
						<form action="#">
							...
							<div class="text-end">
								<Button color="primary"
									><i
										class="ri-mail-send-line align-bottom me-1"
					...
					<div class="col-sm-auto">
						<div>
							<Link
								...
								class="btn btn-info"
								><i class="ri-add-line align-bottom me-1" /> Add
								New</Link
							>
						</div>
					</div>
