...
<div class="col">
	<Card>
		<Link
			href={null}
			class={"card-header bg-" + deal.bgColor+"-subtle border-0"}
			id={"leadDiscovered" + index}
		>
			<h5 class="card-title text-uppercase fw-bold mb-1 fs-15">
				{deal.title}
			</h5>
			<p class="text-muted mb-0">
				{deal.price}{" "}
				<span class="fw-semibold">{deal.deals} Deals</span>
			</p>
		</Link>
	</Card>
				...
				>
					<CardBody>
						<h6 class="fs-15 mb-1">
							...
							<small
								class={"badge bg-" +
									subitem.timeDurationClass+'-subtle text-' + subitem.timeDurationClass}>
					...
					<CardFooter class="hstack gap-2">
						<Button color="primary" class="btn-sm w-100">
