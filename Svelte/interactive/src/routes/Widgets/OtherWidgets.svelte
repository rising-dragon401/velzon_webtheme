	...
	<Col xl={4}>
		<Card>
			<CardBody class="p-0">
				...
				>
					<AlertTriangleIcon class="text-primary me-2 icon-sm" />
					...
					<Col sm={8}>
						<div class="p-3">
							<p class="fs-16 lh-base">
								Upgrade your plan from a <span class="fw-bold"
									>Free trial</span
								>, to ‘Premium Plan’
							...
							<div class="mt-3">
								<Link
									href="/pages/pricing/pages-pricing"
									class="btn btn-info">Upgrade Account!</Link
								>
							</div>
						</div>
					</Col>
				...
				<div class="d-flex p-3">
					<div class="flex-shrink-0">
						<div class="avatar-md me-3">
							<span
								class="avatar-title bg-info-subtle rounded-circle fs-1"
							>
								<i class="ri-gift-2-line text-info" />
							</span>
						</div>
					</div>
					<div>
						<p class="fs-16 lh-base">
							Personalized <span class="fw-semibold"
								>Gift Boxes</span
						...
						<div class="mt-3">
							<Link
								href="/pages/pricing/pages-pricing"
								class="btn btn-primary">Get a Free Gift</Link
							>
						</div>
					</div>
				</div>
	...
	{#each otherWidgets2 as item}
		<Col lg={4}>
			<Card>
				...
				<div
					class="progress animated-progess rounded-bottom rounded-0"
					style="height: 6px"
				>
