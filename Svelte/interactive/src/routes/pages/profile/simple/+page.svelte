			...
			<div>
				<div class="d-flex">
					...
					<div class="flex-shrink-0">
						<Link href="/pages/profile/settings" class="btn btn-info">
									...
									<Card class="profile-project-card shadow-none mb-xxl-0   profile-project-info">
										<CardBody class="p-4">
											<div class="d-flex">
												<div class="flex-grow-1 text-muted overflow-hidden">
													<h5 class="fs-14 text-truncate">
														<Link href={null} class="text-body">Business
														Template -
														UI/UX design</Link>
													</h5>
													<p class="text-muted text-truncate mb-0">
							...
							<CardBody>
								...
								<Row>
												...
												<tr>
													<td>
														<div class="d-flex align-items-center">
															...
															<div class="ms-3 flex-grow-1">
																<h6 class="fs-15 mb-0">
																	<a href={null} class="text-body">Bank
																		Management
																		System</a>
																</h6>
															</div>
												...
												<tr>
													<td>
														<div class="d-flex align-items-center">
															...
															<div class="ms-3 flex-grow-1">
																<h6 class="fs-15 mb-0">
																	<a href={null} class="text-body">Tour-video.mp4</a>
																</h6>
															</div>
														</div>
													</td>
												...
												<tr>
													<td>
														<div class="d-flex align-items-center">
															...
															<div class="ms-3 flex-grow-1">
																<h6 class="fs-15 mb-0">
																	<a href={null} class="text-body" >Project
																		Screenshots
																		Collection</a>
																</h6>
															</div>
												...
												<tr>
													<td>
														<div class="d-flex align-items-center">
															...
															<div class="ms-3 flex-grow-1">
																<h6 class="fs-15 mb-0">
																	<a href={null} class="text-body" >Velzon-logo.png</a>
																</h6>
															</div>
														</div>
													</td>
									...
									<div class="text-center mt-3">
										<Link href={null} class="text-info"><i
