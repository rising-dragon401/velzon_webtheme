			...
			<Col xxl={6}>
				...
				<Card>
					<CardBody>
						...
						<Row>
							<Col md={3}>
								<Nav pills class="flex-column text-center" id="v-pills-tab">
									<NavItem>
										<NavLink
											style="cursor: pointer"
			...
			<Col xxl={6}>
				...
				<Card>
					<CardBody>
						...
						<Nav
							tabs
							class="nav nav-tabs nav-tabs-custom nav-info nav-justified mb-3"
						>
							<NavItem>
								<NavLink
									style="cursor: pointer"
			...
			<Col xxl={6}>
				...
				<Card>
					<CardBody>
						...
						<Nav
							pills
							class="nav nav-pills arrow-navtabs nav-info bg-light mb-3"
						>
							<NavItem>
								<NavLink
									style="cursor: pointer"
							...
							<TabPane
								...
								<div class="d-flex">
									...
									<div class="flex-grow-1 ms-2">
										...
										DIY salvia PBR.
										<div class="mt-2">
											<Link href={null} class="btn btn-link"
												>Read More <i
													class="ri-arrow-right-line ms-1 align-middle"
												/></Link
											>
			...
			<Col xxl={6}>
				...
				<Card>
					<CardBody>
						...
						<Nav
							tabs
							class="nav nav-tabs nav-justified nav-border-top nav-border-top-info mb-3"
						>
							<NavItem>
								<NavLink
									style="cursor: pointer"
			...
			<Col xxl={6}>
				...
				<Card>
					<CardBody>
						...
						<Nav
							pills
							class="nav nav-pills nav-custom nav-custom-info mb-3"
						>
							<NavItem>
								<NavLink
									style="cursor: pointer"
