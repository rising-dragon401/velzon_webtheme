			...
			>
				<NavItem>
					<NavLink
						...
						active={activeTab == 1}>Comments (5)</NavLink
					>
				</NavItem>
				<NavItem>
					<NavLink
				...
				>
					<div class="d-flex mb-4">
						...
						<div class="flex-grow-1 ms-3">
							<h5 class="fs-14">
								<Link
									href="/pages/profile/simple"
									class="text-body">Joseph Parker</Link
								>
							...
							<div class="d-flex mt-4">
								...
								<div class="flex-grow-1 ms-3">
									<h5 class="fs-14">
										<Link
											href="/pages/profile/simple"
											class="text-body">Tonya Noble</Link
										>
										<small class="text-muted"
									...
									<p class="text-muted">
										...
										mailbox to see if your email filters
										have identified the email from Dell as
										spam.
									</p>
									<Link
										href={null}
					...
					<div class="d-flex mb-4">
						...
						<div class="flex-grow-1 ms-3">
							<h5 class="fs-14">
								<Link
									href="/pages/profile/simple"
									class="text-body">Thomas Taylor</Link
								>
								<small class="text-muted"
									>24 Dec 2021 - 05:20PM</small
								>
							</h5>
							<p class="text-muted">
								If you have further questions, please contact
								Customer Support from the “Action Menu” on your <Link
									href={null}
					...
					<div class="d-flex">
						...
						<div class="flex-grow-1 ms-3">
							...
							<p class="text-muted">
								...
								order. To help manage your order refer to the “Action
								Menu” to initiate return, contact Customer Support
								and more.
							</p>
							...
							<div class="d-flex mt-4">
								...
								<div class="flex-grow-1 ms-3">
									...
									<p class="text-muted">
										...
										checkout if you want your purchase
										delivered faster.
									</p>
									<Link
										href={null}
				...
				<form class="mt-4">
					<div class="row g-3">
						...
						<div class="col-12 text-end">
							<button
								type="button"
								class="btn btn-ghost-info btn-icon waves-effect me-1"
