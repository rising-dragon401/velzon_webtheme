...
<nav
    ...
    id="navbar"
>
    <Container fluid class="custom-container">
        ...
        <Collapse class="navbar-collapse" id="navbarSupportedContent" {isOpen}>
            ...
            >
                <li class="nav-item">
                    <NavLink class="fw-normal"  href="#hero">Home</NavLink>
                </li>
                <li class="nav-item">
                    <NavLink class="fw-normal" href="#process">Process</NavLink>
                </li>
                <li class="nav-item">
                    <NavLink class="fw-normal" href="#categories">
                        Categories
                    </NavLink>
                </li>
                <li class="nav-item">
                    <NavLink class="fw-normal" href="#findJob">Find Jobs</NavLink>
                </li>
                <li class="nav-item">
                    <NavLink class="fw-normal" href="#candidates">
                        Candidates
                    </NavLink>
                </li>
                <li class="nav-item">
                    <NavLink class="fw-normal" href="#blog">Blog</NavLink>
                </li>
            </nav>

            <div>
                <Link href="/authenticationInner/login/auth-signin-basic" class="btn btn-soft-primary">
