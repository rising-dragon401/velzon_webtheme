<script>
  import { Card, Col, Container, Form, Input, Row, Tooltip } from "sveltestrap";
        ...
        <div>
              ...
              <Col class="col-md-4">
                <div class="h-100">
                  <button
                    ...
                    type="submit"
                  >
                    <i class="ri-search-2-line align-bottom me-1" />{" "}
                    Find Job
                  </button>
                </div>
              </Col>
          ...
          <ul class="treding-keywords list-inline mb-0 mt-3 fs-13">
            <li class="list-inline-item text-danger fw-semibold">
              <i class="mdi mdi-tag-multiple-outline align-middle" />{" "}
              Trending Keywords:
            </li>
            <li class="list-inline-item">
              <Link href={null}>Design,</Link>
            </li>
            <li class="list-inline-item">
              <Link href={null}>Development,</Link>
            </li>
            <li class="list-inline-item">
              <Link href={null}>Manager,</Link>
            </li>
            <li class="list-inline-item">
              <Link href={null}>Senior</Link>
            </li>
          </ul>
        </div>
      </Col>
        ...
        <div class="position-relative home-img text-center mt-5 mt-lg-0">
          ...
          <div class="bg-white p-3 rounded shadow-lg application-box">
            ...
            <div class="avatar-group">
              <Link href={null} class="avatar-group-item" id="brent">
                <Tooltip placement="top" target="brent">Brent Gonzalez</Tooltip>
                <div class="avatar-xs">
                  <img src={Avatar3} alt="" class="rounded-circle img-fluid" />
                </div>
              </Link>
              <Link href={null} class="avatar-group-item " id="ellen">
                <Tooltip placement="top" target="ellen">Ellen Smith</Tooltip>
                <div class="avatar-xs">
                  <div class="avatar-title rounded-circle bg-danger">S</div>
                </div>
              </Link>
              <Link href={null} class="avatar-group-item" id="smith">
                <Tooltip placement="top" target="smith">Ellen Smith</Tooltip>
                <div class="avatar-xs">
              ...
              >
                <div class="avatar-xs">
                  <div class="avatar-title rounded-circle bg-success">Z</div>
                </div>
              </Link>
              <Link href={null} class="avatar-group-item" id="gonzalez">
                <Tooltip placement="top" target="gonzalez">
                  Brent Gonzalez
                </Tooltip>
                <div class="avatar-xs">
                  <img src={Avatar9} alt="" class="rounded-circle img-fluid" />
                </div>
              </Link>
              <Link href={null} class="avatar-group-item" id="more">
                <Tooltip placement="top" target="more">More Appliances</Tooltip>
                <div class="avatar-xs">
                  <div
          ...
          <img src={JobProfile2} alt="" class="user-img" />
