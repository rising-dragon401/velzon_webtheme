									...
									<Row>
										...
										<Col lg={12}>
											<div class="hstack gap-2 justify-content-end">
												<button type="button" class="btn btn-secondary">Updates</button>
								...
								<form>
									<div id="newlink">
										<div id="1">
											<Row>
												...
												<div class="hstack gap-2 justify-content-end">
													<Link class="btn btn-danger" href={"#"}>Delete</Link>
												</div>
											</Row>
										</div>
									</div>
									...
									<Col lg={12}>
										<div class="hstack gap-2">
											...
											<Link href="{null}" class="btn btn-secondary">Add New</Link>
										</div>
									</Col>
								</form>
							</TabPane>
