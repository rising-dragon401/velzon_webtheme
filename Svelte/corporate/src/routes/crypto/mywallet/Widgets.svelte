...
<Card>
    <CardBody class="bg-primary-subtle">
        <div class="d-flex">
            <div class="flex-grow-1">
                ...
                <p class="text-muted mb-0">
                    $25,10,974 <small
                        ...
                        ><i
                            class="ri-arrow-right-up-line fs-13 align-bottom"
                        />4.37%</small
                    >
                </p>
            </div>
            <div class="flex-shrink-0">
                <i class="mdi mdi-wallet-outline text-primary fs-2" />
            </div>
        </div>
    </CardBody>
</Card>
<Card>
    <CardBody>
        <div class="d-flex">
            ...
            <div class="flex-shrink-0">
                <i class="ri-hand-coin-line text-primary fs-2" />
            </div>
        </div>
    </CardBody>
</Card>
<Card>
    <CardBody>
        <div class="d-flex">
            ...
            <div class="flex-shrink-0">
                <i class="ri-line-chart-line text-primary fs-2" />
            </div>
        </div>
    </CardBody>
</Card>
