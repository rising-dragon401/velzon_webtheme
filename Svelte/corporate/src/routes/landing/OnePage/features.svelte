    ...
    <Container>
        <Row class="align-items-center gy-4">
            ...
            <Col class="col-sm-auto">
                <div>
                    <Link href="https://1.envato.market/velzon-admin" target="_blank" class="btn bg-gradient btn-secondary"><i class="ri-shopping-cart-2-line align-middle me-1"></i> Buy Now</Link>
                </div>
            </Col>
        </Row>
    </Container>
        ...
        <Row class="align-items-center gy-4">
            <Col lg={6} class="order-2 order-lg-1">
                <div class="text-muted">
                    ...
                    <div class="mt-4">
                        <Link href="/dashboard" class="btn btn-primary">Learn More <i class="ri-arrow-right-line align-middle ms-1"></i></Link>
                    </div>
                </div>
            </Col>
