const Navdata = [
	...
	},
	{
		...
		subItems: [
			{ id: 'remix', label: 'Remix', link: '/icons/RemixIcons', parentId: 'icons', badgeColor: "info", badgeName: "v3.5" },
			...
			{ id: 'feather', label: 'Feather', link: '/icons/FeatherIcons', parentId: 'icons', badgeColor: "info", badgeName: "v4.29" },
