...
<div class="input-group">
    ...
    <ul class="dropdown-menu">
        ...
        <li><a class="dropdown-item" href={null}>Separated link</a></li>
    </ul>
...
<div class="input-group">
    ...
    <ul class="dropdown-menu">
        <li><a class="dropdown-item" href={null}>Action before</a></li>
        <li><a class="dropdown-item" href={null}>Another action before</a></li>
        <li><a class="dropdown-item" href={null}>Something else here</a></li>
        <li><hr class="dropdown-divider"></li>
        <li><a class="dropdown-item" href={null}>Separated link</a></li>
    </ul>
							...
							<div>
								...
								<Row class="g-3">
									...
									<Col lg={6}>
										<div class="input-group">
											<button
												class="btn btn-outline-primary material-shadow-none"
												type="button"
												id="button-addon1"
												>Button</button
											>
									...
									<Col lg={12}>
										<div class="input-group">
											<Dropdown>
												<DropdownToggle
													tag="button"
													class="btn btn-outline-secondary dropdown-toggle material-shadow-none"
													type="button"
													color=""
													data-bs-toggle="dropdown"
													aria-expanded="false"
								...
								<Row class="g-3">
									...
									<Col lg={6}>
										<div class="input-group">
											...
											<button
												class="btn btn-outline-secondary material-shadow-none"
												type="button">Button</button
											>
										</div>
									</Col>
