...
<Card>
    <CardHeader class="border-0 align-items-center d-flex">
        ...
        <div class="">
            <Button type="button" color="soft-secondary" size="sm" class="material-shadow-none">
                ALL
            </Button>
            <Button type="button" color="soft-secondary" size="sm" class="material-shadow-none">
                1M
            ...
            <Button type="button" color="soft-primary" size="sm" class="material-shadow-none">
                1Y
            </Button>
        </div>
    </CardHeader>
    <CardHeader class="p-0 border-0 bg-light-subtle">
        <Row class="g-0 text-center">
            ...
            <div class="p-3 border border-dashed border-start-0 border-end-0">
                <h5 class="mb-1"><span class="counter-value" data-target="3">0</span>m <span class="counter-value"
    ...
    <CardBody class="p-0 pb-2">
        <div>
            <AudiencesCharts dataColors={["--vz-success", "--vz-light"]}/>
        </div>
    </CardBody>
</Card>
</Col>