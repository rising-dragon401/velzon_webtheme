				...
				<div class="col">
					<div class="p-2">
						...
						<div class="hstack text-white-50 gap-1">
							<div class="me-2">
								<i
									class="ri-map-pin-user-line me-1 text-white text-opacity-75 fs-16 align-middle" />California,
								United States
							</div>
							<div>
								<i
									class="ri-building-line me-1 text-white text-opacity-75 fs-16 align-middle" />Themesbrand
							</div>
						</div>
					</div>
				</div>
									...
									<div>
										<div class="d-flex align-items-center py-3">
											<div class="avatar-xs flex-shrink-0 me-3">
												<img src={avatar3} alt="" class="img-fluid rounded-circle material-shadow" />
											</div>
											<div class="flex-grow-1">
												<div>
													<h5 class="fs-15 mb-1">
											...
											<div class="flex-shrink-0 ms-2">
												<button type="button" class="btn btn-sm btn-outline-info material-shadow-none"><i
														class="ri-user-add-line align-middle" /></button>
											</div>
										</div>
										<div class="d-flex align-items-center py-3">
											<div class="avatar-xs flex-shrink-0 me-3">
												<img src={avatar4} alt="" class="img-fluid rounded-circle material-shadow" />
											</div>
											<div class="flex-grow-1">
												<div>
													<h5 class="fs-15 mb-1">
											...
											<div class="flex-shrink-0 ms-2">
												<button type="button" class="btn btn-sm btn-outline-success material-shadow-none"><i
														class="ri-user-add-line align-middle" /></button>
											</div>
										</div>
										<div class="d-flex align-items-center py-3">
											<div class="avatar-xs flex-shrink-0 me-3">
												<img src={avatar5} alt="" class="img-fluid rounded-circle material-shadow" />
											</div>
											<div class="flex-grow-1">
												<div>
													<h5 class="fs-15 mb-1">
							...
							<Card>
								<CardBody>
									...
									<div class="d-flex mb-4">
										<div class="flex-shrink-0">
											<img src={img4} alt="" height="50" class="rounded material-shadow" />
										</div>
									...
									<div class="d-flex mb-4">
										<div class="flex-shrink-0">
											<img src={img5} alt="" height="50" class="rounded material-shadow" />
										</div>
										<div class="flex-grow-1 ms-3 overflow-hidden">
											<Link href={null}>
											<h6 class="text-truncate fs-14">
									...
									<div class="d-flex">
										<div class="flex-shrink-0">
											<img src={img6} alt="" height="50" class="rounded material-shadow" />
										</div>
										<div class="flex-grow-1 ms-3 overflow-hidden">
											<Link href={null}>
											<h6 class="text-truncate fs-14">
									...
									<Card>
										<CardHeader class="align-items-center d-flex">
											...
											<div class="flex-shrink-0 ms-auto">
												<Nav class="justify-content-end nav-tabs-custom rounded card-header-tabs border-bottom-0"
													role="tablist">
													<NavItem>
														<NavLink on:click={()=>
															(activeTimelineTab = 1)}
										...
										<CardBody>
											<TabContent class="text-muted">
												<TabPane tabId={1} class={activeTimelineTab==1 ? "active" : "" }
													...
													<div class="profile-timeline">
														<div class="accordion accordion-flush" id="todayExample">
															<div class="accordion-item border-0">
																...
																<Collapse toggler="collapseOne"
																	class="accordion-collapse" isOpen>
															...
															<div class="accordion-item border-0">
																<div class="accordion-header" id="headingTwo">
																	<Link class="accordion-button p-2 shadow-none"
																		id="collapseTwo">
																	<div class="d-flex">
															...
															<div class="accordion-item border-0">
																...
																<Collapse toggler="collapseFour"
																	class="accordion-collapse"
																	aria-labelledby="headingFour"
																	data-bs-parent="#accordionExample" isOpen>
														...
														<div class="accordion accordion-flush" id="weeklyExample">
															<div class="accordion-item border-0">
																<div class="accordion-header" id="heading6">
																	<a class="accordion-button p-2 shadow-none"
																		data-bs-toggle="collapse" id="collapse6"
																		aria-expanded="true">
																		<div class="d-flex">
																			<div class="flex-shrink-0">
																				<img src={avatar3} alt=""
															...
															<div class="accordion-item border-0">
																<div class="accordion-header" id="heading7">
																	<a class="accordion-button p-2 shadow-none"
																		data-bs-toggle="collapse" id="collapse7"
																		aria-expanded="false">
																		<div class="d-flex">
																			<div class="avatar-xs">
																				<div
															...
															<div class="accordion-item border-0">
																<div class="accordion-header" id="heading8">
																	<a class="accordion-button p-2 shadow-none"
																		data-bs-toggle="collapse" id="collapse8"
																		aria-expanded="true">
																		<div class="d-flex">
																			<div class="flex-shrink-0 avatar-xs">
																				<div
															...
															<div class="accordion-item border-0">
																<div class="accordion-header" id="heading9">
																	<a class="accordion-button p-2 shadow-none"
																		data-bs-toggle="collapse" id="collapse9"
																		aria-expanded="false">
																		<div class="d-flex">
																			<div class="flex-shrink-0">
																				<img src={avatar6} alt=""
															...
															<div class="accordion-item border-0">
																<div class="accordion-header" id="heading10">
																	<a class="accordion-button p-2 shadow-none"
																		data-bs-toggle="collapse" id="collapse10"
																		aria-expanded="true">
																		<div class="d-flex">
																			<div class="flex-shrink-0">
																				<img src={avatar5} alt=""
														...
														<div class="accordion accordion-flush" id="monthlyExample">
															<div class="accordion-item border-0">
																<div class="accordion-header" id="heading11">
																	<a class="accordion-button p-2 shadow-none"
																		data-bs-toggle="collapse" id="collapse11"
																		aria-expanded="false">
																		<div class="d-flex">
																			<div class="flex-shrink-0 avatar-xs">
																				<div
																		...
																		<div class="row g-2">
																			<div class="col-auto">
																				<div
																					...
																					<div class="flex-shrink-0">
																						<i
																							class="ri-image-2-line fs-17 text-secondary" />
																					</div>
																					<div class="flex-grow-1 ms-2">
																						<h6>
																							<Link href={null}
																			...
																			<div class="col-auto">
																				<div
																					...
																					<div class="flex-shrink-0">
																						<i
																							class="ri-file-zip-line fs-17 text-secondary" />
																					</div>
																					<div class="flex-grow-1 ms-2">
																						<h6>
																							<Link href={null}
															...
															<div class="accordion-item border-0">
																<div class="accordion-header" id="heading12">
																	<a class="accordion-button p-2 shadow-none"
																		data-bs-toggle="collapse" id="collapse12"
																		aria-expanded="true">
																		<div class="d-flex">
																			<div class="flex-shrink-0">
																				<img src={avatar2} alt=""
									...
									<CardBody>
										...
										<div class="d-flex justify-content-end gap-2 mb-2">
											<div class="slider-button-prev swiper-button-disabled" tabindex="-1"
												...
												aria-controls="swiper-wrapper-d9c950ed1019f4a72" aria-disabled="true">
												<div class="avatar-title fs-18 rounded px-1 material-shadow">
													<i class="ri-arrow-left-s-line" />
												</div>
											</div>
											<div class="slider-button-next" tabindex="0" role="button"
												aria-label="Next slide" aria-controls="swiper-wrapper-d9c950ed1019f4a72"
												aria-disabled="false">
												<div class="avatar-title fs-18 rounded px-1 material-shadow">
										...
										<Swiper class="project-swiper" slidesPerView={3} spaceBetween={25} autoplay={{
											...
											<SwiperSlide>
												<Card
													class="profile-project-card shadow-none profile-project-success mb-0 material-shadow">
													<CardBody class="p-4">
														<div class="d-flex">
											...
											<SwiperSlide>
												<Card
													class="profile-project-card shadow-none profile-project-danger mb-0 material-shadow">
													<CardBody class="p-4">
														<div class="d-flex">
															<div class="flex-grow-1 text-muted overflow-hidden">
																<h5 class="fs-14 text-truncate mb-1">
											...
											<SwiperSlide>
												<Card
													class="profile-project-card shadow-none profile-project-info mb-0 material-shadow">
													<CardBody class="p-4">
														<div class="d-flex">
															<div class="flex-grow-1 text-muted overflow-hidden">
																<h5 class="fs-14 text-truncate mb-1">
											...
											<SwiperSlide>
												<Card
													class="profile-project-card shadow-none profile-project-warning mb-0 material-shadow">
													<CardBody class="p-4">
														<div class="d-flex">
															<div class="flex-grow-1 text-muted overflow-hidden">
																<h5 class="fs-14 text-truncate mb-1">
									...
									<div class="acitivity-item py-3 d-flex">
										...
										<div class="flex-grow-1 ms-3">
											...
											<div class="avatar-group mb-2">
												<Link href="javascript: void(0);" class="avatar-group-item material-shadow"
											...
											<Row>
												<div class="col-xxl-4">
													<div class="row border border-dashed gx-2 p-2 mb-2">
														<div class="col-4">
															<img src={img2} alt="" class="img-fluid rounded material-shadow" />
														</div>

														<div class="col-4">
															<img src={img3} alt="" class="img-fluid rounded material-shadow" />
														</div>

														<div class="col-4">
															<img src={img4} alt="" class="img-fluid rounded material-shadow" />
														</div>
													</div>
												</div>
											</Row>
						...
						<Card>
							<CardBody>
								<Row>
									...
									<Col xxl={3} sm={6}>
									<Card class="profile-project-card shadow-none mb-xxl-0   profile-project-info material-shadow">
										<CardBody class="p-4">
											<div class="d-flex">
												<div class="flex-grow-1 text-muted overflow-hidden">
													<h5 class="fs-14 text-truncate">
									...
									<Col xxl={3} sm={6}>
									<Card class="profile-project-card shadow-none mb-xxl-0  profile-project-success material-shadow">
										<CardBody class="p-4">
											<div class="d-flex">
												<div class="flex-grow-1 text-muted overflow-hidden">
													<h5 class="fs-14 text-truncate">
									...
									<Col xxl={3} sm={6}>
									<Card class="profile-project-card shadow-none mb-sm-0  profile-project-secondary material-shadow">
										<CardBody class="p-4">
											<div class="d-flex">
												<div class="flex-grow-1 text-muted overflow-hidden">
													<h5 class="fs-14 text-truncate">
									...
									<Col xxl={3} sm={6}>
									<Card class="profile-project-card shadow-none mb-0  profile-project-primary material-shadow">
										<CardBody class="p-4">
											<div class="d-flex">
												<div class="flex-grow-1 text-muted overflow-hidden">
													<h5 class="fs-14 text-truncate">
								...
								<div class="d-flex align-items-center mb-4">
									...
									<div class="flex-shrink-0">
										...
										<Label for="formFile" class="btn btn-danger"><i
												class="ri-upload-2-fill me-1 align-bottom" /> Upload File</Label>
									</div>
								</div>
								<Row>
									<Col lg={12}>
										...
										<table class="table table-borderless align-middle mb-0">
											...
											<tbody>
												<tr>
													...
													<td>
														<div class="dropdown">
															<a href="/dashboard" class="btn btn-light btn-icon"
															...
															<ul class="dropdown-menu dropdown-menu-end"
																...
																<li>
																	<a class="dropdown-item" href={null}><i
																			class="ri-eye-fill me-2 align-middle text-muted" />View</a>
																</li>
																<li>
																	<a class="dropdown-item" href={null}><i
																			class="ri-download-2-fill me-2 align-middle text-muted" />Download</a>
																</li>
																<li class="dropdown-divider" />
																<li>
																	<a class="dropdown-item" href={null}><i
																			class="ri-delete-bin-5-line me-2 align-middle text-muted" />Delete</a>
																</li>
															</ul>
														</div>
													</td>
													...
													<td>
														<div class="dropdown">
															...
															<ul class="dropdown-menu dropdown-menu-end"
																...
																<li>
																	<a class="dropdown-item" href={null}><i
																			class="ri-eye-fill me-2 align-middle" />View</a>
																</li>
																<li>
																	<a class="dropdown-item" href={null}><i
																			class="ri-download-2-fill me-2 align-middle" />Download</a>
																</li>
																<li>
																	<a class="dropdown-item" href={null}><i
																			class="ri-delete-bin-5-line me-2 align-middle" />Delete</a>
																</li>
															</ul>
														</div>
													</td>
									...
									<div class="text-center mt-3">
										<Link href={null} class="text-success"><i
