          ...
          <CardBody class="p-4">
            ...
            <div>
              ...
              <p class="text-muted">
                ...
                website. Company Name does not filter, edit, publish or review
                Comments prior to their presence on the website. Comments do not
                reflect the views and opinions of Company Name,its agents and/or
                affiliates.
              </p>
            </div>
            ...
            <div>
              ...
              <p class="text-muted fw-semibold">
                No use of Company Name's logo or other artwork will be allowed
                for linking absent a trademark license agreement.
              </p>
            </div>

            <div class="text-end hstack gap-2 justify-content-end">
              <Link href={null} class="btn btn-success">Accept</Link>
              <Link href={null} class="btn btn-outline-danger material-shadow-none">
                <i class="ri-close-line align-bottom me-1" />{" "}
                Decline
              </Link>
            </div>
          </CardBody>
