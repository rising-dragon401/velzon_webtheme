<svelte:head>
  <title>Order Details | Velzon - Svelte Admin & Dashboard Template</title>
</svelte:head>
<script>
	import { Container, Row, Col, Card, CardBody, CardHeader, Collapse, CardTitle } from 'sveltestrap';
				...
				<Card>
					<CardHeader>
						<div class="d-flex align-items-center">
							<CardTitle class="flex-grow-1 mb-0">Order #VL2667</CardTitle>
							<div class="flex-shrink-0">
								<Link href="/invoices/apps-invoices-details" class="btn btn-success btn-sm">
										...
										<td>
											<div class="d-flex">
												...
												<div class="flex-grow-1 ms-3">
													<h5 class="fs-15">
														<Link href="/ecommerce/apps-ecommerce-product-details" class="link-primary"
										...
										<td>
											<div class="d-flex">
												...
												<div class="flex-grow-1 ms-3">
													<h5 class="fs-15">
														<Link href="/ecommerce/apps-ecommerce-product-details" class="link-primary"
															>Noise NoiseFit Endure Smart Watch</Link
														>
													</h5>
					...
					<CardHeader>
						<div class="d-sm-flex align-items-center">
							...
							<div class="flex-shrink-0 mt-2 mt-sm-0">
								<Link href="#" class="btn btn-soft-info material-shadow-none btn-sm mt-2 mt-sm-0"
									><i class="ri-map-pin-line align-middle me-1" /> Change Address</Link
								>
								<Link href="#" class="btn btn-soft-danger material-shadow-none btn-sm mt-2 mt-sm-0"
									><i class="mdi mdi-archive-remove-outline align-middle me-1" /> Cancel Order</Link
								>
							</div>
						</div>
					</CardHeader>
				...
				<Card>
					<CardHeader>
						<div class="d-flex">
							...
							<div class="flex-shrink-0">
								<Link href="{null}" class="badge bg-primary-subtle text-primary fs-11">Track Order</Link>
							</div>
						</div>
					</CardHeader>
					<CardBody>
