				...
				<Row>
							...
							<div class="col-md">
								...
								<div class="hstack gap-3 flex-wrap">
									...
									<div class="text-muted">
										Create Date : <span
											class="fw-medium"
											id="create-date">20 Dec, 2021</span
										>
									</div>
									<div class="vr" />
									<div class="text-muted">
					...
					<div class="col-md-auto mt-md-0 mt-4">
						<div class="hstack gap-1 flex-wrap">
							<button
								type="button"
								class="btn avatar-xs mt-n1 p-0 favourite-btn active material-shadow-none"
							>
							...
							<Dropdown>
								<DropdownToggle
									...
									color=""
									type="button"
									class="btn py-0 fs-16 text-body material-shadow-none"
								>
