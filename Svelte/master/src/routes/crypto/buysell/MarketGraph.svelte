<script>
	...
	import { Button, Card, CardBody, CardHeader, CardTitle, Col, Row } from "sveltestrap";
...
<Col xxl={9}>
	<Card class="card-height-100">
		<CardHeader class="border-0 align-items-center d-flex">
			<CardTitle class="mb-0 flex-grow-1">Market Graph</CardTitle>
			<div>
				<Button
					type="button" color="soft-secondary" size="sm"
