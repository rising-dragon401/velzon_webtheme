				...
				<CardBody>
					...
					<div>
						...
						<div class="avatar-group">
							<a href="{null}" class="avatar-group-item material-shadow" id="tooltip-1">
								<div class="avatar-xs">
									<img src={avatar3} alt="" class="rounded-circle img-fluid" />
								</div>
							</a>
							<Tooltip target="tooltip-1" placement="top">Brent Gonzalez</Tooltip>
							<a href="{null}" class="avatar-group-item material-shadow" id="tooltip-2" title="Sylvia Wright">
								<div class="avatar-xs">
							...
							<a href="{null}" class="avatar-group-item material-shadow" id="tooltip-3">
								<div class="avatar-xs">
							...
							<a href="{null}" class="avatar-group-item material-shadow" id="tooltip-4">
