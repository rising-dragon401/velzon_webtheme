				...
				<div class="col-sm order-3 order-sm-2">
					<div class="hstack gap-sm-1 align-items-center flex-wrap email-topbar-link">
						...
						<Button
							id="archive"
							color=""
							class="btn-ghost-secondary btn-icon btn-sm fs-16 material-shadow-none"
						>
						...
						<Button
							color=""
							class="btn btn-ghost-secondary btn-icon btn-sm fs-16 remove-mail material-shadow-none"
							id="trash"
						>
				...
				<div class="col-auto order-2 order-sm-3">
					<div class="d-flex gap-sm-1 email-topbar-link">
						...
						<Dropdown>
							<DropdownToggle
								tag="button"
								class="btn btn-ghost-secondary btn-icon btn-sm fs-16 p-0 material-shadow-none"
								color="">
		...
		<OffcanvasBody class="overflow-hidden">
			<div class="pb-4 border-bottom border-bottom-dashed">
				<Row>
					...
					<Col class="col-auto">
						<div class="hstack gap-sm-1 align-items-center flex-wrap email-topbar-link material-shadow-none"
						>
							<button
								type="button"
				...
				<div>
					...
					<div class="bg-light px-2 py-1 rouned-bottom border">
						<Row>
							<Col>
								<ButtonGroup>
									<Button size="sm" color="light" id="Bold1" class="material-shadow-none"
										><i
											class="ri-bold align-bottom"
										/></Button
									>
									<Button size="sm" color="light" id="Italic1" class="material-shadow-none"
										><i
											class="ri-italic align-bottom"
										/></Button
									>
									<Button size="sm" color="light" id="Link1" class="material-shadow-none"
										><i
											class="ri-link align-bottom"
										/></Button
									>
									<Button size="sm" color="light" id="Image1" class="material-shadow-none"
										><i
