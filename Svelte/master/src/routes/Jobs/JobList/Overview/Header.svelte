        ...
        <Row class="mb-3">
              ...
              <div class="col-md">
                <div>
                  ...
                  <div class="hstack gap-3 flex-wrap">
                    ...
                    <div>
                      Post Date :{" "}
                      <span class="fw-medium">15 Sep, 2021</span>
                    </div>
                    <div class="vr" />
          ...
          <div class="col-md-auto">
            <div class="hstack gap-1 flex-wrap mt-4 mt-md-0">
              <button
                type="button"
                class="btn btn-icon btn-sm btn-ghost-warning fs-16 material-shadow-none"
              >
                <i class="ri-star-fill" />
              </button>
              <button
                type="button"
                class="btn btn-icon btn-sm btn-ghost-primary fs-16 material-shadow-none"
              >
