<svelte:head>
  <title>New Job | Velzon - Svelte Admin & Dashboard Template</title>
</svelte:head>
<script>
    import {
        Card,
                    ...
                    <Form action="#">
                        ...
                        <CardBody class="card-body">
                            <Row class="row g-4">
                                <Col class="col-lg-6">
                                    <div>
                                        <Label
                                            ...
                                            class="form-label"
                                        >
                                            Job Title <span class="text-danger"
                                                >*</span
                                            >
                                        </Label>
                                        <Input
                                ...
                                <Col class="col-lg-6">
                                    <div>
                                        <Label
                                            ...
                                            class="form-label"
                                        >
                                            Job Type <span class="text-danger"
                                                >*</span
                                            >
                                        </Label>
                                        <select
                                ...
                                <Col class="col-md-6">
                                    <div>
                                        <Label
                                            ...
                                            class="form-label"
                                        >
                                            Experience <span class="text-danger"
                                                >*</span
                                            >
                                        </Label>
                                        <select
                                ...
                                <Col class="col-lg-6">
                                    <div>
                                        <Label
                                            ...
                                            class="form-label"
                                        >
                                            Close Date <span class="text-danger"
                                                >*</span
                                            >
                                        </Label>
                                        <Flatpickr
                                ...
                                <Col class="col-lg-12">
                                    <div
                                        class="hstack justify-content-end gap-2"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-ghost-danger material-shadow-none"
                                        >
                                            <i
