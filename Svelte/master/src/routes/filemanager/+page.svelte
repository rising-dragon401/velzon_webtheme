    ...
    <div class="modal-body">
        <form autocomplete="off" class="needs-validation createfolder-form" id="createfolder-form" novalidate>
            ...
            <div class="hstack gap-2 justify-content-end">
                <button type="button" class="btn btn-ghost-success material-shadow-none" on:click={closeModal}><i class="ri-close-line align-bottom"></i> Close</button>
...
<Modal isOpen={showFileModal} className="modal-dialog-centered">
    ...
    <div class="modal-body">
        <form autocomplete="off" class="needs-validation createfile-form" id="createfile-form" novalidate>
            ...
            <div class="hstack gap-2 justify-content-end">
                <button type="button" class="btn btn-ghost-success material-shadow-none" on:click={fileToggle}><i class="ri-close-line align-bottom"></i> Close</button>
            ...
            <div class="chat-wrapper d-lg-flex gap-1 mx-n4 mt-n4 p-1">
                ...
                <div class="file-manager-content w-100 p-3 py-0 minimal-border">
                                        ...
                                        <div class="d-flex mb-1">
                                            ...
                                            <Dropdown>
                                                <DropdownToggle tag="button"
                                                    class="btn btn-ghost-primary btn-icon btn-sm dropdown p-0 material-shadow-none" color="">
                ...
                <div class="file-manager-detail-content p-3 py-0 minimal-border">
