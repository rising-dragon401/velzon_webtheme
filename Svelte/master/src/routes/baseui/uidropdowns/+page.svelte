			...
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						...
						<div class="live-preview">
							<div class="d-flex flex-wrap gap-3">
								<Dropdown class="material-shadow">
									<DropdownToggle
										tag="button"
										color="primary"
					...
					<CardBody>
						...
						<div class="live-preview">
							<div class="d-flex flex-wrap gap-3">
								<ButtonGroup>
									<Dropdown class="material-shadow">
										<Button color="primary" class="material-shadow-none">Primary</Button>
										<DropdownToggle
											tag="button"
											color="primary"
											class="material-shadow-none"
								...
								<ButtonGroup>
									<Dropdown class="material-shadow">
										<Button color="success" class="material-shadow-none">Success</Button>
										<DropdownToggle
											tag="button"
											color="success"
											class="material-shadow-none"
								...
								<ButtonGroup>
									<Dropdown class="material-shadow">
										<Button color="light" class="material-shadow-none">Light</Button>
										<DropdownToggle
											tag="button"
											color="light"
											class="material-shadow-none"
								...
								<ButtonGroup>
									<Dropdown class="material-shadow">
										<Button color="info" class="material-shadow-none">Info</Button>
										<DropdownToggle
											tag="button"
											color="info"
											class="material-shadow-none"
								...
								<ButtonGroup>
									<Dropdown class="material-shadow">
										<Button color="secondary" class="material-shadow-none"
											>Secondary</Button
										>
										<DropdownToggle
											tag="button"
								...
								<ButtonGroup>
									<Dropdown class="material-shadow">
										<Button color="warning" class="material-shadow-none">Warning</Button>
										<DropdownToggle
											tag="button"
											color="warning"
											class="material-shadow-none"
								...
								<ButtonGroup>
									<Dropdown class="material-shadow">
										<Button color="danger" class="material-shadow-none">Danger</Button>
										<DropdownToggle
											tag="button"
											color="danger"
											class="material-shadow-none"
								...
								<ButtonGroup>
									<Dropdown class="material-shadow">
										<Button color="dark" class="material-shadow-none">Dark</Button>
										<DropdownToggle
											tag="button"
											color="dark"
											class="material-shadow-none"
					...
					<CardBody>
						...
						<div class="live-preview">
							...
							>
								...
								<ButtonGroup>
									<Dropdown  class="material-shadow">
										<Button color="light" class="material-shadow-none btn-lg"
											>Large split button</Button
										>
										<DropdownToggle
											tag="button"
											color="light"
											class="btn-lg material-shadow-none"
											split
										/>
										<DropdownMenu>
											<DropdownItem>Action</DropdownItem>
								...
								<Dropdown  class="material-shadow">
									<DropdownToggle
										tag="button"
										color="primary"
										class="btn-sm material-shadow-none"
									>
										Small button <i
											class="mdi mdi-chevron-down"
										/>
								...
								<ButtonGroup>
									<Dropdown  class="material-shadow">
										<Button color="light" class="material-shadow-none btn-sm"
											>Small split button</Button
										>
										<DropdownToggle
											tag="button"
