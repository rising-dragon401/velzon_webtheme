...
<!-- Primary Alert -->
<Alert color="primary" class="alert-borderless material-shadow">
    <strong> Hi! </strong> A simple <b>Primary alert</b> —check it out!
</Alert>

<!-- Secondary Alert -->
<Alert color="secondary" class="alert-borderless material-shadow">
    <strong> How are you! </strong> A simple <b>secondary alert</b> —check it out!
</Alert>

<!-- Success Alert -->
<Alert color="success" class="alert-borderless material-shadow">
    <strong> Yey! Everything worked! </strong> A simple <b>success alert</b> —check it out!
</Alert>

<!-- Danger Alert -->
<Alert color="danger" class="alert-borderless mb-xl-0 material-shadow">
    <strong> Something is very wrong! </strong> A simple danger alert—check it out!
</Alert>

<!-- Warning Alert -->
<Alert color="warning" class="alert-borderless material-shadow">
    <strong> Uh oh, something went wrong </strong> A simple <b>warning alert</b> —check it out!
</Alert>

<!-- Info Alert -->
<Alert color="info" class="alert-borderless material-shadow">
    <strong>Don't forget' it !</strong> A simple <b>info alert</b> —check it out!
</Alert>

<!-- Light Alert -->
<Alert color="light" class="alert-borderless bg-light material-shadow">
    <strong>Mind Your Step!</strong> A simple <b>light alert</b> —check it out!
</Alert>

<!-- Dark Alert -->
<Alert color="dark" class="alert-borderless mb-0 material-shadow">
    <strong>Did you know?</strong> A simple <b>dark alert</b> —check it out!
</Alert>`;
...
<!-- Danger Alert -->
<Alert color="danger" class="mb-xl-0 material-shadow">
...
<!-- Dark Alert -->
<Alert color="dark" class="mb-0 material-shadow">
...
<!-- Primary Alert -->
<Alert color="primary">
    A simple Primary alert with <Link href={null} class="alert-link">an example link</Link>. Give it a click if you like.
</Alert>

<!-- Secondary Alert -->
<Alert color="secondary">
    A simple Secondary alert with <Link href={null} class="alert-link">an example link</Link>.  Give it a click if you like.
</Alert>

<!-- Success Alert -->
<Alert color="success">
    A simple Success alert with <Link href={null} class="alert-link">an example link</Link>. Give it a click if you like.
</Alert>

<!-- Danger Alert -->
<Alert color="danger" class="mb-xl-0 material-shadow">
    A simple Danger alert with <Link href={null} class="alert-link">an example link</Link>. Give it a click if you like.
</Alert>

<!-- Warning Alert -->
<Alert color="warning">
    A simple Warning alert with <Link href={null} class="alert-link">an example link</Link>. Give  it a click if you like.
</Alert>

<!-- Info Alert -->
<Alert color="info">
    A simple Info alert with <Link href={null} class="alert-link">an example link</Link>. Give it  a click if you like.
</Alert>

<!-- Light Alert -->
<Alert color="light">
    A simple Light alert with <Link href={null} class="alert-link">an example link</Link>. Give it a click if you like.
</Alert>

<!-- Dark Alert -->
<Alert color="dark" class="mb-0 material-shadow">
    A simple Dark alert with <Link href={null} class="alert-link">an example link</Link>. Give it a click if you like.
</Alert>`;
...
<!-- Success Alert -->
<Alert color="success" class="alert-additional material-shadow">
<div class="alert-body">
    <div class="d-flex">
        <div class="flex-shrink-0 me-3">
...
<!-- Danger Alert -->
<Alert color="danger" class="alert-additional mb-xl-0 material-shadow">
<div class="alert-body">
    <div class="d-flex">
        <div class="flex-shrink-0 me-3">
...
<!-- Warning Alert -->
<Alert color="warning" class="alert-additional mb-0 material-shadow">
<div class="alert-body">
    <div class="d-flex">
        <div class="flex-shrink-0 me-3">
            <i class="ri-alert-line fs-16 align-middle"></i>
...
<!-- Primary Alert -->
<Alert color="primary" class="bg-primary border-primary text-white material-shadow">  
<strong>Hi!</strong> - Solid
<b>primary alert</b> example
</Alert>

<!-- Secondary Alert -->
<Alert color="secondary" class="bg-secondary border-secondary text-white material-shadow">
<strong>How are you!</strong> - Solid
<b>secondary alert</b> example
</Alert>

<!-- Success Alert -->
<Alert color="success" class="bg-success border-success text-white material-shadow">
<strong >Yey! Everything worked! </strong>- Solid <b>success alert</b> example
</Alert>

<!-- Danger Alert -->
<Alert color="danger" class="bg-danger border-danger text-white mb-xl-0 material-shadow"><strong>Something is very wrong!</strong>- Solid <b>danger alert</b> example
</Alert>

<!-- Warning Alert -->
<Alert color="warning" class="bg-warning border-warning text-white material-shadow">
<strong >Uh oh, something went wrong!</strong>- Solid <b>warning alert</b> example</Alert>

<!-- Info Alert -->
<Alert color="info" class="bg-info border-info text-white material-shadow">
<strong>Don't forget' it !</strong> -
Solid <b>info alert</b> example
</Alert>

<!-- Light Alert -->
<Alert color="light" class="bg-light border-light text-body material-shadow">
...
<Alert
color="dark"
class="bg-dark border-primary text-white mb-0"
>
		...
		<Row>
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use the <code>alert</code> class to show a default alert.
						</p>
						<div class="live-preview">
							<Row>
								<Col xl={6}>
									<h6>Primary Alert</h6>
									<Alert color="primary" class="material-shadow">
										<strong> Hi! </strong> A simple
										<b>Primary alert</b> —check it out!
									</Alert>

									<h6>Secondary Alert</h6>
									<Alert color="secondary" class="material-shadow">
										<strong> How are you! </strong> A simple
										<b>secondary alert</b> —check it out!
									</Alert>

									<h6>Success Alert</h6>
									<Alert color="success" class="material-shadow">
										<strong>
								...
								<Col xl={6}>
									<h6>Warning Alert</h6>
									<Alert color="warning" class="material-shadow">
										<strong>
									...
									<h6>Info Alert</h6>
									<Alert color="info" class="material-shadow">
										<strong>Don't forget' it !</strong> A
										simple <b>info alert</b> —check it out!
									</Alert>

									<h6>Light Alert</h6>
									<Alert color="light" class="material-shadow">
					...
					<CardBody>
						...
						<div class="live-preview">
							<Row>
								<Col xl={6}>
									<h6>Primary Alert</h6>
									<Alert color="primary" class="border-0 material-shadow">
										<strong> Hi! </strong> A simple
										<b>Primary alert</b> —check it out!
									</Alert>

									<h6>Secondary Alert</h6>
									<Alert color="secondary" class="border-0 material-shadow">
										<strong> How are you! </strong> A simple
										<b>secondary alert</b> —check it out!
									</Alert>

									<h6>Success Alert</h6>
									<Alert color="success" class="border-0 material-shadow">
										<strong>
											Yey! Everything worked!
										</strong>
										A simple <b>success alert</b> —check it out!
									...
									<Alert
										color="danger"
										class="border-0 material-shadow mb-xl-0"
									>
										<strong>
											Something is very wrong!
								...
								<Col xl={6}>
									<h6>Warning Alert</h6>
									<Alert color="warning" class="border-0 material-shadow">
										<strong>
											Uh oh, something went wrong
										</strong>
										A simple <b>warning alert</b> —check it out!
									...
									<h6>Info Alert</h6>
									<Alert color="info" class="border-0 material-shadow">
										<strong>Don't forget' it !</strong> A
										simple <b>info alert</b> —check it out!
									</Alert>
									...
									<Alert
										color="light"
										class="border-0 material-shadow bg-light"
									>
										<strong>Mind Your Step!</strong> A
										simple <b>light alert</b> —check it out!
									</Alert>
									...
									<h6>Dark Alert</h6>
									<Alert color="dark" class="border-0 material-shadow mb-0">
										<strong>Did you know?</strong> A simple
										<b>dark alert</b> —check it out!
									</Alert>
								</Col>
		...
		<Row>
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use the <code>dismissible</code> tag to add dismissing
							button to the alert.
						</p>
						<div class="live-preview">
							<Row>
								<Col xl={6}>
									<h6>Primary Alert</h6>
									<Alert color="primary" dismissible class="material-shadow">
										<strong> Hi! </strong> A simple
									...
									<h6>Secondary Alert</h6>
									<Alert color="secondary" dismissible class="material-shadow">
										<strong> How are you! </strong> A simple
									...
									<h6>Success Alert</h6>
									<Alert color="success" dismissible class="material-shadow">
								...
								<Col xl={6}>
									<h6>Warning Alert</h6>
									<Alert color="warning" dismissible class="material-shadow">
									...
									<h6>Info Alert</h6>
									<Alert color="info" dismissible class="material-shadow">
										<strong>Don't forget' it !</strong> A
									...
									<h6>Light Alert</h6>
									<Alert color="light" dismissible class="material-shadow">
										<strong>Mind Your Step!</strong> A
		...
		<Row>
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use the <code>border-2 bg-body-secondary</code> class
							to set an alert with outline.
						</p>
						...
						<div class="live-preview">
							<Row>
								<Col xl={6}>
									...
									<Alert
										color="primary"
										class="alert-outline border-2 bg-body-secondary material-shadow"
										dismissible
									>
									...
									<Alert
										color="danger"
										class="alert-outline border-2 bg-body-secondary mb-xl-0 material-shadow"
										dismissible
									>
										<strong>
											Something is very wrong!
								...
								<Col xl={6}>
									...
									<Alert
										color="dark"
										class="alert-outline border-2 bg-body-secondary mb-0  material-shadow"
										dismissible
									>
						...
						<div class="live-preview">
							<Row>
								<Col xl={6}>
									...
									<Alert
										color="danger"
										class="alert-border-left mb-xl-0 material-shadow"
										dismissible
									>
										<i
								...
								<Col xl={6}>
									...
									<Alert
										color="dark"
										class="alert-border-left mb-0 material-shadow"
										dismissible
									>
										<i
						...
						<div class="live-preview">
							<Row>
								<Col xl={6}>
									...
									<Alert
										color="primary"
										class=" alert-label-icon fade show bg-primary text-white material-shadow"
										dismissible
									>
										<i
									...
									<Alert
										color="secondary"
										class=" alert-label-icon fade show bg-secondary text-white material-shadow"
										dismissible
									>
										<i
									...
									<Alert
										color="success"
										class="alert-label-icon fade show bg-success text-white material-shadow"
										dismissible
									>
										<i
									...
									<Alert
										color="danger"
										class="alert-label-icon fade show bg-danger text-white mb-xl-0 material-shadow"
										dismissible
									>
										<i
								...
								<Col xl={6}>
									...
									<Alert
										color="warning"
										class="alert-label-icon fade show bg-warning text-white material-shadow"
										dismissible
									>
										<i
									...
									<Alert
										color="info"
										class="alert-label-icon fade show bg-info text-white material-shadow"
										dismissible
									>
										<i
									...
									<Alert
										color="light"
										class="alert-label-icon fade show bg-light text-body material-shadow"
										dismissible
									>
										<i
									...
									<Alert
										color="dark"
										class="alert-label-icon fade show bg-dark text-white mb-0 material-shadow"
										dismissible
									>
										<i
						...
						<div class="live-preview">
							<Row>
								...
								<Col xl={6}>
									...
									<Alert
										color="warning"
										class="alert-additional mb-0 material-shadow"
										dismissible
									>
										<div class="alert-body">
											<div class="d-flex">
						...
						<div class="live-preview">
							<Row>
								<Col xl={6}>
									...
									<Alert
										color="danger"
										class="alert-top-border mb-xl-0 material-shadow"
										dismissible
									>
										<i
								...
								<Col xl={6}>
									...
									<Alert
										color="dark"
										class="alert-top-border mb-0 material-shadow"
										dismissible
									>
										<i
						...
						<div class="live-preview">
							<Row>
								<Col xl={6}>
									...
									<Alert
										color="danger"
										class="alert-label-icon label-arrow mb-xl-0 material-shadow"
										dismissible
									>
										<i
											class="ri-error-warning-line label-icon"
								...
								<Col xl={6}>
									...
									<Alert
										color="dark"
										class="alert-label-icon label-arrow mb-0 material-shadow"
										dismissible
									>
										<i
											class="ri-refresh-line label-icon"
						...
						<div class="live-preview">
							<Row>
								<Col xl={6}>
									...
									<Alert
										color="primary"
										class="bg-primary border-primary text-white material-shadow material-shadow"
									>
										<strong>Hi!</strong> - Solid
										<b>primary alert</b> example
									</Alert>
									...
									<Alert
										color="secondary"
										class="bg-secondary border-secondary text-white material-shadow"
									>
										<strong>How are you!</strong> - Solid
										<b>secondary alert</b> example
									</Alert>
									...
									<Alert
										color="success"
										class="bg-success border-success text-white material-shadow material-shadow"
									>
										<strong
											>Yey! Everything worked!
										</strong>
									...
									<Alert
										color="danger"
										class="bg-danger border-danger text-white mb-xl-0 material-shadow"
									>
								...
								<Col xl={6}>
									...
									<Alert
										color="warning"
										class="bg-warning border-warning text-white material-shadow material-shadow"
									>
										<strong
									...
									<Alert
										color="info"
										class="bg-info border-info text-white material-shadow material-shadow"
									>
										<strong>Don't forget' it !</strong> -
										Solid <b>info alert</b> example
									</Alert>
									...
									<Alert
										color="light"
										class="bg-light border-light text-body material-shadow material-shadow"
									>
										<strong>Mind Your Step!</strong> - Solid
										<b>secondary alert</b> example
									</Alert>
									...
									<Alert
										color="dark"
										class="bg-dark border-primary text-white mb-0 material-shadow"
									>
										<strong>Did you know?</strong> - Solid
										<b>dark alert</b> example
									</Alert>
