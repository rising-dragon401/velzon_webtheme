...
<div class="vstack gap-2">
    ...
    <Button color="secondary" class="material-shadow" outline>Cancel</Button>
</div>
`;
...
<div class="hstack gap-3"> 
    ...
    <div class="vr"></div>
    <Button color="secondary" class=" material-shadow" outline>Reset</Button>
</div>
`;
...
<!-- Pointer events -->
<p><Link href={null} class="text-success pe-none" tabIndex="-1" aria-disabled="true">This link</Link> can not be clicked.</p>

<p><Link href={null} class="text-success pe-auto">This link</Link> can be clicked (this is default behavior).</p>
    
<p class="pe-none mb-0"><Link href={null} class="text-success" tabindex="-1" aria-disabled="true">This link</Link> can not be clicked because the <code>pointer-events</code> property is inherited from its parent. However, <Link href={null} class="pe-auto">this link</Link> has a <code>pe-auto</code> class and can be clicked.</p>
`;
							...
							<div>
								<div>
									...
									>
										<div class="text-center">
											<img
												src={avatar2}
												class="avatar-md rounded material-shadow"
												alt="rounded"
											/>
										...
										<div class="text-center">
											<img
												src={avatar2}
												class="avatar-md rounded-top material-shadow"
												alt="rounded-top"
											/>
										...
										<div class="text-center">
											<img
												src={avatar2}
												class="avatar-md rounded-end material-shadow"
												alt="rounded-end"
											/>
										...
										<div class="text-center">
											<img
												src={avatar2}
												class="avatar-md rounded-bottom material-shadow"
												alt="rounded-bottom"
											/>
										...
										<div class="text-center">
											<img
												src={avatar2}
												class="avatar-md rounded-start material-shadow"
												alt="rounded-start"
											/>
										...
										<div class="text-center">
											<img
												src={avatar2}
												class="avatar-md rounded-circle material-shadow"
												alt="rounded-circle"
											/>
										...
										<div class="text-center">
											<img
												src={img2}
												class="avatar-md w-auto rounded-pill material-shadow"
												alt="rounded-pill"
											/>
								...
								<div>
									...
									<div class="d-flex align-items-start flex-wrap gap-4">
										<div class="text-center">
											<img src={avatar1}
												class="avatar-md rounded-0 material-shadow" alt="rounded-0" />
											<p><code>.rounded-0</code></p>
										</div>
										<div class="text-center">
											<img src={avatar1}
												class="avatar-md rounded-1 material-shadow" alt="rounded-1" />
											<p><code>.rounded-1</code></p>
										</div>
										<div class="text-center">
											<img src={avatar1}
												class="avatar-md rounded-2 material-shadow" alt="rounded-2" />
											<p><code>.rounded-2</code></p>
										</div>
										<div class="text-center">
											<img src={avatar1}
												class="avatar-md rounded-3 material-shadow" alt="rounded-3" />
											<p><code>.rounded-3</code></p>
										</div>
										<div class="text-center">
											<img src={avatar1} class="avatar-md rounded-4 material-shadow" alt="rounded-4" />
											<p><code>.rounded-4</code></p>
										</div>
										<div class="text-center">
											<img src={avatar1} class="avatar-md rounded-5 material-shadow" alt="rounded-5" />
			...
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						...
						<div class="live-preview">
							<div class="vstack gap-3">
								<div class="bg-light border p-1 px-2 material-shadow">
									First item
								</div>
								<div class="bg-light border p-1 px-2 material-shadow">
									Second item
							...
							<div class="mt-5">
								...
								<div class="vstack gap-2 col-md-5 mx-auto">
									<Button color="primary">Save changes</Button
									>
									<Button color="secondary" class="material-shadow" outline
										>Cancel</Button
									>
								</div>
							</div>
					...
					<CardBody>
						...
						<div class="live-preview">
							...
							<div class="mt-4">
								...
								<div class="hstack gap-3">
									<div class="bg-light border material-shadow p-1 px-2">
										First item
									</div>
									<div
										class="bg-light border material-shadow p-1 px-2 ms-auto"
									>
										Second item
									</div>
									<div class="bg-light border material-shadow p-1 px-2">
					...
					<CardBody>
						...
						<div class="live-preview">
							<div>
								...
								<p>
									<Link href={null} class="text-success pe-auto"
										>This link</Link
