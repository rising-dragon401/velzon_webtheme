					...
					<div class="acitivity-timeline acitivity-main">
						...
						<div class="acitivity-item py-3 d-flex">
							<div class="flex-shrink-0">
								<img src={avatar2} alt="" class="avatar-xs rounded-circle acitivity-avatar material-shadow" />
							</div>
							<div class="flex-grow-1 ms-3">
								<h6 class="mb-1 lh-base">
						...
						<div class="acitivity-item d-flex">
							<div class="flex-shrink-0">
								<img src={avatar3} alt="" class="avatar-xs rounded-circle acitivity-avatar material-shadow" />
							</div>
							<div class="flex-grow-1 ms-3">
								<h6 class="mb-1 lh-base">
				...
				<div class="p-3">
					...
					<div class="mt-3">
						<Row class="align-items-center g-2">
							...
							<div class="col">
								<div class="p-1">
									<Progress class="animated-progess progress-sm" color="success" value="50.16" />
								</div>
							</div>
							<div class="col-auto">
								<div class="p-1">
						...
						<Row class="align-items-center g-2">
							...
							<div class="col">
								<div class="p-1">
									<Progress class="animated-progess progress-sm" color="success" value="29.32" />
								</div>
							</div>
							<div class="col-auto">
								<div class="p-1">
						...
						<Row class="align-items-center g-2">
							...
							<div class="col">
								<div class="p-1">
									<Progress class="animated-progess progress-sm" color="warning" value="18.12" />
								</div>
							</div>
							<div class="col-auto">
								<div class="p-1">
						...
						<Row class="align-items-center g-2">
							...
							<div class="col">
								<div class="p-1">
									<Progress class="animated-progess progress-sm" color="success" value="4.98" />
								</div>
							</div>
						...
						<Row class="align-items-center g-2">
							...
							<div class="col">
								<div class="p-1">
									<Progress class="animated-progess progress-sm" color="danger" value="7.42" />
								</div>
							</div>
							<div class="col-auto">
								<div class="p-1">
