			...
			<Card class={"card-animate " + item.bgColor}>
				<CardBody>
					...
					>
						<div>
							<h4
								class="fs-22 fw-semibold ff-secondary mb-4 {item.counterClass}"
							>
								{item.prefix}<span
									class="counter-value"
					...
					<div class="d-flex justify-content-between">
						...
						<div>
							<div class="avatar-sm flex-shrink-0">
								<span
									class={item.iconClass == "white"
										? "avatar-title rounded-circle fs-2 material-shadow bg-" +
										  item.iconClass +
										  " bg-opacity-25"
										: "avatar-title rounded-circle fs-2 material-shadow bg-" +
										  item.iconClass +
			...
			<Card class={"card-height-100 " + item.bgColor}>
				<CardBody>
					<div class="d-flex align-items-center">
						<div class="avatar-sm flex-shrink-0">
							<span
								class={"avatar-title rounded-2 fs-2 material-shadow bg-" +item.iconClass +"-subtle text-" +item.iconClass}>
								<i class={item.icon} />
							</span>
						</div>
						<div class="flex-grow-1 ms-3">
							<p
								class={"text-uppercase fw-medium mb-3 text-" +
									item.labelClass}
							>
								{item.label}
							</p>
