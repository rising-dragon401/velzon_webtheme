        ...
        <Card class="card-height-100">
            <CardHeader class="align-items-center d-flex">
                ...
                <div class="flex-shrink-0">
                    <Button color="soft-primary" size='sm' class="material-shadow">
                        Export Report
                    </Button>
                </div>
            </CardHeader>
    ...
    <Col xxl={4} xl={6}>
        <Card class="card-height-100">
            <CardHeader class="align-items-center d-flex">
                ...
                <div>
                    <Button color="secondary" size="sm" class="btn-soft-secondary material-shadow-none">
                        ALL
                    </Button>
                    <Button color="primary" size="sm" class="btn-soft-primary material-shadow-none">
                        1M
                    </Button>
                    <Button color="secondary" size="sm" class="btn-soft-secondary material-shadow-none">
                        6M
            ...
            <CardHeader class="border-bottom-dashed align-items-center d-flex">
                ...
                <div>
                    ...
                    <Dropdown class="card-header-dropdown" direction='left'>
                        <DropdownToggle tag="button" color="soft-primary" size="sm" >
