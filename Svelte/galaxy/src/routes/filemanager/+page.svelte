    ...
    <div class="modal-body">
        <form autocomplete="off" class="needs-validation createfolder-form" id="createfolder-form" novalidate>
            ...
            <div class="hstack gap-2 justify-content-end">
                <button type="button" class="btn btn-ghost-danger" on:click={closeModal}><i class="ri-close-line align-bottom"></i> Close</button>
...
<Modal isOpen={showFileModal} className="modal-dialog-centered">
    ...
    <div class="modal-body">
        <form autocomplete="off" class="needs-validation createfile-form" id="createfile-form" novalidate>
            ...
            <div class="hstack gap-2 justify-content-end">
                <button type="button" class="btn btn-ghost-danger" on:click={fileToggle}><i class="ri-close-line align-bottom"></i> Close</button>
                    ...
                    <div class="mx-n3 pt-4 px-4 file-manager-content-scroll" data-simplebar>
                        ...
                        <!-- <div> -->
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="flex-shrink-0">
                                    <button class="btn btn-primary createFile-modal" on:click={fileToggle}><i
                ...
                <div class="file-manager-detail-content p-3 py-0 border">
                    <div class="mx-n3 pt-3 px-3 file-detail-content-scroll" style="overflow-y: auto;overflow-x: hidden;">
                        <div id="folder-overview">
                            ...
                            <SimpleDonutCharts dataColors={[ "--vz-primary", "--vz-primary-rgb, 0.75", "--vz-primary-rgb, 0.60", "--vz-primary-rgb, 0.40" , ]} class="apex-charts mt-3" dir="ltr" />
                            <div class="mt-4">
