			...
			<Row class="g-4">
				...
				<div class="col">
					<div class="p-2">
						...
						<p class="text-muted text-opacity-75">
							Owner & Founder
						</p>
						<div class="hstack text-muted gap-1">
							<div class="me-2">
								<i
									class="ri-map-pin-user-line me-1 fs-16 align-bottom text-body" />California,
								United States
							</div>
							<div>
								<i
									class="ri-building-line me-1 fs-16 align-bottom text-body" />Themesbrand
							</div>
						</div>
					</div>
				</div>
