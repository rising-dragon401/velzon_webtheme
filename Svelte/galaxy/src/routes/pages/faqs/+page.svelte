<svelte:head>
  <title>FAQs | Velzon - Svelte Admin & Dashboard Template</title>
</svelte:head>
<script>
...
<div class="page-content">
	<Container fluid>
		<Row class="mb-4">
			<Col lg={12}>
				<Card class="rounded-0 bg-primary-subtle mx-n4 mt-n4 border-top card-border-effect-none">
					<div class="px-4">
						<Row>
							<Col xxl={5} class="align-self-center">
								<div class="py-4">
									<h4 class="display-6 coming-soon-text">Frequently asked questions</h4>
									<p class="text-primary fs-15 mt-3">
										If you can not find answer to your question in our FAQ, you can always contact
									...
									<div class="hstack flex-wrap gap-2">
										<button type="button" class="btn btn-primary btn-label rounded-pill"
											...
											Email Us</button
										>
										<button type="button" class="btn btn-secondary btn-label rounded-pill"
											><i class="ri-twitter-line label-icon align-middle rounded-pill fs-16 me-2" />
							...
							<Col xxl={3} class="ms-auto">
								<div class="mb-n5 pb-1 faq-img d-none d-xxl-block">
									<img src={faqimg} alt="" class="img-fluid" />
								</div>
							</Col>
						</Row>
					</div>
				...
				<Row class="justify-content-evenly">
						...
						<div class="mt-3">
							<div class="d-flex align-items-center mb-2">
								<div class="flex-shrink-0 me-1">
									<i class="ri-question-line fs-24 align-middle text-primary me-1" />
								</div>
					...
					<Col lg={4}>
						<div class="mt-3">
							<div class="d-flex align-items-center mb-2">
								<div class="flex-shrink-0 me-1">
									<i class="ri-user-settings-line fs-24 align-middle text-primary me-1" />
								</div>
								<div class="flex-grow-1">
					...
					<Col lg={4}>
						<div class="mt-3">
							<div class="d-flex align-items-center mb-2">
								<div class="flex-shrink-0 me-1">
									<i class="ri-shield-keyhole-line fs-24 align-middle text-primary me-1" />
								</div>
								<div class="flex-grow-1">
