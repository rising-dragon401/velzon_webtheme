...
<div class="page-content">
    <Container fluid>
                        ...
                        <Collapse {isOpen}>
                            <Row class="row-cols-xxl-5 row-cols-lg-3 row-cols-md-2 row-cols-1 mt-3 g-3">
                                ...
                                <Col>
                                    ...
                                    <RangeSlider float step={10}  min={0} max={2000} range values={[0,1000]} hoverable data-slider-color="primary" />
                                </Col>
                            </Row>
                        </Collapse>
                    </CardHeader>
        ...
        <div class="text-center mb-3">
            <button class="btn btn-link text-primary mt-2" id="loadmore">
