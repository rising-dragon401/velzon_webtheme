...
<div class="page-content">
    <Container fluid>
                    ...
                    <CardBody class="p-4">
                        ...
                        <div class="hstack gap-2">
                            <Link
                                ...
                                class="btn btn-secondary">Create NFT</Link
                            >
                            <Link
        ...
        <Row>
            <Col lg={12}>
                <Card class="overflow-hidden shadow-none border-0">
                    <CardBody
                        class="bg-primary-subtle text-primary fw-semibold d-flex"
                    >
                        <Marquee speed={50}>
            ...
            <Col lg={12}>
                <div class="d-lg-flex align-items-center mb-4">
                    <div class="flex-grow-1">
                        <h5 class="card-title mb-0 fw-semibold fs-16">
                            Trending Artwork
                        </h5>
                    </div>
