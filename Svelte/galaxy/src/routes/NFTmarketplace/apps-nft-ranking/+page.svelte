            ...
            formatter: (cell, row) => {
                return html(`<div class="collection">
                    <div class="d-flex align-items-center">
                        <img src=${row.cells[1].data} alt="" class="avatar-xs rounded-circle object-cover me-2" /> <a href="/NFTmarketplace/Itemdetails/apps-nft-item-details" class="link-body">${cell}</a>
                    </div>
                </div>`)
            }
        },
