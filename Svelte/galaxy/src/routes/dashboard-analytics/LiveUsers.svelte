        ...
        <div class="card-body p-0">
            <div>
                <div id="countries_charts" class="apex-charts" dir="ltr">
                    <CountriesCharts dataColors={["--vz-primary-rgb, 0.4", "--vz-primary-rgb, 0.4", "--vz-primary-rgb, 0.4", "--vz-primary-rgb, 0.4", "--vz-primary", "--vz-primary-rgb, 0.4", "--vz-primary-rgb, 0.4", "--vz-primary-rgb, 0.4", "--vz-primary-rgb, 0.4", "--vz-primary-rgb, 0.4"]} />
                </div>
            </div>
        </div>
    </Card>
