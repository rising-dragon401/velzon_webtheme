            ...
            <Col lg={8}>
                <div class="text-center mb-5">
                    ...
                    <p class="text-muted mb-4 ff-secondary">
                        If you can not find answer to your question in our FAQ,
                    ...
                    <div class="">
                        <button
                            type="button"
                            class="btn btn-primary btn-label rounded-pill me-1"
                            ><i
                        ...
                        <button
                            type="button"
                            class="btn btn-soft-secondary btn-label rounded-pill"
                            ><i
        ...
        <Row class="g-lg-5 g-4">
            <Col lg={6}>
                <div class="d-flex align-items-center mb-2">
                    <div class="flex-shrink-0 me-1">
                        <i
                            class="ri-question-line fs-24 align-middle text-primary me-1"
                        />
                    </div>
                ...
                >
                    ...
                    >
                        <div class="ff-secondary">
                            A story can have as many themes as the reader can
                    ...
                    <AccordionItem header="What are theme features?">
                        <div class="ff-secondary">
                            Theme features is a set of specific functionality
            ...
            <Col lg={6}>
                <div class="d-flex align-items-center mb-2">
                    <div class="flex-shrink-0 me-1">
                        <i
                            class="ri-shield-keyhole-line fs-24 align-middle text-primary me-1"
                        />
                    </div>
                    <div class="flex-grow-1">
                ...
                >
                    <AccordionItem active header="Does Word have night mode?">
                        <div class="ff-secondary">
                            You can run Microsoft Word in dark mode, which uses
                    ...
                    <AccordionItem header="Is theme an opinion?">
                        <div class="ff-secondary">
                            A theme is an opinion the author expresses on the
                    ...
                    <AccordionItem header="How do you develop a theme?">
                        <div class="ff-secondary">
                            A short story, novella, or novel presents a
