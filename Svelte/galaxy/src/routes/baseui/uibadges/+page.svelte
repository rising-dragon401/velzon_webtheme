					...
					<CardBody>
						...
						<div class="live-preview">
							<div class="d-flex flex-wrap gap-2">
								...
								<Badge color="danger">Danger</Badge>
								<Badge color="dark">Dark</Badge>
								<Badge color="light" class="text-body"
									>Light</Badge
								>
							</div>
						</div>
					...
					<CardBody>
						...
						<div class="live-preview">
							<div class="d-flex flex-wrap gap-2">
								...
								>
								<span
									class="badge bg-light-subtle text-body text-body"
									>Light</span
								>
							</div>
						</div>
					...
					<CardBody>
						...
						<div class="live-preview">
							<div class="d-flex flex-wrap gap-2">
								...
								>
								<span
									class="badge border border-light text-light text-body"
									>Light</span
								>
							</div>
						</div>
					...
					<CardBody>
						...
						<div class="live-preview">
							<div class="d-flex flex-wrap gap-2">
								...
								<Badge color="danger" pill>Danger</Badge>
								<Badge color="dark" pill>Dark</Badge>
								<Badge color="light" class="text-body" pill
									>Light</Badge
								>
							</div>
						</div>
					...
					<CardBody>
						...
						<div class="live-preview">
							<div class="d-flex flex-wrap gap-2">
								...
								>
								<span
									class="badge rounded-pill bg-dark-subtle text-body"
									>Dark</span
								>
								<span
					...
					<CardBody>
						...
						<div class="live-preview">
							<div class="d-flex flex-wrap gap-2">
								...
								>
								<span
									class="badge bg-dark-subtle text-body badge-border"
									>Dark</span
								>
								<span
									class="badge bg-light-subtle text-body badge-border text-body"
									>Light</span
								>
							</div>
						</div>
					...
					<CardBody>
						...
						<div class="live-preview">
							<div class="d-flex flex-wrap gap-2">
								...
								>
								<span
									class="badge rounded-pill border border-dark text-body"
									>Dark</span
								>
								<span
									class="badge rounded-pill border border-light text-light text-body"
									>Light</span
								>
							</div>
						</div>
