...
<div>
	<button on:click={topFunction} class="btn btn-primary btn-icon" id="back-to-top">
		<i class="ri-arrow-up-line" />
	</button>
	<div class="customizer-setting d-none d-md-block">
		<a href="{null}" class="btn-primary rounded-pill shadow-lg btn btn-icon btn-lg p-2" on:click={()=> (open = !open)}
			>
