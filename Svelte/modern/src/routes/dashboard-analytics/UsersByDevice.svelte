...
<Col xl={4}>
    <Card class="card-height-100">
        ...
        <CardBody>
            <div dir="ltr">
                <UsersByDeviceCharts dataColors={["--vz-primary", "--vz-secondary", "--vz-warning"]} />
            </div>
                    ...
                    <tbody class="border-0">
                        <tr>
                            ...
                            <td><p class="text-muted mb-0">
                                ...
                                />
                                78.56k</p></td>
                            <td class="text-end"><p class="text-success fw-medium fs-13 mb-0"><i class="ri-arrow-up-s-fill fs-5 align-middle"></i>2.08%</p></td>
                        </tr>
                        <tr>
                            <td><h4 class="text-truncate fs-14 fs-medium mb-0"><i class="ri-stop-fill align-middle fs-18 text-secondary me-2"></i>Mobile Users</h4></td>
                            <td><p class="text-muted mb-0">
                                <UsersIcon
                                    class="me-2 icon-sm"
                                />
                        ...
                        <tr>
                            <td><h4 class="text-truncate fs-14 fs-medium mb-0"><i class="ri-stop-fill align-middle fs-18 text-warning me-2"></i>Tablet Users</h4></td>
                            <td><p class="text-muted mb-0">
                                <UsersIcon
                                    class="me-2 icon-sm"
                                />
                                42.89k</p></td>
                            <td class="text-end"><p class="text-danger fw-medium fs-13 mb-0"><i class="ri-arrow-down-s-fill fs-5 align-middle"></i>7.36%</p></td>
                        </tr>
                    </tbody>
                </table>
            </div>
