...
<svelte:head>
	<title>Colors | Velzon - Svelte Admin & Dashboard Template</title>
</svelte:head>
				...
				<Card>
					...
					<CardBody>
						<div class="table-responsive">
							<table
								class="table table-bordered table-striped table-nowrap align-middle mb-0"
							>
								<thead>
									<tr>
								...
								<tbody>
									<tr>
										<th class="" scope="row"> Primary </th>
										<td style="width: 100px">
											<code>.bg-gradient</code>
										</td>
										<td style="width: 180px">
											<div
												class="bg-primary bg-gradient p-2"
											/>
										</td>
										<td style="width: 100px">
									...
									<tr>
										...
										<td>
											<div
												class="bg-secondary bg-gradient p-2"
											/>
										</td>
										<td>
									...
									<tr>
										<th class="" scope="row"> Success </th>
										<td>
											<code>.bg-gradient</code>
										</td>
										<td>
											<div
												class="bg-success bg-gradient p-2 align-self-center"
											/>
										</td>
										<td>
									...
									<tr>
										<th class="" scope="row"> Info </th>
										<td>
											<code>.bg-gradient</code>
										</td>
										<td>
											<div
												class="bg-info bg-gradient p-2"
											/>
										</td>
										<td>
											<code>.bg-info</code>
									...
									<tr>
										<th class="" scope="row"> Warning </th>
										<td>
											<code>.bg-gradient</code>
										</td>
										<td>
											<div
												class="bg-warning bg-gradient p-2"
											/>
										</td>
										<td>
										...
										<td>
											<div
												class="border border-warning p-2"
											/>
										</td>
										<td>
									...
									<tr>
										<th class="" scope="row"> Danger </th>
										<td>
											<code>.bg-gradient</code>
										</td>
										<td>
											<div
												class="bg-danger bg-gradient p-2"
											/>
										</td>
										<td>
											<code>.bg-danger</code>
									...
									<tr>
										<th class="" scope="row"> Dark </th>
										<td>
											<code>.bg-gradient</code>
										</td>
										<td>
											<div
												class="bg-dark bg-gradient p-2"
											/>
										</td>
										<td>
											<code>.bg-dark</code>
									...
									<tr>
										<th class="" scope="row"> Light </th>
										<td>
											<code>.bg-gradient</code>
										</td>
										<td>
											<div
												class="bg-light bg-gradient p-2"
											/>
										</td>
										<td>
											<code>.bg-light</code>
									...
									<tr>
										...
										<td>
											<div
												class="bg-body-secondary border p-2"
											/>
										</td>
										<td>
											<div class="text-center">-</div>
									...
									<tr>
										<th class="" scope="row"> White-50 </th>
										<td>
											<div class="text-center">-</div>
										</td>
										<td>
									...
									<tr>
										<th class="" scope="row"> Black-50 </th>
										<td>
											<div class="text-center">-</div>
										</td>
										<td>
									...
									<tr>
										...
										<td>
											<div class="text-center">
												<div
													class="bg-primary bg-opacity-10 p-2"
												/>
											</div>
										</td>
										<td>
										...
										<td>
											<div
												class="border border-primary border-opacity-10 p-2"
											/>
										</td>
										<td>
											<div class="text-center">-</div>
									...
									<tr>
										...
										<td>
											<div class="text-center">
												<div
													class="bg-primary opacity-25 p-2"
												/>
											</div>
										</td>
										<td>
										...
										<td>
											<div class="text-center">
												<div
													class="bg-primary bg-opacity-25 p-2"
												/>
											</div>
										</td>
										<td>
										...
										<td>
											<div
												class="border border-primary border-opacity-25 p-2"
											/>
										</td>
										<td>
										...
										<td>
											<div
												class="text-opacity-25 text-primary"
											>
												text-opacity-25
											</div>
										</td>
									...
									<tr>
										...
										<td>
											<div class="text-center">
												<div
													class="bg-primary opacity-50 p-2"
												/>
											</div>
										</td>
										<td>
										...
										<td>
											<div class="text-center">
												<div
													class="bg-primary bg-opacity-50 p-2"
												/>
											</div>
										</td>
										<td>
										...
										<td>
											<div
												class="border border-primary border-opacity-50 p-2"
											/>
										</td>
										<td>
										...
										<td>
											<div
												class="text-opacity-50 text-primary"
											>
												text-opacity-50
											</div>
										</td>
									...
									<tr>
										...
										<td>
											<div class="text-center">
												<div
													class="bg-primary opacity-75 p-2"
												/>
											</div>
										</td>
										<td>
										...
										<td>
											<div class="text-center">
												<div
													class="bg-primary bg-opacity-75 p-2"
												/>
											</div>
										</td>
										<td>
										...
										<td>
											<div
												class="border border-primary border-opacity-75 p-2"
											/>
										</td>
										<td>
										...
										<td>
											<div
												class="text-opacity-75 text-primary"
											>
												text-opacity-75
											</div>
										</td>
									...
									<tr>
										...
										<td>
											<div class="text-center">
												<div
													class="bg-primary opacity-100 p-2"
												/>
											</div>
										</td>
										<td>
										...
										<td>
											<div class="text-center">
												<div
													class="bg-primary bg-opacity-100 p-2"
												/>
											</div>
										</td>
										<td>
										...
										<td>
											<div
												class="border border-primary border-opacity-100 p-2"
											/>
										</td>
										<td>
										...
										<td>
											<div
												class="text-opacity-100 text-primary"
											>
												text-opacity-100
											</div>
										</td>
