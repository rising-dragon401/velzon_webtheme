...
module.exports = function (route) {
    ...
    route.get('/', (req, res, next) => {
        res.render('index', {layout: 'layouts/layout-without-bradcrumb', title: 'Dashboard', page_title: 'Dashboard', folder: 'Dashboard' });
    })
    ...
    route.get('/layouts-vertical', (req, res, next) => {
        res.render('layouts-vertical', { layout: 'layouts/layout-vertical', title: 'Vertical', page_title: 'Vertical', folder: 'layout' });
    })
