...
module.exports = function (route) {
    ...
    route.get('/apps-calendar', (req, res, next) => {
        res.render('apps-calendar', { title: 'Calendar', page_title: 'Calendar', folder: 'Apps' });
    })
    ...
    route.get('/apps-projects-overview', (req, res, next) => {
        res.render('apps-projects-overview', { title: 'Project Overview', page_title: 'Project Overview', folder: 'Projects' });
    })
    ...
    route.get('/apps-crypto-wallet', (req, res, next) => {
        res.render('apps-crypto-wallet', { title: 'My Wallet', page_title: 'My Wallet', folder: 'Crypto' });
    })
    ...
    route.get('/apps-tickets-details', (req, res, next) => {
        res.render('apps-tickets-details', { title: 'Ticket Details', page_title: 'Ticket Details', folder: 'Tickets' });
    })
    ...
    route.get('/apps-file-manager', (req, res, next) => {
        res.render('apps-file-manager', { title: 'Create NFT', page_title: 'Create NFT', folder: 'NFT Marketplace' });
    })
    route.get('/apps-todo', (req, res, next) => {
        res.render('apps-todo', { title: 'Create NFT', page_title: 'Create NFT', folder: 'NFT Marketplace' });
    })
    ...
    route.get('/apps-job-candidate-grid', (req, res, next) => {
        res.render('apps-job-candidate-grid', { title: 'Grid View', page_title: 'Candidate Lists', folder: 'Jobs' });
    })
    route.get('/apps-job-candidate-lists', (req, res, next) => {
        res.render('apps-job-candidate-lists', { title: 'List View', page_title: 'Candidate Lists', folder: 'Jobs' });
    })
    ...
    route.get('/apps-job-details', (req, res, next) => {
        res.render('apps-job-details', { title: 'Job Overview', page_title: 'Jobs', folder: 'Jobs' });
    })
    route.get('/apps-job-grid-lists', (req, res, next) => {
        res.render('apps-job-grid-lists', { title: 'Job Grid Lists', page_title: 'Jobs', folder: 'Jobs' });
    })
    route.get('/apps-job-lists', (req, res, next) => {
        res.render('apps-job-lists', { title: 'Job Lists', page_title: 'Jobs', folder: 'Jobs' });
    })
    ...
    route.get('/apps-job-statistics', (req, res, next) => {
        res.render('apps-job-statistics', { title: 'Statistics', page_title: 'Jobs', folder: 'Jobs' });
    })
    ...
    route.get('/pages-profile', (req, res, next) => {
        res.render('pages-profile', { title: 'Profile', page_title: 'Profile', folder: 'Pages' });
    })
    route.get('/pages-profile-settings', (req, res, next) => {
        res.render('pages-profile-settings', { title: 'Profile', page_title: 'Profile', folder: 'Pages' });
    })
    ...
    route.get('/pages-faqs', (req, res, next) => {
        res.render('pages-faqs', { title: 'FAQs', page_title: 'FAQs', folder: 'Pages' });
    })
    ...
    route.get('/advance-ui-scrollbar', (req, res, next) => {
        res.render('advance-ui-scrollbar', { title: 'Scrollbar', page_title: 'Scrollbar', folder: 'Advanced UI' });
    })
    ...
    route.get('/advance-ui-ratings', (req, res, next) => {
        res.render('advance-ui-ratings', { title: 'Ratings', page_title: 'Ratings', folder: 'Advanced UI' });
    })
