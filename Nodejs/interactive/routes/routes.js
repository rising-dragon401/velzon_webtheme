...
route.get('/', (req, res, next) => {
    res.render('index', { title: 'Dashboard', page_title: 'Dashboard', folder: 'Dashboards', layout: 'layouts/layout-without-bradcrumb' });
})
...
route.get('/apps-invoices-create', (req, res, next) => {
    res.render('apps-invoices-create', { title: 'Create Invoice', page_title: 'Create Invoice', folder: 'Invoices' });
})
...
route.get('/apps-file-manager', (req, res, next) => {
    res.render('apps-file-manager', { title: 'File Manager', page_title: 'File Manager', folder: 'File Manager', layout: 'layouts/layout-without-bradcrumb' });
})
route.get('/apps-todo', (req, res, next) => {
    res.render('apps-todo', { title: 'Todo', page_title: 'Todo', folder: 'Todo', layout: 'layouts/layout-without-bradcrumb' });
})
...
route.get('/apps-job-categories', (req, res, next) => {
    res.render('apps-job-categories', { title: 'Job Categories', page_title: 'Job Categories', folder: 'Jobs' });
})
route.get('/apps-job-companies-lists', (req, res, next) => {
    res.render('apps-job-companies-lists', { title: 'Companies List', page_title: 'Companies List', folder: 'Companies' });
})
route.get('/apps-job-details', (req, res, next) => {
    res.render('apps-job-details', { title: 'Job Overview', page_title: 'Jobs', folder: 'Jobs', layout: 'layouts/layout-without-bradcrumb' });
})
route.get('/apps-job-grid-lists', (req, res, next) => {
    res.render('apps-job-grid-lists', { title: 'Job Grid Lists', page_title: 'Job Grid Lists', folder: 'Jobs' });
})
...
route.get('/apps-job-new', (req, res, next) => {
    res.render('apps-job-new', { title: 'New Job', page_title: 'New Job', folder: 'Jobs' });
})
...
route.get('/pages-privacy-policy', (req, res, next) => {
    res.render('pages-privacy-policy', { title: 'Privacy Policy', page_title: 'Privacy Policy', folder: 'Pages' });
})
route.get('/pages-term-conditions', (req, res, next) => {
    res.render('pages-term-conditions', { title: 'Term & Conditions', page_title: 'Term & Conditions', folder: 'Pages' });
})
...
route.get('/charts-apex-range-area', (req, res, next) => {
    res.render('charts-apex-range-area', { title: 'Apex Range Charts', page_title: 'Range Area Charts', folder: 'Apexcharts' });
})
...
route.get('/charts-apex-polar', (req, res, next) => {
    res.render('charts-apex-polar', { title: 'Apex Polararea Charts', page_title: 'Polararea Charts', folder: 'Apexcharts' });
})
...
route.get('/charts-echarts', (req, res, next) => {
    res.render('charts-echarts', { title: 'E Charts', page_title: 'E Charts', folder: 'Charts' });
})
