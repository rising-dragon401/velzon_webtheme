...
module.exports = function (route) {
    ...
    route.get('/auth-signin-basic', (req, res, next) => {
        res.render('auth-signin-basic', { title: 'Sign In', layout: 'layouts/layout-without-nav' });
    })
    route.get('/auth-signin-cover', (req, res, next) => {
        res.render('auth-signin-cover', { title: 'Sign In', layout: 'layouts/layout-without-nav' });
    })
    route.get('/auth-signup-basic', (req, res, next) => {
        res.render('auth-signup-basic', { title: 'Sign Up', layout: 'layouts/layout-without-nav' });
    })
    route.get('/auth-signup-cover', (req, res, next) => {
        res.render('auth-signup-cover', { title: 'Sign Up', layout: 'layouts/layout-without-nav' });
    })
    route.get('/auth-pass-reset-basic', (req, res, next) => {
        res.render('auth-pass-reset-basic', { title: 'Reset Password', layout: 'layouts/layout-without-nav' });
    })
    route.get('/auth-pass-reset-cover', (req, res, next) => {
        res.render('auth-pass-reset-cover', { title: 'Reset Password', layout: 'layouts/layout-without-nav' });
    })
    route.get('/auth-pass-change-basic', (req, res, next) => {
        res.render('auth-pass-change-basic', { title: 'Change Password', layout: 'layouts/layout-without-nav' });
    })
    route.get('/auth-pass-change-cover', (req, res, next) => {
        res.render('auth-pass-change-cover', { title: 'Change Password', layout: 'layouts/layout-without-nav' });
    })
    route.get('/auth-offline', (req, res, next) => {
        res.render('auth-offline', { title: 'Offline', layout: 'layouts/layout-without-nav' });
    })
    route.get('/auth-lockscreen-basic', (req, res, next) => {
        res.render('auth-lockscreen-basic', { title: 'Lock Screen', layout: 'layouts/layout-without-nav' });
    })
    route.get('/auth-lockscreen-cover', (req, res, next) => {
        res.render('auth-lockscreen-cover', { title: 'Lock Screen', layout: 'layouts/layout-without-nav' });
    })
    route.get('/auth-logout-basic', (req, res, next) => {
        res.render('auth-logout-basic', { title: 'Logout', layout: 'layouts/layout-without-nav' });
    })
    route.get('/auth-logout-cover', (req, res, next) => {
        res.render('auth-logout-cover', { title: 'Logout', layout: 'layouts/layout-without-nav' });
    })
    route.get('/auth-success-msg-basic', (req, res, next) => {
        res.render('auth-success-msg-basic', { title: 'Success Message', layout: 'layouts/layout-without-nav' });
    })
    route.get('/auth-success-msg-cover', (req, res, next) => {
        res.render('auth-success-msg-cover', { title: 'Success Message', layout: 'layouts/layout-without-nav' });
    })
    route.get('/auth-twostep-basic', (req, res, next) => {
        res.render('auth-twostep-basic', { title: 'Two Step Verification', layout: 'layouts/layout-without-nav' });
    })
    route.get('/auth-twostep-cover', (req, res, next) => {
        res.render('auth-twostep-cover', { title: 'Two Step Verification', layout: 'layouts/layout-without-nav' });
    })
    route.get('/auth-404-basic', (req, res, next) => {
        res.render('auth-404-basic', { title: '404 Error', layout: 'layouts/layout-without-nav' });
    })
    route.get('/auth-404-cover', (req, res, next) => {
        res.render('auth-404-cover', { title: '404 Error', layout: 'layouts/layout-without-nav' });
    })
    ...
    route.get('/', (req, res, next) => {
        res.render('index', {  layout: 'layouts/layout-without-bradcrumb',title: 'Dashboard', page_title: 'Dashboard', folder: 'Dashboards' });
    })
    ...
    route.get('/apps-calendar-month-grid', (req, res, next) => {
        res.render('apps-calendar-month-grid', { title: 'Month Grid Calendar', page_title: 'Month Grid Calendar', folder: 'Apps' });
    })
    ...
    route.get('/apps-chat', (req, res, next) => {
        res.render('apps-chat', { layout: 'layouts/layout-without-bradcrumb', title: 'Chat', page_title: 'Chat', folder: 'Apps' });
    })
    route.get('/apps-mailbox', (req, res, next) => {
        res.render('apps-mailbox', { layout: 'layouts/layout-without-bradcrumb', title: 'Mailbox', page_title: 'Mailbox', folder: 'Apps' });
    })
    route.get('/apps-mailbox', (req, res, next) => {
    ...
    route.get('/apps-projects-overview', (req, res, next) => {
        res.render('apps-projects-overview', { layout: 'layouts/layout-without-bradcrumb', title: 'Project Overview', page_title: 'Project Overview', folder: 'Projects' });
    })
    ...
    route.get('/apps-tickets-details', (req, res, next) => {
        res.render('apps-tickets-details', { layout: 'layouts/layout-without-bradcrumb', title: 'Ticket Details', page_title: 'Ticket Details', folder: 'Tickets' });
    })
    ...
    route.get('/apps-file-manager', (req, res, next) => {
        res.render('apps-file-manager', { layout: 'layouts/layout-without-bradcrumb', title: 'Create NFT', page_title: 'Create NFT', folder: 'NFT Marketplace' });
    })
    route.get('/apps-todo', (req, res, next) => {
        res.render('apps-todo', { layout: 'layouts/layout-without-bradcrumb', title: 'Create NFT', page_title: 'Create NFT', folder: 'NFT Marketplace' });
    })

    // Jobs
    route.get('/apps-job-application', (req, res, next) => {
        res.render('apps-job-application', { title: 'Application', page_title: 'Application', folder: 'Jobs' });
    })
    route.get('/apps-job-candidate-grid', (req, res, next) => {
        res.render('apps-job-candidate-grid', { title: 'Candidate Grid View', page_title: 'Grid View', folder: 'Candidate Lists' });
    })
    route.get('/apps-job-candidate-lists', (req, res, next) => {
        res.render('apps-job-candidate-lists', { title: 'Candidate List View', page_title: 'List View', folder: 'Candidate Lists' });
    })
    route.get('/apps-job-categories', (req, res, next) => {
        res.render('apps-job-categories', { title: 'Job Categories', page_title: 'Jobs', folder: 'Jobs' });
    })
    route.get('/apps-job-companies-lists', (req, res, next) => {
        res.render('apps-job-companies-lists', { title: 'Companies List', page_title: 'Companies', folder: 'Jobs' });
    })
    route.get('/apps-job-details', (req, res, next) => {
        res.render('apps-job-details', { layout:'layouts/layout-without-bradcrumb', title: 'Job Overview', page_title: 'Jobs', folder: 'Jobs' });
    })
    route.get('/apps-job-grid-lists', (req, res, next) => {
        res.render('apps-job-grid-lists', { title: 'Job Grid Lists', page_title: 'Jobs Grid Lists', folder: 'Jobs' });
    })
    route.get('/apps-job-lists', (req, res, next) => {
        res.render('apps-job-lists', { title: 'Job Lists', page_title: 'Job Lists', folder: 'Jobs' });
    })
    route.get('/apps-job-new', (req, res, next) => {
        res.render('apps-job-new', { title: 'New Job', page_title: 'Jobs', folder: 'Jobs' });
    })
    route.get('/apps-job-statistics', (req, res, next) => {
        res.render('apps-job-statistics', { title: 'Statistics', page_title: 'Statistics', folder: 'Jobs' });
    })


    route.get('/apps-api-key', (req, res, next) => {
        res.render('apps-api-key', { title: 'API Key', page_title: 'API Key', folder: 'Apps' });
    })
    ...
    route.get('/pages-profile', (req, res, next) => {
        res.render('pages-profile', { layout: 'layouts/layout-without-bradcrumb', title: 'Profile', page_title: 'Profile', folder: 'Pages' });
    })
    route.get('/pages-profile-settings', (req, res, next) => {
        res.render('pages-profile-settings', { layout: 'layouts/layout-without-bradcrumb', title: 'Profile', page_title: 'Profile', folder: 'Pages' });
    })
    ...
    route.get('/pages-faqs', (req, res, next) => {
        res.render('pages-faqs', { layout: 'layouts/layout-without-bradcrumb', title: 'FAQs', page_title: 'FAQs', folder: 'Pages' });
    })
    ...
    route.get('/pages-maintenance', (req, res, next) => {
        res.render('pages-maintenance', { layout: 'layouts/layout-without-nav', title: 'Maintanance' });
    })
    route.get('/pages-coming-soon', (req, res, next) => {
        res.render('pages-coming-soon', { title: 'Maintanance', layout: 'layouts/layout-without-nav' });
    })
    ...
    route.get('/pages-privacy-policy', (req, res, next) => {
        res.render('pages-privacy-policy', { title: 'Privacy Policy', page_title: 'Pages', folder: 'Pages' });
    })
    route.get('/pages-term-conditions', (req, res, next) => {
        res.render('pages-term-conditions', { title: 'Term & Conditions', page_title: 'Pages', folder: 'Pages' });
    })
    ...
    route.get('/ui-links', (req, res, next) => {
        res.render('ui-links', { title: 'Colored Links', page_title: 'Colored Links', folder: 'Base UI' });
    })
    ...
    route.get('/charts-apex-funnel', (req, res, next) => {
        res.render('charts-apex-funnel', { title: 'Apex Funnel Charts', page_title: 'Funnel Charts', folder: 'Apexcharts' });
    })
    ...
    route.get('/charts-apex-range-area', (req, res, next) => {
        res.render('charts-apex-range-area', { title: 'Apex Range Area Charts', page_title: 'Range Area Charts', folder: 'Apexcharts' });
    })
    ...
    route.get('/icons-crypto', (req, res, next) => {
        res.render('icons-crypto', { title: 'Crypto Icons', page_title: 'Crypto Icons', folder: 'Icons' });
    })
    ...
    route.get('/job-landing', (req, res, next) => {
        res.render('job-landing', { title: 'Job Landing', layout: false });
    })

    route.get('/layouts-horizontal', (req, res, next) => {
        res.render('layouts-horizontal', { layout: 'layouts/layout-horizontal', title: 'Horizontal', page_title: 'Horizontal', folder: 'layout' });
    })
    route.get('/layouts-detached', (req, res, next) => {
        res.render('layouts-detached', { layout: 'layouts/layout-detached', title: 'Detached', page_title: 'Detached', folder: 'layout' });
    })
    route.get('/layouts-two-column', (req, res, next) => {
        res.render('layouts-two-column', { layout: 'layouts/layout-twocolumn', title: 'Two Column', page_title: 'Two Column', folder: 'layout' });
    })
    route.get('/layouts-vertical-hovered', (req, res, next) => {
        res.render('layouts-vertical-hovered', { layout: 'layouts/layout-verti-hoverd', title: 'Vertical Hovered', page_title: 'Vertical Hovered', folder: 'layout' });
    })
    // Authentication
