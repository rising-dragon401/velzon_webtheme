                                                    ...
                                                    <div class="row align-items-center">
                                                        <div class="col-6">
                                                            <div class="d-flex flex-wrap gap-4 align-items-center">
                                                                ...
                                                                <p class="fw-semibold text-muted mb-0">High <span class="text-body fs-13 ms-1">0.014578</span></p>
                                                                <p class="fw-semibold text-muted mb-0">Low <span class="text-body fs-13 ms-1">0.0175489</span></p>
                                                            </div>
                                                        </div><!-- end col -->
                                                        <div class="col-6">
                                                            <div class="d-flex">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <img src="/static/images/svg/crypto-icons/etc.svg" class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <img src="/static/images/svg/crypto-icons/bnb.svg" class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <img src="/static/images/svg/crypto-icons/usdt.svg" class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2">
                                                                <img src="/static/images/svg/crypto-icons/eth.svg" alt="" class="avatar-xxs">
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2">
                                                                <img src="/static/images/svg/crypto-icons/bnb.svg" alt="" class="avatar-xxs">
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2">
                                                                <img src="/static/images/svg/crypto-icons/usdt.svg" alt="" class="avatar-xxs">
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2">
                                                                <img src="/static/images/svg/crypto-icons/dash.svg" alt="" class="avatar-xxs">
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2">
                                                                <img src="/static/images/svg/crypto-icons/neo.svg" alt="" class="avatar-xxs">
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2">
                                                                <img src="/static/images/svg/crypto-icons/doge.svg" alt="" class="avatar-xxs">
                                                            </div>
                                                            <div>
                                                ...
                                                <div class="mt-3 pt-2">
                                                    <div class="d-flex mb-2">
                                                        <div class="flex-grow-1">
                                                            <p class="fs-14 mb-0">Transaction Fees<span class="text-muted ms-1 fs-13">(0.05%)</span></p>
                                                        </div>
                                                        <div class="flex-shrink-0">
                                                    ...
                                                    <div class="d-flex mb-2">
                                                        <div class="flex-grow-1">
                                                            <p class="fs-14 mb-0">Minimum Received<span class="text-muted ms-1 fs-13">(2%)</span></p>
                                                        </div>
                                                        <div class="flex-shrink-0">
                                    ...
                                    <div data-simplebar style="height: 390px;">
                                        <div class="p-3">
                                            ...
                                            <div class="d-flex align-items-center mt-3">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    <h6 class="fs-15 mb-1">Sent Ethereum</h6>
                                                    <p class="text-muted fs-13 mb-0">
                            ...
                            <div class="card card-height-100">
                                ...
                                <div class="card-body p-0">
                                    <ul class="list-group list-group-flush border-dashed mb-0">
                                        ...
                                        <li class="list-group-item d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="/static/images/svg/crypto-icons/eth.svg" class="avatar-xs" alt="">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h6 class="fs-15 mb-1">Ethereum</h6>
                                        ...
                                        <li class="list-group-item d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="/static/images/svg/crypto-icons/aave.svg" class="avatar-xs" alt="">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                        ...
                                        <li class="list-group-item d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="/static/images/svg/crypto-icons/doge.svg" class="avatar-xs" alt="">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                        ...
                                        <li class="list-group-item d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="/static/images/svg/crypto-icons/bnb.svg" class="avatar-xs" alt="">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                        ...
                                        <li class="list-group-item d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="/static/images/svg/crypto-icons/ltc.svg" class="avatar-xs" alt="">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-middle">
                                        <div class="flex-shrink-0">
                                            <img src="/static/images/small/img-1.jpg" class="rounded img-fluid" style="height: 60px;" alt="">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="d-flex mt-4">
                                        <div class="flex-shrink-0">
                                            <img src="/static/images/small/img-2.jpg" class="rounded img-fluid" style="height: 60px;" alt="">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="d-flex mt-4">
                                        <div class="flex-shrink-0">
                                            <img src="/static/images/small/img-3.jpg" class="rounded img-fluid" style="height: 60px;" alt="">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="d-flex mt-4">
                                        <div class="flex-shrink-0">
                                            <img src="/static/images/small/img-6.jpg" class="rounded img-fluid" style="height: 60px;" alt="">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
