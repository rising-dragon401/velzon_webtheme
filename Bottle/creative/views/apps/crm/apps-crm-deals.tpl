                            ...
                            <div class="collapse show" id="needsIdentified">
                                ...
                                <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                                    ...
                                    <div class="collapse border-top border-top-dashed" id="needsIdentified4">
                                        <div class="card-body">
                                            <h6 class="fs-15 mb-1">Themesbrand <small class="badge bg-danger-subtle text-danger">3 Month</small></h6>
                                            <p class="text-muted">As a company grows however, you find it's not as easy to shout across</p>
                                            <ul class="list-unstyled vstack gap-2 mb-0">
                                                <li>
                                                    <div class="d-flex">
                                ...
                                <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                                    ...
                                    <div class="collapse border-top border-top-dashed" id="needsIdentified5">
                                        <div class="card-body">
                                            <h6 class="fs-15 mb-1">Themesbrand <small class="badge bg-danger-subtle text-danger">3 Days</small></h6>
                                            <p class="text-muted">As a company grows however, you find it's not as easy to shout across</p>
                                            <ul class="list-unstyled vstack gap-2 mb-0">
                                                <li>
                                                    <div class="d-flex">
                        ...
                        <div class="col">
                            <div class="card">
                                <a class="card-body bg-secondary-subtle" data-bs-toggle="collapse" href="#offerAccepted" role="button" aria-expanded="false" aria-controls="offerAccepted">
                                    <h5 class="card-title text-uppercase fw-semibold mb-1 fs-16">Offer Accepted</h5>
