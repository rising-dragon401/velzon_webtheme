                ...
                <!-- start page title -->
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Wallet Connect</h4>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-3">
                            <div class="card text-center">
                                <div class="card-body py-5 px-4">
                                    <img src="/static/images/nft/wallet/kukai.png" alt="" height="55" class="mb-3 pb-2">
                        ...
                        <div class="col-lg-3">
                            <div class="card text-center">
                                <div class="card-body py-5 px-4">
                                    <img src="/static/images/nft/wallet/enjin.png" alt="" height="55" class="mb-3 pb-2">
                        ...
                        <div class="col-lg-3">
                            <div class="card text-center">
                                <div class="card-body py-5 px-4">
                                    <img src="/static/images/nft/wallet/alpha.png" alt="" height="55" class="mb-3 pb-2">
                        ...
                        <div class="col-lg-3">
                            <div class="card text-center">
                                <div class="card-body py-5 px-4">
                                    <img src="/static/images/nft/wallet/math.png" alt="" height="55" class="mb-3 pb-2">
