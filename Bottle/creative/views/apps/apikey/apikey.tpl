                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            ...
                                            <h1 class="mt-4 ff-secondary fw-bold"><span class="counter-value" data-target="50"></span></h1>
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            ...
                                            <h1 class="mt-4 ff-secondary fw-semibold"><span class="counter-value" data-target="8"></span></h1>
                            ...
                            <div class="card" id="apiKeyList">
                                <div class="card-header d-flex align-items-center">
                                    ...
                                    <div class="d-flex gap-1 flex-wrap">
                                        ...
                                        <button type="button" class="btn btn-primary create-btn" data-bs-toggle="modal" data-bs-target="#api-key-modal"><i class="ri-add-line align-bottom me-1"></i> Add</button>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div>
...
<script src="/static/js/pages/api-key.init.js"></script>
%end