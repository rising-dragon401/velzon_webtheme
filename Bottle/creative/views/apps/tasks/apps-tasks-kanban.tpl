                        ...
                        <div class="tasks-list">
                            <div class="d-flex mb-3">
                                <div class="flex-grow-1">
                                    <h6 class="fs-14 text-uppercase fw-bold mb-0">Unassigned <small class="badge bg-success align-bottom ms-1 totaltask-badge">2</small></h6>
                                </div>
                                ...
                                <div id="unassigned-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
 												<h6 class="fs-16 mb-0 flex-grow-1 text-truncate task-title"><a href="/tasks/details" class="d-block">Profile Page Structure</a></h6>
                                                <div class="dropdown">
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <div class="flex-grow-1">
                                               <h6 class="fs-16 mb-0 text-truncate task-title"><a href="/tasks/details" class="d-block text-body">Velzon - Admin Layout Design</a></h6>
                                                </div>
                                                <div class="flex-shrink-0">
                                ...
                                <div id="inprogress-task" class="tasks">
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 text-truncate task-title"><a href="/tasks/details" class="text-body d-block">Change Old App Icon</a></h6>
                                ...
                                <div id="reviews-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 text-truncate task-title"><a href="/tasks/details" class="text-body d-block">Create Product Animations</a></h6>
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 text-truncate task-title"><a href="/tasks/details" class="text-body d-block">Product Features Analysis</a></h6>
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-15 text-truncate task-title"><a href="/tasks/details" class="d-block">Create a Graph of Sketch</a></h6>
                                ...
                                <div id="new-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 text-truncate task-title"><a href="/tasks/details" class="text-body d-block">Banner Design for FB & Twitter</a></h6>
