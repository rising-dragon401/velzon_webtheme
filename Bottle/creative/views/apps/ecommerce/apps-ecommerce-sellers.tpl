                ...
                <!-- start page title -->
                            ...
                            <div class="row g-2">
                                <div class="col-xl-3">
                                    <div class="search-box"> 
                                        <input type="text" class="form-control search" id="searchResultList" placeholder="Search for sellers & owner name or something..."> <i class="ri-search-line search-icon"></i>
                                    </div>
                                </div>
                                <!--end col-->
                    ...
                    <div class="row mt-4">
                        <div class="col-xl-3 col-lg-6">
                            <div class="card ribbon-box right overflow-hidden">
                                <div class="card-body text-center p-4">
                                    ...
                                    <img src="/static/images/companies/img-1.png" alt="" height="45">
                                    <h5 class="mb-1 mt-4"><a href="/ecommerce/sellers-details" class="link-primary">Force Medicines</a></h5>
                                    ...
                                    <div class="mt-4">
                                        <a href="/ecommerce/sellers-details" class="btn btn-light w-100">View Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-lg-6">
                            <div class="card">
                                <div class="card-body text-center p-4">
                                    <img src="/static/images/companies/img-2.png" alt="" height="45">
                                    <h5 class="mb-1 mt-4"><a href="/ecommerce/sellers-details" class="link-primary">Micro Design</a></h5>
                        ...
                        <div class="col-xl-3 col-lg-6">
                            <div class="card">
                                <div class="card-body text-center p-4">
                                    <img src="/static/images/companies/img-3.png" alt="" height="45">
                                    <h5 class="mb-1 mt-4"><a href="/ecommerce/sellers-details" class="link-primary">Nesta Technologies</a></h5>
                        ...
                        <div class="col-xl-3 col-lg-6">
                            <div class="card ribbon-box right overflow-hidden">
                                <div class="card-body text-center p-4">
                                    <div class="ribbon ribbon-info ribbon-shape trending-ribbon"><i class="ri-flashlight-fill text-white align-bottom"></i> <span class="trending-ribbon-text">Trending</span></div>
                                    <img src="/static/images/companies/img-4.png" alt="" height="45">
                                    <h5 class="mb-1 mt-4"><a href="/ecommerce/sellers-details" class="link-primary">iTest Factory</a></h5>
                        ...
                        <div class="col-xl-3 col-lg-6">
                            <div class="card">
                                <div class="card-body text-center p-4">
                                    <img src="/static/images/companies/img-5.png" alt="" height="45">
                                    <h5 class="mb-1 mt-4"><a href="/ecommerce/sellers-details" class="link-primary">Meta4Systems</a></h5>
                        ...
                        <div class="col-xl-3 col-lg-6">
                            <div class="card ribbon-box right overflow-hidden">
                                <div class="card-body text-center p-4">
                                    <div class="ribbon ribbon-info ribbon-shape trending-ribbon"><i class="ri-flashlight-fill text-white align-bottom"></i> <span class="trending-ribbon-text">Trending</span></div>
                                    <img src="/static/images/companies/img-6.png" alt="" height="45">
                                    <h5 class="mb-1 mt-4"><a href="/ecommerce/sellers-details" class="link-primary">Digitech Galaxy</a></h5>
                        ...
                        <div class="col-xl-3 col-lg-6">
                            <div class="card ribbon-box right overflow-hidden">
                                <div class="card-body text-center p-4">
                                    <div class="ribbon ribbon-info ribbon-shape trending-ribbon"><i class="ri-flashlight-fill text-white align-bottom"></i> <span class="trending-ribbon-text">Trending</span></div>
                                    <img src="/static/images/companies/img-7.png" alt="" height="45">
                                    <h5 class="mb-1 mt-4"><a href="/ecommerce/sellers-details" class="link-primary">Syntyce Solutions</a></h5>
                        ...
                        <div class="col-xl-3 col-lg-6">
                            <div class="card">
                                <div class="card-body text-center p-4">
                                    <img src="/static/images/companies/img-8.png" alt="" height="45">
                                    <h5 class="mb-1 mt-4"><a href="/ecommerce/sellers-details" class="link-primary">Zoetic Fashion</a></h5>
...
%def extra_js():
    ...
    <!-- sellers init js -->
    <script src="/static/js/pages/sellers.init.js"></script>
%end