                        ...
                        <div class="col-xl-8">
                            <div class="row align-items-center gy-3 mb-3">
                                ...
                                <div class="col-sm-auto">
                                    <a href="/ecommerce/products" class="link-primary text-decoration-underline">Continue Shopping</a>
                                </div>
                            </div>
                            ...
                            <div class="card product">
                                <div class="card-body">
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-sm">
                                            <h5 class="fs-14 text-truncate"><a href="/ecommerce/products-details" class="text-body">Sweatshirt for Men (Pink)</a></h5>
                                    ...
                                    <div class="row align-items-center gy-3">
                                        ...
                                        <div class="col-sm-auto">
                                            <div class="d-flex align-items-center gap-2 text-muted">
                                                <div>Total :</div>
                                                <h5 class="fs-15 mb-0">$<span class="product-line-price">239.98</span></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card product">
                                <div class="card-body">
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-sm">
                                            <h5 class="fs-14 text-truncate"><a href="/ecommerce/products-details" class="text-body">Noise NoiseFit Endure Smart Watch</a></h5>
                                ...
                                <div class="card-footer">
                                    <div class="row align-items-center gy-3">
                                        ...
                                        <div class="col-sm-auto">
                                            <div class="d-flex align-items-center gap-2 text-muted">
                                                <div>Total :</div>
                                                <h5 class="fs-15 mb-0">$<span class="product-line-price">94.99</span></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card product">
                                <div class="card-body">
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-sm">
                                            <h5 class="fs-14 text-truncate"><a href="/ecommerce/products-details" class="text-body">350 ml Glass Grocery Container</a></h5>
                                ...
                                <div class="card-footer">
                                    <div class="row align-items-center gy-3">
                                        ...
                                        <div class="col-sm-auto">
                                            <div class="d-flex align-items-center gap-2 text-muted">
                                                <div>Total :</div>
                                                <h5 class="fs-15 mb-0">$<span class="product-line-price">24.99</span></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="text-end mb-4">
                                <a href="/ecommerce/checkout" class="btn btn-success btn-label right ms-auto"><i class="ri-arrow-right-line label-icon align-bottom fs-16 ms-2"></i> Checkout</a>
                            </div>
                        </div>
                        <!-- end col -->
