                                ...
                                <div class="card job-list-view-card overflow-hidden" id="job-overview">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="py-3 border border-dashed border-start-0 border-end-0 mt-4">
                                                <div class="row">
                                                    <div class="col-lg-4 col-sm-6">
                                                        <div>
                                                            <p class="mb-2 text-uppercase fw-semibold fs-12 text-muted">Job Type</p>
                                                            <h5 class="fs-14 mb-0 view-type">Full Time</h5>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-sm-6">
                                                        <div>
                                                            <p class="mb-2 text-uppercase fw-semibold fs-12 text-muted">Post Date</p>
                                                            <h5 class="fs-14 mb-0 view-postdate">15 Sep, 2022</h5>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-sm-6">
                                                        <div>
                                                            <p class="mb-2 text-uppercase fw-semibold fs-12 text-muted">Experience</p>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <div>
                                                <div id="simple_dount_chart" data-colors='["--vz-success", "--vz-primary", "--vz-danger", "--vz-danger", "--vz-info"]' class="apex-charts" dir="ltr"></div>
                                            </div>
                                        </div>
                                        <div class="mt-4">
                                            <button type="button" class="btn btn-info w-100">Apply Now</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="px-1 pt-1">
                                                <div class="modal-team-cover position-relative mb-0 mt-n4 mx-n4 rounded-top overflow-hidden">
                                                    <img src="/static/images/small/img-9.jpg" alt="" id="modal-cover-img" class="img-fluid">
                                            ...
                                            <div class="text-center mb-4 mt-n5 pt-2">
                                                <div class="position-relative d-inline-block">
                                                    ...
                                                    <div class="avatar-lg p-1">
                                                        <div class="avatar-title bg-light rounded-circle">
                                                            <img src="/static/images/users/multi-user.jpg" id="companylogo-img" class="avatar-md rounded-circle object-fit-cover" />
                                                        </div>
                                                    </div>
                                                </div>
