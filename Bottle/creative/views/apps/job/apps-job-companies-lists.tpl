                                ...
                                <div class="card" id="company-overview">
                                    <div class="card-body">
                                        <div class="avatar-lg mx-auto mb-3">
                                            <div class="avatar-title bg-light rounded">
                                                <img src="/static/images/companies/img-6.png" alt="" class="avatar-sm company-logo">
                                            </div>
                                        </div>
                                        ...
                                        <div class="text-center">
                                            ...
                                            <ul class="list-inline mb-0">
                                                <li class="list-inline-item avatar-xs">
                                                    <a href="javascript:void(0);" class="avatar-title bg-body text-body fs-15 rounded">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="hstack gap-3">
                                            <button type="button" class="btn btn-soft-primary custom-toggle w-100" data-bs-toggle="button">
...
<script src="/static/js/pages/job-companies-lists.init.js"></script> 
%end