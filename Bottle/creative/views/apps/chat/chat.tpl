                                                            ...
                                                            <div class="flex-grow-1 overflow-hidden">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="flex-grow-1 overflow-hidden">
                                                                        ...
                                                                        <p class="text-truncate text-muted mb-0 userStatus"><small>Online</small></p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
...
%def extra_js():
    ...
    <!-- fgEmojiPicker js -->
    <script src="/static/libs/fg-emoji-picker/fgEmojiPicker.js"></script>

    <!-- chat init js -->
    <script src="/static/js/pages/chat.init.js"></script>
