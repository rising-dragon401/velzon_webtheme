                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card card-height-100">
                                <div class="card-body">
                                    ...
                                    <a href="#!" class="btn btn-soft-secondary d-block">Add to Cart</a>
                                    ...
                                    <div class="notification-elem" id="notification-overlay">
                                        <div class="text-center">
                                            ...
                                            <div class="mt-4 pt-2">
                                                ...
                                                <div>
                                                    <button type="button" class="btn btn-danger btn-sm w-sm" id="back-btn">Back to Home</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="card-body text-center">
                                            ...
                                            <div>
                                                <button type="button" class="btn btn-danger rounded-pill w-sm"><i class="ri-add-fill me-1 align-bottom"></i> Follow</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
