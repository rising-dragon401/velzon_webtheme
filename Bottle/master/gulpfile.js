...
gulp.task('watch', async function () {
    gulp.watch([paths.src.scss.files, '!' + paths.src.custom.files, '!' + paths.src.icon.files], gulp.series('scss'));
