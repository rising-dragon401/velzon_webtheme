                                        ...
                                        <div class="content">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="/static/images/users/avatar-5.jpg" alt="" class="avatar-sm rounded material-shadow-none">
                                                </div>
                                    ...
                                    <div class="timeline-item left">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="avatar-group mb-2">
                                                <a href="javascript: void(0);" class="avatar-group-item material-shadow-none" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title="Christi">
                                                    <img src="/static/images/users/avatar-4.jpg" alt="" class="rounded-circle avatar-xs">
                                                </a>
                                                <a href="javascript: void(0);" class="avatar-group-item material-shadow-none" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title="Frank Hook">
                                                    <img src="/static/images/users/avatar-3.jpg" alt="" class="rounded-circle avatar-xs">
                                                </a>
                                                <a href="javascript: void(0);" class="avatar-group-item material-shadow-none" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title=" Ruby">
                                                    <div class="avatar-xs">
                                                ...
                                                <a href="javascript: void(0);" class="avatar-group-item material-shadow-none" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title="more">
                                                    <div class="avatar-xs">
                                    ...
                                    <div class="timeline-item left">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="row border border-dashed rounded gx-2 p-2">
                                                <div class="col-3">
                                                    <img src="/static/images/small/img-2.jpg" alt="" class="img-fluid rounded material-shadow-none">
                                                </div>
                                                <!--end col-->
                                                <div class="col-3">
                                                    <img src="/static/images/small/img-3.jpg" alt="" class="img-fluid rounded material-shadow-none">
                                                </div>
                                                <!--end col-->
                                                <div class="col-3">
                                                    <img src="/static/images/small/img-4.jpg" alt="" class="img-fluid rounded material-shadow-none">
                                                </div>
                                                <!--end col-->
                                                <div class="col-3">
                                                    <img src="/static/images/small/img-6.jpg" alt="" class="img-fluid rounded material-shadow-none">
                                                </div>
                                                <!--end col-->
                                            </div>
                                            <!--end row-->
                                            ...
                                            <div class="col-12">
                                                <div class="timeline-box material-shadow">
                                                    <div class="timeline-text">
                                                        <div class="d-flex">
                                                            <img src="/static/images/users/avatar-7.jpg" alt="" class="avatar-sm rounded" />
                                                            <div class="flex-grow-1 ms-3">
                                            ...
                                            <div class="col-12">
                                                <div class="timeline-box material-shadow">
                                                    <div class="timeline-text">
                                                        ...
                                                        <div class="row border border-dashed rounded gx-2 p-2">
                                                            <div class="col-3">
                                                                <a href="javascript:void(0);"><img src="/static/images/small/img-7.jpg" alt="" class="img-fluid rounded material-shadow"></a>
                                                            </div>
                                                            <!--end col-->
                                                            <div class="col-3">
                                                                <a href="javascript:void(0);"><img src="/static/images/small/img-3.jpg" alt="" class="img-fluid rounded material-shadow"></a>
                                                            </div>
                                                            <!--end col-->
                                                            <div class="col-3">
                                                                <a href="javascript:void(0);"><img src="/static/images/small/img-10.jpg" alt="" class="img-fluid rounded material-shadow"></a>
                                                            </div>
                                                            <!--end col-->
                                                            <div class="col-3">
                                                                <a href="javascript:void(0);"><img src="/static/images/small/img-9.jpg" alt="" class="img-fluid rounded material-shadow"></a>
                                                            </div>
                                                            <!--end col-->
                                                        </div>
                                                    </div>
...
%def extra_js():
    ...
    <script src="/static/js/pages/timeline.init.js"></script>
%end