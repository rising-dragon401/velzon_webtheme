                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4 card-bg-fill">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="user-thumb text-center">
                                    <img src="/static/images/users/avatar-1.jpg" class="rounded-circle img-thumbnail avatar-lg material-shadow" alt="thumbnail">
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">Not you ? return <a href="/pages/auth-signin-basic" class="fw-semibold text-primary text-decoration-underline"> Signin </a> </p>
                        </div>
