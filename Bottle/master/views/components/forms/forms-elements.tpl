                                        ...
                                        <div class="row gy-4">
                                            ...
                                            <div class="col-xxl-3 col-md-6">
                                                <div>
                                                    ...
                                                    <input type="color" class="form-control form-control-color w-100" value="#364574">
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-xxl-3 col-md-6">
                                    ...
                                    <div class="live-preview">
                                        <div>
                                            ...
                                            <div class="row g-3">
                                                <div class="col-lg-6">
                                                    <div class="input-group">
                                                        <button class="btn btn-primary  material-shadow-none dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">Dropdown</button>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" aria-label="Text input with dropdown button">
                                                        <button class="btn btn-success  material-shadow-none dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">Dropdown</button>
