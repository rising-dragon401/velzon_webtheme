                                                    ...
                                                    <div class="col-md-auto">
                                                        <div class="avatar-md">
                                                            <div class="avatar-title bg-white rounded-circle">
                                                                <img src="/static/images/brands/slack.png" alt="" class="avatar-xs">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="text-muted">
                                                        ...
                                                        <div>
                                                            <button type="button" class="btn btn-link link-success p-0 material-shadow-none">Read more</button>
                                                        </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div data-simplebar style="height: 300px;" class="px-3 mx-n3 mb-2">
                                                        <div class="d-flex mb-4">
                                                            <div class="flex-shrink-0">
                                                                <img src="/static/images/users/avatar-8.jpg" alt="" class="avatar-xs rounded-circle material-shadow" />
                                                            </div>
                                                    ...
                                                    <form class="mt-4">
                                                        <div class="row g-3">
                                                            ...
                                                            <div class="col-12 text-end">
                                                                <button type="button" class="btn btn-ghost-secondary btn-icon waves-effect me-1 material-shadow-none"><i class="ri-attachment-line fs-16"></i></button>
                                        ...
                                        <div class="col-xl-3 col-lg-4">
                                            ...
                                            <div class="card">
                                                <div class="card-header align-items-center d-flex border-bottom-dashed">
                                                    ...
                                                    <div class="flex-shrink-0">
                                                        <button type="button" class="btn btn-soft-danger btn-sm material-shadow-none" data-bs-toggle="modal" data-bs-target="#inviteMembersModal"><i class="ri-share-line me-1 align-bottom"></i> Invite Member</button>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="flex-shrink-0">
                                                                    <div class="d-flex align-items-center gap-1">
                                                                        <button type="button" class="btn btn-light btn-sm material-shadow-none">Message</button>
                                                                        <div class="dropdown">
                                                    ...
                                                    <div class="col-lg-4 col">
                                                        <div class="team-profile-img">
                                                            <div class="avatar-lg img-thumbnail rounded-circle">
                                                                <img src="/static/images/users/avatar-2.jpg" alt="" class="img-fluid d-block rounded-circle" />
                                                            </div>
                                            ...
                                            <div class="card-body px-4">
                                                <div class="row align-items-center team-row">
                                                    ...
                                                    <div class="col-lg-4 col">
                                                        <div class="team-profile-img">
                                                            <div class="avatar-lg img-thumbnail rounded-circle">
                                                                <img src="/static/images/users/avatar-3.jpg" alt="" class="img-fluid d-block rounded-circle" />
                                                            </div>
                                                            <div class="team-content">
                                                                <a href="#" class="d-block">
                                            ...
                                            <div class="card-body px-4">
                                                <div class="row align-items-center team-row">
                                                    ...
                                                    <div class="col-lg-4 col">
                                                        <div class="team-profile-img">
                                                            <div class="avatar-lg img-thumbnail rounded-circle">
                                                                <img src="/static/images/users/avatar-8.jpg" alt="" class="img-fluid d-block rounded-circle" />
                                                            </div>
                                                            <div class="team-content">
                                                                <a href="#" class="d-block">
                                            ...
                                            <div class="card-body px-4">
                                                <div class="row align-items-center team-row">
                                                    ...
                                                    <div class="col-lg-4 col">
                                                        <div class="team-profile-img">
                                                            <div class="avatar-lg img-thumbnail rounded-circle">
                                                                <img src="/static/images/users/avatar-4.jpg" alt="" class="img-fluid d-block rounded-circle" />
                                                            </div>
                                                            <div class="team-content">
                                                                <a href="#" class="d-block">
                                            ...
                                            <div class="card-body px-4">
                                                <div class="row align-items-center team-row">
                                                    ...
                                                    <div class="col-lg-4 col">
                                                        <div class="team-profile-img">
                                                            <div class="avatar-lg img-thumbnail rounded-circle">
                                                                <img src="/static/images/users/avatar-7.jpg" alt="" class="img-fluid d-block rounded-circle" />
                                                            </div>
                                                            <div class="team-content">
                                                                <a href="#" class="d-block">
                                            ...
                                            <div class="card-body px-4">
                                                <div class="row align-items-center team-row">
                                                    ...
                                                    <div class="col-lg-4 col">
                                                        <div class="team-profile-img">
                                                            <div class="avatar-lg img-thumbnail rounded-circle">
                                                                <img src="/static/images/users/avatar-5.jpg" alt="" class="img-fluid d-block rounded-circle" />
                                                            </div>
                                                            <div class="team-content">
                                                                <a href="#" class="d-block">
                    ...
                    <div class="mx-n4 px-4" data-simplebar style="max-height: 225px;">
                        <div class="vstack gap-3">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-shrink-0">
                                    <button type="button" class="btn btn-light btn-sm material-shadow-none">Add</button>
                                </div>
                            </div>
                            <!-- end member item -->
                            <div class="d-flex align-items-center">
...
%def extra_js():
    <script src="/static/js/pages/project-overview.init.js"></script>
%end