                                ...
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    ...
                                    <tbody class="list form-check-all">
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/static/images/svg/crypto-icons/btc.svg" alt="" class="avatar-xxs me-2 material-show"> BTC
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/static/images/svg/crypto-icons/eth.svg" alt="" class="avatar-xxs me-2 material-show"> ETH
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/static/images/svg/crypto-icons/eur.svg" alt="" class="avatar-xxs me-2 material-show"> EUR
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/static/images/svg/crypto-icons/gbp.svg" alt="" class="avatar-xxs me-2 material-show"> GBP
                                                </div>
                                            </td>
                                            <td class="form_name">Wallet</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/static/images/svg/crypto-icons/jpy.svg" alt="" class="avatar-xxs me-2 material-show"> JPY
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/static/images/svg/crypto-icons/xrp.svg" alt="" class="avatar-xxs me-2 material-show"> XRP
                                                </div>
                                            </td>
                                            <td class="form_name">Wallet</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/static/images/svg/crypto-icons/ltc.svg" alt="" class="avatar-xxs me-2 material-show"> LTC
                                                </div>
                                            </td>
                                            <td class="form_name">Tonya Noble</td>
                                            <td class="to_name">Wallet</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/static/images/svg/crypto-icons/xmr.svg" alt="" class="avatar-xxs me-2 material-show"> XMR
                                                </div>
                                            </td>
                                            <td class="form_name">Wallet</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/static/images/svg/crypto-icons/xpm.svg" alt="" class="avatar-xxs me-2 material-show"> XPM
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/static/images/svg/crypto-icons/ppt.svg" alt="" class="avatar-xxs me-2 material-show"> PPT
                                                </div>
                                            </td>
