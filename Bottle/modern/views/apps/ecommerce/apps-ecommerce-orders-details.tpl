                                ...
                                <div class="card-header">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-shrink-0">
                                            <a href="/invoices/details" class="btn btn-secondary btn-sm"><i class="ri-download-2-fill align-middle me-1"></i> Invoice</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                <h5 class="fs-16"><a href="/ecommerce/products-details" class="link-primary">Noise NoiseFit Endure Smart Watch</a></h5>
