                                            ...
                                            <table class="table table-nowrap align-middle" id="orderTable">
                                                ...
                                                <tbody class="list form-check-all">
                                                    <tr>
                                                        ...
                                                        <td class="id"><a href="/ecommerce/orders-details" class="fw-medium link-primary">#VZ2101</a></td>
                                                        ...
                                                        <td>
                                                            <ul class="list-inline hstack gap-2 mb-0">
                                                                <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                                                    ...
                                                                    <a href="/ecommerce/orders-details" class="text-primary d-inline-block">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-control" data-trigger
                                                                name="productname-field" id="productname-field" required>
                                                        ...
                                                        <div>
                                                            <label for="delivered-status" class="form-label">Delivery
                                                                Status</label>
                                                            <select class="form-control" data-trigger
                                                                name="delivered-status" id="delivered-status" required>
