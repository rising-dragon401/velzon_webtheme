                                            ...
                                            <div class="p-3">
                                                ...
                                                <div class="mt-3 pt-2">
                                                    <div class="d-flex mb-2">
                                                        <div class="flex-grow-1">
                                                            <p class="mb-0">Transaction Fees<span class="text-muted ms-1 fs-11">(0.05%)</span></p>
                                                        </div>
                                                    ...
                                                    <div class="d-flex mb-2">
                                                        <div class="flex-grow-1">
                                                            <p class="mb-0">Minimum Received<span class="text-muted ms-1 fs-11">(2%)</span></p>
                                                        </div>
                                                        <div class="flex-shrink-0">
                                ...
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    ...
                                    <tbody class="list form-check-all">
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center fw-medium">
                                                    <img src="/static/images/svg/crypto-icons/dot.svg" alt="" class="avatar-xxs me-2">
...
%def extra_js():
    ...
    <script src="/static/js/pages/crypto-buy-sell.init.js"></script>
