                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        ...
                                                        <p class="text-success fw-medium mb-0">+0.63%<span class="text-muted ms-2 fs-10">(BTC)</span></p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        ...
                                                        <p class="text-danger fw-medium mb-0">-3.42%<span class="text-muted ms-2 fs-10">(LTC)</span></p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        ...
                                                        <p class="text-danger fw-medium mb-0">+0.42%<span class="text-muted ms-2 fs-10">(ETH)</span></p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
