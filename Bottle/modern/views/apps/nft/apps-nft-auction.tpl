                        ...
                        <div class="col-xxl-9">
                            ...
                            <div class="row">
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                                    <div class="card explore-box card-animate">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 mb-3"><a href="/nft/item-details" class="text-body">Abstract Face Painting</a></h6>
                                            <div>
                                ...
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-30">
                                    <div class="card explore-box card-animate">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 mb-3"><a href="/nft/item-details" class="text-body">Patterns Arts & Culture</a></h6>
                                            <div>
                                ...
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-40">
                                    <div class="card explore-box card-animate">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 mb-3"><a href="/nft/item-details" class="text-body">Creative Filtered Portrait</a></h6>
                                            <div>
                                ...
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                                    <div class="card explore-box card-animate">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 mb-3"><a href="/nft/item-details" class="text-body">Smillevers Crypto</a></h6>
                                            <div>
                                ...
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-40">
                                    <div class="card explore-box card-animate">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h5 class="text-success"><i class="mdi mdi-ethereum"></i> 245.23ETH </h5>
                                            <h6 class="fs-16 mb-3"><a href="/nft/item-details" class="text-body">Long-tailed Macaque</a></h6>
                                            <div>
                                ...
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                                    <div class="card explore-box card-animate">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 mb-3"><a href="/nft/item-details" class="text-body">The Chirstoper</a></h6>
                                            <div>
                                ...
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-30">
                                    <div class="card explore-box card-animate">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 mb-3"><a href="/nft/item-details" class="text-body">Robotic Body Art</a></h6>
                                            <div>
                                ...
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                                    <div class="card explore-box card-animate">
                                        <div class="position-relative rounded overflow-hidden">
                                            <img src="https://dl.dropboxusercontent.com/s/btp4y39rjs3iopw/img-4.gif" alt="" class="card-img-top explore-img">
                                            <div class="discount-time">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h5 class="text-success"><i class="mdi mdi-ethereum"></i> 245.23ETH </h5>
                                            <h6 class="fs-16 mb-3"><a href="/nft/item-details" class="text-body">Evolved Reality</a></h6>
                                            <div>
                                        ...
                                        <table class="table table-borderless align-middle">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="/static/images/nft/img-03.jpg" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                                            <div class="ms-2">
                                                                <a href="/nft/item-details"><h6 class="fs-15 mb-1">Creative filtered portrait</h6></a>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <a href="/nft/item-details"><h6 class="fs-15 mb-1">Patterns arts & culture</h6></a>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <a href="/nft/item-details"><h6 class="fs-15 mb-1">Evolved Reality</h6></a>
                                                                <p class="mb-0 text-muted">Sold at 34.81 ETH</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="/static/images/nft/img-04.jpg" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                                            <div class="ms-2">
                                                                <a href="/nft/item-details"><h6 class="fs-15 mb-1">Smillevers Crypto</h6></a>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="/static/images/nft/img-05.jpg" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                                            <div class="ms-2">
                                                                <a href="/nft/item-details"><h6 class="fs-15 mb-1">Robotic Body Art</h6></a>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="/static/images/nft/img-02.jpg" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                                            <div class="ms-2">
                                                                <a href="/nft/item-details"><h6 class="fs-15 mb-1">Trendy fashion portraits</h6></a>
                                        ...
                                        <table class="table table-borderless align-middle">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="/static/images/users/avatar-1.jpg" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                                            <div class="ms-2">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                        <img src="/static/images/users/avatar-3.jpg" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                                            <div class="ms-2">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="/static/images/users/avatar-5.jpg" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                                            <div class="ms-2">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="/static/images/users/avatar-10.jpg" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                                            <div class="ms-2">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="/static/images/users/avatar-8.jpg" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                                            <div class="ms-2">
...
%def extra_js():
 <script src="/static/js/pages/apps-nft-auction.init.js"></script>
