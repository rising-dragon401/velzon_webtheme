                                    ...
                                    <div class="swiper-slide">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <img src="/static/images/svg/crypto-icons/btc.svg" class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                                                    <h6 class="ms-2 mb-0 fs-15">Bitcoin</h6>
                                                </div>
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        <h5 class="mb-1 mt-4">$46,335.40</h5>
                                                        <p class="text-success fs-14 mb-0">+0.63%<span class="text-muted ms-2 fs-12">(BTC)</span></p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <img src="/static/images/svg/crypto-icons/ltc.svg" class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                                                    <h6 class="ms-2 mb-0 fs-15">Litecoin</h6>
                                                </div>
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        <h5 class="mb-1 mt-4">$65.64</h5>
                                                        <p class="text-danger fs-14 mb-0">-3.42%<span class="text-muted ms-2 fs-12">(LTC)</span></p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <img src="/static/images/svg/crypto-icons/eth.svg" class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                                                    <h6 class="ms-2 mb-0 fs-15">Ethereum</h6>
                                                </div>
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        <h5 class="mb-1 mt-4">$3,748.66</h5>
                                                        <p class="text-danger fs-14 mb-0">+0.42%<span class="text-muted ms-2 fs-12">(ETH)</span></p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <img src="/static/images/svg/crypto-icons/xmr.svg" class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                                                    <h6 class="ms-2 mb-0 fs-15">Monero</h6>
                                                </div>
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        <h5 class="mb-1 mt-4">$226.55</h5>
                                                        <p class="text-danger fs-14 mb-0">-1.92%<span class="text-muted ms-2 fs-12">(XMR)</span></p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <img src="/static/images/svg/crypto-icons/dash.svg" class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                                                    <h6 class="ms-2 mb-0 fs-15">Dash</h6>
                                                </div>
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        <h5 class="mb-1 mt-4">$142.5</h5>
                                                        <p class="text-success fs-14 mb-0">+16.38%<span class="text-muted ms-2 fs-12">(DASH)</span></p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <img src="/static/images/svg/crypto-icons/mkr.svg" class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                                                    <h6 class="ms-2 mb-0 fs-15">Maker</h6>
                                                </div>
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        <h5 class="mb-1 mt-4">$2,390.75</h5>
                                                        <p class="text-success fs-14 mb-0">+0.36%<span class="text-muted ms-2 fs-12">(MKR)</span></p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <img src="/static/images/svg/crypto-icons/neo.svg" class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                                                    <h6 class="ms-2 mb-0 fs-15">Neo</h6>
                                                </div>
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        <h5 class="mb-1 mt-4">$2,145.65</h5>
                                                        <p class="text-success fs-14 mb-0">32.07%<span class="text-muted ms-2 fs-12">(NEO)</span></p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center fw-semibold">
                                                            <img src="/static/images/svg/crypto-icons/btc.svg" alt="" class="avatar-xxs me-2" />
                                                    ...
                                                    <td class="returns_per">
                                                        <h6 class="text-success fs-14 mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>0.63%</h6>
                                                    </td>
                                                </tr>
                                                <!--end tr-->
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center fw-semibold">
                                                            <img src="/static/images/svg/crypto-icons/eth.svg" alt="" class="avatar-xxs me-2" />
                                                    ...
                                                    <td class="returns_per">
                                                        <h6 class="text-danger fs-14 mb-0"><i class="mdi mdi-trending-down align-middle me-1"></i>3.42%</h6>
                                                    </td>
                                                </tr>
                                                <!--end tr-->
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center fw-semibold">
                                                            <img src="/static/images/svg/crypto-icons/xrp.svg" alt="" class="avatar-xxs me-2" />
                                                    ...
                                                    <td class="returns_per">
                                                        <h6 class="text-success fs-14 mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>1.20%</h6>
                                                    </td>
                                                </tr>
                                                <!--end tr-->
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center fw-semibold">
                                                            <img src="/static/images/svg/crypto-icons/xmr.svg" alt="" class="avatar-xxs me-2" />
                                                    ...
                                                    <td class="returns_per">
                                                        <h6 class="text-danger fs-14 mb-0"><i class="mdi mdi-trending-down align-middle me-1"></i>1.92%</h6>
                                                    </td>
                                                </tr>
                                                <!--end tr-->
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center fw-semibold">
                                                            <img src="/static/images/svg/crypto-icons/ltc.svg" alt="" class="avatar-xxs me-2" />
                                                    ...
                                                    <td class="returns_per">
                                                        <h6 class="text-danger fs-14 mb-0"><i class="mdi mdi-trending-down align-middle me-1"></i>0.87%</h6>
                                                    </td>
                                                </tr>
                                                <!--end tr-->
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center fw-semibold">
                                                            <img src="/static/images/svg/crypto-icons/aave.svg" alt="" class="avatar-xxs me-2" />
                                                    ...
                                                    <td class="returns_per">
                                                        <h6 class="text-success fs-14 mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>3.96%</h6>
                                                    </td>
                                                </tr>
                                                <!--end tr-->
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center fw-semibold">
                                                            <img src="/static/images/svg/crypto-icons/mkr.svg" alt="" class="avatar-xxs me-2" />
                                                    ...
                                                    <td class="returns_per">
                                                        <h6 class="text-success fs-14 mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>0.36%</h6>
                                                    </td>
                                                </tr>
                                                <!--end tr-->
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center fw-semibold">
                                                            <img src="/static/images/svg/crypto-icons/yfi.svg" alt="" class="avatar-xxs me-2" />
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="d-flex mb-3">
                                        <div class="flex-shrink-0">
                                            <img src="/static/images/svg/crypto-icons/btc.svg" alt="" class="avatar-xxs" />
                                        </div>
                                    ...
                                    <div class="d-flex mb-3">
                                        <div class="flex-shrink-0">
                                            <img src="/static/images/svg/crypto-icons/ltc.svg" alt="" class="avatar-xxs" />
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="d-flex mb-3">
                                        <div class="flex-shrink-0">
                                            <img src="/static/images/svg/crypto-icons/xmr.svg" alt="" class="avatar-xxs" />
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="d-flex mb-3">
                                        <div class="flex-shrink-0">
                                            <img src="/static/images/svg/crypto-icons/fil.svg" alt="" class="avatar-xxs" />
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="d-flex mb-3">
                                        <div class="flex-shrink-0">
                                            <img src="/static/images/svg/crypto-icons/dot.svg" alt="" class="avatar-xxs" />
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                    ...
                                    <div>
                                        <a href="/crypto/wallet" class="btn btn-soft-info w-100">View All Transactions <i class="ri-arrow-right-line align-bottom"></i></a>
                                    </div>
                                </div>
                            </div>
                            <!--end card-->
...
%def extra_js():
    ...
    <!-- crypto-wallet init-->
    <script src="/static/js/pages/crypto-wallet.init.js"></script>
%end