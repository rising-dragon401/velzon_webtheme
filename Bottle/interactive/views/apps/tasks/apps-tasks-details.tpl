                            ...
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <div class="hstack gap-2 justify-content-center">
                                        <button class="btn btn-info btn-sm"><i class="ri-stop-circle-line align-bottom me-1"></i> Stop</button>
                                        <button class="btn btn-info btn-sm"><i class="ri-play-circle-line align-bottom me-1"></i> Start</button>
                                    </div>
                                </div>
                            </div>
                            <!--end card-->
                                    ...
                                    <div class="vstack gap-2">
                                        <div class="border rounded border-dashed p-2">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <h5 class="fs-14 mb-1"><a href="javascript:void(0);" class="text-body text-truncate d-block">App pages.zip</a></h5>
                                        ...
                                        <div class="border rounded border-dashed p-2">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <h5 class="fs-14 mb-1"><a href="javascript:void(0);" class="text-body text-truncate d-block">Velzon admin.ppt</a></h5>
                                        ...
                                        <div class="border rounded border-dashed p-2">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <h5 class="fs-14 mb-1"><a href="javascript:void(0);" class="text-body text-truncate d-block">Images.zip</a></h5>
                                            ...
                                            <div data-simplebar style="height: 508px;" class="px-3 mx-n3 mb-2">
                                                <div class="d-flex mb-4">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <h5 class="fs-14"><a href="/pages/profile" class="text-body">Joseph Parker</a> <small class="text-muted">20 Dec 2021 - 05:47AM</small></h5>
                                                        ...
                                                        <div class="d-flex mt-4">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                <h5 class="fs-14"><a href="/pages/profile" class="text-body">Tonya Noble</a> <small class="text-muted">22 Dec 2021 - 02:32PM</small></h5>
                                                ...
                                                <div class="d-flex mb-4">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <h5 class="fs-14"><a href="/pages/profile" class="text-body">Thomas Taylor</a> <small class="text-muted">24 Dec 2021 - 05:20PM</small></h5>
                                                        <p class="text-muted">If you have further questions, please contact Customer Support from the “Action Menu” on your <a href="javascript:void(0);" class="text-decoration-underline link-info">Online Order Support</a>.</p>
                                                        <a href="javascript: void(0);" class="badge text-muted bg-light"><i class="mdi mdi-reply"></i> Reply</a>
                                                    </div>
                                                </div>
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <h5 class="fs-14"><a href="/pages/profile" class="text-body">Tonya Noble</a> <small class="text-muted">26 min ago</small></h5>
                                                        ...
                                                        <div class="d-flex mt-4">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                <h5 class="fs-14"><a href="/pages/profile" class="text-body">Nancy Martino</a> <small class="text-muted">8 sec ago</small></h5>
                                            ...
                                            <form class="mt-4">
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-12 text-end">
                                                        <button type="button" class="btn btn-ghost-info btn-icon waves-effect me-1"><i class="ri-attachment-line fs-16"></i></button>
