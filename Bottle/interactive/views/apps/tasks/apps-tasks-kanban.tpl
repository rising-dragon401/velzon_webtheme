                                ...
                                <div class="col-auto ms-sm-auto">
                                    <div class="avatar-group" id="newMembar">
                                        <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Nancy">
                                            <img src="/static/images/users/avatar-5.jpg" alt="" class="rounded-circle avatar-xs">
                                        </a>
                                        <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Frank">
                                            <img src="/static/images/users/avatar-3.jpg" alt="" class="rounded-circle avatar-xs">
                                        </a>
                                        ...
                                        <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Thomas">
                                            <img src="/static/images/users/avatar-8.jpg" alt="" class="rounded-circle avatar-xs">
                                        </a>
                                        <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Herbert">
                                            <img src="/static/images/users/avatar-2.jpg" alt="" class="rounded-circle avatar-xs">
                                        </a>
                                ...
                                <div class="flex-shrink-0">
                                    <div class="dropdown card-header-dropdown">
                                        <a class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <span class="fw-semibold text-muted fs-14">Priority<i class="mdi mdi-chevron-down ms-1"></i></span>
                                        </a>
                                ...
                                <div id="unassigned-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
 												<h6 class="fs-16 mb-0 flex-grow-1 text-truncate task-title"><a href="/tasks/details" class="text-body d-block">Profile Page Structure</a></h6>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                        <li><a class="dropdown-item" href="/tasks/details"><i class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a></li>
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <div class="flex-grow-1">
                                               <h6 class="fs-16 mb-0 text-truncate task-title"><a href="/tasks/details" class="d-block">Velzon - Admin Layout Design</a></h6>
                                                </div>
                                                <div class="flex-shrink-0">
                                ...
                                <div id="todo-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <div class="flex-grow-1">
                                                    <h6 class="fs-16 mb-0 text-truncate task-title"><a href="/tasks/details" class="text-body d-block">Admin Layout Design</a></h6>
                                                </div>
                                                <div class="flex-shrink-0">
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <div class="flex-grow-1">
                                                <h6 class="fs-16 mb-0 text-truncate task-title"><a href="/tasks/details" class="text-body d-block">Marketing & Sales</a></h6>
                                                </div>
                                                <div class="flex-shrink-0">
                            ...
                            <div data-simplebar class="tasks-wrapper px-3 mx-n3">
                                <div id="inprogress-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <a href="javascript:void(0)" class="text-muted fw-semibold fs-14 flex-grow-1">#VL2457</a>
                                                <div class="dropdown">
                                            ...
                                            <h6 class="fs-16 text-truncate task-title"><a href="/tasks/details" class="text-body d-block">Brand Logo Design</a></h6>
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <a href="javascript:void(0)" class="text-muted fw-semibold fs-14 flex-grow-1">#VL2743</a>
                                                <div class="dropdown">
                                            ...
                                            <h6 class="fs-15 text-truncate task-title"><a href="/tasks/details" class="text-body d-block">Change Old App Icon</a></h6>
                            ...
                            <div data-simplebar class="tasks-wrapper px-3 mx-n3">
                                <div id="reviews-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <a href="javascript:void(0)" class="text-muted fw-semibold fs-14 flex-grow-1">#VL2453</a>
                                                <div class="dropdown">
                                            ...
                                            <h6 class="fs-15 text-truncate task-title"><a href="/tasks/details" class="text-body d-block">Create Product Animations</a></h6>
                                            <div class="tasks-img rounded" style="background-image: url('/static/images/small/img-7.jpg');"></div>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-grow-1">
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <a href="javascript:void(0)" class="text-muted fw-semibold fs-14 flex-grow-1">#VL2340</a>
                                                <div class="dropdown">
                                            ...
                                            <h6 class="fs-15 text-truncate task-title"><a href="/tasks/details" class="text-body d-block">Product Features Analysis</a></h6>
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <a href="javascript:void(0)" class="text-muted fw-semibold fs-14 flex-grow-1">#VL2462</a>
                                                <div class="dropdown">
                                            ...
                                            <h6 class="fs-16 text-truncate task-title"><a href="/tasks/details" class="text-body d-block">Create a Graph of Sketch</a></h6>
                            ...
                            <div data-simplebar class="tasks-wrapper px-3 mx-n3">
                                <div id="completed-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <h6 class="fs-16 mb-0 flex-grow-1 text-truncate task-title"><a href="/tasks/details" class="text-body d-block">Create a Blog Template UI</a></h6>
                                                <div class="dropdown">
                            ...
                            <div data-simplebar class="tasks-wrapper px-3 mx-n3">
                                <div id="new-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <a href="javascript:void(0)" class="text-muted fw-semibold fs-14 flex-grow-1">#VL5287</a>
                                                <div class="dropdown">
                                            ...
                                            <h6 class="fs-15 text-truncate task-title"><a href="/tasks/details" class="text-body d-block">Banner Design for FB & Twitter</a></h6>
                                            <div class="tasks-img rounded" style="background-image: url('/static/images/small/img-4.jpg');"></div>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-grow-1">
                                                    <span class="badge bg-primary-subtle text-primary">UI/UX</span>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mt-4">
                                                <div class="hstack gap-2 justify-content-end">
                                                    ...
                                                    <button type="button" class="btn btn-primary" id="addNewBoard">Add Board</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                                            ...
                                                            <div class="form-check d-flex align-items-center">
                                                                ...
                                                                <label class="form-check-label d-flex align-items-center" for="anna-adame">
                                                                    <span class="flex-shrink-0">
                                                                        <img src="/static/images/users/avatar-1.jpg" alt="" class="avatar-xxs rounded-circle" />
                                                                    </span>
                                                        ...
                                                        <li>
                                                            <div class="form-check d-flex align-items-center">
                                                                ...
                                                                <label class="form-check-label d-flex align-items-center" for="frank-hook">
                                                                    <span class="flex-shrink-0">
                                                                        <img src="/static/images/users/avatar-3.jpg" alt="" class="avatar-xxs rounded-circle" />
                                                                    </span>
                                                                    <span class="flex-grow-1 ms-2">
                                                                        Frank Hook
                                                                    </span>
                                                        ...
                                                        <li>
                                                            <div class="form-check d-flex align-items-center">
                                                                ...
                                                                <label class="form-check-label d-flex align-items-center" for="alexis-clarke">
                                                                    <span class="flex-shrink-0">
                                                                        <img src="/static/images/users/avatar-6.jpg" alt="" class="avatar-xxs rounded-circle" />
                                                                    </span>
                                                                    <span class="flex-grow-1 ms-2">
                                                                        Alexis Clarke
                                                                    </span>
                                                        ...
                                                        <li>
                                                            <div class="form-check d-flex align-items-center">
                                                                ...
                                                                <label class="form-check-label d-flex align-items-center" for="herbert-stokes">
                                                                    <span class="flex-shrink-0">
                                                                        <img src="/static/images/users/avatar-2.jpg" alt="" class="avatar-xxs rounded-circle" />
                                                                    </span>
                                                                    <span class="flex-grow-1 ms-2">
                                                                        Herbert Stokes
                                                                    </span>
                                                        ...
                                                        <li>
                                                            <div class="form-check d-flex align-items-center">
                                                                ...
                                                                <label class="form-check-label d-flex align-items-center" for="michael-morris">
                                                                    <span class="flex-shrink-0">
                                                                        <img src="/static/images/users/avatar-7.jpg" alt="" class="avatar-xxs rounded-circle" />
                                                                    </span>
                                                                    <span class="flex-grow-1 ms-2">
                                                                        Michael Morris
                                                                    </span>
                                                        ...
                                                        <li>
                                                            <div class="form-check d-flex align-items-center">
                                                                ...
                                                                <label class="form-check-label d-flex align-items-center" for="nancy-martino">
                                                                    <span class="flex-shrink-0">
                                                                        <img src="/static/images/users/avatar-5.jpg" alt="" class="avatar-xxs rounded-circle" />
                                                                    </span>
                                                                    <span class="flex-grow-1 ms-2">
                                                                        Nancy Martino
                                                                    </span>
                                                        ...
                                                        <li>
                                                            <div class="form-check d-flex align-items-center">
                                                                ...
                                                                <label class="form-check-label d-flex align-items-center" for="thomas-taylor">
                                                                    <span class="flex-shrink-0">
                                                                        <img src="/static/images/users/avatar-8.jpg" alt="" class="avatar-xxs rounded-circle" />
                                                                    </span>
                                                                    <span class="flex-grow-1 ms-2">
                                                                        Thomas Taylor
                                                                    </span>
                                                        ...
                                                        <li>
                                                            <div class="form-check d-flex align-items-center">
                                                                ...
                                                                <label class="form-check-label d-flex align-items-center" for="tonya-noble">
                                                                    <span class="flex-shrink-0">
                                                                        <img src="/static/images/users/avatar-10.jpg" alt="" class="avatar-xxs rounded-circle" />
                                                                    </span>
                                                                    <span class="flex-grow-1 ms-2">
                                                                        Tonya Noble
                                                                    </span>
...
%def extra_js():
    ...
    <!--taks-kanban-->
    <script src="/static/js/pages/tasks-kanban.init.js"></script>
%end