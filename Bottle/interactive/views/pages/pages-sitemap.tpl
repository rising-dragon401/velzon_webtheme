                                            ...
                                            <div class="verti-sitemap">
                                                <ul class="list-unstyled mb-0">
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="first-list">
                                                            <div class="list-wrap">
                                                                <a href="javascript: void(0);" class="fw-semibold text-primary">Rachel Rose - HR</a>
                                                            </div>
                                                        </div>
                                                    </li>
                                                </ul>
                                            ...
                                            <div class="verti-sitemap">
                                                <ul class="list-unstyled mb-0">
                                                    ...
                                                    <li>
                                                        <div class="first-list">
                                                            <div class="list-wrap">
                                                                <a href="javascript: void(0);" class="fw-semibold text-primary"><i class="ri-airplay-line me-1 align-bottom"></i> Dashboards</a>
                                                            </div>
                                                            <ul class="second-list list-unstyled">
                                                                <li>
                                                        ...
                                                        <div class="first-list">
                                                            <div class="list-wrap">
                                                                <a href="javascript: void(0);" class="fw-semibold text-primary"><i class="ri-pencil-ruler-2-line me-1 align-bottom"></i> App Pages</a>
                                                            </div>
                                                            <ul class="second-list list-unstyled">
