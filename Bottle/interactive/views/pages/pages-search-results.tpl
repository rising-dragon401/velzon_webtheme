                                            ...
                                            <div class="row g-2">
                                                <div class="col">
                                                    <div class="position-relative mb-3">
                                                        ...
                                                        <a class="btn btn-link link-info btn-lg position-absolute end-0 top-0" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample"><i class="ri-mic-fill"></i></a>
                                                    </div>
                                                </div>
                                                <div class="col-auto">
                                                    ...
                                                    <div class="col-xl-4 col-lg-10">
                                                        <div class="row g-2">
                                                            <div class="col-md-3 col-sm-6">
                                                                <div>
                                                                    <a href="/static/images/small/img-1.jpg" class="image-popup d-block">
                                                                        <img src="/static/images/small/img-1.jpg" alt="" class="img-fluid d-block rounded" />
                                                                    </a>
                                                                </div>
                                                            </div>
                                                            <!--end col-->
                                                            <div class="col-md-3 col-sm-6">
                                                                <div>
                                                                    <a href="/static/images/small/img-3.jpg" class="image-popup d-block">
                                                                        <img src="/static/images/small/img-3.jpg" alt="" class="img-fluid d-block rounded" />
                                                                    </a>
                                                                </div>
                                                            </div>
                                                            <!--end col-->
                                                            <div class="col-md-3 col-sm-6">
                                                                <div>
                                                                    <a href="/static/images/small/img-4.jpg" class="image-popup d-block">
                                                                        <img src="/static/images/small/img-4.jpg" alt="" class="img-fluid d-block rounded" />
                                                                    </a>
                                                                </div>
                                                            </div>
                                                            <!--end col-->
                                                            <div class="col-md-3 col-sm-6">
                                                                <div class="search-more-results rounded">
                                                                    <a href="javascript:void(0);" onclick="myFunction()" class="d-block">
                                                                        <img src="/static/images/small/img-5.jpg" alt="" class="img-fluid d-block rounded" />
                                                        ...
                                                        <div class="swiper-wrapper">
                                                            <div class="swiper-slide">
                                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                                    <div class="flex-shrink-0">
                                                                        <img src="/static/images/small/img-12.jpg" alt="" width="65" class="rounded" />
                                                                    </div>
                                                            ...
                                                            <div class="swiper-slide">
                                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                                    <div class="flex-shrink-0">
                                                                        <img src="/static/images/small/img-11.jpg" alt="" width="65" class="rounded" />
                                                                    </div>
                                                                    <div class="flex-grow-1 ms-2">
                                                            ...
                                                            <div class="swiper-slide">
                                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                                    <div class="flex-shrink-0">
                                                                        <img src="/static/images/small/img-10.jpg" alt="" width="65" class="rounded" />
                                                                    </div>
                                                                    <div class="flex-grow-1 ms-2">
                                                            ...
                                                            <div class="swiper-slide">
                                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                                    <div class="flex-shrink-0">
                                                                        <img src="/static/images/small/img-9.jpg" alt="" width="65" class="rounded" />
                                                                    </div>
                                                                    <div class="flex-grow-1 ms-2">
                                                            ...
                                                            <div class="swiper-slide">
                                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                                    <div class="flex-shrink-0">
                                                                        <img src="/static/images/small/img-8.jpg" alt="" width="65" class="rounded" />
                                                                    </div>
                                                                    <div class="flex-grow-1 ms-2">
                                                            ...
                                                            <div class="swiper-slide">
                                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                                    <div class="flex-shrink-0">
                                                                        <img src="/static/images/small/img-7.jpg" alt="" width="65" class="rounded" />
                                                                    </div>
                                                                    <div class="flex-grow-1 ms-2">
                                                            ...
                                                            <div class="swiper-slide">
                                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                                    <div class="flex-shrink-0">
                                                                        <img src="/static/images/small/img-6.jpg" alt="" width="65" class="rounded" />
                                                                    </div>
                                                                    <div class="flex-grow-1 ms-2">
                                                                        <a href="javascript:void(0);" class="stretched-link fw-medium">Admin Panel</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="swiper-slide">
                                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                                    <div class="flex-shrink-0">
                                                                        <img src="/static/images/small/img-5.jpg" alt="" width="65" class="rounded" />
                                                                    </div>
                                                                    <div class="flex-grow-1 ms-2">
                                                            ...
                                                            <div class="swiper-slide">
                                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                                    <div class="flex-shrink-0">
                                                                        <img src="/static/images/small/img-3.jpg" alt="" width="65" class="rounded" />
                                                                    </div>
                                                                    <div class="flex-grow-1 ms-2">
                                            ...
                                            <div class="gallery-light">
                                                <div class="row">
                                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                                        <div class="gallery-box card">
                                                            <div class="gallery-container">
                                                                <a class="image-popup" href="/static/images/small/img-1.jpg" title="">
                                                                    <img class="gallery-img img-fluid mx-auto" src="/static/images/small/img-1.jpg" alt="" />
                                                    ...
                                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                                        <div class="gallery-box card">
                                                            <div class="gallery-container">
                                                                <a class="image-popup" href="/static/images/small/img-2.jpg" title="">
                                                                    <img class="gallery-img img-fluid mx-auto" src="/static/images/small/img-2.jpg" alt="" />
                                                                    <div class="gallery-overlay">
                                                    ...
                                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                                        <div class="gallery-box card">
                                                            <div class="gallery-container">
                                                                <a class="image-popup" href="/static/images/small/img-3.jpg" title="">
                                                                    <img class="gallery-img img-fluid mx-auto" src="/static/images/small/img-3.jpg" alt="" />
                                                                    <div class="gallery-overlay">
                                                    ...
                                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                                        <div class="gallery-box card">
                                                            <div class="gallery-container">
                                                                <a class="image-popup" href="/static/images/small/img-4.jpg" title="">
                                                                    <img class="gallery-img img-fluid mx-auto" src="/static/images/small/img-4.jpg" alt="" />
                                                                    <div class="gallery-overlay">
                                                    ...
                                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                                        <div class="gallery-box card">
                                                            <div class="gallery-container">
                                                                <a class="image-popup" href="/static/images/small/img-5.jpg" title="">
                                                                    <img class="gallery-img img-fluid mx-auto" src="/static/images/small/img-5.jpg" alt="" />
                                                                    <div class="gallery-overlay">
                                                    ...
                                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                                        <div class="gallery-box card">
                                                            <div class="gallery-container">
                                                                <a class="image-popup" href="/static/images/small/img-6.jpg" title="">
                                                                    <img class="gallery-img img-fluid mx-auto" src="/static/images/small/img-6.jpg" alt="" />
                                                                    <div class="gallery-overlay">
                                                    ...
                                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                                        <div class="gallery-box card">
                                                            <div class="gallery-container">
                                                                <a class="image-popup" href="/static/images/small/img-7.jpg" title="">
                                                                    <img class="gallery-img img-fluid mx-auto" src="/static/images/small/img-7.jpg" alt="" />
                                                                    <div class="gallery-overlay">
                                                    ...
                                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                                        <div class="gallery-box card">
                                                            <div class="gallery-container">
                                                                <a class="image-popup" href="/static/images/small/img-8.jpg" title="">
                                                                    <img class="gallery-img img-fluid mx-auto" src="/static/images/small/img-8.jpg" alt="" />
                                                                    <div class="gallery-overlay">
                                                                        <h5 class="overlay-caption">Glasses and laptop from above</h5>
                                                                    </div>
                                                                </a>
                                                    ...
                                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                                        <div class="gallery-box card">
                                                            <div class="gallery-container">
                                                                <a class="image-popup" href="/static/images/small/img-9.jpg" title="">
                                                                    <img class="gallery-img img-fluid mx-auto" src="/static/images/small/img-9.jpg" alt="" />
                                                                    <div class="gallery-overlay">
                                                    ...
                                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                                        <div class="gallery-box card">
                                                            <div class="gallery-container">
                                                                <a class="image-popup" href="/static/images/small/img-10.jpg" title="">
                                                                    <img class="gallery-img img-fluid mx-auto" src="/static/images/small/img-10.jpg" alt="" />
                                                                    <div class="gallery-overlay">
                                                    ...
                                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                                        <div class="gallery-box card">
                                                            <div class="gallery-container">
                                                                <a class="image-popup" href="/static/images/small/img-11.jpg" title="">
                                                                    <img class="gallery-img img-fluid mx-auto" src="/static/images/small/img-11.jpg" alt="" />
                                                                    <div class="gallery-overlay">
                                                    ...
                                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                                        <div class="gallery-box card">
                                                            <div class="gallery-container">
                                                                <a class="image-popup" href="/static/images/small/img-12.jpg" title="">
                                                                    <img class="gallery-img img-fluid mx-auto" src="/static/images/small/img-12.jpg" alt="" />
                                                                    <div class="gallery-overlay">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            <div class="d-sm-flex">
                                                                <div class="flex-shrink-0">
                                                                    <img src="/static/images/small/img-1.jpg" alt="" width="115" class="rounded-1" />
                                                                </div>
                                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                                    ...
                                                                    <ul class="list-inline mb-0">
                                                                        <li class="list-inline-item"><i class="ri-user-3-fill text-info align-middle me-1"></i> James Ballard</li>
                                                                        <li class="list-inline-item"><i class="ri-calendar-2-fill text-info align-middle me-1"></i> 23 Nov, 2021</li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            <div class="d-sm-flex">
                                                                <div class="flex-shrink-0">
                                                                    <img src="/static/images/small/img-2.jpg" alt="" width="115" class="rounded-1" />
                                                                </div>
                                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                                    <ul class="list-inline mb-2">
                                                                    ...
                                                                    <ul class="list-inline mb-0">
                                                                        <li class="list-inline-item"><i class="ri-user-3-fill text-info align-middle me-1"></i> Ruby Griffin</li>
                                                                        <li class="list-inline-item"><i class="ri-calendar-2-fill text-info align-middle me-1"></i> 23 Nov, 2021</li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            <div class="d-sm-flex">
                                                                <div class="flex-shrink-0">
                                                                    <img src="/static/images/small/img-3.jpg" alt="" width="115" class="rounded-1" />
                                                                </div>
                                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                                    <ul class="list-inline mb-2">
                                                                    ...
                                                                    <ul class="list-inline mb-0">
                                                                        <li class="list-inline-item"><i class="ri-user-3-fill text-info align-middle me-1"></i> Elwood Arter</li>
                                                                        <li class="list-inline-item"><i class="ri-calendar-2-fill text-info align-middle me-1"></i> 23 Nov, 2021</li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            <div class="d-sm-flex">
                                                                <div class="flex-shrink-0">
                                                                    <img src="/static/images/small/img-4.jpg" alt="" width="115" class="rounded-1" />
                                                                </div>
                                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                                    <ul class="list-inline mb-2">
                                                                    ...
                                                                    <ul class="list-inline mb-0">
                                                                        <li class="list-inline-item"><i class="ri-user-3-fill text-info align-middle me-1"></i> Nancy Martino</li>
                                                                        <li class="list-inline-item"><i class="ri-calendar-2-fill text-info align-middle me-1"></i> 23 Nov, 2021</li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            <div class="d-sm-flex">
                                                                <div class="flex-shrink-0">
                                                                    <img src="/static/images/small/img-5.jpg" alt="" width="115" class="rounded-1" />
                                                                </div>
                                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                                    <ul class="list-inline mb-2">
                                                                        <li class="list-inline-item"><span class="badge bg-success-subtle text-success fs-11">Business</span></li>
                                                                    ...
                                                                    <ul class="list-inline mb-0">
                                                                        <li class="list-inline-item"><i class="ri-user-3-fill text-info align-middle me-1"></i> Erica Kernan</li>
                                                                        <li class="list-inline-item"><i class="ri-calendar-2-fill text-info align-middle me-1"></i> 11 Nov, 2021</li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            <div class="d-sm-flex">
                                                                <div class="flex-shrink-0">
                                                                    <img src="/static/images/small/img-6.jpg" alt="" width="115" class="rounded-1" />
                                                                </div>
                                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                                    <ul class="list-inline mb-2">
                                                                    ...
                                                                    <ul class="list-inline mb-0">
                                                                        <li class="list-inline-item"><i class="ri-user-3-fill text-info align-middle me-1"></i> Jason McQuaid</li>
                                                                        <li class="list-inline-item"><i class="ri-calendar-2-fill text-info align-middle me-1"></i> 14 Nov, 2021</li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            <div class="d-sm-flex">
                                                                <div class="flex-shrink-0">
                                                                    <img src="/static/images/small/img-7.jpg" alt="" width="115" class="rounded-1" />
                                                                </div>
                                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                                    <ul class="list-inline mb-2">
                                                                        <li class="list-inline-item"><span class="badge bg-danger-subtle text-danger fs-11">Design</span></li>
                                                                    ...
                                                                    <ul class="list-inline mb-0">
                                                                        <li class="list-inline-item"><i class="ri-user-3-fill text-info align-middle me-1"></i> Henry Baird</li>
                                                                        <li class="list-inline-item"><i class="ri-calendar-2-fill text-info align-middle me-1"></i> 19 Nov, 2021</li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            <div class="d-sm-flex">
                                                                <div class="flex-shrink-0">
                                                                    <img src="/static/images/small/img-8.jpg" alt="" width="115" class="rounded-1" />
                                                                </div>
                                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                                    <ul class="list-inline mb-2">
                                                                        <li class="list-inline-item"><span class="badge bg-warning-subtle text-warning fs-11">Development</span></li>
                                                                    ...
                                                                    <ul class="list-inline mb-0">
                                                                        <li class="list-inline-item"><i class="ri-user-3-fill text-info align-middle me-1"></i> Elwood Arter</li>
                                                                        <li class="list-inline-item"><i class="ri-calendar-2-fill text-info align-middle me-1"></i> 10 Aug, 2021</li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
...
%def extra_js():
    ...
    <script src="/static/js/pages/search-result.init.js"></script>
%end