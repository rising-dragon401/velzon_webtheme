                                        ...
                                        <div>
                                            ...
                                            <div>
                                                ...
                                                <div class="d-flex align-items-start flex-wrap gap-4">
                                                    ...
                                                    <div class="text-center">
                                                        <img src="/static/images/users/avatar-1.jpg" class="avatar-md rounded-4" alt="rounded-4">
                                                        <p><code>.rounded-4</code></p>
                                                    </div>
                                                    <div class="text-center">
                                                        <img src="/static/images/users/avatar-1.jpg" class="avatar-md rounded-5" alt="rounded-5">
