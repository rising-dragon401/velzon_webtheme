                                ...
                                <div class="card-body">
                                    <div>
                                        <div class="toolbar d-flex align-items-start justify-content-center flex-wrap gap-2">
                                            ...
                                            <button type="button" class="btn btn-soft-info timeline-btn btn-sm" id="all">
                                                ALL
                                            </button>
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="github-style d-flex align-items-center my-2">
                                            <div class="flex-shrink-0 me-2">
                                                <img class="avatar-sm rounded" src="/static/images/users/avatar-2.jpg" data-hovercard-user-id="634573" alt="" />
                                            </div>
