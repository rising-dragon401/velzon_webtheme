                                            ...
                                            <div class="row g-0">
                                                ...
                                                <div class="col-xxl-4">
                                                    <div class="border-start p-4 h-100 d-flex flex-column">
                                                        ...
                                                        <div class="w-100">
                                                            <div class="d-flex align-items-center">
                                                                <img src="https://img.themesbrand.com/velzon/images/img-1.gif" class="img-fluid avatar-xs rounded-circle object-fit-cover" alt="">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card explore-box card-animate rounded">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-1"><a href="/nft/item-details" class="text-body">Walking On Air</a></h5>
                                                <p class="text-muted mb-0">Artwork</p>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card explore-box card-animate rounded">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-1"><a href="/nft/item-details" class="text-body">Filtered Portrait</a></h5>
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="bookmark-icon position-absolute top-0 end-0 p-2">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-1"><a href="/nft/item-details" class="text-body">Patterns Arts & Culture</a></h5>
                                                <p class="text-muted mb-0">Artwork</p>
                                            </div>
                                            <div class="card-footer border-top border-top-dashed">
                                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card explore-box card-animate rounded">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-1"><a href="/nft/item-details" class="text-body">Evolved Reality</a></h5>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="flex-grow-1">
                                                                <h6 class="mb-1"><a href="/nft/item-details">Abstract Face Painting</a></h6>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="flex-grow-1">
                                                                ...
                                                                <p class="text-muted mb-0 fs-13">Games</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="flex-grow-1">
                                                                <h6 class="mb-1"><a href="/nft/item-details" class="text-body" class="text-body">Creative Filtered Portrait</a></h6>
                                                                <p class="text-muted mb-0 fs-13"> 3d Style</p>
                                                            </div>
