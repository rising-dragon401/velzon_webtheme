...
@route('/components/base-ui/ui-links')
def base_ui_links():
    title = "Links"
    return template('components/base-ui/ui-links',title=title)   
...
@route('/components/charts/charts-apex-funnel')
def charts_apex_funnel():
    title = "Apex Funnel Charts"
    return template('components/charts/apexcharts/charts-apex-funnel',title=title)     

@route('/components/charts/charts-apex-range-area')
def charts_apex_range_area():
    title = "Apex Range Area Charts"
    return template('components/charts/apexcharts/charts-apex-range-area',title=title)    
