                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="swiper pagination-dynamic-swiper rounded">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <img src="/static/images/small/img-7.jpg" alt="" class="img-fluid" />
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="/static/images/small/img-8.jpg" alt="" class="img-fluid" />
                                            </div>
                                            <div class="swiper-slide">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="swiper pagination-fraction-swiper rounded">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <img src="/static/images/small/img-10.jpg" alt="" class="img-fluid" />
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="/static/images/small/img-11.jpg" alt="" class="img-fluid" />
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="/static/images/small/img-12.jpg" alt="" class="img-fluid" />
                                            </div>
                                        </div>
                                        <div class="swiper-button-next"></div>
                                        <div class="swiper-button-prev"></div>
...
%def extra_js():
    ...
    <!-- swiper.init js -->
    <script src="/static/js/pages/swiper.init.js"></script> 
%end