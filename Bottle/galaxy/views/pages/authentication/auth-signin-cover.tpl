                                    ...
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <div class="mt-4">
                                            <form action="/">
                                                ...
                                                <div class="mb-3">
                                                    <div class="float-end">
                                                        <a href="/pages/auth-pass-reset-cover" class="text-muted">Forgot password?</a>
                                                    </div>
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="mb-0">Don't have an account ? <a href="/pages/auth-signup-cover" class="fw-semibold text-primary text-decoration-underline"> Signup</a> </p>
                                        </div>
                                    </div>
                                </div>
                                <!-- end col -->
