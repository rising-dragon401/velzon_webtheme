...
%def content():
            <div class="row">
                        <div class="col-lg-12">
                            <div class="card rounded-0 bg-primary-subtle mx-n4 mt-n4 border-top border-0 card-border-effect-none">
                                <div class="px-4">
                                    <div class="row">
                                        <div class="col-xxl-5 align-self-center">
                                            <div class="py-4">
                                                <h4 class="display-6 coming-soon-text">Frequently asked questions</h4>
                                                <p class="text-primary fs-15 mt-3">If you can not find answer to your question in our FAQ, you can always contact us or email us. We will answer you shortly!</p>
                                        ...
                                        <div class="col-xxl-3 ms-auto">
                                            <div class="mb-n5 pb-1 faq-img d-none d-xxl-block">
                                                <img src="/static/images/faq-img.png" alt="" class="img-fluid">
                                            </div>
                                        </div>
                                    </div>
                                </div>
