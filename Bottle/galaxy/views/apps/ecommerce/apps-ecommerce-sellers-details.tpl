                                    ...
                                    <div>
                                        <div class="flex-shrink-0 avatar-md mx-auto">
                                            <div class="avatar-title bg-light rounded">
                                                <img src="/static/images/companies/img-2.png" alt="" height="50" />
                                            </div>
                                        </div>
                        ...
                        <div class="col-xxl-9">
                            <div class="card">
                                ...
                                <div class="card-body p-0 pb-2">
                                    <div>
                                        <div id="customer_impression_charts" data-colors='["--vz-secondary", "--vz-primary", "--vz-primary-rgb, 0.60"]' class="apex-charts"></div>
                                    </div>
                                </div><!-- end card body -->
                            </div><!-- end card -->
                            ...
                            <div class="row g-4 mb-3">
                                <div class="col-sm-auto">
                                    <div>
                                        <a href="/ecommerce/add-product" class="btn btn-primary"><i class="ri-add-line align-bottom me-1"></i> Add New</a>
                                    </div>
                                </div>
                                <div class="col-sm">
...
%def extra_js():
    ...
    <script src="/static/js/pages/seller-details.init.js"></script>
%end