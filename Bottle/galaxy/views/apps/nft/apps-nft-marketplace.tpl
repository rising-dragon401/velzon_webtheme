                            ...
                            <div class="card bg-primary" style="background-image: url('/static/images/nft/bg-pattern.png');">
                                <div class="card-body p-4">
                                    ...
                                    <div class="hstack gap-2">
                                        <a href="/nft/create" class="btn btn-secondary">Create NFT</a>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card overflow-hidden shadow-none border-0">
                                <div class="card-body bg-primary-subtle text-primary fw-semibold d-flex">
                                    <marquee class="fs-14">
                            ...
                            <div class="card explore-box">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-16 mb-0"><a href="/nft/item-details">Robotic Body Art</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card explore-box">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-16 mb-0"><a href="/nft/item-details">Creative Filtered Portrait</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1"><a href="/nft/item-details">Trendy Fashion Portraits</a></h5>
                        ...
                        <div class="col">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1"><a href="/nft/item-details">Smillevers Crypto</a></h5>
