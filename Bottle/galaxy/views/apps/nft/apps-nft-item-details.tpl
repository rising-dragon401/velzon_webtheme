                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-lg-8">
                                    <div>
                                        ...
                                        <span class="badge bg-primary-subtle text-primary mb-3 fs-12"><i class="ri-eye-line me-1 align-bottom"></i> 8,634 people views this</span>
                                            ...
                                            <div class="col-lg-3 col-sm-6">
                                                <div class="p-2 border border-dashed rounded text-center">
                                                    <div>
                                                        ...
                                                        <h5 class="fs-17 text-primary mb-0"><i class="mdi mdi-ethereum me-1"></i> 83.06 ETH</h5>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- end col -->
                                                        ...
                                                        <table class="table align-middle table-nowrap mb-0">
                                                            <tbody>
                                                                <tr>
                                                                    <th scope="row">
                                                                        <div class="d-flex align-items-center">
                                                                            <img src="/static/images/nft/img-01.jpg" alt="" class="avatar-xs rounded object-fit-cover" />
                                                                            <a href="/nft/item-details" class="text-body"><span class="mb-0 ms-2">Brave Tigers NFT</span></a>
                                                                        </div>
                                                                    </th>
                                                                    <td>0.235 ETH</td>
                                                                    <td>
                                                                        <div class="d-flex align-items-center">
                                                                            <img src="/static/images/users/avatar-1.jpg" alt="" class="avatar-xs rounded object-fit-cover" />
                                                                            <div class="ms-2">
                                                                ...
                                                                <tr>
                                                                    <th scope="row">
                                                                        <div class="d-flex align-items-center">
                                                                            <img src="/static/images/nft/img-03.jpg" alt="" class="avatar-xs rounded object-fit-cover" />
                                                                            <a href="/nft/item-details" class="text-body"><span class="mb-0 ms-2">Creative filtered portrait</span></a>
                                                                        </div>
                                                                    </th>
                                                                    <td>571.24 ETH</td>
                                                                    <td>
                                                                        <div class="d-flex align-items-center">
                                                                            <img src="/static/images/users/avatar-3.jpg" alt="" class="avatar-xs rounded object-fit-cover" />
                                                                            <div class="ms-2">
                                                                ...
                                                                <tr>
                                                                    <th scope="row">
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <a href="/nft/item-details" class="text-body"><span class="mb-0 ms-2">Evolved Reality</span></a>
                                                                        </div>
                                                                    </th>
                                                                    <td>130.39 ETH</td>
                                                                    <td>
                                                                        <div class="d-flex align-items-center">
                                                                            <img src="/static/images/users/avatar-5.jpg" alt="" class="avatar-xs rounded object-fit-cover" />
                                                                            <div class="ms-2">
                                                                ...
                                                                <tr>
                                                                    <th scope="row">
                                                                        <div class="d-flex align-items-center">
                                                                            <img src="/static/images/nft/img-06.jpg" alt="" class="avatar-xs rounded object-fit-cover" />
                                                                            <a href="/nft/item-details" class="text-body"><span class="mb-0 ms-2">Robotic Body Art</span></a>
                                                                        </div>
                                                                    </th>
                                                                    <td>81.72 ETH</td>
                                                                    <td>
                                                                        <div class="d-flex align-items-center">
                                                                            <img src="/static/images/users/avatar-8.jpg" alt="" class="avatar-xs rounded object-fit-cover" />
                                                                            <div class="ms-2">
                                                        ...
                                                        <div class="mt-3">
                                                            ...
                                                            <div class="row align-items-center g-2">
                                                                ...
                                                                <div class="col">
                                                                    <div class="p-2">
                                                                        <div class="progress animated-progress progress-sm">
                                                                            <div class="progress-bar bg-primary" role="progressbar" style="width: 19.32%" aria-valuenow="19.32" aria-valuemin="0" aria-valuemax="100"></div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-auto">
                                                                    ...
                                                                    <div class="border border-dashed rounded p-3">
                                                                        ...
                                                                        <div class="d-flex flex-grow-1 gap-2 mb-3">
                                                                            <a href="#" class="d-block">
                                                                                <img src="/static/images/small/img-12.jpg" alt="" class="avatar-sm rounded object-fit-cover" />
                                                                            </a>
                                                                            <a href="#" class="d-block">
                                                                                <img src="/static/images/small/img-11.jpg" alt="" class="avatar-sm rounded object-fit-cover" />
                                                                            </a>
                                                                            <a href="#" class="d-block">
                                                                                <img src="/static/images/small/img-10.jpg" alt="" class="avatar-sm rounded object-fit-cover" />
                                                                            </a>
                                                                        </div>
...
%def extra_js():
<script src="/static/js/pages/apps-nft-item-details.init.js"></script>
%end