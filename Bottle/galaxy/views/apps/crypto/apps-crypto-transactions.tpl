                                    ...
                                    <div class="swiper-slide">
                                        <div class="card card-animate">
                                            <div class="card-body bg-primary-subtle">
                                                <div class="d-flex mb-3">
                                                    <div class="flex-grow-1">
                                                        <lord-icon src="https://cdn.lordicon.com/vaeagfzc.json" trigger="loop" colors="primary:#8c68cd,secondary:#8c68cd" style="width:55px;height:55px"></lord-icon>
                                                    </div>
                                                    <div class="flex-shrink-0">
                                ...
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    ...
                                    <tbody class="list form-check-all">
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/static/images/svg/crypto-icons/btc.svg" alt="" class="avatar-xxs me-2"> BTC
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/static/images/svg/crypto-icons/eth.svg" alt="" class="avatar-xxs me-2"> ETH
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/static/images/svg/crypto-icons/eur.svg" alt="" class="avatar-xxs me-2"> EUR
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/static/images/svg/crypto-icons/gbp.svg" alt="" class="avatar-xxs me-2"> GBP
                                                </div>
                                            </td>
                                            <td class="form_name">Wallet</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/static/images/svg/crypto-icons/jpy.svg" alt="" class="avatar-xxs me-2"> JPY
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/static/images/svg/crypto-icons/xrp.svg" alt="" class="avatar-xxs me-2"> XRP
                                                </div>
                                            </td>
                                            <td class="form_name">Wallet</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/static/images/svg/crypto-icons/ltc.svg" alt="" class="avatar-xxs me-2"> LTC
                                                </div>
                                            </td>
                                            <td class="form_name">Tonya Noble</td>
                                            <td class="to_name">Wallet</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/static/images/svg/crypto-icons/xmr.svg" alt="" class="avatar-xxs me-2"> XMR
                                                </div>
                                            </td>
                                            <td class="form_name">Wallet</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/static/images/svg/crypto-icons/xpm.svg" alt="" class="avatar-xxs me-2"> XPM
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/static/images/svg/crypto-icons/ppt.svg" alt="" class="avatar-xxs me-2"> PPT
                                                </div>
                                            </td>
