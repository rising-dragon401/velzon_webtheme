                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Placeholders</h4>
                                            ...
                                            <div class="col-xl-7">
                                                <div class="row justify-content-between">
                                                    <div class="col-lg-5 col-sm-6">
                                                        <div class="card">
                                                            <img src="/static/images/small/img-1.jpg" class="card-img-top" alt="card img">
                                                    ...
                                                    <div class="col-lg-5 col-sm-6">
                                                        <div class="card" aria-hidden="true">
                                                            <img src="/static/images/small/img-2.jpg" class="card-img-top" alt="card dummy img">
                                                            <div class="card-body">
