                                ...
                                <div class="card-header">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-shrink-0">
                                            <a href="/invoices/details" class="btn btn-success btn-sm"><i class="ri-download-2-fill align-middle me-1"></i> Invoice</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                <h5 class="fs-15"><a href="/ecommerce/products-details" class="text-body">Sweatshirt for Men (Pink)</a></h5>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                <h5 class="fs-15"><a href="/ecommerce/products-details" class="text-body">Noise NoiseFit Endure Smart Watch</a></h5>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                <h5 class="fs-15"><a href="/ecommerce/products-details" class="text-body">350 ml Glass Grocery Container</a></h5>
                                                ...
                                                <div class="accordion-header" id="headingOne">
                                                    <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                <h6 class="fs-14 mb-0 fw-semibold">Order Placed - <span class="fw-normal">Wed, 15 Dec 2021</span></h6>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </div>
                                                ...
                                                <div class="accordion-header" id="headingTwo">
                                                    <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                <h6 class="fs-14 mb-1 fw-semibold">Packed - <span class="fw-normal">Thu, 16 Dec 2021</span></h6>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </div>
                                                ...
                                                <div class="accordion-header" id="headingThree">
                                                    <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                <h6 class="fs-14 mb-1 fw-semibold">Shipping - <span class="fw-normal">Thu, 16 Dec 2021</span></h6>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </div>
