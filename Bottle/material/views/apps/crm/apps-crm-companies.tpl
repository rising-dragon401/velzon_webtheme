                                    ...
                                    <div class="d-flex align-items-center flex-wrap gap-2">
                                        ...
                                        <div class="flex-shrink-0">
                                            <div class="hstack text-nowrap gap-2">
                                                <button class="btn btn-soft-danger shadow-none" onClick="deleteMultiple()"><i class="ri-delete-bin-2-line"></i></button>
                                                <button class="btn btn-danger shadow-none"><i class="ri-filter-2-line me-1 align-bottom"></i> Filters</button>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="flex-shrink-0">
                                                                    <img src="/static/images/brands/dribbble.png" alt="" class="avatar-xxs rounded-circle image_src object-fit-cover">
                                                                </div>
                                    ...
                                    <div class="position-relative d-inline-block">
                                        <div class="avatar-md">
                                            <div class="avatar-title bg-light rounded-circle shadow">
                                                <img src="/static/images/brands/mail_chimp.png" alt="" class="avatar-sm rounded-circle object-fit-cover">
                                            </div>
                                        </div>
                                    </div>
