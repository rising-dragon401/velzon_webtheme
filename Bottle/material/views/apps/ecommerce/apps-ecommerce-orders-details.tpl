                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                <h5 class="fs-15"><a href="/ecommerce/products-details" class="link-primary">Sweatshirt for Men (Pink)</a></h5>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                <h5 class="fs-15"><a href="/ecommerce/products-details" class="link-primary">Noise NoiseFit Endure Smart Watch</a></h5>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                <h5 class="fs-15"><a href="/ecommerce/products-details" class="link-primary">350 ml Glass Grocery Container</a></h5>
                                ...
                                <div class="card-header">
                                    <div class="d-sm-flex align-items-center">
                                        ...
                                        <div class="flex-shrink-0 mt-2 mt-sm-0">
                                            ...
                                            <a href="javascript:void(0);" class="btn btn-soft-danger btn-sm mt-2 mt-sm-0 shadow-none"><i class="mdi mdi-archive-remove-outline align-middle me-1"></i> Cancel Order</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
