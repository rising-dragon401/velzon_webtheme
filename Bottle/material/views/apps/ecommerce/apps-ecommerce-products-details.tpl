                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="mt-3">
                                                                    <div class="row align-items-center g-2">
                                                                        ...
                                                                        <div class="col">
                                                                            <div class="p-2">
                                                                                <div class="progress animated-progress bg-success-subtle progress-sm">
                                                                            ...
                                                                            <div class="border border-dashed rounded p-3">
                                                                                ...
                                                                                <div class="d-flex flex-grow-1 gap-2 mb-3">
                                                                                    <a href="#" class="d-block">
                                                                                        <img src="/static/images/small/img-12.jpg" alt="" class="avatar-sm shadow rounded object-fit-cover">
                                                                                    </a>
                                                                                    <a href="#" class="d-block">
                                                                                        <img src="/static/images/small/img-11.jpg" alt="" class="avatar-sm shadow rounded object-fit-cover">
                                                                                    </a>
                                                                                    <a href="#" class="d-block">
                                                                                        <img src="/static/images/small/img-10.jpg" alt="" class="avatar-sm shadow rounded object-fit-cover">
                                                                                    </a>
                                                                                </div>
