                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-2">
                                    <form action="/pages/auth-signin-basic">
                                        <div class="mb-3">
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">Wait, I remember my password... <a href="/pages/auth-signin-basic" class="fw-semibold text-primary text-decoration-underline"> Click here </a> </p>
                        </div>
