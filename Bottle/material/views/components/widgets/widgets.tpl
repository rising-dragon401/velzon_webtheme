                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            ...
                                            <p class="mb-0 text-white-50"><span class="badge bg-light-subtle text-body mb-0"><i class="ri-arrow-down-line align-middle"></i> 0.24 % </span> vs. previous month</p>
                                        </div>
                                        <div>
                                            <div class="avatar-sm flex-shrink-0">
                                                <span class="avatar-title bg-light-subtle rounded-circle fs-2 shadow">
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-success card-height-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-sm flex-shrink-0">
                                            <span class="avatar-title bg-white text-success rounded-2 fs-2 shadow">
                                        ...
                                        <div class="flex-shrink-0 align-self-center">
                                            <span class="badge bg-white bg-opacity-25 text-white fs-12"><i class="ri-arrow-up-s-line fs-13 align-middle me-1"></i>6.11 %<span>
                                        </div>
                                    </div>
                                </div><!-- end card body -->
                            </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card card-height-100">
                                <div class="card-body">
                                    ...
                                    <div class="mb-4 pb-2">
                                        <img src="/static/images/companies/img-3.png" alt="" class="avatar-sm">
                                    </div>
                                    <a href="#!">
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card card-height-100">
                                <div class="card-body">
                                    ...
                                    <div class="mb-4 pb-2">
                                        <img src="/static/images/companies/img-4.png" alt="" class="avatar-sm">
                                    </div>
                                    <a href="#!">
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card card-height-100 bg-primary-subtle shadow-none bg-opacity-10">
                                <div class="card-body">
                                    ...
                                    <div class="mb-4 pb-2">
                                        <img src="/static/images/companies/img-6.png" alt="" class="avatar-sm">
                                    </div>
                                    <a href="#!">
                                        <h6 class="fs-15 fw-semibold">Sr. Web Designer <span class="text-muted fs-13">(2+ Yrs Exp.)</span></h6>
                                    </a>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card card-height-100 bg-info-subtle shadow-none bg-opacity-10">
                                <div class="card-body">
                                    ...
                                    <div class="mb-4 pb-2">
                                        <img src="/static/images/companies/img-8.png" alt="" class="avatar-sm">
                                    </div>
                                    <a href="#!">
                                        <h6 class="fs-15 fw-semibold">Sr. Web Designer <span class="text-muted fs-13">(2+ Yrs Exp.)</span></h6>
                                    </a>
                            ...
                            <div class="card">
                                <div class="card-body p-0">
                                    ...
                                    <div class="row align-items-end">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="px-3">
                                                <img src="/static/images/user-illustarator-2.png" class="img-fluid" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div> <!-- end card-body-->
                            ...
                            <div class="card bg-primary">
                                <div class="card-body p-0">
                                    ...
                                    <div class="row align-items-end">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="px-3">
                                                <img src="/static/images/user-illustarator-1.png" class="img-fluid" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div> <!-- end card-body-->
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card">
                                ...
                                <div class="progress animated-progress bg-primary-subtle rounded-bottom rounded-0" style="height: 6px;">
                                                    ...
                                                    <div class="avatar-group">
                                                        <div class="avatar-group-item shadow">
                                                            <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Frida Bang">
                                                                <img src="/static/images/users/avatar-4.jpg" alt="" class="rounded-circle avatar-xxs">
                                                            </a>
                                                        </div>
                                                        <div class="avatar-group-item shadow">
                                                            <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Malou Silva">
                                                                <img src="/static/images/users/avatar-5.jpg" alt="" class="rounded-circle avatar-xxs">
                                                            </a>
                                                        </div>
                                                        <div class="avatar-group-item shadow">
                                                            <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Simon Schmidt">
                                                                <img src="/static/images/users/avatar-6.jpg" alt="" class="rounded-circle avatar-xxs">
                                                            </a>
                                                        </div>
                                                        <div class="avatar-group-item shadow">
                                                            <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Tosh Jessen">
                                                                <img src="/static/images/users/avatar-7.jpg" alt="" class="rounded-circle avatar-xxs">
                                                            </a>
                                                        </div>
                                                        <div class="avatar-group-item shadow">
                                                            <a href="javascript: void(0);">
                                        ...
                                        <div class="card-body p-0">
                                            <div data-simplebar style="max-height: 364px;" class="p-3">
                                                <div class="acitivity-timeline acitivity-main">
                                                    ...
                                                    <div class="acitivity-item py-3 d-flex">
                                                        ...
                                                        <div class="flex-grow-1 ms-3">
                                                            ...
                                                            <div class="d-inline-flex gap-2 border border-dashed p-2 mb-2 w-75">
                                                                <a href="/ecommerce/products-details" class="bg-light rounded p-1">
                                                                    <img src="/static/images/products/img-8.png" alt="" class="img-fluid d-block" />
                                                                </a>
                                                                <a href="/ecommerce/products-details" class="bg-light rounded p-1">
                                                                    <img src="/static/images/products/img-2.png" alt="" class="img-fluid d-block" />
                                                                </a>
                                                                <a href="/ecommerce/products-details" class="bg-light rounded p-1">
                                                                    <img src="/static/images/products/img-10.png" alt="" class="img-fluid d-block" />
                                                                </a>
                                                            </div>
                                                    ...
                                                    <div class="acitivity-item py-3 d-flex">
                                                        <div class="flex-shrink-0">
                                                            <img src="/static/images/users/avatar-2.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar shadow">
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                    ...
                                                    <div class="acitivity-item py-3 d-flex">
                                                        ...
                                                        <div class="flex-grow-1 ms-3">
                                                            <h6 class="mb-1">Today offers by <a href="/ecommerce/sellers-details" class="link-secondary">Digitech Galaxy</a></h6>
                                                    ...
                                                    <div class="acitivity-item d-flex">
                                                        <div class="flex-shrink-0">
                                                            <img src="/static/images/users/avatar-3.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar shadow" />
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-md-6">
                            <div class="card card-height-100">
                                <div class="card-body">
                                    <div>
                                        <h5 class="mb-1">598 Exam Report Taken</h5>
                                        <p class="text-muted">79% Results shared, 11% Pending</p>
                                        <span class="text-success fw-medium">+11% <small>from 19/20</small></span>
                                    </div>

                                    <div class="apex-charts position-absolute end-0 bottom-0" data-colors='["--vz-success" , "--vz-transparent"]' dir="ltr" id="results_sparkline_charts"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-md-6">
                            <div class="card card-height-100">
                                <div class="card-body">
                                    ...
                                    <div class="apex-charts position-absolute end-0 bottom-0" data-colors='["--vz-danger" , "--vz-transparent"]' dir="ltr" id="results_sparkline_charts2"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-md-6">
                            <div class="card card-height-100">
                                <div class="card-body">
                                    ...
                                    <div class="apex-charts position-absolute end-0 bottom-0" data-colors='["--vz-success" , "--vz-transparent"]' dir="ltr" id="results_sparkline_charts3"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <ul class="list-group list-group-flush border-dashed mb-0">
                                            ...
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 avatar-xs">
                                                    <span class="avatar-title bg-light p-1 rounded-circle shadow">
                                                        <img src="/static/images/svg/crypto-icons/btc.svg" class="img-fluid" alt="">
                                                    </span>
                                                </div>
                                        ...
                                        <li class="list-group-item px-0">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 avatar-xs">
                                                    <span class="avatar-title bg-light p-1 rounded-circle shadow">
                                                        <img src="/static/images/svg/crypto-icons/eth.svg" class="img-fluid" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                        ...
                                        <li class="list-group-item px-0">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 avatar-xs">
                                                    <span class="avatar-title bg-light p-1 rounded-circle shadow">
                                                        <img src="/static/images/svg/crypto-icons/ltc.svg" class="img-fluid" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                        ...
                                        <li class="list-group-item px-0 pb-0">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 avatar-xs">
                                                    <span class="avatar-title bg-light p-1 rounded-circle shadow">
                                                        <img src="/static/images/svg/crypto-icons/dash.svg" class="img-fluid" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                            ...
                                            <div class="swiper-slide" style="max-width: 200px;">
                                                <div>
                                                    <div class="bg-info-subtle rounded">
                                                        <img src="/static/images/products/img-3.png" alt="" style="max-height: 210px;max-width: auto;" />
                                                    </div>
                                                    <div class="pt-3">
                                            ...
                                            <div class="swiper-slide" style="max-width: 200px;">
                                                <div>
                                                    <div class="bg-success-subtle rounded">
                                                        <img src="/static/images/products/img-4.png" alt="" style="max-height: 210px;max-width: auto;" />
                                                    </div>
                                                    <div class="pt-3">
                                                        <h5 class="text-secondary">$99.94</h5>
                                                        <a href="#!">
                                            ...
                                            <div class="swiper-slide" style="max-width: 200px;">
                                                <div>
                                                    <div class="bg-warning-subtle rounded">
                                                        <img src="/static/images/products/img-5.png" alt="" style="max-height: 210px;max-width: auto;" />
                                                    </div>
                                                    <div class="pt-3">
                                                        <h5 class="text-secondary">$99.94</h5>
                                                        <a href="#!">
                                            ...
                                            <div class="swiper-slide" style="max-width: 200px;">
                                                <div>
                                                    <div class="bg-secondary-subtle rounded">
                                                        <img src="/static/images/products/img-6.png" alt="" style="max-height: 210px;max-width: auto;" />
                                                    </div>
                                                    <div class="pt-3">
                                                        <h5 class="text-secondary">$99.94</h5>
                                                        <a href="#!">
                                                            <h6 class="fs-15 fw-semibold lh-base text-truncate mb-0">Half Sleeve T-Shirts (Blue)</h6>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="d-flex align-items-center mb-3">
                                        <div class="avatar-sm me-3 flex-shrink-0">
                                            <div class="avatar-title bg-info-subtle rounded">
                                                <img src="/static/images/products/img-6.png" alt="" class="avatar-xs">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <div class="card-body position-relative">
                                    ...
                                    <div class="notification-elem" id="notification-overlay">
                                        <div class="text-center">
                                            ...
                                            <div class="mt-4 pt-2">
                                                <h5 class="mb-1">$6,201 Payment Successfully</h5>
                                                ...
                                                <ul class="list-unstyled mb-0 pt-2" id="candidate-list">
                                                    <li>
                                                        <a href="javascript:void(0);" class="d-flex align-items-center py-2">
                                                            <div class="flex-shrink-0 me-2">
                                                                <div class="avatar-xs">
                                                                    <img src="/static/images/users/avatar-1.jpg" alt="" class="img-fluid rounded-circle candidate-img">
                                                                </div>
                                                            </div>
                                                            <div class="flex-grow-1">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0);" class="d-flex align-items-center py-2">
                                                            <div class="flex-shrink-0 me-2">
                                                                <div class="avatar-xs">
                                                                    <img src="/static/images/users/avatar-2.jpg" alt="" class="img-fluid rounded-circle candidate-img">
                                                                </div>
                                                            </div>
                                                            <div class="flex-grow-1">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0);" class="d-flex align-items-center py-2">
                                                            <div class="flex-shrink-0 me-2">
                                                                <div class="avatar-xs">
                                                                    <img src="/static/images/users/avatar-3.jpg" alt="" class="img-fluid rounded-circle candidate-img">
                                                                </div>
                                                            </div>
                                                            <div class="flex-grow-1">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0);" class="d-flex align-items-center py-2">
                                                            <div class="flex-shrink-0 me-2">
                                                                <div class="avatar-xs">
                                                                    <img src="/static/images/users/avatar-4.jpg" alt="" class="img-fluid rounded-circle candidate-img">
                                                                </div>
                                                            </div>
                                                            <div class="flex-grow-1">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0);" class="d-flex align-items-center py-2">
                                                            <div class="flex-shrink-0 me-2">
                                                                <div class="avatar-xs">
                                                                    <img src="/static/images/users/avatar-5.jpg" alt="" class="img-fluid rounded-circle candidate-img">
                                                                </div>
                                                            </div>
                                                            <div class="flex-grow-1">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="card-body text-center">
                                            <div class="avatar-md mb-3 mx-auto">
                                                <img src="/static/images/users/avatar-1.jpg" alt="" id="candidate-img" class="img-thumbnail rounded-circle shadow-none">
                                            </div>
...
%def extra_js():
    ...
    <script src="/static/libs/jsvectormap/dist/maps/us-merc-en.js"></script>
