                ...
                <!-- start page title -->
                    ...
                    <div class="row g-4 mb-3">
                        <div class="col-sm-auto">
                            <div>
                                <a href="/projects/create" class="btn btn-soft-secondary"><i class="ri-add-line align-bottom me-1"></i> Add New</a>
                            </div>
                        </div>
                        <div class="col-sm">
                                                ...
                                                <div class="d-flex gap-1 align-items-center">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item" href="/projects/overview"><i class="ri-eye-fill align-bottom me-2 text-muted"></i> 
                                                                View</a>
                                                            <a class="dropdown-item" href="/projects/create"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> 
                                                                Edit</a>
