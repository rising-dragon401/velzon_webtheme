                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-shrink-0">
                                            <div class="d-flex gap-2 flex-wrap">
                                            	...
                                            	<a href="/invoices/create" class="btn btn-soft-primary"><i class="ri-add-line align-bottom me-1"></i> Create Invoice</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
%def extra_js():
    ...
    <!-- invoicelist init js -->
    <script src="/static/js/pages/invoiceslist.init.js"></script>
