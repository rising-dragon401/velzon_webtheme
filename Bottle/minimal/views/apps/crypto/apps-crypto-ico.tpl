                        ...
                        <div class="col-xxl-3 col-md-6">
                            ...
                            <div class="card mb-2">
                                <div class="card-body">
                                    <div class="d-flex mb-3">
                                        ...
                                        <div>
                                            <a href="javascript:void(0);" class="badge bg-secondary-subtle text-secondary">Visit Website <i class="ri-arrow-right-up-line align-bottom"></i></a>
                                        </div>
                                    </div>
                            ...
                            <div class="card mb-2">
                                <div class="card-body">
                                    <div class="d-flex mb-3">
                                        <div class="flex-shrink-0 avatar-sm">
                                            <div class="avatar-title bg-light rounded">
                                                <img src="/static/images/companies/img-6.png" alt="" class="avatar-xxs" />
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                            ...
                            <div class="card mb-2">
                                <div class="card-body">
                                    <div class="d-flex mb-3">
                                        <div class="flex-shrink-0 avatar-sm">
                                            <div class="avatar-title bg-light rounded">
                                                <img src="/static/images/svg/crypto-icons/vtc.svg" alt="" class="avatar-xxs" />
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                            ...
                            <div class="card mb-2">
                                <div class="card-body">
                                    <div class="d-flex mb-3">
                                        <div class="flex-shrink-0 avatar-sm">
                                            <div class="avatar-title bg-light rounded">
                                                <img src="/static/images/svg/crypto-icons/xsg.svg" alt="" class="avatar-xxs" />
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h6 class="text-muted mb-0">$40,00,000 / $24,12,741 <span class="badge bg-secondary-subtle text-secondary">62.04%</span></h6>
                                </div>
                                <div class="card-body border-top border-top-dashed">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                            ...
                            <div class="card mb-2">
                                <div class="card-body">
                                    <div class="d-flex mb-3">
                                        <div class="flex-shrink-0 avatar-sm">
                                            <div class="avatar-title bg-light rounded">
                                                <img src="/static/images/svg/crypto-icons/add.svg" alt="" class="avatar-xxs" />
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex mb-3">
                                        <div class="flex-shrink-0 avatar-sm">
                                            <div class="avatar-title bg-light rounded">
                                                <img src="/static/images/svg/crypto-icons/atm.svg" alt="" class="avatar-xxs" />
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                            ...
                            <div class="card mb-2 ribbon-box ribbon-fill right">
                                ...
                                <div class="card-body">
                                    <div class="d-flex mb-3">
                                        <div class="flex-shrink-0 avatar-sm">
                                            <div class="avatar-title bg-light rounded">
                                                <img src="/static/images/svg/crypto-icons/bcbc.svg" alt="" class="avatar-xxs" />
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                            ...
                            <div class="card mb-2 ribbon-box ribbon-fill right">
                                ...
                                <div class="card-body">
                                    <div class="d-flex mb-3">
                                        <div class="flex-shrink-0 avatar-sm">
                                            <div class="avatar-title bg-light rounded">
                                                <img src="/static/images/svg/crypto-icons/bix.svg" alt="" class="avatar-xxs" />
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                            ...
                            <div class="card mb-2 ribbon-box ribbon-fill right">
                                ...
                                <div class="card-body">
                                    <div class="d-flex mb-3">
                                        <div class="flex-shrink-0 avatar-sm">
                                            <div class="avatar-title bg-light rounded">
                                                <img src="/static/images/svg/crypto-icons/rise.svg" alt="" class="avatar-xxs" />
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                            ...
                            <div class="card ribbon-box ribbon-fill right">
                                ...
                                <div class="card-body">
                                    <div class="d-flex mb-3">
                                        <div class="flex-shrink-0 avatar-sm">
                                            <div class="avatar-title bg-light rounded">
                                                <img src="/static/images/svg/crypto-icons/ark.svg" alt="" class="avatar-xxs" />
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 ms-3">
