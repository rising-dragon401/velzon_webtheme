                                ...
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                                    <div class="card explore-box card-animate">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-15 mb-3"><a href="/nft/item-details" class="text-body">Abstract Face Painting</a></h6>
                                            <div>
                                ...
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-30">
                                    <div class="card explore-box card-animate">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-15 mb-3"><a href="/nft/item-details" class="text-body">Patterns Arts & Culture</a></h6>
                                            <div>
                                ...
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-40">
                                    <div class="card explore-box card-animate">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-15 mb-3"><a href="/nft/item-details" class="text-body">Creative Filtered Portrait</a></h6>
                                            <div>
                                ...
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                                    <div class="card explore-box card-animate">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-15 mb-3"><a href="/nft/item-details" class="text-body">Smillevers Crypto</a></h6>
                                            <div>
                                ...
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-40">
                                    <div class="card explore-box card-animate">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h5 class="text-primary"><i class="mdi mdi-ethereum"></i> 245.23ETH </h5>
                                            <h6 class="fs-15 mb-3"><a href="/nft/item-details" class="text-body">Long-tailed Macaque</a></h6>
                                            <div>
                                ...
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                                    <div class="card explore-box card-animate">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-15 mb-3"><a href="/nft/item-details" class="text-body">The Chirstoper</a></h6>
                                            <div>
                                ...
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-30">
                                    <div class="card explore-box card-animate">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-15 mb-3"><a href="/nft/item-details" class="text-body">Robotic Body Art</a></h6>
                                            <div>
                                ...
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                                    <div class="card explore-box card-animate">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h5 class="text-primary"><i class="mdi mdi-ethereum"></i> 245.23ETH </h5>
                                            <h6 class="fs-15 mb-3"><a href="/nft/item-details" class="text-body">Evolved Reality</a></h6>
                                            <div>
