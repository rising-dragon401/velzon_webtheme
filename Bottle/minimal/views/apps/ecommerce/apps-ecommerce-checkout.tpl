                                    ...
                                    <form action="#">
                                        <div class="step-arrow-nav mt-n3 mx-n3 mb-3">
                                            ...
                                            <ul class="nav nav-pills nav-justified custom-nav" role="tablist">
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link fs-15 p-3" id="pills-bill-address-tab" data-bs-toggle="pill" data-bs-target="#pills-bill-address" type="button" role="tab" aria-controls="pills-bill-address" aria-selected="false"> <i class="ri-truck-line fs-16 p-2 bg-primary-subtle text-primary rounded-circle align-middle me-2"></i>
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link fs-15 p-3" id="pills-finish-tab" data-bs-toggle="pill" data-bs-target="#pills-finish" type="button" role="tab" aria-controls="pills-finish" aria-selected="false"> <i class="ri-checkbox-circle-line fs-16 p-2 bg-primary-subtle text-primary rounded-circle align-middle me-2"></i> Finish </button>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade" id="pills-finish" role="tabpanel" aria-labelledby="pills-finish-tab">
                                                <div class="text-center py-5">
                                                    ...
                                                    <h3 class="fw-semibold">Order ID: <a href="/ecommerce/orders-details" class="text-decoration-underline">VZ2451</a></h3>
                                                </div>
                                            </div>
                                            <!-- end tab pane -->
                                        </div>
                                        ...
                                        <table class="table table-borderless align-middle mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h5 class="fs-14"><a href="/ecommerce/products-details" class="text-body">Sweatshirt for Men (Pink)</a>
                                                        </h5>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="avatar-md bg-light rounded p-1">
                                                            <img src="/static/images/products/img-7.png" alt="" class="img-fluid d-block">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <h5 class="fs-14"><a href="/ecommerce/products-details" class="text-body">Noise Evolve Smartwatch</a></h5>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h5 class="fs-14"><a href="/ecommerce/products-details" class="text-body">350 ml Glass Grocery Container</a>
                                                        </h5>
...
%def extra_js():
    <!-- init js -->
    <script src="/static/js/pages/ecommerce-product-checkout.init.js"></script>
%end