                                ...
                                <div class="col-lg-12">
                                    <div class="d-flex align-items-center mb-4">
                                        ...
                                        <div class="flex-shrink-0">
                                            <a href="#!" class="btn btn-ghost-danger">View All <i class="ri-arrow-right-line ms-1 align-bottom"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex gap-4 mb-3">
                                                <div>
                                                    <i class="ri-map-pin-2-line text-danger me-1 align-bottom"></i> Escondido,California
                                                </div>
                                ...
                                <div class="col-xl-4">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex gap-4 mb-3">
                                                <div>
                                                    <i class="ri-map-pin-2-line text-danger me-1 align-bottom"></i> Stordorf, Germany
                                                </div>
