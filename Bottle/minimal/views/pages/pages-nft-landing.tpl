...
<body data-bs-spy="scroll" data-bs-target="#navbar-example">
        ...
        <nav class="navbar navbar-expand-lg navbar-landing navbar-light fixed-top" id="navbar">
            <div class="container">
                <a class="navbar-brand" href="/">
                    <img src="/static/images/logo-dark.png" class="card-logo card-logo-dark" alt="logo dark" height="17">
                    <img src="/static/images/logo-light.png" class="card-logo card-logo-light" alt="logo light" height="17">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="">
                        <a href="/nft/wallet" class="btn btn-primary btn-sm">Wallet Connect</a>
                    </div>
                </div>
                    ...
                    <div class="col-lg-8 col-sm-10">
                        <div class="text-center">
                            ...
                            <div class="hstack gap-2 justify-content-center">
                                <a href="/nft/create" class="btn btn-primary">Create Own <i class="ri-arrow-right-line align-middle ms-1"></i></a>
                                <a href="/nft/explore" class="btn btn-secondary">Explore Now <i class="ri-arrow-right-line align-middle ms-1"></i></a>
                            </div>
                        </div>
                    </div><!--end col-->
                </div><!-- end row -->
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    <div class="col-lg-4">
                        <div class="card text-center border shadow-none">
                            <div class="card-body py-5 px-4">
                                <img src="/static/images/nft/wallet/metamask.png" alt="" height="55" class="mb-3 pb-2">
                                <h5>Metamask</h5>
                    ...
                    <div class="col-lg-4">
                        <div class="card text-center border shadow-none">
                            <div class="card-body py-5 px-4">
                                <img src="/static/images/nft/wallet/coinbase.png" alt="" height="55" class="mb-3 pb-2">
                    ...
                    <div class="col-lg-4">
                        <div class="card text-center border shadow-none">
                            <div class="card-body py-5 px-4">
                                <img src="/static/images/nft/wallet/binance.png" alt="" height="55" class="mb-3 pb-2">
                                <h5>Binance</h5>
                ...
                <div class="row">
                    <div class="col-lg-4 product-item artwork crypto-card 3d-style">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="explore-place-bid-img">
                                <img src="/static/images/nft/img-03.jpg" alt="" class="card-img-top explore-img" />
                                <div class="bg-overlay"></div>
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1 fs-16"><a href="/nft/item-details" class="text-body">Creative Filtered Portrait</a></h5>
                    ...
                    <div class="col-lg-4 product-item music crypto-card games">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="explore-place-bid-img">
                                <img src="/static/images/nft/img-02.jpg" alt="" class="card-img-top explore-img" />
                                <div class="bg-overlay"></div>
                                <div class="place-bid-btn">
                                    <a href="#!" class="btn btn-primary"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1 fs-16"><a href="/nft/item-details" class="text-body">The Chirstoper</a></h5>
                    ...
                    <div class="col-lg-4 product-item crypto-card 3d-style">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="explore-place-bid-img">
                                <img src="/static/images/nft/img-01.jpg" alt="" class="card-img-top explore-img" />
                                <div class="bg-overlay"></div>
                                <div class="place-bid-btn">
                                    <a href="#!" class="btn btn-primary"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1 fs-16"><a href="/nft/item-details" class="text-body">Abstract Face Painting</a></h5>
                    ...
                    <div class="col-lg-4 product-item games music 3d-style">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="explore-place-bid-img">
                                <img src="/static/images/nft/img-05.jpg" alt="" class="card-img-top explore-img" />
                                <div class="bg-overlay"></div>
                                <div class="place-bid-btn">
                                    <a href="#!" class="btn btn-primary"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1 fs-16"><a href="/nft/item-details" class="text-body">Long-tailed Macaque</a></h5>
                    ...
                    <div class="col-lg-4 product-item artwork music crypto-card">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="explore-place-bid-img">
                                <img src="/static/images/nft/img-06.jpg" alt="" class="card-img-top explore-img" />
                                <div class="bg-overlay"></div>
                                <div class="place-bid-btn">
                                    <a href="#!" class="btn btn-primary"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1 fs-16"><a href="/nft/item-details" class="text-body">Robotic Body Art</a></h5>
                                <p class="text-muted fs-14 mb-0">Artwork</p>
                            </div>
                            <div class="card-footer border-top border-top-dashed">
                                <div class="d-flex align-items-center">
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="card shadow-none">
                            <div class="card-body">
                                <img src="/static/images/nft/wallet.png" alt="" class="avatar-sm">
                    ...
                    <div class="col-lg-3">
                        <div class="card shadow-none">
                            <div class="card-body">
                                <img src="/static/images/nft/money.png" alt="" class="avatar-sm">
                    ...
                    <div class="col-lg-3">
                        <div class="card shadow-none">
                            <div class="card-body">
                                <img src="/static/images/nft/add.png" alt="" class="avatar-sm">
                    ...
                    <div class="col-lg-3">
                        <div class="card shadow-none">
                            <div class="card-body">
                                <img src="/static/images/nft/sell.png" alt="" class="avatar-sm">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row g-1 mb-3">
                                                <div class="col-6">
                                                    <img src="/static/images/nft/img-06.jpg" alt="" class="img-fluid rounded">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <img src="/static/images/nft/img-03.jpg" alt="" class="img-fluid rounded">
                                                </div><!--end col-->
                                            </div><!--end row-->
                                            <a href="#!" class="float-end fs-14"> View All <i class="ri-arrow-right-line align-bottom"></i></a>
                                            <h5 class="mb-0 fs-15"><a href="#!" class="text-body">Artwork <span class="badge bg-secondary-subtle text-secondary">206</span></a></h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row g-1 mb-3">
                                                <div class="col-6">
                                                    <img src="/static/images/nft/img-05.jpg" alt="" class="img-fluid rounded">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <img src="/static/images/nft/img-04.jpg" alt="" class="img-fluid rounded">
                                                </div><!--end col-->
                                            </div><!--end row-->
                                            <a href="#!" class="float-end fs-14"> View All <i class="ri-arrow-right-line align-bottom"></i></a>
                                            <h5 class="mb-0 fs-15"><a href="#!" class="text-body">Crypto Card <span class="badge bg-secondary-subtle text-secondary">743</span></a></h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row g-1 mb-3">
                                                <div class="col-6">
                                                    <img src="/static/images/nft/img-02.jpg" alt="" class="img-fluid rounded">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <img src="/static/images/nft/img-01.jpg" alt="" class="img-fluid rounded">
                                                </div><!--end col-->
                                            </div><!--end row-->
                                            <a href="#!" class="float-end fs-14"> View All <i class="ri-arrow-right-line align-bottom"></i></a>
                                            <h5 class="mb-0 fs-15"><a href="#!" class="text-body">Music <span class="badge bg-secondary-subtle text-secondary">679</span></a></h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <a href="#!" class="float-end fs-14"> View All <i class="ri-arrow-right-line align-bottom"></i></a>
                                            <h5 class="mb-0 fs-15"><a href="#!" class="text-body">Games <span class="badge bg-secondary-subtle text-secondary">341</span></a></h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <a href="#!" class="float-end fs-14"> View All <i class="ri-arrow-right-line align-bottom"></i></a>
                                            <h5 class="mb-0 fs-15"><a href="#!" class="text-body">Photography <span class="badge bg-secondary-subtle text-secondary">1452</span></a></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <a href="/nft/explore" class="btn btn-secondary">View All <i class="ri-arrow-right-line align-bottom"></i></a>
                        </div>
                    </div>
                </div><!-- end row -->
                <div class="row">
                        ...
                        <div class="card explore-box card-animate border">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                                    <img src="/static/images/users/avatar-2.jpg" alt="" class="avatar-xs rounded-circle">
                                ...
                                <div class="explore-place-bid-img overflow-hidden rounded">
                                    <img src="/static/images/nft/img-05.jpg" alt="" class="explore-img w-100">
                                    <div class="bg-overlay"></div>
                                    <div class="place-bid-btn">
                                        <a href="#!" class="btn btn-primary"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                    </div>
                                ...
                                <div class="mt-3">
                                    ...
                                    <h6 class="fs-16 mb-0"><a href="/nft/item-details" class="text-body">Patterns arts &amp; culture</a></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="card explore-box card-animate border">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                                    <img src="/static/images/users/avatar-9.jpg" alt="" class="avatar-xs rounded-circle">
                                    <div class="ms-2 flex-grow-1">
                                ...
                                <div class="explore-place-bid-img overflow-hidden rounded">
                                    <img src="/static/images/nft/img-03.jpg" alt="" class="explore-img w-100">
                                    <div class="bg-overlay"></div>
                                    <div class="place-bid-btn">
                                        <a href="#!" class="btn btn-primary" class="text-body"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                    </div>
                                </div>
                                <div class="mt-3">
                                    ...
                                    <h6 class="fs-16 mb-0"><a href="/nft/item-details">Evolved Reality</a></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card explore-box card-animate border">
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    ...
                                    <h6 class="fs-16 mb-0"><a href="/nft/item-details" class="text-body">Long-tailed macaque</a></h6>
                                </div>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-shink-0">
                                        <img src="/static/images/users/avatar-5.jpg" alt="" class="avatar-sm object-fit-cover rounded">
                                    </div>
                                    <div class="ms-3 flex-grow-1">
                                        <a href="/pages/profile">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-shink-0">
                                        <img src="/static/images/nft/img-06.jpg" alt="" class="avatar-sm object-fit-cover rounded">
                                    </div>
                                    <div class="ms-3 flex-grow-1">
                                        <a href="/pages/profile">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-shink-0">
                                        <img src="/static/images/users/avatar-8.jpg" alt="" class="avatar-sm object-fit-cover rounded">
                                    </div>
                                    <div class="ms-3 flex-grow-1">
                                        <a href="/pages/profile">
            ...
            <div class="container">
                <div class="row align-items-center gy-4">
                    ...
                    <div class="col-sm-auto">
                        <div>
                            <a href="/nft/create" class="btn bg-gradient btn-danger">Create NFT</a>
                            <a href="/nft/explore" class="btn bg-secondary">Discover More</a>
                        </div>
                    </div>
                    <!-- end col -->
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 mt-4">
                        <div>
                            <div>
                                <img src="/static/images/logo-light.png" alt="logo light" height="17">
                            </div>
                            <div class="mt-4">
                            ...
                            <div class="col-sm-4 mt-4">
                                ...
                                <div class="text-muted mt-3">
                                    <ul class="list-unstyled footer-list fs-14">
                                        ...
                                        <li><a href="/crm/deals">Deals</a></li>
    ...
    <script src="/static/js/pages/nft-landing.init.js"></script>
</body>
