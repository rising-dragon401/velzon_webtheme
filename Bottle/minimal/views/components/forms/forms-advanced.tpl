...
%def extra_css():
    <!-- multi.js css -->
    <link rel="stylesheet" type="text/css" href="/static/libs/multi.js/dist/multi.min.css" />
    <!-- autocomplete css -->
                                        ...
                                        <div class="col-lg-6">
                                            <div>
                                                ...
                                                <div class="input-group" data-input-flag>
                                                    <button class="btn btn-light border" type="button" data-bs-toggle="dropdown" aria-expanded="false"><img src="/static/images/flags/us.svg" alt="flag img" height="20" class="country-flagimg rounded"><span class="ms-2 country-codeno">+ 1</span></button>
...
%def extra_js():
    ...
    <!-- input flag init -->
    <script src="/static/js/pages/flag-input.init.js"></script>
