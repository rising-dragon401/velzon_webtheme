                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-body text-center p-5">
                                                            <lord-icon src="https://cdn.lordicon.com/hrqwmuhr.json" trigger="loop" colors="primary:#25a0e2,secondary:#00bd9d" style="width:120px;height:120px"></lord-icon>
                                                            <div class="mt-4">
                                        ...
                                        <div>
                                            ...
                                            <div class="modal fade" id="secondmodal" aria-hidden="true" tabindex="-1">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-body text-center p-5">
                                                            <lord-icon src="https://cdn.lordicon.com/zpxybbhl.json" trigger="loop" colors="primary:#25a0e2,secondary:#0ab39c" style="width:150px;height:150px"></lord-icon>
                                                            <div class="mt-4 pt-3">
                                    ...
                                    <div class="card text-center border">
                                        <div class="card-body p-4 pb-0">
                                            ...
                                            <div class="row justify-content-center mt-2">
                                                <div class="col-lg-10">
                                                    <div>
                                                        <img src="/static/images/modals/success-payment.png" alt="Mac Image" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                        </div><!-- end card body -->
                                    ...
                                    <div class="card text-center border">
                                        <div class="card-body p-4 pb-0">
                                            ...
                                            <div class="row justify-content-center mt-2">
                                                <div class="col-lg-10">
                                                    <div>
                                                        <img src="/static/images/modals/login.png" alt="Mac Image" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                        </div><!-- end card body -->
                                                    ...
                                                    <form>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="mt-1 text-end">
                                                                <a href="/pages/auth-pass-reset-basic">Forgot password ?</a>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="card text-center border">
                                        <div class="card-body p-4 pb-0">
                                            ...
                                            <div class="row justify-content-center mt-2">
                                                <div class="col-lg-10">
                                                    <div>
                                                        <img src="/static/images/modals/subscribe.png" alt="Mac Image" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                        </div><!-- end card body -->
                                                ...
                                                <div class="row g-0">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <div class="subscribe-modals-cover h-100">
                                                            <img src="/static/images/auth-one-bg.jpg" alt="" class="h-100 w-100 object-fit-cover" style="clip-path: polygon(100% 0%, 100% 100%, 100% 100%, 0% 100%, 25% 50%, 0% 0%);">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div><!-- /.modal-content -->
                                    ...
                                    <div class="card text-center border">
                                        <div class="card-body p-4 pb-0">
                                            ...
                                            <div class="row justify-content-center mt-2">
                                                <div class="col-lg-10">
                                                    <div>
                                                        <img src="/static/images/modals/signup.png" alt="Mac Image" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                        </div><!-- end card body -->
