                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-primary card-height-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-sm flex-shrink-0">
                                            <span class="avatar-titlebg-white bg-opacity-25 text-white rounded-2 fs-2">
                            ...
                            <div class="card">
                                <div class="card-body p-0">
                                    ...
                                    <div class="row align-items-end">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="px-3">
                                                <img src="/static/images/user-illustarator-2.png" class="img-fluid"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card bg-primary">
                                <div class="card-body p-0">
                                    ...
                                    <div class="row align-items-end">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="px-3">
                                                <img src="/static/images/user-illustarator-1.png" class="img-fluid"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="avatar-group">
                                                        <div class="avatar-group-item">
                                                            <a href="javascript: void(0);" class="d-inline-block"
                                                                ...
                                                                <img src="/static/images/users/avatar-8.jpg" alt=""
                                                                    class="rounded-circle avatar-xxs">
                                                            </a>
                                                        </div>
                                                        <div class="avatar-group-item">
                                                    ...
                                                    <div class="acitivity-item py-3 d-flex">
                                                        ...
                                                        <div class="flex-grow-1 ms-3">
                                                            ...
                                                            <div
                                                                ...
                                                                <a href="/ecommerce/products-details"
                                                                    class="bg-light rounded p-1">
                                                                    <img src="/static/images/products/img-8.png" alt=""
                                                                        class="img-fluid d-block" />
                                                                </a>
                                                                <a href="/ecommerce/products-details"
                                                                    class="bg-light rounded p-1">
                                                                    <img src="/static/images/products/img-2.png" alt=""
                                                                        class="img-fluid d-block" />
                                                                </a>
                                                                <a href="/ecommerce/products-details"
                                                                    class="bg-light rounded p-1">
                                                                    <img src="/static/images/products/img-10.png" alt=""
                                                                        class="img-fluid d-block" />
                                                                </a>
                                                            </div>
                                    ...
                                    <ul class="list-group list-group-flush border-dashed mb-0">
                                            ...
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 avatar-xs">
                                                    <span class="avatar-title bg-light p-1 rounded-circle">
                                                        <img src="/static/images/svg/crypto-icons/btc.svg"
                                                            class="img-fluid" alt="">
                                                    </span>
                                                </div>
                                        ...
                                        <li class="list-group-item px-0">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 avatar-xs">
                                                    <span class="avatar-title bg-light p-1 rounded-circle">
                                                        <img src="/static/images/svg/crypto-icons/eth.svg"
                                                            class="img-fluid" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                        ...
                                        <li class="list-group-item px-0">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 avatar-xs">
                                                    <span class="avatar-title bg-light p-1 rounded-circle">
                                                        <img src="/static/images/svg/crypto-icons/ltc.svg"
                                                            class="img-fluid" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                        ...
                                        <li class="list-group-item px-0 pb-0">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 avatar-xs">
                                                    <span class="avatar-title bg-light p-1 rounded-circle">
                                                        <img src="/static/images/svg/crypto-icons/dash.svg"
                                                            class="img-fluid" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-grow-1 ms-2">
