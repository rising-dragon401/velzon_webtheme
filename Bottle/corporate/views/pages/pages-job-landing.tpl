            ...
            <nav class="navbar navbar-expand-lg navbar-landing fixed-top job-navbar" id="navbar">
                <div class="container-fluid custom-container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div class="">
                            <a href="/pages/auth-signin-basic" class="btn btn-soft-secondary"><i class="ri-user-3-line align-bottom me-1"></i> Login & Register</a>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div>
                                        <a href="#!" class="link-secondary">Learn More <i class="ri-arrow-right-line align-bottom ms-1"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
