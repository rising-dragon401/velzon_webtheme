                                ...
                                <div class="timeline">
                                    ...
                                    <div class="timeline-item right">
                                        ...
                                        <div class="content">
                                            ...
                                            <p class="text-muted fst-italic mb-2">" This is an awesome admin dashboard template. It is extremely well structured and uses state of the art components (e.g. one of the only templates using bootstrap 5.1.3 so far). I integrated it into a Rails 6 project. Needs manual integration work of course but the template structure made it easy. "</p>
                                            <div class="hstack gap-2">
                                            ...
                                            <div class="col-12">
                                                <div class="timeline-box">
                                                    <div class="timeline-text">
                                                        ...
                                                        <div class="row border border-dashed rounded gx-2 p-2">
                                                            <div class="col-3">
                                                                <a href="javascript:void(0);"><img src="/static/images/small/img-7.jpg" alt="" class="img-fluid rounded"></a>
                                                            </div>
                                                            <!--end col-->
                                                            <div class="col-3">
                                                                <a href="javascript:void(0);"><img src="/static/images/small/img-3.jpg" alt="" class="img-fluid rounded"></a>
                                                            </div>
                                                            <!--end col-->
                                                            <div class="col-3">
                                                                <a href="javascript:void(0);"><img src="/static/images/small/img-10.jpg" alt="" class="img-fluid rounded"></a>
                                                            </div>
                                                            <!--end col-->
                                                            <div class="col-3">
                                                                <a href="javascript:void(0);"><img src="/static/images/small/img-9.jpg" alt="" class="img-fluid rounded"></a>
                                                            </div>
                                                            <!--end col-->
                                                        </div>
                                                    </div>
