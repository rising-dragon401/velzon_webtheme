                    ...
                    <div class="row dash-nft">
                                ...
                                <div class="col-xl-6">
                                    <div class="card overflow-hidden">
                                        <div class="card-body bg-marketplace d-flex">
                                            ...
                                            <img src="/static/images/bg-d.png" alt="" class="img-fluid" />
                                        </div>
                                    </div>
                                </div><!--end col-->
                                                        ...
                                                        <div class="row g-0 text-center">
                                                            <div class="col-6 col-sm-4">
                                                                <div class="p-3 border border-dashed border-start-0">
                                                                    <h5 class="mb-1 fs-16"><span class="counter-value" data-target="36.48">0</span>k</h5>
                                                            ...
                                                            <div class="col-6 col-sm-4">
                                                                <div class="p-3 border border-dashed border-start-0">
                                                                    <h5 class="mb-1 fs-16"><span class="counter-value" data-target="92.54">0</span>k</h5>
                                                            ...
                                                            <div class="col-6 col-sm-4">
                                                                <div class="p-3 border border-dashed border-end-0">
                                                                    <h5 class="mb-1 fs-16"><span class="counter-value" data-target="8.62">0</span>k</h5>
                                                                    <p class="text-muted mb-0">Creators</p>
                                                                </div>
                                                            </div>
                                                            <!--end col-->
                                                        </div>
                                                        <div id="line_chart_basic" data-colors='["--vz-primary","--vz-secondary", "--vz-light"]' class="apex-charts" dir="ltr"></div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xxl-4">
                                                    <div class="border-start p-4 h-100 d-flex flex-column">
                                                        ...
                                                        <div class="w-100">
                                                            ...
                                                            <h4 class="ff-secondary fw-bold mt-4"><i class="mdi mdi-ethereum text-primary"></i> 346.12 ETH</h4>
                                                            ...
                                                            <div class="row mt-4 pt-2">
                                                                <div class="col">
                                                                    <a href="/nft/item-details" class="btn btn-primary w-100">View Details</a>
                                                                </div>
                                                                <div class="col">
                        ...
                        <div class="col-xxl-3">
                            <div class="card">
                                ...
                                <div>
                                    <div id="market-overview" data-colors='["--vz-success", "--vz-secondary"]' class="apex-charts mt-n4"></div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-header d-flex align-items-center">
                                    ...
                                    <a class="text-muted" href="/nft/item-details">
                                        ...
                                        <div data-simplebar style="max-height: 350px;">
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item list-group-item-action">
                                                    <div class="d-flex align-items-center">
                                                        <img src="/static/images/users/avatar-10.jpg" alt="" class="avatar-xs object-fit-cover rounded-circle">
                                                        <div class="ms-3 flex-grow-1">
                                                ...
                                                <li class="list-group-item list-group-item-action">
                                                    <div class="d-flex align-items-center">
                                                        <img src="/static/images/nft/img-01.jpg" alt="" class="avatar-xs object-fit-cover rounded-circle">
                                                        <div class="ms-3 flex-grow-1">
                                                            <a href="#!">
                                                ...
                                                <li class="list-group-item list-group-item-action">
                                                    <div class="d-flex align-items-center">
                                                        <img src="/static/images/nft/img-04.jpg" alt="" class="avatar-xs object-fit-cover rounded-circle">
                                                        <div class="ms-3 flex-grow-1">
                                                            <a href="#!">
                                                ...
                                                <li class="list-group-item list-group-item-action">
                                                    <div class="d-flex align-items-center">
                                                        <img src="/static/images/nft/img-06.jpg" alt="" class="avatar-xs object-fit-cover rounded-circle">
                                                        <div class="ms-3 flex-grow-1">
                                                            <a href="#!">
                                                ...
                                                <li class="list-group-item list-group-item-action">
                                                    <div class="d-flex align-items-center">
                                                        <img src="/static/images/users/avatar-8.jpg" alt="" class="avatar-xs object-fit-cover rounded-circle">
                                                        <div class="ms-3 flex-grow-1">
                                                            <a href="#!">
                                                ...
                                                <li class="list-group-item list-group-item-action">
                                                    <div class="d-flex align-items-center">
                                                        <img src="/static/images/nft/img-03.jpg" alt="" class="avatar-xs object-fit-cover rounded-circle">
                                                        <div class="ms-3 flex-grow-1">
                                                            <a href="#!">
                                                ...
                                                <li class="list-group-item list-group-item-action">
                                                    <div class="d-flex align-items-center">
                                                        <img src="/static/images/nft/img-05.jpg" alt="" class="avatar-xs object-fit-cover rounded-circle">
                                                        <div class="ms-3 flex-grow-1">
                                                            <a href="#!">
                                                                <h6 class="fs-14 mb-1">Timothy Smith</h6>
                                                            </a>
                            ...
                            <div class="swiper marketplace-swiper rounded gallery-light">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="card explore-box card-animate rounded">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-1 fs-16"><a href="/nft/item-details" class="text-body">Walking On Air</a></h5>
                                                <p class="text-muted mb-0">Artwork</p>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card explore-box card-animate rounded">
                                            <div class="explore-place-bid-img">
                                                <img src="/static/images/nft/img-03.jpg" alt="" class="img-fluid card-img-top explore-img" />
                                                <div class="bg-overlay"></div>
                                                <div class="place-bid-btn">
                                                    <a href="#!" class="btn btn-secondary"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                                </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-1 fs-16"><a href="/nft/item-details" class="text-body">Filtered Portrait</a></h5>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card explore-box card-animate rounded">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-1 fs-16"><a href="/nft/item-details" class="text-body">Patterns Arts & Culture</a></h5>
                                                <p class="text-muted mb-0">Artwork</p>
                                            </div>
                                            <div class="card-footer border-top border-top-dashed">
                                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card explore-box card-animate rounded">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-1 fs-16"><a href="/nft/item-details" class="text-body">Evolved Reality</a></h5>
                                            ...
                                            <table class="table table-borderless align-middle">
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <img src="/static/images/nft/img-01.jpg" alt="" class="avatar-sm rounded-circle">
                                                                <div class="ms-3">
                                                                    <a href="#!">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <img src="/static/images/nft/img-02.jpg" alt="" class="avatar-sm rounded-circle">
                                                                <div class="ms-3">
                                                                    <a href="#!">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <img src="/static/images/nft/img-03.jpg" alt="" class="avatar-sm rounded-circle">
                                                                <div class="ms-3">
                                                                    <a href="#!">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <img src="/static/images/nft/img-04.jpg" alt="" class="avatar-sm rounded-circle">
                                                                <div class="ms-3">
                                                                    <a href="#!">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <img src="/static/images/nft/img-05.jpg" alt="" class="avatar-sm rounded-circle">
                                                                <div class="ms-3">
                                                                    <a href="#!">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <img src="/static/images/nft/img-06.jpg" alt="" class="avatar-sm rounded-circle">
                                                                <div class="ms-3">
                                                                    <a href="#!">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2">
                                                                <img src="/static/images/nft/img-01.jpg" alt="" class="avatar-xs rounded-circle">
                                                            </div>
                                                            <div class="flex-grow-1">
                                                                <h6 class="mb-1"><a href="/nft/item-details" class="text-body">Abstract Face Painting</a></h6>
                                                                <p class="text-muted fs-13 mb-0"> Artworks</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td><img src="/static/images/svg/crypto-icons/btc.svg" class="avatar-xxs me-2" alt="">48,568.025</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="flex-grow-1">
                                                                <h6 class="mb-1"><a href="/nft/item-details" class="text-body">Long-tailed Macaque</a></h6>
                                                                <p class="text-muted fs-13 mb-0">Games</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td><img src="/static/images/svg/crypto-icons/ltc.svg" class="avatar-xxs me-2" alt="">87,142.027</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2">
                                                                <img src="/static/images/nft/img-06.jpg" alt="" class="avatar-xs rounded-circle">
                                                            </div>
                                                            <div class="flex-grow-1">
                                                                <h6 class="mb-1"><a href="/nft/item-details" class="text-body">Robotic Body Art</a></h6>
                                                                <p class="text-muted fs-13 mb-0">Photography</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td><img src="/static/images/svg/crypto-icons/etc.svg" class="avatar-xxs me-2" alt="">33,847.961</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2">
                                                                <img src="/static/images/nft/img-04.jpg" alt="" class="avatar-xs rounded-circle">
                                                            </div>
                                                            <div class="flex-grow-1">
                                                                <h6 class="mb-1"><a href="/nft/item-details" class="text-body">Smillevers Crypto</a></h6>
                                                                <p class="text-muted fs-13 mb-0">Artworks</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td><img src="/static/images/svg/crypto-icons/dash.svg" class="avatar-xxs me-2" alt="">73,654.421</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2">
                                                                <img src="/static/images/nft/img-03.jpg" alt="" class="avatar-xs rounded-circle">
                                                            </div>
                                                            <div class="flex-grow-1">
                                                                <h6 class="mb-1"><a href="/nft/item-details" class="text-body">Creative Filtered Portrait</a></h6>
                                                                <p class="text-muted fs-13 mb-0"> 3d Style</p>
                                                            </div>
                                                            <div class="flex-grow-1"></div>
                                                        </div>
                                                    </td>
                                                    <td><img src="/static/images/svg/crypto-icons/bnb.svg" class="avatar-xxs me-2" alt="">66,742.077</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2">
                                                                <img src="/static/images/nft/img-02.jpg" alt="" class="avatar-xs rounded-circle">
                                                            </div>
                                                            <div class="flex-grow-1">
                                                                <h6 class="mb-1"><a href="/nft/item-details" class="text-body">The Chirstoper</a></h6>
                                                                <p class="text-muted fs-13 mb-0"> Crypto Card</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td><img src="/static/images/svg/crypto-icons/usdt.svg" class="avatar-xxs me-2" alt="">34,736.209</td>
                                                    <td>
                        ...
                        <div class="col-xxl-3 col-lg-6">
                            <div class="card card-height-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-1">
                                        <p class="mb-1"><img src="/static/images/flags/us.svg" alt="" height="15" class="rounded me-2"> United States <span class="float-end">34%</span></p>
                                        <p class="mb-1"><img src="/static/images/flags/russia.svg" alt="" height="15" class="rounded me-2"> Russia <span class="float-end">27%</span></p>
                                        <p class="mb-1"><img src="/static/images/flags/spain.svg" alt="" height="15" class="rounded me-2"> Spain <span class="float-end">21%</span></p>
                                        <p class="mb-1"><img src="/static/images/flags/italy.svg" alt="" height="15" class="rounded me-2"> Italy <span class="float-end">13%</span></p>
                                        <p class="mb-0"><img src="/static/images/flags/germany.svg" alt="" height="15" class="rounded me-2"> Germany <span class="float-end">5%</span></p>
                                    </div>
                                </div>
                                <!-- end card body -->
                            </div>
                        ...
                        <div class="col-xxl-3 col-lg-6">
                            <div class="card">
                                <div class="card-header d-flex align-items-center">
                                    ...
                                    <a href="/nft/collections" type="button" class="btn btn-soft-primary btn-sm flex-shrink-0">
                                        See All <i class="ri-arrow-right-line align-bottom"></i>
                                    </a>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="dash-collection overflow-hidden rounded-top position-relative">
                                                    <img src="/static/images/nft/img-03.jpg" alt="" height="220" class="object-fit-cover w-100" />
                                            ...
                                            <div class="swiper-slide">
                                                <div class="dash-collection overflow-hidden rounded-top position-relative">
                                                    <img src="/static/images/nft/img-04.jpg" alt="" height="220" class="object-fit-cover w-100" />
                                                    <div class="content position-absolute bottom-0 m-2 p-2 start-0 end-0 rounded d-flex align-items-center">
                                                        <div class="flex-grow-1">
                                                            <a href="#!">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="dash-collection overflow-hidden rounded-top position-relative">
                                                    <img src="/static/images/nft/img-06.jpg" alt="" height="220" class="object-fit-cover w-100" />
                                                    <div class="content position-absolute bottom-0 m-2 p-2 start-0 end-0 rounded d-flex align-items-center">
                                                        <div class="flex-grow-1">
                                                            <a href="#!">
                            ...
                            <div class="card">
                                <div class="card-header d-flex align-items-center">
                                    ...
                                    <a href="/nft/creators" type="button" class="btn btn-soft-primary btn-sm flex-shrink-0">
                                        See All <i class="ri-arrow-right-line align-bottom"></i>
                                    </a>
                                </div>
                                <div class="card-body">
                                    <div class="swiper collection-slider">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="d-flex">
                                                    <div class="flex-shink-0">
                                                        <img src="/static/images/nft/img-02.jpg" alt="" class="avatar-sm object-fit-cover rounded">
                                                    </div>
                                                    <div class="ms-3 flex-grow-1">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex">
                                                    <div class="flex-shink-0">
                                                        <img src="/static/images/nft/img-01.jpg" alt="" class="avatar-sm object-fit-cover rounded">
                                                    </div>
                                                    <div class="ms-3 flex-grow-1">
                                                        <a href="/pages/profile">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex">
                                                    <div class="flex-shink-0">
                                                        <img src="/static/images/nft/img-04.jpg" alt="" class="avatar-sm object-fit-cover rounded">
                                                    </div>
                                                    <div class="ms-3 flex-grow-1">
                                                        <a href="/pages/profile">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex">
                                                    <div class="flex-shink-0">
                                                        <img src="/static/images/users/avatar-1.jpg" alt="" class="avatar-sm object-fit-cover rounded">
                                                    </div>
                                                    <div class="ms-3 flex-grow-1">
                                                        <a href="/pages/profile">
...
%def extra_js():
    ...
    <!-- Marketplace init -->
    <script src="/static/js/pages/dashboard-nft.init.js"></script>
