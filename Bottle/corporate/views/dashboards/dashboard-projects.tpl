                                        ...
                                        <table class="table table-nowrap table-centered align-middle">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="/static/images/users/avatar-1.jpg" class="avatar-xxs rounded-circle me-1" alt="">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="/static/images/users/avatar-2.jpg" class="avatar-xxs rounded-circle me-1" alt="">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="/static/images/users/avatar-3.jpg" class="avatar-xxs rounded-circle me-1" alt="">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="/static/images/users/avatar-5.jpg" class="avatar-xxs rounded-circle me-1" alt="">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="/static/images/users/avatar-6.jpg" class="avatar-xxs rounded-circle me-1" alt="">
                    ...
                    <div class="row">
                                    ...
                                    <div class="table-responsive table-card">
                                        <table class="table table-borderless table-nowrap align-middle mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="d-flex">
                                                        <img src="/static/images/users/avatar-1.jpg" alt="" class="avatar-xs rounded-3 me-2">
                                                        <div>
                                                ...
                                                <tr>
                                                    <td class="d-flex">
                                                        <img src="/static/images/users/avatar-2.jpg" alt="" class="avatar-xs rounded-3 me-2">
                                                        <div>
                                                ...
                                                <tr>
                                                    <td class="d-flex">
                                                        <img src="/static/images/users/avatar-7.jpg" alt="" class="avatar-xs rounded-3 me-2">
                                                        <div>
                                                ...
                                                <tr>
                                                    <td class="d-flex">
                                                        <img src="/static/images/users/avatar-4.jpg" alt="" class="avatar-xs rounded-3 me-2">
                                                        <div>
                                                ...
                                                <tr>
                                                    <td class="d-flex">
                                                        <img src="/static/images/users/avatar-6.jpg" alt="" class="avatar-xs rounded-3 me-2">
                                                        <div>
                                                ...
                                                <tr>
                                                    <td class="d-flex">
                                                        <img src="/static/images/users/avatar-5.jpg" alt="" class="avatar-xs rounded-3 me-2">
                                                        <div>
                                                ...
                                                <tr>
                                                    <td class="d-flex">
                                                        <img src="/static/images/users/avatar-3.jpg" alt="" class="avatar-xs rounded-3 me-2">
                                                        <div>
                        ...
                        <div class="col-xxl-4 col-lg-6">
                            <div class="card card-height-100">
                                ...
                                <div class="card-body">
                                    <div id="prjects-status" data-colors='["--vz-success", "--vz-primary", "--vz-warning", "--vz-secondary"]' class="apex-charts" dir="ltr"></div>
                                    <div class="mt-3">
                                        ...
                                        <div class="d-flex justify-content-between py-2">
                                            <p class="fw-medium mb-0"><i class="ri-checkbox-blank-circle-fill text-secondary align-middle me-2"></i> Cancelled</p>
                                            <div>
