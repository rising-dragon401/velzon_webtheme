                    ...
                    <div class="row">
                        <div class="col-xxl-3">
                            <div class="card card-height-100">
                                ...
                                <div class="card-body">
                                    <div id="portfolio_donut_charts" data-colors='["--vz-primary", "--vz-secondary", "--vz-info", "--vz-success"]' class="apex-charts" dir="ltr"></div>
                                        ...
                                        <li class="list-group-item px-0">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1 ms-2">
                                                    ...
                                                    <p class="fs-12 mb-0 text-muted"><i class="mdi mdi-circle fs-10 align-middle text-secondary me-1"></i>LTC </p>
                                                </div>
                                                <div class="flex-shrink-0 text-end">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="row align-items-end g-0">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="apex-charts crypto-widget" data-colors='["--vz-success", "--vz-transparent"]' dir="ltr" id="Ethereum_sparkline_charts"></div>
                                                    </div><!-- end col -->
                                                </div><!-- end row -->
                                            </div><!-- end card body -->
                                        </div><!-- end card -->
                                    ...
                                    <div class="tab-content p-0">
                                        <div class="tab-pane active" id="buy-tab" role="tabpanel">
                                            ...
                                            <div class="p-3">
                                                ...
                                                <div class="mt-3 pt-2">
                                                    <button type="button" class="btn btn-success w-100">Buy Coin</button>
                                                </div>
                                            </div>
                                        </div><!-- end tabpane -->
