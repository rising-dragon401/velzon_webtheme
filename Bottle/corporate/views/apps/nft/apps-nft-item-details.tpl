                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-lg-8">
                                    <div>
                                        ...
                                        <span class="badge bg-secondary-subtle text-secondary mb-3 fs-12"><i class="ri-eye-line me-1 align-bottom"></i> 8,634 people views this</span>
                                            ...
                                            <div class="col-lg-3 col-sm-6">
                                                <div class="p-2 border border-dashed rounded text-center">
                                                    <div>
                                                        ...
                                                        <h5 class="fs-16 text-success mb-0"><i class="mdi mdi-ethereum me-1"></i> 83.06 ETH</h5>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- end col -->
