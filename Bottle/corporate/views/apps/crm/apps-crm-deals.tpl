                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-auto ms-auto">
                                    <div class="d-flex hastck gap-2 flex-wrap">
                                        ...
                                        <button data-bs-toggle="modal" data-bs-target="#adddeals" class="btn btn-secondary"><i class="ri-add-fill align-bottom me-1"></i> Add Deals</button>
                                        <div class="dropdown">
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="deatType" data-choices aria-label="Default select example" required>
                                                ...
                                                <option value="Lead Discovered">Lead Discovered</option>
