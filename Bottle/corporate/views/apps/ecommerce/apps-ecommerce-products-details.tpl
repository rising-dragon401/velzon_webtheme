                                            ...
                                            <div class="product-img-slider sticky-side-div">
                                                <div class="swiper product-thumbnail-slider p-2 rounded bg-light">
                                                    <div class="swiper-wrapper">
                                                        ...
                                                        <div class="swiper-slide">
                                                            <img src="/static/images/products/img-6.png" alt="" class="img-fluid d-block" />
                                                        </div>
                                                        <div class="swiper-slide">
                                            ...
                                            <div class="mt-xl-0 mt-5">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-shrink-0">
                                                        <div>
                                                            <a href="/ecommerce/add-product" class="btn btn-light" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="ri-pencil-fill align-bottom"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
