                    ...
                    <div class="row mb-3">
                        <div class="col-xl-8">
                            ...
                            <div class="text-end mb-4">
                                <a href="/ecommerce/checkout" class="btn btn-secondary btn-label right ms-auto"><i class="ri-arrow-right-line label-icon align-bottom fs-16 ms-2"></i> Checkout</a>
                            </div>
                        </div>
                        <!-- end col -->
                                ...
                                <div class="alert border-dashed alert-danger" role="alert">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2">
                                            ...
                                            <p class="text-body mb-1">Gift wrap and personalised message on card, <br />Only for <span class="fw-semibold">$9.99</span> USD </p>
