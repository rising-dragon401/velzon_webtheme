                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade" id="pills-bill-address" role="tabpanel" aria-labelledby="pills-bill-address-tab">
                                                ...
                                                <div class="d-flex align-items-start gap-3 mt-4">
                                                    ...
                                                    <button type="button" class="btn btn-secondary btn-label right ms-auto nexttab" data-nexttab="pills-payment-tab"><i class="ri-bank-card-line label-icon align-middle fs-16 ms-2"></i>Continue to Payment</button>
                                                </div>
                                            </div>
                                            <!-- end tab pane -->
                                            ...
                                            <div class="tab-pane fade" id="pills-payment" role="tabpanel" aria-labelledby="pills-payment-tab">
                                                ...
                                                <div class="d-flex align-items-start gap-3 mt-4">
                                                    ...
                                                    <button type="button" class="btn btn-secondary btn-label right ms-auto nexttab" data-nexttab="pills-finish-tab"><i class="ri-shopping-basket-line label-icon align-middle fs-16 ms-2"></i>Complete Order</button>
                                                </div>
                                            </div>
                                            <!-- end tab pane -->
                                            ...
                                            <div class="tab-pane fade" id="pills-finish" role="tabpanel" aria-labelledby="pills-finish-tab">
                                                <div class="text-center py-5">
                                                    ...
                                                    <h5 class="fw-semibold">Order ID: <a href="/ecommerce/orders-details" class="text-decoration-underline">VZ2451</a></h5>
                                                </div>
                                            </div>
                                            <!-- end tab pane -->
                                        </div>
                                        ...
                                        <table class="table table-borderless align-middle mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h5 class="fs-14"><a href="/ecommerce/products-details" class="text-body">Sweatshirt for Men (Pink)</a></h5>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h5 class="fs-14"><a href="/ecommerce/products-details" class="text-body">350 ml Glass Grocery Container</a></h5>
