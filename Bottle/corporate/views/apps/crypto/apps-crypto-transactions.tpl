                    ...
                    <div class="row align-items-center mb-4 g-3">
                        ...
                        <div class="col-sm-auto ms-auto">
                            <div class="d-flex gap-2">
                                <a href="javascript:void(0);" class="btn btn-success">Deposite</a>
                                <a href="javascript:void(0);" class="btn btn-secondary">Withdraw</a>
                            </div>
                        </div>
                        <!--end col-->
                    </div>
                            ...
                            <div class="row align-items-center g-3">
                                ...
                                <div class="col-md-auto ms-auto">
                                    <div class="d-flex gap-2">
                                        ...
                                        <button class="btn btn-soft-primary"><i class="ri-equalizer-line align-bottom me-1"></i> Filters</button>
                                    </div>
                                </div>
                                <!--end col-->
                            </div>
