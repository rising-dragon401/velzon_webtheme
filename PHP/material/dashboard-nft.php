                        ...
                        <div class="col-xxl-3 col-lg-6">
                            <div class="card">
                                <div class="card-header d-flex align-items-center">
                                    ...
                                    <a href="apps-nft-collections.php" type="button" class="btn btn-soft-primary btn-sm shadow-none flex-shrink-0">
                                        See All <i class="ri-arrow-right-line align-bottom"></i>
                                    </a>
                                </div>
                                <div class="card-body">
                            ...
                            <div class="card">
                                <div class="card-header d-flex align-items-center">
                                    ...
                                    <a href="apps-nft-creators.php" type="button" class="btn btn-soft-primary btn-sm shadow-none flex-shrink-0">
                                        See All <i class="ri-arrow-right-line align-bottom"></i>
                                    </a>
                                </div>
                                <div class="card-body">
