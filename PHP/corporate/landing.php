                    ...
                    <div class="col-lg-8 col-sm-10">
                        <div class="text-center mt-lg-5 pt-5">
                            ...
                            <div class="d-flex gap-2 justify-content-center mt-4">
                                ...
                                <a href="pages-pricing.php" class="btn btn-soft-secondary">View Plans <i class="ri-eye-line align-middle ms-1"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body text-center p-4">
                                <div class="avatar-xl mx-auto mb-4 position-relative">
                                    ...
                                    <a href="apps-mailbox.php" class="btn btn-secondary btn-sm position-absolute bottom-0 end-0 rounded-circle avatar-xs">
