            ...
            <div class="container">
                <div class="row align-items-center gy-4">
                    ...
                    <div class="col-sm-auto">
                        <div>
                            <a href="apps-nft-create.php" class="btn bg-gradient btn-success">Create NFT</a>
                            <a href="apps-nft-explore.php" class="btn bg-gradient btn-secondary">Discover More</a>
                        </div>
                    </div>
                    <!-- end col -->
                </div>
