                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="d-flex mb-2">
                                            ...
                                            <div class="flex-grow-1">
                                                <h5 class="mb-1 fs-16"><a href="apps-projects-overview.php" class="text-body">Slack brand logo design</a></h5>
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="d-flex mb-2">
                                            ...
                                            <div class="flex-grow-1">
                                                <h5 class="mb-1 fs-16"><a href="apps-projects-overview.php" class="text-body">Redesign - Landing page</a></h5>
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="d-flex mb-2">
                                            ...
                                            <div class="flex-grow-1">
                                                <h5 class="mb-1 fs-16"><a href="apps-projects-overview.php" class="text-body">Chat Application</a></h5>
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="d-flex mb-2">
                                            ...
                                            <div class="flex-grow-1">
                                                <h5 class="mb-1 fs-16"><a href="apps-projects-overview.php" class="text-body">Project App</a></h5>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="p-3 mt-n3 mx-n3 bg-danger-subtle rounded-top">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h5 class="mb-0 fs-15"><a href="apps-projects-overview.php" class="text-body">Multipurpose landing template</a></h5>
                                            </div>
                                            <div class="flex-shrink-0">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="p-3 mt-n3 mx-n3 bg-warning-subtle rounded-top">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h5 class="mb-0 fs-15"><a href="apps-projects-overview.php" class="text-body">Dashboard UI</a></h5>
                                            </div>
                                            <div class="flex-shrink-0">
                                                <div class="d-flex gap-1 align-items-center my-n2">
                                                    <button type="button" class="btn avatar-xs p-0 favourite-btn active">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="p-3 mt-n3 mx-n3 bg-info-subtle rounded-top">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h5 class="mb-0 fs-15"><a href="apps-projects-overview.php" class="text-body">Vector Images</a></h5>
                                            </div>
                                            <div class="flex-shrink-0">
                                                <div class="d-flex gap-1 align-items-center my-n2">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="p-3 mt-n3 mx-n3 bg-success-subtle rounded-top">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h5 class="mb-0 fs-15"><a href="apps-projects-overview.php" class="text-body">Authentication</a></h5>
                                            </div>
                                            <div class="flex-shrink-0">
                                                <div class="d-flex gap-1 align-items-center my-n2">
                                                    <button type="button" class="btn avatar-xs p-0 favourite-btn active">
                        ...
                        <div class="col-xxl-3 col-sm-6 project-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="py-3">
                                        <h5 class="fs-15 mb-3"><a href="apps-projects-overview.php" class="text-body">Kanban Board</a></h5>
                                        <div class="row gy-3">
                                            <div class="col-6">
                                                <div>
                                                    <p class="text-muted mb-1">Status</p>
                        ...
                        <div class="col-xxl-3 col-sm-6 project-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="py-3">
                                        <h5 class="mb-3 fs-15"><a href="apps-projects-overview.php" class="text-body">Ecommerce app</a></h5>
                                        <div class="row gy-3">
                                            <div class="col-6">
                                                <div>
                                                    <p class="text-muted mb-1">Status</p>
                        ...
                        <div class="col-xxl-3 col-sm-6 project-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="py-3">
                                        <h5 class="mb-3 fs-15"><a href="apps-projects-overview.php" class="text-body">Redesign - Landing page</a></h5>
                                        <div class="row gy-3">
                                            <div class="col-6">
                                                <div>
                                                    <p class="text-muted mb-1">Status</p>
                        ...
                        <div class="col-xxl-3 col-sm-6 project-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="py-3">
                                        <h5 class="mb-3 fs-15"><a href="apps-projects-overview.php" class="text-body">Multipurpose landing template</a></h5>
                                        <div class="row gy-3">
                                            <div class="col-6">
                                                <div>
                                                    <p class="text-muted mb-1">Status</p>
