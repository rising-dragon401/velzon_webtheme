                            ...
                            <div>
                                <div class="d-flex profile-wrapper">
                                    ...
                                    <div class="flex-shrink-0">
                                        <a href="pages-profile-settings.php" class="btn btn-info"><i class="ri-edit-box-line align-bottom"></i> Edit Profile</a>
                                    </div>
                                </div>
                                <!-- Tab panes -->
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="d-flex align-items-center">
                                                                                ...
                                                                                <div class="ms-3 flex-grow-1">
                                                                                    <h6 class="fs-15 mb-0"><a href="javascript:void(0);" class="text-body">Velzon-logo.png</a></h6>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td>PNG File</td>
