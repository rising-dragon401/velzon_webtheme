                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-sm-8">
                                            <div class="p-3">
                                                ...
                                                <div class="mt-3">
                                                    <a href="pages-pricing.php" class="btn btn-success">Upgrade
                                                        Account!</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="p-3">
                                                <p class="fs-16 lh-base text-white">Upgrade your plan from a <span class="fw-semibold">Free
                                                        trial</span>, to ‘Premium Plan’ <i class="mdi mdi-arrow-right"></i></p>
                                                <div class="mt-3">
                                                    <a href="pages-pricing.php" class="btn btn-info">Upgrade
                                                        Account!</a>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body p-0">
                                    ...
                                    <div class="d-flex p-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-3">
                                                <a href="pages-pricing.php" class="btn btn-secondary">Get a Free
                                                    Gift</a>
                                            </div>
                                        </div>
                                    </div>
