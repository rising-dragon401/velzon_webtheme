                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade" id="pills-finish" role="tabpanel" aria-labelledby="pills-finish-tab">
                                                <div class="text-center py-5">
                                                    ...
                                                    <h3>Order ID: <a href="apps-ecommerce-order-details.php" class="text-decoration-underline">VZ2451</a></h3>
                                                </div>
                                            </div>
                                            <!-- end tab pane -->
                                        </div>
                                        ...
                                        <table class="table table-borderless align-middle mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h5 class="fs-14"><a href="apps-ecommerce-product-details.php" class="text-body">Sweatshirt for Men (Pink)</a>
                                                        </h5>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h5 class="fs-14"><a href="apps-ecommerce-product-details.php" class="text-body">350 ml Glass Grocery Container</a>
                                                        </h5>
