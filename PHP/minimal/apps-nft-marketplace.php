                            ...
                            <div class="card explore-box">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-15 mb-0"><a href="apps-nft-item-details.php" class="text-body">Patterns Arts & Culture</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card explore-box">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-15 mb-0"><a href="apps-nft-item-details.php" class="text-body">Evolved Reality</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card explore-box">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-15 mb-0"><a href="apps-nft-item-details.php" class="text-body">Long-tailed Macaque</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card explore-box">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-15 mb-0"><a href="apps-nft-item-details.php" class="text-body">Robotic Body Art</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card explore-box">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-15 mb-0"><a href="apps-nft-item-details.php" class="text-body">Creative Filtered Portrait</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1 fs-15"><a href="apps-nft-item-details.php" class="text-body">The Chirstoper</a></h5>
                        ...
                        <div class="col">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1 fs-15"><a href="apps-nft-item-details.php" class="text-body">Trendy Fashion Portraits</a></h5>
                        ...
                        <div class="col">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1 fs-15"><a href="apps-nft-item-details.php" class="text-body">Smillevers Crypto</a></h5>
                        ...
                        <div class="col">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1 fs-15"><a href="apps-nft-item-details.php" class="text-body">Evolved Reality</a></h5>
                        ...
                        <div class="col">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1 fs-15"><a href="apps-nft-item-details.php" class="text-body">Abstract Face Painting</a></h5>
                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <h5 class="mt-3 mb-1 fs-15"><a href="pages-profile.php" class="text-body">Tonya Noble</a></h5>
                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <h5 class="mt-3 mb-1 fs-15"><a href="pages-profile.php" class="text-body">Kevin Dawson</a></h5>
                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <h5 class="mt-3 mb-1 fs-15"><a href="pages-profile.php" class="text-body">Herbert Stokes</a></h5>
                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <h5 class="mt-3 mb-1 fs-15"><a href="pages-profile.php" class="text-body">Thomas Taylor</a></h5>
                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <h5 class="mt-3 mb-1 fs-15"><a href="pages-profile.php" class="text-body">James Price</a></h5>
