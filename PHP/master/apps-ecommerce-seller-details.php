                        ...
                        <div class="col-xxl-9">
                            <div class="card">
                                ...
                                <div class="card-body p-0 pb-2">
                                    <div>
                                        <div id="customer_impression_charts" data-colors-minimal='["--vz-primary-rgb, 0.1", "--vz-primary", "--vz-primary-rgb, 0.6"]' data-colors-saas='["--vz-success", "--vz-primary", "--vz-danger"]' data-colors-creative='["--vz-warning", "--vz-secondary", "--vz-success"]' data-colors='["--vz-primary", "--vz-success", "--vz-danger"]' class="apex-charts"></div>
                                    </div>
                                </div><!-- end card body -->
                            </div><!-- end card -->
