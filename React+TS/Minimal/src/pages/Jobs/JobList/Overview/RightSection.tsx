...
const RightSection = () => {
  ...
  const favouriteBtn = (ele: any) => {
    if (ele.closest("#id").classList.contains("active")) {
      ele.closest("#id").classList.remove("active");
    } else {
      ele.closest("#id").classList.add("active");
    }
      ...
      <Card>
        ...
        <CardBody >
          ...
          <div className="mt-4 pt-2 hstack gap-2">
            ...
            <Link
              to="#!"
              className="btn btn-soft-danger btn-icon custom-toggle flex-shrink-0 active"
