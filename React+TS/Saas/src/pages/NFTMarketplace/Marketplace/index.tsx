                ...
                <Container fluid>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card className="overflow-hidden shadow-none">
                                ...
                                <div className="fs-14 marquee">NFT art is a digital asset that is collectable, unique, and non-transferrable, Cortes explained. Every NFT is unique in its creative design and cannot be duplicated, making them limited and rare. NFTs get their value because the transaction proves ownership of the art.</div>
                                </CardBody>
                            </Card>
                        </Col>
                    </Row>
                    ...
                    <Row>
                        <Col lg={12}>
                            <div className="d-lg-flex align-items-center mb-4">
                                <div className="flex-grow-1">
                                    <h5 className="card-title mb-0 fw-bold fs-16">Popular Creators</h5>
                                </div>
                                <div className="flex-shrink-0 mt-4 mt-lg-0">
                                    <Link to="/apps-nft-creators" className="btn btn-soft-primary">View All <i className="ri-arrow-right-line align-bottom"></i></Link>
                                </div>
