                            ...
                            <Card>
                                ...
                                <CardBody className="p-4">
                                    <TabContent activeTab={activeTab} className="text-muted">
                                        <TabPane tabId="1">
                                            <div className="pb-3">
                                                <h5 className="fs-14 mb-1"><Link to="#">Velzon - Responsive Bootstrap 5 Admin Dashboard</Link></h5>
                                            ...
                                            <div className="py-3">
                                                <h5 className="fs-14 mb-1"><Link to="#">Skote - Admin & Dashboard Template by Themesbrand</Link></h5>
                                            ...
                                            <div className="py-3">
                                                <h5 className="fs-14 mb-1"><Link to="#">Minia - React Js Admin & Dashboard Template</Link></h5>
                                            ...
                                            <div className="py-3">
                                                <h5 className="fs-14 mb-1"><Link to="#">Doson - Angular Admin & Dashboard Template by Themesbrand</Link></h5>
                                                ...
                                                {(video || []).map((item, key) => (
                                                    <Col lg={12} className="video-list" key={key}>
                                                        <div className="list-element mt-4">
                                                            <h5 className="fs-14 mb-1"><Link to="#">{item.title}</Link></h5>
