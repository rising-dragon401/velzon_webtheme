                                            ...
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="ms-3 flex-grow-1">
                                                        <h6 className="fs-14 mb-0"><Link to="#" className='text-body'>App pages.zip</Link></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>Zip File</td>
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="ms-3 flex-grow-1">
                                                        <h6 className="fs-14 mb-0"><Link to="#" className='text-body'>Velzon admin.ppt</Link></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>PPT File</td>
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="ms-3 flex-grow-1">
                                                        <h6 className="fs-14 mb-0"><Link to="#" className='text-body'>Images.zip</Link></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>ZIP File</td>
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="ms-3 flex-grow-1">
                                                        <h6 className="fs-14 mb-0"><Link to="#" className='text-body'>Bg-pattern.png</Link></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>PNG File</td>
