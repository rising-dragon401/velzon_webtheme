...
// get application list data from json 
var currentHash = window.location.hash;
$.ajax({
    url: "assets/json/application-list.json",
    // cache: false,
    dataType: "JSON",
    type: "GET",
    success: function (data) {
        ...
        data.forEach(raw => {
            applicationList.add({
                id: '<a href="#" class="fw-medium link-primary">#VZ' + raw.id + '</a>',
                company: '<div class="d-flex align-items-center">\
            <div class="flex-shrink-0">\
                <img src="'+ raw.company[0] + '" alt="" class="avatar-xxs rounded-circle image_src object-fit-cover">\
            </div>\
            <div class="flex-grow-1 ms-2 name">'+ raw.company[1] + '</div>\
        </div>',
