...
function emailDetailShow() {
    ...
    window.addEventListener('click', function (e) {
        if (document.querySelector(".email-menu-sidebar") && document.querySelector(".email-menu-sidebar").classList.contains('menubar-show')) {
            if (!isShowMenu) {
...
function checkBoxAll() {
    ...
    function checkAll() {
        ...
        Array.from(checkboxes).forEach(function (chkbox) {
            chkbox.checked = true;
            if (chkbox.parentNode.parentNode.parentNode)
