...
// get order list data from json 
var currentHash = window.location.hash;
$.ajax({
    url: "assets/json/orders-list.init.json",
    // cache: false,
    dataType: "JSON",
    type: "GET",
    success: function (data) {
        ...
        data.forEach(raw => {
            orderList.add({
                id: '<a href="apps-ecommerce-order-details.html" class="fw-medium link-primary">#VZ' + raw.id + '</a>',
                customer_name: raw.customer_name,
                product_name: raw.product_name,
                date: str_dt(raw.date),
                amount: raw.amount,
                payment: raw.payment,
