    ...
    <div class="row row-cols-xxl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
        <div class="col">
            <div class="card border-0 overflow-hidden">
                <a class="card-body bg-primary-subtle" data-bs-toggle="collapse" href="#leadDiscovered" role="button"
            ...
            <div class="collapse show" id="leadDiscovered">
                <div class="card mb-1">
                    ...
                    <div class="collapse border-top border-top-dashed" id="leadDiscovered1">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Nesta Technologies <small class="badge bg-primary-subtle text-primary">4
                                    Days</small></h6>
            ...
            <div class="collapse show" id="contactInitiated">
                ...
                <div class="card mb-1">
                    ...
                    <div class="collapse border-top border-top-dashed" id="contactInitiated2">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Zoetic Fashion <small class="badge bg-success-subtle text-success">25
                                    Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
        ...
        <div class="col">
            <div class="card border-0 overflow-hidden">
                <a class="card-body bg-primary-subtle" data-bs-toggle="collapse" href="#needsIdentified" role="button"
            ...
            <div class="collapse show" id="needsIdentified">
                <div class="card mb-1">
                    ...
                    <div class="collapse border-top border-top-dashed" id="needsIdentified1">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Alexis Clarke <small class="badge bg-primary-subtle text-primary">7
                                    Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
                ...
                <div class="card mb-1">
                    ...
                    <div class="collapse border-top border-top-dashed" id="needsIdentified2">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Meta4Systems <small class="badge bg-success-subtle text-success">35
                                    Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
                ...
                <div class="card mb-1">
                    ...
                    <div class="collapse border-top border-top-dashed" id="needsIdentified3">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Syntyce Solutions <small class="badge bg-primary-subtle text-primary">15
                                    Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
                ...
                <div class="card mb-1">
                    ...
                    <div class="collapse border-top border-top-dashed" id="needsIdentified6">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">iTest Factory <small class="badge bg-primary-subtle text-primary">42
                                    Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
        ...
        <div class="col">
            <div class="card border-0 overflow-hidden">
                <a class="card-body bg-primary-subtle" data-bs-toggle="collapse" href="#meetingArranged" role="button"
            ...
            <div class="collapse show" id="meetingArranged">
                <div class="card mb-1">
                    ...
                    <div class="collapse border-top border-top-dashed" id="meetingArranged1">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Nesta Technologies <small class="badge bg-primary-subtle text-primary">10
                                    Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
        ...
        <div class="col">
            <div class="card border-0 overflow-hidden">
                <a class="card-body bg-primary-subtle" data-bs-toggle="collapse" href="#offerAccepted" role="button"
            ...
            <div class="collapse show" id="offerAccepted">
                ...
                <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                    ...
                    <div class="collapse border-top border-top-dashed" id="offerAccepted2">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Nesta Technologies <small class="badge bg-success-subtle text-success">47
                                    Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
