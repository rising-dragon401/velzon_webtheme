            ...
            <div class="card card-animate">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-22 fw-bold ff-secondary mb-4">$<span class="counter-value"
        ...
        <div class="col-xl-3 col-md-6">
            ...
            <div class="card card-animate bg-info">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-22 fw-bold ff-secondary mb-4 text-white"><span class="counter-value"
                ...
                <div class="card-body p-0">
                    <div class="row row-cols-md-3 row-cols-1">
                        <div class="col col-lg border-end">
                            <div class="py-4 px-3">
                                <h5 class="text-muted text-uppercase fs-14">Campaign Sent <i
                        ...
                        <div class="col col-lg border-end">
                            <div class="mt-3 mt-md-0 py-4 px-3">
                                <h5 class="text-muted text-uppercase fs-14">Annual Profit <i
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h2 class="mt-4 ff-secondary fw-bold text-white"><span class="counter-value"
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card card-height-100">
                <div class="card-body">
                    ...
                    <a href="#!">
                        <h6 class="fs-15 fw-bold">Marketing Director <span class="text-muted fs-13">(2-4 Yrs Exp.)</span>
                        </h6>
                    </a>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card card-height-100">
                <div class="card-body">
                    ...
                    <a href="#!">
                        <h6 class="fs-15 fw-bold">Sr. Web Designer <span class="text-muted fs-13">(2+ Yrs Exp.)</span>
                        </h6>
                    </a>
                    <p class="text-muted mb-0"><i class="ri-building-line align-bottom"></i> Themesbrand <span
                            class="ms-2"><i class="ri-map-pin-2-line align-bottom"></i> California</span></p>
            ...
            <div class="card bg-primary">
                <div class="card-body p-0">
                    ...
                    <div class="row align-items-end">
                        <div class="col-sm-8">
                            <div class="p-3">
                                <p class="fs-16 lh-base text-white">Upgrade your plan from a <span class="fw-bold">Free
                                        trial</span>, to ‘Premium Plan’ <i class="mdi mdi-arrow-right"></i></p>
                                <div class="mt-3">
            ...
            <div class="card">
                <div class="card-body p-0">
                    ...
                    <div class="d-flex p-3">
                        ...
                        <div>
                            <p class="fs-16 lh-base">Personalized <span class="fw-bold">Gift Boxes</span>, with attitude,
                                Let's collect your Xmas box <i class="mdi mdi-arrow-right"></i></p>
                            <div class="mt-3">
                        ...
                        <li class="list-group-item ps-0">
                            <div class="row align-items-center g-3">
                                ...
                                <div class="col">
                                    ...
                                    <a href="#" class="text-reset fs-15 mb-0">Weekly closed sales won checking with
                                        sales team</a>
                                </div>
                                <div class="col-sm-auto">
                                    <div class="avatar-group">
                    ...
                    <div class="card card-height-100">
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="align-items-center p-3 justify-content-between d-flex">
                                <div class="flex-shrink-0">
                                    <div class="text-muted"><span class="fw-bold">4</span> of <span
                                            class="fw-bold">10</span> remaining</div>
                                </div>
                            ...
                            <div data-simplebar style="max-height: 364px;" class="p-3">
                                <div class="acitivity-timeline acitivity-main">
                                    ...
                                    <div class="acitivity-item py-3 d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h6 class="mb-1">Added new <span class="fw-bold">style collection</span>
                                            </h6>
                    ...
                    <div class="notification-elem" id="notification-overlay">
                        <div class="text-center">
                            ...
                            <div class="mt-4 pt-2">
                                ...
                                <div>
                                    <button type="button" class="btn btn-danger btn-sm w-sm" id="back-btn">Back to
                                        Home</button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-lg-6">
                        <div class="card-body text-center">
                            ...
                            <div>
                                <button type="button" class="btn btn-danger rounded-pill w-sm"><i
