                ...
                <table class="table align-middle table-nowrap" id="customerTable">
                    ...
                    <tbody class="list form-check-all">
                        <tr>
                            ...
                            <td class="valume"><h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>1.50%</h6></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td class="valume"><h6 class="text-danger mb-0"><i class="mdi mdi-trending-down align-middle me-1"></i>0.42%</h6></td>
                            <td>
                               <button class="btn btn-sm btn-soft-info">Trade Now</button>
                            </td>
                        </tr><!--end tr-->
                        <tr>
                            ...
                            <td class="market_cap">$314,520,675</td>
                            <td class="valume"><h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>0.89%</h6></td>
                            <td>
                               <button class="btn btn-sm btn-soft-info">Trade Now</button>
                            </td>
                        </tr><!--end tr-->
                        <tr>
                            ...
                            <td class="valume"><h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>1.92%</h6></td>
                            <td>
                               <button class="btn btn-sm btn-soft-info">Trade Now</button>
                            </td>
                        </tr><!--end tr-->
                        <tr>
                            ...
                            <td class="valume"><h6 class="text-danger mb-0"><i class="mdi mdi-trending-down align-middle me-1"></i>2.87%</h6></td>
                            <td>
                               <button class="btn btn-sm btn-soft-info">Trade Now</button>
                            </td>
                        </tr><!--end tr-->
                        <tr>
                            ...
                            <td class="valume"><h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>3.96%</h6></td>
                            <td>
                               <button class="btn btn-sm btn-soft-info">Trade Now</button>
                            </td>
                        </tr><!--end tr-->
                        <tr>
                            ...
                            <td class="valume"><h6 class="text-danger mb-0"><i class="mdi mdi-trending-down align-middle me-1"></i>0.84%</h6></td>
                            <td>
                               <button class="btn btn-sm btn-soft-info">Trade Now</button>
                            </td>
                        </tr><!--end tr-->
                        <tr>
                            ...
                            <td class="market_cap">$156,209,195.18</td>
                            <td class="valume"><h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>8.20%</h6></td>
                            <td>
                               <button class="btn btn-sm btn-soft-info">Trade Now</button>
                            </td>
                        </tr><!--end tr-->
                        ...
                        <tr>
                            ...
                            <td class="market_cap">$880,387,980.14</td>
                            <td class="valume"><h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>1.03%</h6></td>
                            <td>
                               <button class="btn btn-sm btn-soft-info">Trade Now</button>
                            </td>
                        </tr><!--end tr-->
