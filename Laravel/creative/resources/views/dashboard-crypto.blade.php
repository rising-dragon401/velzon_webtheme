...
@endsection
@section('css')
    <link href="{{ URL::asset('build/libs/swiper/swiper.min.css') }}" rel="stylesheet">
@endsection
@section('content')
                                        ...
                                        <div class="col-6">
                                            <div class="d-flex flex-wrap gap-4 align-items-center">
                                                ...
                                                <p class="fw-semibold text-muted mb-0">High <span
                                                        class="text-body fs-13 ms-1">0.014578</span></p>
                                                <p class="fw-semibold text-muted mb-0">Low <span
                                                        class="text-body fs-13 ms-1">0.0175489</span>
                                                </p>
                                            </div>
                                        </div><!-- end col -->
                                        <div class="col-6">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-success fw-semibold mb-0">+13.11%<span
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-success fw-semibold mb-0">+15.08%<span
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-success fw-semibold mb-0">+08.57%<span
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-success fw-semibold mb-0">+12.07%<span
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-success fw-semibold mb-0">+14.99%<span
