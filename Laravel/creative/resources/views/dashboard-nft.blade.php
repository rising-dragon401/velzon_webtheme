                    ...
                    <div class="card overflow-hidden">
                        <div class="card-body bg-marketplace d-flex">
                            <div class="flex-grow-1">
                                <h4 class="fs-18 lh-base fw-bold mb-0">Discover, Collect, Sell and Create <br> your own
                                    <span class="text-success">NFTs.</span> </h4>
                        ...
                        <div class="card explore-box card-animate rounded">
                            ...
                            <div class="card-body">
                                <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                    37.41k </p>
                                <h5 class="mb-1"><a href="apps-nft-item-details" class="text-body">Walking On
                                        Air</a></h5>
                                <p class="text-muted mb-0">Artwork</p>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="card explore-box card-animate rounded">
                            ...
                            <div class="card-body">
                                <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                    15.93k </p>
                                <h5 class="mb-1"><a href="apps-nft-item-details" class="text-body">Evolved
                                        Reality</a></h5>
                        ...
                        <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><img src="{{ URL::asset('build/images/svg/crypto-icons/btc.svg') }}" class="avatar-xxs me-2"
                                            alt="">48,568.025</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{ URL::asset('build/images/svg/crypto-icons/ltc.svg') }}" class="avatar-xxs me-2"
                                            alt="">87,142.027</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{ URL::asset('build/images/svg/crypto-icons/etc.svg') }}" class="avatar-xxs me-2"
                                            alt="">33,847.961</td>
                                    <td>
                                        <span class="text-success mb-0"><i
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{ URL::asset('build/images/svg/crypto-icons/dash.svg') }}" class="avatar-xxs me-2"
                                            alt="">73,654.421</td>
                                    <td>
                                        <span class="text-success mb-0"><i
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{ URL::asset('build/images/svg/crypto-icons/bnb.svg') }}" class="avatar-xxs me-2"
                                            alt="">66,742.077</td>
                                    <td>
                                        <span class="text-danger mb-0"><i
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1"><a href="apps-nft-item-details"
                                                        class="text-body">The Chirstoper</a></h6>
                                                <p class="text-muted fs-13 mb-0"> Crypto Card</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td><img src="{{ URL::asset('build/images/svg/crypto-icons/usdt.svg') }}" class="avatar-xxs me-2"
                                            alt="">34,736.209</td>
                                    <td>
                                        <span class="text-success mb-0"><i
        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card card-height-100">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-1">
                        <p class="mb-1"><img src="{{ URL::asset('build/images/flags/us.svg') }}" alt="" height="15"
                                class="rounded me-2"> United States <span class="float-end">34%</span></p>
                        <p class="mb-1"><img src="{{ URL::asset('build/images/flags/russia.svg') }}" alt="" height="15"
                                class="rounded me-2"> Russia <span class="float-end">27%</span></p>
                        <p class="mb-1"><img src="{{ URL::asset('build/images/flags/spain.svg') }}" alt="" height="15"
                                class="rounded me-2"> Spain <span class="float-end">21%</span></p>
                        <p class="mb-1"><img src="{{ URL::asset('build/images/flags/italy.svg') }}" alt="" height="15"
                                class="rounded me-2"> Italy <span class="float-end">13%</span></p>
                        <p class="mb-0"><img src="{{ URL::asset('build/images/flags/germany.svg') }}" alt="" height="15"
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="dash-collection overflow-hidden rounded-top position-relative">
                                    <img src="{{ URL::asset('build/images/nft/img-03.jpg') }}" alt="" height="220"
                            ...
                            <div class="swiper-slide">
                                <div class="dash-collection overflow-hidden rounded-top position-relative">
                                    <img src="{{ URL::asset('build/images/nft/img-04.jpg') }}" alt="" height="220"
                                        class="object-fit-cover w-100" />
                                    <div
                                        class="content position-absolute bottom-0 m-2 p-2 start-0 end-0 rounded d-flex align-items-center">
                                        <div class="flex-grow-1">
                            ...
                            <div class="swiper-slide">
                                <div class="dash-collection overflow-hidden rounded-top position-relative">
                                    <img src="{{ URL::asset('build/images/nft/img-06.jpg') }}" alt="" height="220"
                                        class="object-fit-cover w-100" />
                                    <div
                                        class="content position-absolute bottom-0 m-2 p-2 start-0 end-0 rounded d-flex align-items-center">
                                        <div class="flex-grow-1">
