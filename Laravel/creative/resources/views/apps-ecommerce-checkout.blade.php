                                        ...
                                        <div class="col-lg-4 col-sm-6">
                                            <div class="form-check card-radio">
                                                ...
                                                <label class="form-check-label" for="shippingAddress01">
                                                    <span
                                                        class="mb-4 fw-bold d-block text-muted text-uppercase">Home
                                                        Address</span>
                                        ...
                                        <div class="col-lg-4 col-sm-6">
                                            <div class="form-check card-radio">
                                                ...
                                                <label class="form-check-label" for="shippingAddress02">
                                                    <span
                                                        class="mb-4 fw-bold d-block text-muted text-uppercase">Office
                                                        Address</span>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-check card-radio">
                                                    ...
                                                    <label class="form-check-label"
                                                        ...
                                                        <span
                                                            class="fs-20 float-end mt-2 text-wrap d-block fw-bold">Free</span>
                                                        <span class="fs-16 mb-1 text-wrap d-block">Free
                                                            Delivery</span>
                                                        <span
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-check card-radio">
                                                    ...
                                                    <label class="form-check-label"
                                                        ...
                                                        <span
                                                            class="fs-20 float-end mt-2 text-wrap d-block fw-bold">$24.99</span>
                                                        <span
                                                            class="fs-16 mb-1 text-wrap d-block">Express
                                                            Delivery</span>
                                                        <span
