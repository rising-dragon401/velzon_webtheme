            ...
            <div class="card card-height-100">
                <div class="card-body">
                    ...
                    <div class="progress animated-progress custom-progress mb-1">
                        <div class="progress-bar bg-primary" role="progressbar" style="width: 38%" aria-valuenow="38"
                            aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <p class="text-muted mb-2">You used 215 of 2000 of your API</p>
                    <div class="text-end">
                        <button type="button" class="btn btn-secondary btn-sm create-btn" data-bs-toggle="modal"
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h1 class="mt-4 ff-secondary fw-bold"><span class="counter-value" data-target="50"></span></h2>
                ...
                <div class="card-header d-flex align-items-center">
                    ...
                    <div class="d-flex gap-1 flex-wrap">
                        ...
                        <button type="button" class="btn btn-primary create-btn" data-bs-toggle="modal"
                            data-bs-target="#api-key-modal"><i class="ri-add-line align-bottom me-1"></i> Add New</button>
                    </div>
                </div>
                <div class="card-body">
                    <div>
                            ...
                            <table class="table align-middle table-nowrap mb-0">
                                ...
                                <tbody class="list form-check-all">
                                    <tr>
                                        ...
                                        <td class="status"><span class="badge bg-danger-subtle text-danger">Disable</span>
                                        </td>
