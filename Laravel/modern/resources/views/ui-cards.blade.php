            ...
            <div class="row">
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="row g-0">
                            ...
                            <div class="col-md-4">
                                <img class="rounded-end img-fluid h-100 object-fit-cover" src="{{ URL::asset('build/images/small/img-4.jpg') }}"
                                    alt="Card image">
                            </div>
                        </div>
                    </div><!-- end card -->
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img class="rounded-start img-fluid h-100 object-fit-cover" src="{{ URL::asset('build/images/small/img-9.jpg') }}"
                                    alt="Card image">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="row g-0">
                            ...
                            <div class="col-md-4">
                                <img class="rounded-end img-fluid h-100 object-fit-cover" src="{{ URL::asset('build/images/small/img-2.jpg') }}"
                                    alt="Card image">
                            </div>
                        </div>
                    </div><!-- end card -->
