                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-success fw-medium mb-0">+15.08%<span
                                                class="text-muted ms-2 text-uppercase">(ltc)</span></p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                                            data-colors='["--vz-success", "--vz-transparent"]'
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-success fw-medium mb-0">+08.57%<span
                                                class="text-muted ms-2 text-uppercase">(etc)</span></p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                                            data-colors='["--vz-success", "--vz-transparent"]'
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-danger fs-13 fw-medium mb-0">-09.21%<span
                                                class="text-muted ms-2 text-uppercase">(bnb)</span></p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-success fw-medium mb-0">+12.07%<span
                                                class="text-muted ms-2 text-uppercase">(dash)</span></p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-success fw-medium mb-0">+14.99%<span
                                                class="text-muted ms-2 text-uppercase">(usdt)</span></p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-danger fs-13 fw-medium mb-0">-05.07%<span
                                                class="text-muted ms-2 text-uppercase">(neo)</span></p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
