            ...
            <div class="card">
                <div class="card-body">
                    <p class="text-muted">Use <code>nav-pills</code> class to generate particular selected nav links
                        without borders.</p>
                    <!-- Nav tabs -->
                    <ul class="nav nav-pills nav-info mb-3" role="tablist">
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content text-muted">
                        <div class="tab-pane active" id="home2" role="tabpanel">
                            <p class="flex-grow-1 mb-0"><img src="{{ URL::asset('build/images/users/avatar-2.jpg') }}"
        ...
        <div class="col-xxl-6">
            ...
            <div class="card">
                <div class="card-body">
                    <p class="text-muted">Use <code>nav-custom-</code> class with modifier class to color tabs.</p>
                    <!-- Nav tabs -->
                    <ul class="nav nav-pills nav-custom nav-custom-info mb-3" role="tablist">
                        <li class="nav-item">
