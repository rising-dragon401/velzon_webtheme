    ...
    <div class="row">
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div id="area_chart_negative" data-colors='["--vz-primary", "--vz-info"]' class="apex-charts"
                        dir="ltr"></div>
                </div><!-- end card-body -->
            </div><!-- end card -->
        </div>
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div>
                        <div class="bg-light">
                            <div id="area_chart-months" data-colors='["--vz-info"]' class="apex-charts" dir="ltr">
                            </div>
                        </div>
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div id="area_chart_stacked" data-colors='["--vz-primary", "--vz-info", "--vz-gray-300"]'
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div id="area_chart_irregular" data-colors='["--vz-primary", "--vz-info", "--vz-gray-300"]'
                        class="apex-charts" dir="ltr"></div>
                </div><!-- end card-body -->
            </div><!-- end card -->
        </div>
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div id="area-missing-null-value" data-colors='["--vz-primary"]' class="apex-charts" dir="ltr">
                    </div>
                </div><!-- end card-body -->
            </div><!-- end card -->
        </div>
