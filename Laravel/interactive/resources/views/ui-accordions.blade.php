    ...
    <div class="row">
        <div class="col-xxl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>custom-accordionwithicon</code> class to show custom icon at
                        accordion.</p>
                    <div class="live-preview">
    ...
    <div class="row">
        <div class="col-xxl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>lefticon-accordion</code> class to show the icon on the left side
                        of the accordion.</p>
                    <div class="live-preview">
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="accordionnesting2Example1">
                                                    <button class="accordion-button" type="button"
                                                        ...
                                                        aria-expanded="true" aria-controls="accor_nesting2Examplecollapse1">
                                ...
                                <div class="accordion custom-accordionwithicon accordion-fill-success" id="accordionFill">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="accor_fill3" class="accordion-collapse collapse"
                                            aria-labelledby="accordionFillExample3" data-bs-parent="#accordionFill">
                                            <div class="accordion-body">
                                ...
                                <div class="accordion custom-accordionwithicon accordion-flush accordion-fill-secondary"
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="accor_fill23" class="accordion-collapse collapse"
                                            aria-labelledby="accordionFill2Example3" data-bs-parent="#accordionFill2">
                                            <div class="accordion-body">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use the <code>collapse-horizontal</code> class to transition the
                        ...
                        child element for horizontal collapse.</p>
                    <div class="live-preview">
                        <div class="mb-3">
                            <button class="btn btn-primary" type="button" data-bs-toggle="collapse"
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <div class="hstack gap-3 mb-3">
                            <a class="link-success" data-bs-toggle="collapse" href="#collapseWithicon" role="button"
                                aria-expanded="true" aria-controls="collapseWithicon">
                    ...
                    <div class="live-preview">
                        <div class="mb-3">
                            ...
                            <span role="button" class="text-primary fw-medium" data-bs-toggle="collapse"
                                data-bs-target="#collapseinline" aria-expanded="true" aria-controls="collapseinline">
