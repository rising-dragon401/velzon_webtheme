<?php echo $this->render('partials/main'); ?>
    ...
    <head>
        ...
        <?php echo $this->render('partials/title-meta', array('title'=>'Candidate Grid View')); ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <?php echo $this->render('partials/page-title', array('pagetitle'=>'Candidate Lists', 'title'=>'Grid View')); ?>
