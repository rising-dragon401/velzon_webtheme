...
<head>
    ...
    <?php echo $this->render('partials/title-meta', array('title'=>'Month Grid Calendar')); ?>
...
<body>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo $this->render('partials/page-title', array('pagetitle'=>'Apps', 'title'=>'Month Grid')); ?>
    ...
    <!-- Calendar init -->
    <script src="/js/pages/calendar-month-grid.init.js"></script>
