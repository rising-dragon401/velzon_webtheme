...
<head>
    ...
    <?php echo $this->render('partials/title-meta', array('title' => 'Pricing')); ?>
...
<body>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo $this->render('partials/page-title', array('pagetitle'=>'Pages', 'title'=>'Pricing')); ?>
                            ...
                            <div class="text-center mb-4">
                                ...
                                <div class="d-inline-flex">
                                    <ul class="nav nav-pills arrow-navtabs plan-nav rounded mb-3 p-1" id="pills-tab" role="tablist">
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link fw-semibold" id="annual-tab" data-bs-toggle="pill" data-bs-target="#annual" type="button" role="tab" aria-selected="false">Annually <span class="badge bg-success">25%
                                                    Off</span></button>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <div class="card pricing-box">
                                        <div class="card-body p-4 m-2">
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-4">
                                                    <a href="javascript:void(0);" class="btn btn-soft-success w-100 waves-effect waves-light">Sign
                                                        up free</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card pricing-box ribbon-box right">
                                        <div class="card-body p-4 m-2">
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-4">
                                                    <a href="javascript:void(0);" class="btn btn-success w-100 waves-effect waves-light">Get
                                                        started</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card pricing-box">
                                        <div class="card-body p-4 m-2">
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-4">
                                                    <a href="javascript:void(0);" class="btn btn-soft-success w-100 waves-effect waves-light">Get
                                                        started</a>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script src="/js/pages/pricing.init.js"></script>
