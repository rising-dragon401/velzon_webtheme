...
<head>
    ...
    <?php echo $this->render('partials/title-meta', array('title' => 'Apex Pie Charts')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo $this->render('partials/page-title', array('pagetitle'=>'Apexcharts', 'title'=>'Pie Charts')); ?>
