...
<head>
    ...
    <?php echo $this->render('partials/title-meta', array('title'=>'Animation')); ?>
...
<body>
        ...
        <div class="main-content overflow-hidden">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo $this->render('partials/page-title', array('pagetitle'=>'Advance UI', 'title'=>'Animation')); ?>
                                                        ...
                                                        <div class="row justify-content-center">
                                                            <div class="col-sm-10 col-lg-8">
                                                                <div data-aos="fade-up">
                                                                    <img src="/images/mac-img.png" alt="Mac Image" class="img-fluid">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <!-- animation init -->
    <script src="/js/pages/animation-aos.init.js"></script>
