                                        ...
                                        <div class="list-group-item nested-1">
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-xs flex-shrink-0 me-3">
                                                    <img src="/images/users/avatar-1.jpg" alt="" class="img-fluid rounded-circle shadow">
                                                </div>
                                            ...
                                            <div class="list-group nested-list nested-sortable">
                                                <div class="list-group-item nested-2">
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar-xs flex-shrink-0 me-3">
                                                            <img src="/images/users/avatar-2.jpg" alt="" class="img-fluid rounded-circle shadow">
                                                        </div>
                                                        <div class="flex-grow-1">
                                                    ...
                                                    <div class="list-group nested-list nested-sortable">
                                                        <div class="list-group-item nested-3">
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar-xs flex-shrink-0 me-3">
                                                                    <img src="/images/users/avatar-6.jpg" alt="" class="img-fluid rounded-circle shadow">
                                                                </div>
                                                                <div class="flex-grow-1">
