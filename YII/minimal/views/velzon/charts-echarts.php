...
<head>
    ...
    <?php echo $this->render('partials/title-meta', array('title'=>'E Charts')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo $this->render('partials/page-title', array('pagetitle'=>'Charts', 'title'=>'E Charts')); ?>
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div id="chart-step-line" data-colors='["--vz-primary", "--vz-light", "--vz-info"]' class="e-charts"></div>
                                </div>
                            </div>
                            <!-- end card -->
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div id="chart-bar-label-rotation" data-colors='["--vz-primary", "--vz-info", "--vz-success", "--vz-light"]' class="e-charts"></div>
                                </div>
                            </div>
                            <!-- end card -->
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div id="chart-horizontal-bar-stacked" data-colors='["--vz-primary", "--vz-success", "--vz-warning", "--vz-light", "--vz-info"]' class="e-charts"></div>
                                </div>
                            </div>
                            <!-- end card -->
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div id="chart-pie" data-colors='["--vz-primary", "--vz-success", "--vz-warning", "--vz-light", "--vz-info"]' class="e-charts"></div>
                                </div>
                            </div>
                            <!-- end card -->
                        </div>
