...
<head>
    ...
    <?php echo $this->render('partials/title-meta', array('title' => 'Swiper Slider')); ?>
...
<body>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo $this->render('partials/page-title', array('pagetitle'=>'Advance UI', 'title'=>'Swiper Slider')); ?>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="swiper pagination-dynamic-swiper rounded">
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide">
                                                <img src="/images/small/img-8.jpg" alt="" class="img-fluid" />
                                            </div>
                                            <div class="swiper-slide">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="swiper pagination-fraction-swiper rounded">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <img src="/images/small/img-10.jpg" alt="" class="img-fluid" />
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="/images/small/img-11.jpg" alt="" class="img-fluid" />
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="/images/small/img-12.jpg" alt="" class="img-fluid" />
                                            </div>
                                        </div>
                                        <div class="swiper-button-next"></div>
                                        <div class="swiper-button-prev"></div>
    ...
    <!-- swiper.init js -->
    <script src="/js/pages/swiper.init.js"></script>
