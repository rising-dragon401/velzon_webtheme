...
<head>
    ...
    <?php echo $this->render('partials/title-meta', array('title'=>'Nestable List')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo $this->render('partials/page-title', array('pagetitle'=>'Advance UI', 'title'=>'Nestable List')); ?>
                                        ...
                                        <div class="list-group-item nested-1">
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-xs flex-shrink-0 me-3">
                                                    <img src="/images/users/avatar-1.jpg" alt="" class="img-fluid rounded-circle material-shadow">
                                                </div>
                                            ...
                                            <div class="list-group nested-list nested-sortable">
                                                <div class="list-group-item nested-2">
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar-xs flex-shrink-0 me-3">
                                                            <img src="/images/users/avatar-2.jpg" alt="" class="img-fluid rounded-circle material-shadow">
                                                        </div>
                                                        <div class="flex-grow-1">
                                                    ...
                                                    <div class="list-group nested-list nested-sortable">
                                                        <div class="list-group-item nested-3">
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar-xs flex-shrink-0 me-3">
                                                                    <img src="/images/users/avatar-6.jpg" alt="" class="img-fluid rounded-circle material-shadow">
                                                                </div>
                                                                <div class="flex-grow-1">
                                                            ...
                                                            <div class="list-group nested-list nested-sortable">
                                                                <div class="list-group-item nested-4">
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="avatar-xs flex-shrink-0 me-3">
                                                                            <img src="/images/users/avatar-7.jpg" alt="" class="img-fluid rounded-circle material-shadow">
                                                                        </div>
                                                                        <div class="flex-grow-1">
