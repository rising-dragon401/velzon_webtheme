...
<head>
    ...
    <?php echo $this->render('partials/title-meta', array('title'=>'Material Design Icons')); ?>
...
<body>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo $this->render('partials/page-title', array('pagetitle'=>'Icons', 'title'=>'Material Design')); ?>
    ...
    <script src="/js/pages/materialdesign.list.js"></script>
