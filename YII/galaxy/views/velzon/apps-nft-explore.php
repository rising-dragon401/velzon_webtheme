...
<head>
    ...
    <?php echo $this->render('partials/title-meta', array('title'=>'Explore Now')); ?>
...
<body>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo $this->render('partials/page-title', array('pagetitle'=>'NFT Marketplace', 'title'=>'Explore Now')); ?>
                            ...
                            <div class="card">
                                <div class="card-header border-0">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <a class="btn btn-priamry" data-bs-toggle="collapse" href="#collapseExample"><i class="ri-filter-2-line align-bottom"></i> Filters</a>
                                        </div>
                                    </div>
                                    <div class="collaps show" id="collapseExample">
                                        <div class="row row-cols-xxl-5 row-cols-lg-3 row-cols-md-2 row-cols-1 mt-3 g-3">
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="slider" id="range-product-price" data-slider-color="primary"></div>
                    ...
                    <div class="text-center mb-3">
                        <button class="btn btn-link text-primary mt-2" id="loadmore"><i class="mdi mdi-loading mdi-spin fs-20 align-middle me-2"></i> Load More </button>
                    </div>
                </div>
                <!-- container-fluid -->
            </div>
    ...
    <script src="/js/pages/apps-nft-explore.init.js"></script>
