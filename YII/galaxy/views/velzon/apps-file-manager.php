                        ...
                        <div class="file-manager-detail-content p-3 py-0 border">
                            <div class="mx-n3 pt-3 px-3 file-detail-content-scroll" data-simplebar>
                                <div id="folder-overview">
                                    ...
                                    <div id="simple_dount_chart" data-colors='["--vz-primary", "--vz-primary-rgb, 0.75", "--vz-primary-rgb, 0.60", "--vz-primary-rgb, 0.40"]' class="apex-charts mt-3" dir="ltr"></div>
                                    <div class="mt-4">
                        ...
                        <div class="modal-body">
                            <form autocomplete="off" class="needs-validation createfile-form" id="createfile-form" novalidate>
                                <div class="mb-4">
                                    ...
                                    <input type="hidden" class="form-control" id="fileid-input" value="" placeholder="Enter folder name">
                                </div>
                                <div class="hstack gap-2 justify-content-end">
                                    <button type="button" class="btn btn-ghost-danger" data-bs-dismiss="modal"><i class="ri-close-line align-bottom"></i> Close</button>
