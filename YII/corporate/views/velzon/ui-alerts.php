                                    ...
                                    <div class="live-preview">
                                        <div class="row">
                                            <div class="col-xl-6">
                                                ...
                                                <h6>Secondary Alert</h6>
                                                <div class="alert alert-secondary alert-dismissible bg-primary text-white alert-label-icon fade show" role="alert">
                                                ...
                                                <h6>Success Alert</h6>
                                                <div class="alert alert-success alert-dismissible bg-primary text-white alert-label-icon fade show" role="alert">
                                                ...
                                                <h6>Danger Alert</h6>
                                                <div class="alert alert-danger alert-dismissible bg-primary text-white alert-label-icon fade show mb-xl-0" role="alert">
                                            ...
                                            <div class="col-xl-6">
                                                <h6>Warning Alert</h6>
                                                <div class="alert alert-warning alert-dismissible bg-primary text-white alert-label-icon fade show" role="alert">
                                                ...
                                                <h6>Info Alert</h6>
                                                <div class="alert alert-info alert-dismissible bg-primary text-white alert-label-icon fade show" role="alert">
                                                ...
                                                <h6>Light Alert</h6>
                                                <div class="alert alert-light alert-dismissible bg-primary text-white alert-label-icon fade show" role="alert">
                                                ...
                                                <h6>Dark Alert</h6>
                                                <div class="alert alert-dark alert-dismissible bg-primary text-white alert-label-icon fade show mb-0" role="alert">
...
<code>&lt;!-- Danger Alert --&gt;
&lt;div class=&quot;alert alert-danger alert-dismissible bg-primary text-white alert-label-icon fade show&quot; role=&quot;alert&quot;&gt;
...
<code>&lt;!-- Light Alert --&gt;
&lt;div class=&quot;alert bg-light border-light text-white&quot; role=&quot;alert&quot;&gt;
