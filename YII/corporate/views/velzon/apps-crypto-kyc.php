...
<head>
    ...
    <?php echo $this->render('partials/title-meta', array('title'=>'KYC Application')); ?>
...
<body>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo $this->render('partials/page-title', array('pagetitle'=>'Crypto', 'title'=>'KYC Application')); ?>
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="d-flex align-items-start gap-3 mt-3">
                                                            <button type="button" class="btn btn-secondary btn-label right ms-auto nexttab" data-nexttab="pills-bill-address-tab"><i class="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i> Next Step</button>
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="hstack align-items-start gap-3 mt-4">
                                                            ...
                                                            <button type="button" class="btn btn-secondary btn-label right ms-auto nexttab" data-nexttab="pills-payment-tab"><i class="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i>Next Step</button>
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                </div>
                                                ...
                                                <div class="row text-center justify-content-center py-4">
                                                    <div class="col-lg-11">
                                                        ...
                                                        <div class="hstack justify-content-center gap-2">
                                                            ...
                                                            <button type="button" class="btn btn-secondary"><i class="ri-home-4-line align-bottom ms-1"></i> Back to Home</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <!--crypto-kyc init-->
    <script src="/js/pages/crypto-kyc.init.js"></script>
