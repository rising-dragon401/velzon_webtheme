                        ...
                        <div class="col-xxl-3 col-lg-6">
                            <div class="card pricing-box ribbon-box right">
                                <div class="card-body bg-light m-2 p-4">
                                    ...
                                    <p class="text-muted">This plan is for those who have a team mb-4 and running a large business.</p>
                                    <ul class="list-unstyled vstack gap-3">
                                        <li>
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 text-success me-1">
                                    ...
                                    <div class="card pricing-box">
                                        <div class="card-body p-4 m-2">
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-4">
                                                    <a href="javascript:void(0);" class="btn btn-soft-info w-100 waves-effect waves-light">Sign up free</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card pricing-box ribbon-box right">
                                        <div class="card-body p-4 m-2">
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-4">
                                                    <a href="javascript:void(0);" class="btn btn-info w-100 waves-effect waves-light">Get started</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card pricing-box">
                                        <div class="card-body p-4 m-2">
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-4">
                                                    <a href="javascript:void(0);" class="btn btn-soft-info w-100 waves-effect waves-light">Get started</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
