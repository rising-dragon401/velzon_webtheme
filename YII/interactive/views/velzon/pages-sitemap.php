...
<head>
    ...
    <?php echo $this->render('partials/title-meta', array('title'=>'Sitemap')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo $this->render('partials/page-title', array('pagetitle'=>'Pages', 'title'=>'Sitemap')); ?>
                                                            ...
                                                            <ul class="departments">
                                                                ...
                                                                <li class="department">
                                                                    ...
                                                                    <ul>
                                                                        ...
                                                                        <li><a href="javascript:void(0);"><span>Confirmation</span></a></li>
                                                                    </ul>
                                                                </li>
                                                                <li class="department">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="verti-sitemap">
                                                <ul class="list-unstyled mb-0">
                                                    <li class="p-0 parent-title"><a href="javascript: void(0);" class="fw-semibold fs-14">Nancy Martino - Project Director</a>
                                                    </li>
                                                    <li>
                                                        <div class="first-list">
                                                            <div class="list-wrap">
                                                                <a href="javascript: void(0);" class="fw-semibold text-primary">Erica Kernan - Team Leader</a>
                                                            </div>
                                                        ...
                                                        <div class="first-list">
                                                            <div class="list-wrap">
                                                                <a href="javascript: void(0);" class="fw-semibold text-primary">Mary Jones - Project Manager</a>
                                                            </div>
                                                            <ul class="second-list list-unstyled">
                                                        ...
                                                        <div class="first-list">
                                                            <div class="list-wrap">
                                                                <a href="javascript: void(0);" class="fw-semibold text-primary">Tilly Kent - Executive Manager</a>
                                                            </div>
                                                            <ul class="second-list list-unstyled">
                                                                <li>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="verti-sitemap">
                                                <ul class="list-unstyled mb-0">
                                                    <li class="p-0 parent-title"><a href="javascript: void(0);" class="fw-semibold fs-14">Velzon</a></li>
                                                    <li>
                                                        <div class="first-list">
                                                            <div class="list-wrap">
                                                                <a href="javascript: void(0);" class="fw-semibold text-primary"><i class="ri-airplay-line me-1 align-bottom"></i>
                                                                    Dashboards</a>
                                                            </div>
                                                            <ul class="second-list list-unstyled">
                                                                <li>
                                                        ...
                                                        <div class="first-list">
                                                            <div class="list-wrap">
                                                                <a href="javascript: void(0);" class="fw-semibold text-primary"><i class="ri-pencil-ruler-2-line me-1 align-bottom"></i>
                                                                    App Pages</a>
                                                            </div>
                                                            <ul class="second-list list-unstyled">
                                                        ...
                                                        <div class="first-list">
                                                            <div class="list-wrap">
                                                                <a href="javascript: void(0);" class="fw-semibold text-primary"><i class="ri-file-list-3-line me-1 align-bottom"></i> Pages</a>
                                                            </div>
                                                        </div>
                                                        <div class="first-list">
                                                            <div class="list-wrap">
                                                                <a href="javascript: void(0);" class="fw-semibold text-primary"><i class="ri-stack-line me-1 align-bottom"></i> Components</a>
                                                            </div>
                                                            <ul class="second-list list-unstyled">
                                                                <li>
