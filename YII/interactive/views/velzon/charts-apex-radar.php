...
<head>
    ...
    <?php echo $this->render('partials/title-meta', array('title'=>'Apex Radar Charts')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo $this->render('partials/page-title', array('pagetitle'=>'Apexcharts', 'title'=>'Radar Charts')); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div id="multi_radar" data-colors='["--vz-gray-300", "--vz-success", "--vz-primary"]' class="apex-charts" dir="ltr"></div>
                                </div><!-- end card-body -->
                            </div><!-- end card -->
                        </div>
                        <!-- end col -->
