...
<head>
    ...
    <?php echo $this->render('partials/title-meta', array('title'=>'Line Awesome Icons')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo $this->render('partials/page-title', array('pagetitle'=>'Icons', 'title'=>'Line Awesome')); ?>
