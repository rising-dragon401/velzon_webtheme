...
from apps.views import(
    ...
    apps_job_candidate_list_view,
    apps_job_companies_list_view,
    apps_job_categories_view,
    apps_job_detail_view,
    apps_job_grid_list_view,
    apps_job_list_view,
    apps_job_new_view,
    apps_job_statistic_view,
...
urlpatterns = [
    ...
    path("job/candidate-lists", view=apps_job_candidate_list_view, name="job.candidate_lists"),
    ...
    path("job/detail", view=apps_job_detail_view, name="job.details"),
    path("job/grid-list", view=apps_job_grid_list_view, name="job.grid_lists"),
    path("job/list", view=apps_job_list_view, name="job.lists"),
    path("job/new", view=apps_job_new_view, name="job.new"),
    path("job/statistic", view=apps_job_statistic_view, name="job.statistics"),
