...
from apps.views import(
    ...
    apps_tickets_list_update_view,
    apps_tickets_list_delete_view,
...
urlpatterns = [
    ...
    path("crm/update-companies/<int:pk>", view=apps_crm_update_companies_view, name="crm.update_companies"),
    ...
    path("crm/update-leads/<int:pk>", view=apps_crm_update_leads_view, name="crm.update_leads"),
    ...
    path("support-tickets/update-list/<int:pk>", view=apps_tickets_list_update_view, name="tickets.update_list"),
    path("support-tickets/delete-list/<int:pk>", view=apps_tickets_list_delete_view, name="tickets.delete_list"),
