...
from . models import CrmCompany,CrmContact,CrmLead,JobApplication,EcommerceOrder
from . forms import *
...
def apps_ecommerce_delete_orders_view(request):
    orders = EcommerceOrder.objects.all().order_by('-id')
    orders.delete()
...
def apps_ecommerce_delete_customers_view(request):
    customers = EcommerceCustomer.objects.all().order_by('-id')
    customers.delete()
...
def apps_tickets_delete_list_view(request):
    tickets = TicketList.objects.all().order_by('-id')
    tickets.delete()
